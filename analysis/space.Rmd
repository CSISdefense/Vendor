...
launch_residual<-launch_residual%>%group_by_list(common_cols[!common_cols %in% c("Action_Obligation_Then_Year",
  "Action_Obligation_OMB25_GDP23")])%>%summarise(
    Action_Obligation_Then_Year=sum(Action_Obligation_Then_Year,na.rum=TRUE),
        Action_Obligation_OMB25_GDP23=sum(Action_Obligation_OMB25_GDP23,na.rum=TRUE)
  )
...
launch_residual<-launch_residual %>% mutate(
  Residual_Action_Obligation_OMB25_GDP23=
    ifelse(is.na(Action_Obligation_OMB25_GDP23),Total_Action_Obligation_OMB25_GDP23,
           Total_Action_Obligation_OMB25_GDP23-Action_Obligation_OMB25_GDP23),
  Action_Obligation_Then_Year=
    ifelse(is.na(Action_Obligation_Then_Year),Total_Action_Obligation_Then_Year,
           Total_Action_Obligation_Then_Year-Action_Obligation_Then_Year))
...
launch_residual$SpaceParentID<-"Residual"
...
colnames(launch_residual)[colnames(launch_residual)=="Action_Obligation_Then_Year"]<-"Action_Obligation_Then_Year"
...
launch<-read_and_join_experiment(launch,path="",dir=file.path("..","output","space"),lookup_file="space_psc.csv",
                                add_var="SpaceArea",by=c("ProductOrServiceCode","ProductOrServiceCodeText",
                                                         "ProductServiceOrRnDarea"))
launch_plus<-read_and_join_experiment(launch,path="",dir=file.path("..","output","space"),lookup_file="space_psc.csv",
                                add_var="SpaceArea",by=c("ProductOrServiceCode","ProductOrServiceCodeText",
                                                         "ProductServiceOrRnDarea"))
