...
$β_{2}cl\_def6\_HHI\_lag1_{i}~+~β_{3}Comp1Offr~+~β_{4}Comp2Offr~+~β_{5}Comp3–4Offr_{i}+$

$β_{6}Comp5plusOffr_{i}~+β_{7}cl\_def3\_ratio\_lag1_{i}~+~β_{8}cl\_def6\_obl\_lag1_{i}~+$

$β_{9}cl\_def6\_ratio\_lag1_{i}+~β_{10}cl\_US6\_avg\_sal\_lag1_{i}~+β_{11}cl\_Ceil\_Then\_Year_{i}~+$

$β_{12}cl\_Days_{i}~+~β_{13}SIDC_{i}~+β_{14}MIDC_{i}+~β_{15}FSS–GWAC_{i}+~β_{16}BPA–BOA_{i}~+$
