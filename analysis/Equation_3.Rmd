...
$β_{22}b\_UCA_{i}~+~β_{23}b\_Intl_{i}~+~β_{24}cl\_Ceil\_Then\_Year_{i}·b\_UCA_{i}~+~cl\_def6\_HHI\_lag1l_{i}·cl\_def6\_obl\_lag1_{i}~+$

$β_{25}β_{26}cl\_def3\_HHI\_lag1_{i}·cl\_def3\_ratio\_lag1_{i}~+~ε_{i}),~for~i=1~to~1,000,000$

$$a^{NAICS3}_{j}\sim~N(μ_{α},σ^{2}_{α}),~for~j= 1~to~82;~~~~ a^{NAICS6:NAICS3}_{k}\sim~N(μ_{α},σ^{2}_{α}),~for~k= 1~to~973;$$
