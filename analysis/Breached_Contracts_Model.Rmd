...
Current cumulative model: ln_CBre_Cons_10D_NCS3, ln_CBre_Comp_10B. ln_CBre_Cons_Comp_10D_NCS3
...
glmer_examine(ln_CBre_Cons_Comp_11B)
  ...
  stargazer::stargazer(ln_CBre_02A,ln_CBre_04B,ln_CBre_11A_no_interact,ln_CBre_11A,
                       ln_CBre_Cons_10K_NCS6,ln_CBre_Cons_11B,ln_CBre_Comp_10B,ln_CBre_Comp_11B,ln_CBre_Cons_Comp_10K_NCS6,ln_CBre_Cons_Comp_11B,type="text",
                         digits=2)
...
glmer_examine(ln_CBre_Cons_Comp_11D2)
  ...
  stargazer::stargazer(ln_CBre_02A,ln_CBre_04B,ln_CBre_11C_no_interact,ln_CBre_11C,
                       ln_CBre_Cons_10K_NCS6,ln_CBre_Cons_11D,ln_CBre_Comp_10B,ln_CBre_Comp_11D2,ln_CBre_Cons_Comp_10K_NCS6,ln_CBre_Cons_Comp_11D2,type="text",
                         digits=2)
...
## Agency/Office & NAICS3/NAICS6
###Model 12A: 2019-08-12 1st ln_CBre_Then_Year multilevel 
...
stargazer::stargazer(ln_CBre_Cons_NCS6A,ln_CBre_Cons_NCS3A,
                     ln_CBre_Cons_10K_NCS6,ln_CBre_Cons_12A_1m,
                     ln_CBre_Comp_10B,ln_CBre_Comp_12A_1m,
                     ln_CBre_Cons_Comp_10K_NCS6,ln_CBre_Cons_Comp_12A_1m,type="text",
                       digits=2)


debug(binned_fitted_versus_residuals)
summary_residual_compare(ln_CBre_Cons_10K_NCS6,ln_CBre_Cons_12A_1m,
                         ln_CBre_Comp_10B,ln_CBre_Comp_12A_1m,bins=50)

summary_residual_compare(ln_CBre_Cons_Comp_10K_NCS6,ln_CBre_Cons_Comp_12A_1m,bins=50)
...
ln_CBre_Cons_12B <- glmer (data=def_breach,
                        ln_CBre_Then_Year ~cl_def6_HHI_lag1 +cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_def6_obl_lag1+
                          cl_US6_avg_sal_lag1+
                          cl_Ceil_Then_Year + cl_Days+ 
                          Veh +
                          PricingFee + b_UCA +
