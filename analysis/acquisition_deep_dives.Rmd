...
for(p in platform_levels){
  ...
  (Breakout<-build_plot(
    data=platpscintldef %>% filter(Fiscal_Year>=2000&Fiscal_Year<=2022&PlatformPortfolio==p),
 chart_geom = "Line Chart",
  share = FALSE,
  # labels_and_colors=labels_and_colors,
  # NA, #VAR.ncol
  ...
  undebug(log_plot)
  log_plot(plot=Breakout, df=def_data  %>% filter(Fiscal_Year<=2022&PlatformPortfolio==p),
