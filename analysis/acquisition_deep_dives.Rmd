...
#### NTIB
```{r FPDS_vendor_Intl}
ntibisoalpha3<-c("AUS","NZL","CAN","GBR")
...
(ntibintl <-  build_plot(data=platpscintldef%>% filter((PlaceISOalpha3 %in% ntibisoalpha3|
                            ...
                            color_var="CrisisProductOrServiceArea",
                            facet_var="PlaceIsForeign",
                            second_var="VendorNTIB",
                            labels_and_colors=intl_lc,
                            column_key=intl_ck,
                            legend=TRUE,
                            caption=FALSE,
                            format=TRUE)+theme(legend.position = "right")+
    facet_grid( .~VendorNTIB~PlaceIsForeign )+labs(title="Present NTIB Vendor or Location Internationally")#, scales="free_y"#, scales="free_y"
  )
summary(platpscintldef$dFYear)
...
# write.csv(file="..//Output//ntibintl_service_vendor.csv",row.names = FALSE,na = "",
...
ggsave600dpi(ntibintl_service_vendor,file="../output/ntibintl_service_vendor.png",
             size = 12, lineheight=1, height =6, width=9)
