...
(
SWpscdetail<-build_plot(
  data=platpsc %>% filter(fiscal_year>=2000 & ProductServiceOrRnDarea!="Unlabeled" &
                            SWpsc %in% c("Annual Software Maint.", "Software as a product"  ))  ,
  chart_geom = "Bar Chart",
  share = FALSE,
  # labels_and_colors=ds_lc,
  # NA, #VAR.ncol
  ...
  y_var="Action_Obligation_OMB20_GDP20", #VAR.y.variable
  color_var="SWpsc", #color_var
  facet_var="ContractingAgencyTextSwr", #facet_var
  # column_key=ds_ck,
  format=TRUE,
  ytextposition=FALSE
)+
...
ggsave600dpi(SWpscdetail,file="..//output//sw_Agency.png",  
             width=13, height= 6, units="in",size=8, lineheight=1.2
             )
ggsave600dpi(SWpscdetail,file="..//output//sw_Agency.eps",  
             width=13, height= 6, units="in",size=16, lineheight=1.2
             )
