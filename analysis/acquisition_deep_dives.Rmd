...
topplat<-platpscintldef %>% group_by (Project.Name,PlatformPortfolio) %>%
  summarise(Action_Obligation_OMB24_GDP22=sum(Action_Obligation_OMB24_GDP22,na.rm = TRUE),
            Action_Obligation_2023=sum(ifelse(Fiscal_Year>=2023,Action_Obligation_OMB24_GDP22,NA),na.rm = TRUE))%>%
...
platpscintldef
View(platpscintldef%>% group_by(PlatformPortfolio,TopProjectTest,TopProject,rank_total,TopProjectTest_rank_total,rank_2023,TopProjectTest_rank_recent,recent_weight) %>%  
