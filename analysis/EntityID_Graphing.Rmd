...
ggsave600dpi(all_10k_small_line+labs(title=NULL),file="nps_fig09_vendor_count_line.svg",size=12,lineheight = 1.2,
...
(
  ...
  log_plot(plot=ntdc_label+theme(legend.position = "right"),
           ...
           second_path=online_path,
                       ...
                       sheet="11 NTDC",path="../output/AcqTrends/",
           height=3.5,
...
```{r def_rpuh_hhi}
  ...
  log_plot(plot=def_rpuh_hhi+labs(title=NULL),
           ...
           second_path=online_path,
                       ...
                       sheet="XX hhi",path="../output/AcqTrends/",
           height=2,
