...
```{r def_rpuh_uei}
  ...
  all_10k_small_bar<-build_plot(
    ...
    first_color_on_bottom = FALSE
         ...
         title="DOD Contractor Count by Small Business Status\n and Size of Largest Federal Contract, FY 2007-FY 2025 Q2",
    ...
    date_x_year_breaks(2007,2022,3,partial_year=2025,partial_label="\nQ1–Q2")+date_x_year_breaks(2007,2022,3,partial_year=2025,partial_label="\nQ1–Q2")
  )
...
(
  all_10k_small_line<-build_plot(
    ...
    format=TRUE,
    first_color_on_bottom = FALSE
  )+labs(y="Count of Vendors with\nContracts Above $10 K, FY 2007-FY 2025 Q2",x="Fiscal Year",
         title="DOD Contractor Count by Small Business Status\n and Size of Largest Federal Contract",
         caption="Note: Threshold values are adjusted for inflation (in 2018 $s).\nSource: FPDS Unique Entity (UEI) reporting and CSIS analysis.")+date_x_year_breaks(2007,2022,3,partial_year=2025,partial_label="\nQ1–Q2")
  )
...
```{r def_rpuh}
  ...
  ntdc_count_bar<-build_plot(
    ...
    format=TRUE
         ...
         title="DOD Contractor Count by Small Business Status\nand Size of Largest Federal Contract",
         caption="Note: Threshold values are adjusted for inflation (in 2018 $s).\nSource: FPDS Unique Entity (UEI) reporting and CSIS analysis.")+
    date_x_year_breaks(2007,2022,3,partial_year=2025,partial_label="\nQ1–Q2")+date_x_year_breaks(2007,2022,3,partial_year=2025,partial_label="\nQ1–Q2")+facet_wrap(~IsEntityTraditionalLabel, scales="free_y")
  )
...
(
  ...
  labs(title="DOD Contract Obligations by Non-Traditional Status and\nCost Accounting Standards Exemption, FY 2007-FY 2025 Q2",y="Obligations (2023 $s)",x="Fiscal Year")+date_x_year_breaks(2007,2022,3,partial_year=2025,partial_label="\nQ1–Q2"))
