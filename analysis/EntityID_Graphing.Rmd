...
cas <- cas %>%
  ...
  CostAccountingStandardsClause=="N"~"Waived",
   IsSealedBid==1 | (costorpricingdata %in% c("W","N") & FixedPriceEffective==1) ~ "Competition",
  ...
  IsAbove2018constantCommercialItem7500k==0 | AlwaysIsSmall==1~"Vendor Size or Largest Contract",
