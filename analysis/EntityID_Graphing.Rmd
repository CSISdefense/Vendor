...
```{r def_rpuh}
def_rpuh<-def_rpuh%>%mutate(count=1)
  ...
  all_10k_small_bar<-build_plot(
    ...
    facet_var="AlwaysIsSmall",        # name of facet variable, as string
  ...
  all_10k_small_dollar<-build_plot(
    ...
    share = FALSE,
    x_var="Fiscal_Year",
    y_var="Defense_Action_Obligation_OMB25_GDP23", #Name of variable to plot on y-axis
    color_var="IsEntityAbove2018constantSimplifedAcquisition250kThreshold",       # name of coloration variable, as string
    facet_var="AlwaysIsSmall",        # name of facet variable, as string
    legend=TRUE, #Include a legend
    caption=TRUE, #Include a source caption
...
```{r def_rpuh}
  ...
  all_10k_small_bar<-build_plot(
    ...
    color_var="IsEntityAbove2018constantCostAccounting2000kThreshold",       # name of coloration variable, as string
    facet_var="AlwaysIsSmall",        # name of facet variable, as string
    second_var="IsEntityTraditional",
    legend=TRUE, #Include a legend
    caption=TRUE, #Include a source caption
    # labels_and_colors=eid_lc,
    column_key=NULL,
