...
or_ceil<-odds_ratio(CBre_Cons_Comp_15A_1m,"CBre_Comp_13C_1m","Competition","Ceiling Breaches",walds = TRUE)
or_term<-odds_ratio(Term_Cons_Comp_14C_1m,"Term_Comp_13F_1m","Competition","Terminations",walds = TRUE)
