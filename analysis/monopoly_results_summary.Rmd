...
ggsave(NAICS3long_wide+theme(text=element_text(size=12.5)),file="..//Output\\NAICS3long.png",width=9.5,height=5.5,dpi=600)
ggsave(NAICS3long_wide+theme(text=element_text(size=12.5)),file="..//Output\\NAICS3long.eps",width=9.5,height=5.5,dpi=600)
...
#Drop the ratios and average salaries w/ unique values
# NAICS_long<-NAICS_long[NAICS_long$variable %in% c(),]
NAICS_long$value[NAICS_long$variable=="def3_obl_lag1"]<-NAICS_long$value[NAICS_long$variable=="def6_obl_lag1"]/1e9
NAICS_long$value[NAICS_long$variable=="def3_ratio_lag1"]<-NAICS_long$value[NAICS_long$variable=="def6_ratio_lag1"]*1e2
...
ggsave(NAICS6long_wide+theme(text=element_text(size=12.5)),file="..//Output\\NAICS6long.png",width=9.5,height=5.5,dpi=600)
ggsave(NAICS6long_wide+theme(text=element_text(size=12.5)),file="..//Output\\NAICS6long.eps",width=9.5,height=5.5,dpi=600)
...
### Breach Likelihood
```{r b_CBre_Residuals_1m, fig.width=7.5 , fig.height=8.5}
