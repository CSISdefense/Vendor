...
load("..\\data\\clean\\JSCAN\\transformed_def.Rdata")
...
stargazer::stargazer(CBre_Cons_Comp_15C,type="text",
                       digits=2)
...
glmer_examine(CBre_Cons_Comp_15C,display=TRUE)
CBre_Cons_Comp_15C_odds_ratio<-odds_ratio(CBre_Cons_Comp_15C,"CBre_Cons_Comp_15C",walds = TRUE)
get_icc(CBre_Cons_Comp_15C)

stargazer::stargazer(CBre_Cons_Comp_15A,CBre_Cons_Comp_15C,type="text",
                       digits=2)
...
stargazer(Term_Cons_Comp_14D_1m,type="text",
                         digits=2)
