...
PricingHistory<-rbind(pricing_history[pricing_history$Fiscal_Year>2023,colnames(pricing_history) %in% colnames(PricingUpdate)],
                     PricingUpdate[PricingUpdate$Fiscal_Year<=2023 & PricingUpdate$Fiscal_Year>=2000,
...
HistoricPricing<-build_plot(
  data=PricingHistory %>% filter(Fiscal_Year>=1979 & Fiscal_Year<=2021 ),
  chart_geom = "Line Chart",
  share = TRUE,
