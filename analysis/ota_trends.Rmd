...
log_plot(plot=TypeSubCustomer, df=ota_def %>% filter(Fiscal_YQ<=2024.1),
         ...
         height=3,include_YTD=FALSE, width=4,height=5.5,
                     startRow=1,format=TRUE,excel_y_var=TRUE,excel_formulas = TRUE,
         output_doc_svg=TRUE
         )


ggsave600dpi("nps_fig12_ota_type_cust",path="..//Output//OTA//NPS//",
             TypeSubCustomer+facet_wrap(~TypeOfAgreement),output_doc_svg=TRUE ,
