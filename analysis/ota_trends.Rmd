...
ToplinePSR<-build_plot(
  data=ota_def %>% filter(Fiscal_Year>=2015& Fiscal_YQ<=2023.2),
  chart_geom = "Bar Chart",
  share = FALSE,
  labels_and_colors=ota_lc,
  # NA, #VAR.ncol
...
log_plot(plot=ToplinePSR, df=ota_def   %>% filter(Fiscal_YQ<=2023.2),
                     filename="acq_fig5_3_OTAarea",xlsx="DoD_Acq_Trends_Contracts.xlsx",
                     sheet="5-3A OTAarea",path="../output/AcqTrends/", height=3,
...
log_plot(plot=Platform, df=ota_def   %>% filter(Fiscal_YQ<=2023.2),
...
ggsave("..//..//Vendor//Output//AcqTrends//acq_fig5_3_OTAplatarea.svg",
             gridExtra::grid.arrange(ToplinePSR+labs(caption=NULL),Platform+labs(y=NULL,caption=NULL)+
                                       theme(plot.margin = c(t=0,b=0, l=0, r=0.25)),nrow=1),
             width=6.5, height= 3.5, units="in"#, size=20, lineheight = 0.75
             )
ggsave("..//..//Vendor//Output//AcqTrends//acq_fig5_3_OTAplatarea.png",
             gridExtra::grid.arrange(ToplinePSR+labs(caption=NULL),Platform+labs(y=NULL,caption=NULL)+
                                       theme(plot.margin = c(t=0,b=0, l=0, r=0.25)),nrow=1),
             width=6.5, height= 3.5, units="in"#, size=20, lineheight = 0.75
             )
