...
# drone %>% group_by(ContractingCustomer) %>% summarise(Action_Obligation_OMB24_GDP22=sum(Action_Obligation_OMB24_GDP22,na.rm=TRUE))
...
droneEO %>% filter(CaseStudy=="EO Sensors") %>% filter(VendorSize_Intl=="International") %>%
  ...
  summarise(Action_Obligation_OMB24_GDP22=sum(Action_Obligation_OMB24_GDP22,na.rm=TRUE)) %>% arrange(-Action_Obligation_OMB24_GDP22)
