...
platpscintl$CaseStudy[platpscintl$PlatformPortfolioUAV=="Remotely Crewed"]<-"Remotely Crewed"
...
droneEO<-platpscintl %>% filter(CaseStudy %iN% c("Remotely Crewed","Electro-Optical Sensors")) 
