...
topUAVannual<-defense_UAV_vendor %>%
  ...
  dplyr::summarize(Action_Obligation_OMB23_GDP21=sum(Action_Obligation_OMB23_GDP21,na.rm=TRUE)) %>% arrange(Fiscal_Year,Toppos)
...
ggsave600dpi(ab,
                          file="../output/Remotely_Crewed//uav_entity_count_size_slide.png",
              size = 16, lineheight=1,height =5.5, width=12)
