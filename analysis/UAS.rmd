...
droneplat<-drone %>%
  ...
  dplyr::summarise(Action_Obligation_2020=sum(ifelse(Fiscal_Year==2020,Action_Obligation_OMB23_GDP21,0)),
...
drone<-left_join(drone,dronePSC %>% select(-Action_Obligation_OMB23_GDP21,
...
drone %>% dplyr::group_by(ProjectName, IsRemotelyOperated)  %>% dplyr::summarise(Action_Obligation_OMB23_GDP21=sum(Action_Obligation_OMB23_GDP21))%>%
