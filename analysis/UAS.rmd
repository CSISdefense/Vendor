...
drone<-platpscintl %>% filter(PlatformPortfolioUAV)
...
fed_data<-fed_data %>% group_by(SubCustomer.sum,Fiscal_Year) %>%
...
OTA_data %>% filter(SubCustomer.sum=="Army"& PlatformPortfolioUAV=="Remotely Crewed"& Fiscal_Year<=2014)%>%
