...
wb<-loadWorkbook(file=file.path("..","Output","Assistance","selected_assistance_critical_tech.xlsx"))
...
saveWorkbook(wb,file=file.path("..","Output","Assistance","selected_assistance_critical_tech.xlsx"),overwrite = TRUE)
...
for(i in 1:length(agency_list$agency)){
  ...
  log_plot(plot=Breakout, df=agency_assist  %>% filter(AnyTag==TRUE&Agency==agency_list$agency[i]),#Fiscal_YQ<=2023.2&
           ...
           sheet="Crit",path=file.path("../output/Assistance/",file_c),second_path=sharepoint_log_path,
           height=3.5,
...
for(i in 1:length(agency_list$agency)){
  ...
  log_plot(plot=Breakout, df=agency_assist  %>% filter(AnyTag==TRUE&Agency==agency_list$agency[i]),#Fiscal_YQ<=2023.2&
           ...
           sheet="Status",path=file.path("../output/Assistance/",file_c),second_path=sharepoint_log_path, height=3.5,
           startRow=1,startCol=13,format=TRUE,#,var_list=c("PricingUCA.sumlong","PricingUCA"),
           output_doc_png=TRUE,excel_y_var=TRUE
  )
...
for(i in 1:length(agency_list$agency)){
  ...
  log_plot(plot=Breakout, df=agency_assist  %>% filter(AnyTag==TRUE&Agency==agency_list$agency[i]),#Fiscal_YQ<=2023.2&
           ...
           sheet="Type",path=file.path("../output/Assistance/",file_c),second_path=sharepoint_log_path, height=3.5,
           startRow=1,startCol=13,format=TRUE,#,var_list=c("PricingUCA.sumlong","PricingUCA"),
           output_doc_png=TRUE,excel_y_var=TRUE
  )
