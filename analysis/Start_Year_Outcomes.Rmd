...
```{r StartYearDur}
if(!file.exists("../data/semi_clean/Contract.SP_UnmodifiedScopeHistory.rda")){
  unmod_scope<-read_delim("../data/semi_clean/Contract.SP_UnmodifiedScopeHistory.txt",delim="\t", na=c("NA","NULL"))
...
} else load(file="../data/semi_clean/Contract.SP_UnmodifiedScopeHistory.rda")
