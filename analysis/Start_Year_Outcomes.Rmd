...
def_dur$LastCurrentCompletionYear[def_dur$IsComplete==1 & !is.na(def_dur$IsComplete) &
                                    def_dur$LastCurrentCompletionYear>2018]<-"Ambiguous Ending"

def_dur$LastCurrentCompletionYear[def_dur$IsComplete==0 | is.na(def_dur$IsComplete)]<-"Active in 2018"

def_dur$LastCurrentCompletionYear<-factor(def_dur$LastCurrentCompletionYear,levels=c("Active in 2018","Ambiguous Ending",2017:2007))
