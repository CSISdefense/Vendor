...
big_dollar<-subset(def_full, Action.Obligation>=1000000000 | UnmodifiedContractBaseAndAllOptionsValue>=1000000000)
write.csv(big_dollar,file="Output//big_dollar.csv",row.names = FALSE)
...
def<-read_and_join_experiment(def,
                              ...
                              lookup_file ="Contract_SP_ContractSampleCriteriaDetailsCustomer.txt",
                              add_var="MaxOfSignedDate",
                              by="CSIScontractID"
                              )
```
...
save(Term_Cons_13D,file="Output//Term_Cons_13D")
...
save(Term_Comp_13D,file="Output//Term_Cons_13D.rdata")
...
load("..//Output//Term_Comp_13E.rdata")
...
if(!exists("Term_Cons_13E_1m")){
  ...
  Term_Cons_13E_1m <- glmer (data=smp1m,
                             b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                               #cl_US3_avg_sal_lag1+
                               cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                               cl_US6_avg_sal_lag1+
...
if(!exists("Term_Cons_13F_1m")){
  ...
  save(Term_Comp_13E,Term_Comp_13F,file="Output//Term_Comp_13E2.rdata")
  
  save(Term_Cons_13E,Term_Cons_13E_1m,file="Output//Term_Cons_13E.Rdata")
}

summary(Term_Comp_13E)
summary(Term_Comp_13E2)
glmer_examine(Term_Cons_13E_1m)
...
### Model 13F:
```{r 13F_Interactions}
load(file="..//Output//Term_Comp_15A.rdata")
...
if(!exists("Term_Cons_13F_1m")){
  ...
  save(Term_Comp_13F,Term_Cons_13F_1m,file="Output//Term_Cons_13D.rdata")
}

glmer_examine(Term_Comp_13F_1m)
...
stargazer(Term_Cons_Comp_14B_1m,type="text",
                         digits=2)

if(!exists("Term_Cons_Comp_14B_1m")){
...
stargazer(Term_Cons_Comp_14B_1m,
          Term_Cons_Comp_14C_1m,type="text",
                         digits=2)
...
###Model 14D Rerun after UCA, ratio, and construction fixes
```{r 14D}
load(file="..//Output//Term_Cons_Comp_14D.rdata") 
stargazer(Term_Cons_Comp_14B_1m,
          Term_Cons_Comp_14D_1m,type="text",
                         digits=2)

if(!exists("Term_Cons_Comp_14D_1m")){
  
  Term_Cons_Comp_14D_1m <- glmer (data=smp,
                               b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                                 #cl_US3_avg_sal_lag1+
                                 cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                                 cl_US6_avg_sal_lag1+
                                 ...
                                 (1 | NAICS3/NAICS) + (1 | Agency/Office)
                               , family=binomial(link="logit"),verbose=1)
save(Term_Cons_Comp_14D,file="..//Output//Term_Cons_Comp_14D.rdata")
  
  Term_Cons_Comp_14D_1m <- glmer (data=smp1m,
                                  b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                                    #cl_US3_avg_sal_lag1+
                                    cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                                    cl_US6_avg_sal_lag1+
  ...
  save(Term_Cons_Comp_14D,Term_Cons_Comp_14D_1m,file="..//Output//Term_Cons_Comp_14D.rdata")
...
stargazer::stargazer(Term_Cons_Comp_14C_1m,Term_Cons_Comp_14D,Term_Cons_Comp_14D_1m,type="text",
                       digits=2)
...
### Model 15A 1-level traditional
```{r Model15A}
Term_Cons_Comp_15A <- glm (data=smp,
                             b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                               #cl_US3_avg_sal_lag1+
                               cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                               cl_US6_avg_sal_lag1+
...
Term_Cons_Comp_15A_1m <- glm (data=smp1m,
                             b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                               #cl_US3_avg_sal_lag1+
                               cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                               cl_US6_avg_sal_lag1+
...
stargazer::stargazer(Term_Cons_Comp_15A,Term_Cons_Comp_15A_1m,type="text",
                       digits=2)
...
#   save(Term_Cons_Comp_15A_1m,file="Output//Term_Cons_Comp_15A.rdata")
#   
# }
# glmer_examine(Term_Cons_Comp_15A)
# odds_ratio(Term_Cons_Comp_14C,"Term_Cons_Comp_14C")
# get_icc(Term_Cons_Comp_14C)

```

### Model 15B 1-level rare events
```{r Both-Term}

library(Zelig)
Term_Cons_Comp_15B <- Zelig::zelig(data=as.data.frame(smp),
                             formula=b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                               #cl_US3_avg_sal_lag1+
                               cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                               cl_US6_avg_sal_lag1+
                               CompOffr+
...
Term_Cons_Comp_15B_1m <- Zelig::zelig(data=as.data.frame(smp1m),
                             b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                               #cl_US3_avg_sal_lag1+
                               cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                               cl_US6_avg_sal_lag1+
...
screenreg(list(Term_Cons_Comp_15A,Term_Cons_Comp_15B,Term_Cons_Comp_14C_1m,Term_Cons_Comp_15A_1m,Term_Cons_Comp_15B_1m))
...
# summary(Term_Cons_Comp_15B)  
# stargazer::stargazer(Term_Cons_Comp_15B,Term_Cons_Comp_15B_1m,type="text",
#                        digits=2)
# 
# 
# stargazer(lm(Term_Cons_Comp_15B$zelig.out$z.out[[1]]), type='text')
...
#   save(Term_Cons_Comp_15B_1m,file="Output//Term_Cons_Comp_15B.rdata")
#   
# }
# glmer_examine(Term_Cons_Comp_15B)
# odds_ratio(Term_Cons_Comp_14C,"Term_Cons_Comp_14C")
# get_icc(Term_Cons_Comp_14C)

```
### Model 15A and 15B: 50k Test
A simple variant to see if any differences show up with a more limited sample size.
```{r Model15AB25}
smp25k<-smp[sample(nrow(smp),50000),]
Term_Cons_Comp_15A_25k <- glm (data=smp25k,
                             b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                               #cl_US3_avg_sal_lag1+
                               cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                               cl_US6_avg_sal_lag1+
...
Term_Cons_Comp_15B_25k <- Zelig::zelig(data=as.data.frame(smp25k),
                             formula=b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                               #cl_US3_avg_sal_lag1+
                               cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                               cl_US6_avg_sal_lag1+
...
screenreg(list(Term_Cons_Comp_15A_25k,Term_Cons_Comp_15B_25k))
