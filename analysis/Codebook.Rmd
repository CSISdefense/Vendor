...
ggsave(cbre_plot+theme(text=element_text(size=13)+labs(y="Count of Contracts that Experienced\na Ceiling Breach (Variable Scale)",x="Ceiling Breach Size on a Logarithmic Scale")),file="..//Output\\JSCAN\\Figure 1.png",width=9.5,height=4,dpi=600)
ggsave(cbre_plot+theme(text=element_text(size=13)+labs(y="Count of Contracts that Experienced\na Ceiling Breach (Variable Scale)",x="Ceiling Breach Size on a Logarithmic Scale")),file="..//Output\\JSCAN\\Figure 1.eps",width=9.5,height=4,dpi=600)
