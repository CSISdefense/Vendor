...
$Probability~of~Ceiling~Breach~(y_i = 1) =$

$Logit^{-1}(α~+~α^{NAICS3}_{j[i]}~+~α^{NAICS3:NAICS6}_{k[i]}~+~α^{Agency}_{l[i]}~+~α^{Agency:Office}_{m[i]}~+~β_{1}cl\_def3\_HHI\_lag1_{i}~+$
...
$β_{22}UCA_{i}~+~β_{23}b\_Intl_{i}~+~β_{24}cl\_def6\_HHI\_lag1l_{i}·cl\_def6\_obl\_lag1_{i}~+$

$β_{25}cl\_def6\_HHI\_lag1_{i}·UCA_{i}~+~β_{26}cl\_Ceil_{i}·UCA_{i}~+~β_{27}CompOff1_{i}·UCA_{i}~+$

$β_{28}CompOff2_{i}·UCA_{i}~+~β_{29}CompOff3–4_{i}·UCA_{i}+~β_{30}CompOff5plus_{i}·UCA_{i}~+~ε_{i}),$ 
