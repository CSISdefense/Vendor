...
if(!"Action_Obligation_OMB24_GDP22" %in% colnames(ota_def))
  ota_def<-deflate(ota_def, "Dollars_Obligated_Then_Year",deflator_var="OMB24_GDP22")
...
log_plot(plot=topline+theme(plot.margin =margin(t=0,b=0,l=0.1,r=0.25,"inches")), df=output_TY   ,y_var="Then_Year_Dollars",#%>% filter(Fiscal_YQ<=2023.2),
...
log_plot(plot=ToplinePricing+theme(plot.margin = margin(t=0,r=0.25,b=0.1,l=0.1,"inches")), df=def_data  %>% filter(Fiscal_YQ<=2023.2),
...
log_plot(plot=Platform_Bar+theme(plot.margin = margin(t=0,r=0.25,b=0.1,l=0.1,"inches")), df=def_data   %>% filter(Fiscal_YQ<=2023.2),
...
ggsave600dpi("..//Output//AcqTrends//PlatformQ_slide.svg", PlatformQ+
               labs(title="Defense Contract Obligations by Platform Portfolio, FY2013-FY2023Q2")+
...
log_plot(PlatformMultiYearShare, full_data %>% filter(Fiscal_YQ<=2023.2) ,
                     ...
                     sheet="4-2 Multi",path="../output/AcqTrends/", height=3.5,excel_y_var = TRUE,excel_formulas = TRUE,
