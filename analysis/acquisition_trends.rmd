...
# addWorksheet(wb, sheetName = "2-2 FYQ")
 writeData(wb, output_TY, sheet = "2-2 FYQ", startRow = 1, startCol = 13)
...
PlatformMultiYearShare<-build_plot(
  data=full_data %>% filter(Fiscal_Year>=2000 &
                             (multiyearcontract==1)&
                              !is.na(PlatformPortfolio)), #is.na(multiyearcontract)|
  chart_geom = "Line Chart",
  share = FALSE,
  labels_and_colors=labels_and_colors,
  # NA, #VAR.ncol
...
ggsave600dpi("..//Output//AcqTrends//Platform_MultiYearShare_keynote.png", 
...
ggsave600dpi("..//Output//AcqTrends//Platform_MultiYearShare_keynote.svg", 
               PlatformMultiYearShare+labs(
                 title="DOD Share of Contract Obligations to Multiyear Contracts, 2000-2023Q1")+
                 facet_wrap(PlatformPortfolio~.,nrow=2)+
                labs(y="Share of Obligations",
...
log_plot(plot=PlatformMultiYearShare, df=full_data,
                     filename="acq_fig4_2_multiyear",xlsx="DoD_Acq_Trends_Contracts.xlsx",
                     sheet="4-2 Multi",path="../output/AcqTrends/", height=3.5,
                     startRow=1,startCol=11,format=TRUE,y_var="Action_Obligation_OMB24_GDP22"#,var_list=c("Vehicle.AwardTask","Vehicle.sum7")
         )
