...
if(!"Action_Obligation_OMB23_GDP21" %in% colnames(ota_def))
...
#Kludge
toa<-toa[11,c(-1,-3)]
colnames(def_data)[colnames(def_data)=="Action_Obligation_Then_Year_OMB23_GDP21"]<-"Action_Obligation_OMB23_GDP21"
...
summary(factor(def_psc$SimpleArea))
(
...
full_data<-full_data %>% group_by(Fiscal_Year,PlatformPortfolio)%>%
  mutate(pPlatFYear=Action_Obligation_OMB23_GDP21/sum(Action_Obligation_OMB23_GDP21,na.rm=TRUE))
(
...
ggsave600dpi("..//Output//vendorsize_pricing_2021.png", VendorSizePricing2021+theme(legend.position = "none")+
  labs(y="Obligations (Constant 2021 $s)",caption="Source: FPDS and CSIS analysis.")+facet_wrap(~Shiny.VendorSize,nrow=1),
...
#     ifelse(multiyearcontracttext=="Multiyear Contract",Action_Obligation_OMB23_GDP21,0),na.rm=TRUE))
