...
SubCustomer<-build_plot(
 ...
 #             )+labs(title=NULL,
  ...
  # color="Competition")+
  theme(legend.position = "right")+
  labs(y="Obligations (Constant 2022 $s)") +date_x_year_breaks(1990,2020,10,partial_year=2023,partial_label="\nQ1-Q2")+
...
ggsave600dpi("..//Output//AcqTrends//topline_subcustomer_keynote.svg", SubCustomer+
               ...
               date_x_year_breaks(1990,2020,10,partial_year=2023,partial_label="\nQ1-Q2"), 
             width=13, height= 5.5, units="in", size=20, lineheight = 0.75
             )
