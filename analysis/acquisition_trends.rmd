...
(topline_q<-ggplot(data=quarterlyEst %>% filter(Fiscal.Year>=2000) #rbind(quarterly,q2021,e2021),
    ...
    geom_path(aes(x=dFYear,y=Total_Obligation_Authority_OMB20_GDP20),group="Quarter")+
  scale_alpha_discrete(range=c(0.4,1))+
  geom_errorbar(aes(x=dFYear,ymin=lwr,ymax=upr))+labs(x="Fiscal Year",y="Constant FY 2020 $ Billions",fill="Quarter")
)
