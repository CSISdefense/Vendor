...
VendorSizePricing2021<-build_plot(
  data=full_data %>% filter(Fiscal_Year==2021& Shiny.VendorSize!="Unlabeled" & CurrentDurationIsYear!="Unlabeled"&
                             PricingUCA.sum!="Unclear"),
  chart_geom = "Bar Chart",
  # share = TRUE,
  labels_and_colors=labels_and_colors,
...
ggsave600dpi("..//Output//VendorSize_Pricing2021share.png", VendorSizePricing2021share+
  ...
  labs(caption="Source: FPDS and CSIS analysis. Unlabeled data is not shown."),
