...
log_plot(plot=PricingHistory, df=PriceHist  %>% filter(Fiscal_YQ<=2022),
                     filename="acq_fig8_1_pricing_history",xlsx="DoD_Acq_Trends_Contracts.xlsx",
                     sheet="8-1 PriceHist",path="../output/AcqTrends/", height=3.5,
...
log_plot(PlatformMultiYearShare,full_data ,
