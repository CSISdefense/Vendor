...
log_plot(plot=toplineq, df=def_data   %>% filter(Fiscal_YQ<=2023.2),
                     filename="acq_fig2_1_fq",xlsx="DoD_Acq_Trends_Contracts.xlsx",
                     sheet="2-2 FYQ",path="../output/AcqTrends/", height=3,
...
log_plot(plot=Platform_Bar, df=def_data   %>% filter(Fiscal_YQ<=2023.2),
                     filename="acq_fig3_2_platform",xlsx="DoD_Acq_Trends_Contracts.xlsx",
                     sheet="3-2 Plat",path="../output/AcqTrends/", height=3,
                     startRow=1,startCol=12,format=TRUE,#var_list=c("Source","fiscal_quarter"),
         output_plot=FALSE
         )
