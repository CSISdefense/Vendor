...
PlatformMultiYearShare<-build_plot(
  data=def_data %>% filter(Fiscal_Year>=2000 & PlatformPortfolio!="Unlabeled"&
...
ggsave600dpi("..//Output//Platform_MultiYearShare.png", PlatformMultiYearShare,  
             width=6.5, height= 4, units="in",size=12, lineheight=1.2
             )
...
VendorSizePricing<-build_plot(
 ...
 #             )+labs(title=NULL,
  ...
  (
  VendorSizePricing2021<-build_plot(
   ...
   #             )+labs(title=NULL,
    ...
    # theme(legend.position = "right")+
    labs(y="Obligations (Constant 2021 $s)",
         caption="Source: FPDS and CSIS analysis. Unlabeled data is not shown.")
  )
...
VendorSizePricing2021share<-build_plot(
  ...
  share = TRUE,
  # NA, #VAR.ncol
  x_var="PricingInflation.1year", #x_var
  y_var="Action_Obligation_OMB23_GDP21", #VAR.y.variable
  color_var="PricingInflation.1year", #color_var
  facet_var="Shiny.VendorSize", #facet_var
  # second_var="CurrentDurationIsYear",
  labels_and_colors=def_lc,
  column_key=def_ck,
...
VendorSizePricing2021share<-build_plot(
 ...
 #             )+labs(title=NULL,
  ...
  theme(legend.position = "none")+
  labs(y="Share of Obligations",
       x="Pricing Mechanism]n(For contract planned to last more than a yaer",
       caption="Source: FPDS and CSIS analysis. Categories are mutully exclusive.\nLess than 0.1 percent of data is unlabeled and not shown.")
)



ggsave600dpi("..//Output//VendorSize_Pricing2021share.png", VendorSizePricing2021share+
               facet_wrap(~Shiny.VendorSize,nrow=1)+#scale_y_discrete(name ="Share of Obligations", 
                    # breaks=c(0,0.15,0.30,0.45))+
  labs(y="Share of Obligations",
       x="Pricing Mechanism\n(For contract planned to\nlast more than a year",
       caption="Source: FPDS and CSIS analysis. Categories are mutully exclusive.\nLess than 0.1 percent of data is unlabeled and not shown."),
             width=6.5, height= 2.5, units="in",size=10,lineheight=1
             )
