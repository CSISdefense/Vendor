...
PricingHistory<-build_plot(
 ...
 #             )+labs(title=NULL,
  ...
  theme(legend.position = "right",
    ...
    xlim(c(as.Date("1979-01-01"), as.Date("2022-12-30")))+
...
ggsave600dpi("..//Output//PlatformQ_keynote.svg", PlatformQ+
               labs(title="DOD Contract Obligations by Platform Portfolio, 2013-2023Q1"),
             width=10, height= 5.5, units="in", size=20, lineheight = 0.75
             )
