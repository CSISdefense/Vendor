...
ggsave600dpi("..//Output//AcqTrends//toplineqr_keynote.svg", toplineq+
               labs(title="DOD Contract Obligations, 2000–2023Q2"),
...
ggsave600dpi("..//Output//AcqTrends//topline_pricing.png", ToplinePricing,  
  ...
  ggsave600dpi("..//Output//AcqTrends//topline_pricing_keynote.svg", ToplinePricing+
               # facet_wrap(~SubCustomer.sum,nrow=1)+
               labs(title="DOD Contract Obligations by Component, 2000–2023Q2"), 
             width=13, height= 5.5, units="in", size=20, lineheight = 0.75
             )  
...
ggsave("..//Output//AcqTrends//PSRComp_both_keynote.png", 
             gridExtra::grid.arrange(
               PSRComp_bar+labs(
                 title="DOD Contract Obligations by Commercial Categorization, 2000–2023Q2",
                  y="Obligations\n(Const. 2022 $s)",
...
ggsave600dpi("..//Output//AcqTrends//topline_subcustomer_keynote.svg", SubCustomer+
               facet_wrap(~SubCustomer.sum,nrow=1)+
               labs(title="DOD Contract Obligations by Component, 1990–2023Q2")+
...
ggsave600dpi("..//Output//AcqTrends//subcustomer_commercial_keynote.png", CommercialCust+
               labs(title="DOD Contract Obligations by  Commercial Categorization, 2000–2023Q2"),
             width=13, height= 5.5, units="in", size=20, lineheight = 0.75
             )
...
ggsave600dpi("..//Output//AcqTrends//topline_platform_bar_keynote.svg", Platform_Bar+
               labs(title="DOD Contract Obligations by Platform Portfolio, 2000–2023Q2"),
             width=13, height= 5.5, units="in", size=20, lineheight = 0.75
             )
...
PlatformQ<-build_plot(
  ...
  format=TRUE,
  ytextposition=FALSE
)+date_x_year_breaks(2013,2020,4,partial_year=2023,partial_label="\nQ1–Q2")+   scale_alpha_ordinal(range=c(1,0.5))+
  # theme(strip.text.y = element_text(angle=0))+
 # theme(axis.text.x = element_text(angle=90))+
 #    scale_y_continuous("Percent of Obligations", labels = percent_format(accuracy=1))+
 #      facet_grid(.~Competition.sum ,scales="free_x", space="free_x"
...
OnMQ<-build_plot(
  ...
  format=TRUE,
  ytextposition=FALSE
)+date_x_year_breaks(2000,2020,8,partial_year=2023,partial_label="\nQ1–Q2")+   scale_alpha_ordinal(range=c(1,0.5))+
  # theme(strip.text.y = element_text(angle=0))+
 # theme(axis.text.x = element_text(angle=90))+
 #    scale_y_continuous("Percent of Obligations", labels = percent_format(accuracy=1))+
 #      facet_grid(.~Competition.sum ,scales="free_x", space="free_x"
...
ggsave600dpi("..//Output//AcqTrends//PlatformQ_keynote.svg", PlatformQ+
               labs(title="Ordnance & Missile Contract Obligations, 2000–2023Q2"),
...
PlatformVendorIntl_share<-build_plot(
  data=full_data %>% filter(PlatformPortfolio!="Unlabeled" & Fiscal_YQ<=2023.2 & Fiscal_YQ>=2000) ,
  chart_geom = "Bar Chart",
  share = TRUE,
  labels_and_colors=labels_and_colors,
  # NA, #VAR.ncol
...
ggsave600dpi("..//Output//AcqTrends//platform_vendor_intl_share.png", PlatformVendorIntl_share, 
             width=6.5, height= 4, units="in",size=11,lineheight = 0.75
             )
...
log_plot(plot=PlatformVendorIntl_dollar, df=full_data  %>% filter(Fiscal_YQ<=2023.2),
                     filename="acq_fig6_2_plat_vendor_intl",xlsx="DoD_Acq_Trends_Contracts.xlsx",
                     sheet="6-2 PlatVend",path="../output/AcqTrends/", height=5,
         excel_y_var = TRUE, excel_formulas = TRUE,
...
ggsave600dpi("..//Output//AcqTrends//Platform_MultiYearShare_keynote.png", 
               PlatformMultiYearShare+labs(
                 title="DOD Share of Contract Obligations to Multiyear Contracts, 2000–2023Q2")+
...
(
ToplineVendor<-build_plot(
  data=full_data %>% filter(Fiscal_Year>=1991& Fiscal_YQ<=2023.2  ),
  chart_geom = "Bar Chart",
  share = FALSE,
  labels_and_colors=labels_and_colors,
  # NA, #VAR.ncol
...
log_plot(plot=ToplineVendor, df=full_data  %>% filter(Fiscal_YQ<=2023.2 ),
