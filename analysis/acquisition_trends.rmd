...
def_data<-deflate(def_data, "Action_Obligation_Then_Year",deflator_var="OMB23_GDP21")
...
ota_merge<-ota_def%>%filter(Fiscal_Year >=2015 & Fiscal_Year <=2021) %>%
  ...
  dplyr::summarise(Action_Obligation_OMB23_GDP21=sum(Dollars_Obligated_OMB20_GDP20),
