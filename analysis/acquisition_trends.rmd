...
log_plot(plot=SubCustomer+facet_wrap(~SubCustomer.sum,nrow=1), df=def_data %>% filter(Fiscal_YQ<=2025.2),
...
ToplineVendor_line<-build_plot(
  ...
  share=TRUE#,
  # first_color_on_bottom = TRUE
)+date_x_year_breaks(1990,2025,5,partial_year=2025,partial_label="\nQ1-Q2")+
