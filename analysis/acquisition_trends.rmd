...
wb <- loadWorkbook("..//Output//AcqTrends//DoD_Acq_Trends_Contracts.xlsx")
 writeData(wb, output_TY, sheet = "3-1 Area", startRow = 1, startCol = 12)
saveWorkbook(wb,file="..//Output//AcqTrends//DoD_Acq_Trends_Contracts.xlsx",overwrite = TRUE)
...
log_plot(plot=PSRComp_bar, df=def_data %>% filter(Fiscal_YQ<=2023.2),
                     filename="acq_fig2_2_subcustomer",xlsx="DoD_Acq_Trends_Contracts.xlsx",
