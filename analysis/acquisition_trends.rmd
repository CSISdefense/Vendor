...
ggsave600dpi(topline,file=file.path("..","Output","AcqTrends","topline_outlay_annual.emf"),  
             width=6.5, height= 3.5, units="in",size=11, lineheight=1.2
             )
...
log_plot(plot=OTAPSR, df=def_kota %>% filter(Fiscal_YQ<2024),
                     ...
                     sheet="2 K&Ota",path="../output/AcqTrends/NPS2024/",second_path=online_path,
