...
quarterlyYTD<-rbind(quarterlyYTD,toa %>% select(-Series, -dFYear))
...
write.csv(file="..//Output//Archives//2020_Trends//toa_topline.csv",row.names = FALSE,na="",
...
p
ggsave600dpi(topline_q,file=file.path("..","Output","Archives","2020_Trends","toa_quarterly.png"),  
...
fpds_annual<-rbind(as.data.frame(fpds_annual),as.data.frame(toa) %>% select(-fiscal_quarter))
...
write.csv(file="..//Output//Archives//2020_Trends//toa_annual.csv",row.names = FALSE,na="",
          topline %>% mutate(fiscal_quarter=ifelse(!is.na(Total_Obligation_Authority_OMB20_GDP20),"TOA",fiscal_quarter),
                                            Dollars_GDP20=ifelse(fiscal_quarter=="TOA",
                                                                 Total_Obligation_Authority_OMB20_GDP20,Action_Obligation_OMB20_GDP20))%>%
            filter(Fiscal_Year>=2000)%>%
          format_data_for_plot(
...
ggsave600dpi(topline,file=file.path("..","Output","Archives","2020_Trends","topline_toa_annual.png"),  
             width=12, height= 6, units="in",size=12, lineheight=1.2
             )
```
...
ggsave600dpi("..//Output//Archives//2020_Trends//topline_comp.png", ToplineComp,  
             width=12, height= 6, units="in",size=12, lineheight=1.2
             )

ggsave600dpi("..//Output//Archives//2020_Trends//topline_comp_square.png", ToplineComp,  
             width=6, height= 5, units="in",size=14, lineheight=1.2
             )

ggsave600dpi("..//Output//Archives//2020_Trends//topline_comp.svg", ToplineComp,  
             width=6.5, height= 3.5, units="in",size=11, lineheight=1.2
             )


write.csv(file="..//Output//Archives//2020_Trends//topline_competition.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//Archives//2020_Trends//unlabeled_comp.png", UnlabeledComp,  
             width=12, height= 6, units="in",size=12, lineheight=1.2
             )



write.csv(file="..//Output//Archives//2020_Trends//unlabeled_competition.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//Archives//2020_Trends//topline_vendor_wide.png", ToplineVendor+
  labs(y="Obligations (Constant 2020 $s)",caption="Source: FPDS; CSIS Analysis.\nNote: The Merger of Raytheon and United Technologies took place in April of 2020 and thus did not make the cutofff for inclusion in FY2020."), 
             width=12, height= 6, units="in",size=12,lineheight=1
             )


ggsave600dpi("..//Output//Archives//2020_Trends//topline_vendor_cq.png", ToplineVendor+
...
ggsave600dpi("..//Output//Archives//2020_Trends//topline_vendor_cq.svg", ToplineVendor+
  labs(y="Obligations (Constant 2020 $s)",caption="Source: FPDS; CSIS Analysis.\nNote: The Merger of Raytheon and United Technologies took place in April\nof 2020 and thus did not make the cutofff for inclusion in FY2020."), 
             width=6.5, height= 4, units="in",size=11,lineheight=1
             )

ggsave600dpi("..//Output//Archives//2020_Trends//topline_vendor.png", ToplineVendor, 
             width=6.5, height= 4, units="in",size=11,lineheight=1
             )

ggsave600dpi("..//Output//Archives//2020_Trends//topline_vendor.eps", ToplineVendor+
  labs(y="Obligations (Constant 2020 $s)",caption="Source: FPDS; CSIS Analysis.\nNote: The Merger of Raytheon and United Technologies took place in April\nof 2020 and thus did not make the cutofff for inclusion in FY2020."), 
             width=6.5, height= 4, units="in",size=11,lineheight=1
             )


write.csv(file="..//Output//Archives//2020_Trends//topline_vendor_cur.csv",row.names = FALSE,
...
write.csv(file="..//Output//Archives//2020_Trends//topline_vendor.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//Archives//2020_Trends//topline_vendor_intl_square.png", ToplineVendorIntl+
...
ggsave600dpi("..//Output//Archives//2020_Trends//topline_vehicle.png", ToplineVehicle, 
             width=13, height= 4.5, units="in",size=11
             )

write.csv(file="..//Output//Archives//2020_Trends//topline_vehicle.csv",row.names = FALSE,
...
# ggsave600dpi("..//Output//Archives//2020_Trends//topline_pricing.png", ToplinePricing, 
...
write.csv(file="..//Output//Archives//2020_Trends//topline_pricing.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//Archives//2020_Trends//topline_psr.png", ToplinePSR, 
             width=12, height= 6, units="in",size=12, lineheight=1.2
             )

write.csv(file="..//Output//Archives//2020_Trends//topline_psr.csv",row.names = FALSE,
          full_data %>% group_by(SimpleArea,Fiscal_Year)%>%
...
ggsave600dpi("..//Output//Archives//2020_Trends//psr_RnDPhase.png", RnDphase, 
             width=12, height= 6, units="in",size=12, lineheight=1.2
             )
                           

write.csv(file="..//Output//Archives//2020_Trends//psr_RnDPhase.csv",row.names = FALSE,
          pivot_wider(RnDphase$data,id_cols=c(ProductServiceOrRnDarea),
                      names_from=Fiscal_Year,values_from=Action_Obligation_OMB20_GDP20)%>%
            arrange(ProductServiceOrRnDarea))
            

write.csv(file="..//Output//Archives//2020_Trends//psr_RnDPhase_current.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//Archives//2020_Trends//RnDPhasePlusOTA.png", RnDphasePlusOTA+labs(caption="Source: FPDS and CSIS analysis."),
             width=5, height= 4.75, units="in",size=11, lineheight=1.2
             )

ggsave600dpi("..//Output//Archives//2020_Trends//RnDPhasePlusOTA.eps", RnDphasePlusOTA+labs(caption="Source: FPDS and CSIS analysis."),
             width=5, height= 4.75, units="in",size=11, lineheight=1.2
             )
#                            
# 
write.csv(file="..//Output//Archives//2020_Trends//RnDPhasePlusOTA.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//Archives//2020_Trends//contractota_RnDPhase.png", RnDphase,
             width=12, height= 6, units="in",size=12, lineheight=1.2
             )
#                            
# 
write.csv(file="..//Output//Archives//2020_Trends//contractota_RnDPhase.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//Archives//2020_Trends//psr_Services.png", Services, 
             width=12, height= 6, units="in",size=14, lineheight=1.2
             )
              
ggsave600dpi("..//Output//Archives//2020_Trends//psr_Services.svg", Services, 
             width=6.5, height= 3.25, units="in",size=10, lineheight=1.2
             )             

write.csv(file="..//Output//Archives//2020_Trends//psr_Services.csv",row.names = FALSE,
          pivot_wider(Services$data,id_cols=c(ProductServiceOrRnDarea),
                      names_from=Fiscal_Year,values_from=Action_Obligation_OMB20_GDP20)%>%
            arrange(ProductServiceOrRnDarea))
            

write.csv(file="..//Output//Archives//2020_Trends//psr_Services_current.csv",row.names = FALSE,
          full_data %>% filter(SimpleArea=="R&D") %>%
            format_data_for_plot(fy_var="Fiscal_Year",y_var="Action_Obligation_Then_Year",color_var = "ProductServiceOrRnDarea",
                                 labels_and_colors=labels_and_colors) %>%
          pivot_wider(id_cols=c(ProductServiceOrRnDarea),
...
ggsave600dpi("..//Output//Archives//2020_Trends//topline_subcustomer.png", SubCustomer, 
             width=12, height= 6, units="in",size=12,lineheight = 1.2
             )

write.csv(file="..//Output//Archives//2020_Trends//topline_subcustomer.csv",row.names = FALSE,
          pivot_wider(SubCustomer$data,id_cols=c(SubCustomer.sum,SubCustomer.platform),
                      names_from=Fiscal_Year,values_from=Action_Obligation_OMB20_GDP20))

write.csv(file="..//Output//Archives//2020_Trends//topline_subcustomer_current.csv",row.names = FALSE,
...
# ggsave600dpi("..//Output//Archives//2020_Trends//subcustomer_PSR.png", SubCustomerPSR, 
#              width=6.5, height= 4, units="in",size=11
#              )
ggsave600dpi("..//Output//Archives//2020_Trends//subcustomer_PSR.png", SubCustomerPSR, 
             width=12, height= 6, units="in",size=12,lineheight = 1.2
...
#              width=6.5, height= 4, units="in",size=11
#              )
ggsave600dpi("..//Output//Archives//2020_Trends//subcustomer_Comp_line.png", SubCustomerComp_line, 
             width=12, height= 6, units="in",size=12,lineheight = 1.2
             )
...
ggsave600dpi("..//Output//Archives//2020_Trends//subcustomer_Comp_bar.png", SubCustomerComp_bar, 
             width=12, height= 6, units="in",size=12,lineheight = 1.2
             )


write.csv(file="..//Output//Archives//2020_Trends//subcustomer_competition.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//Archives//2020_Trends//topline_platform.png", Platform, 
             width=12, height= 6, units="in",size=14,lineheight = 1.2
             )

ggsave600dpi("..//Output//Archives//2020_Trends//topline_platform.svg", Platform, 
...
ggsave600dpi("..//Output//Archives//2020_Trends//topline_platform_bar.png", Platform_Bar, 
             width=12, height= 6, units="in",size=12,lineheight = 1.2
             )

write.csv(file="..//Output//Archives//2020_Trends//topline_platform_current.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//Archives//2020_Trends//platform_subcustomer.png", PlatformSubCustomer, 
...
ggsave600dpi("..//Output//Archives//2020_Trends//platform_PSR.png", PlatformPSR, 
             width=6.5, height= 4, units="in",size=11,lineheight = 0.75
             )
...
ggsave600dpi("..//Output//Archives//2020_Trends//PlatformRnD.png", PlatformPSR, 
             width=6.5, height= 4, units="in",size=11,lineheight = 0.75
             )
...
ggsave600dpi("..//Output//Archives//2020_Trends//platform_vendor.png", PlatformVendor, 
             width=6.5, height= 4, units="in",size=11,lineheight = 0.75
             )
...
ggsave600dpi("..//Output//Archives//2020_Trends//platform_comp_bar.png", PlatformComp_bar, 
             width=6.5, height= 4, units="in",size=11,lineheight = 0.75
             )


ggsave600dpi("..//Output//Archives//2020_Trends//platform_comp_line.png", PlatformComp_line, 
             width=6.5, height= 4, units="in",size=11,lineheight = 0.75
             )

write.csv(file="..//Output//Archives//2020_Trends//platform_comp_line.csv",row.names = FALSE,
...
(waiverdetail <-  build_plot(data=full_data %>% filter(PlaceOfManufacture_Sum %in% c("In U.S. but Foreign Services or Content",
  ...
  ggsave600dpi(waiverdetail,file="../output/waiverdetail.png",size=14,lineheight=1, height =5.75, width=7)
    ...
    write.csv(file="..//Output//Archives//2020_Trends//waiverdetail.csv",row.names = FALSE,
...
(waiversimple <-  build_plot(data=full_data %>% filter(PlaceOfManufacture_Sum %in% c("In U.S. but Foreign Services or Content",
  ...
  ggsave600dpi(waiversimple,file="../output/waiversimple.svg",size=14,lineheight=1, height =5.75, width=7)
    ...
    write.csv(file="..//Output//Archives//2020_Trends//waiversimple.csv",row.names = FALSE,
...
eid_lc<-prepare_labels_and_colors(ec)
  ...
  #            format=TRUE)+labs(x="Fiscal Year",y="Vendor Count")
  # )
  ggsave600dpi(file.path("..","Output","Archives","2020_Trends","def_entity_count_bar.png"), edefbar+ theme(legend.position = "right"),#guides(fill = guide_legend(nrow = 2)), 
               width=6.5, height= 3, units="in",size=11,lineheight = 0.75
               )
  
  ggsave600dpi(file.path("..","Output","Archives","2020_Trends","def_entity_count_bar.svg"), edefbar+ theme(legend.position = "right"),#guides(fill = guide_legend(nrow = 2)), 
               width=6.5, height= 3, units="in",size=11,lineheight = 0.75
               )
  # ggsave600dpi(file.path("..","Output","Archives","2020_Trends","def_entity_count.png"), edef, 
  #              width=6.5, height= 4, units="in",size=11,lineheight = 0.75
  #              )
  
  
    write.csv(file=file.path("..","Output","Archives","2020_Trends","def_entity_count.csv"),row.names = FALSE,
...
write.csv(file=file.path("..","Output","Archives","2020_Trends","def_entity_count_plat.csv"),row.names = FALSE,
          eplatline$data%>% mutate(Fiscal_Year=lubridate::year(dFYear))%>%
            pivot_wider(id_cols=c(PlatformPortfolio),
                        names_from=Fiscal_Year,values_from=EntityCount))

ggsave600dpi(file=file.path("..","Output","Archives","2020_Trends","def_entity_count_plat_line.png"), eplatline, 
...
ggsave600dpi(file.path("..","Output","Archives","2020_Trends","def_entity_count_plat.png"), eplat, 
             width=6.5, height= 4, units="in",size=11,lineheight = 0.75
             )
...
write.csv(file=file.path("..","Output","Archives","2020_Trends","def_entity_count_subcust.csv"),row.names = FALSE,
