...
log_plot(plot=Commercial, df=def_data %>% filter(Fiscal_YQ<=2023.2),
                     filename="acq_fig5_4_commercia",xlsx="DoD_Acq_Trends_Contracts.xlsx",
...
ot(plot=PlatformMultiYearShare %>%, df=full_data,
...
log_plot(plot=ToplineVendor, df=ToplineVendorIntl  %>% filter(Fiscal_YQ<=2023.2),
