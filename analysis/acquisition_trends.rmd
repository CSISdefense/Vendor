...
(
PlatComp<-build_plot(
  data=full_data %>% filter(Fiscal_Year>=1991 & PlatformPortfolio!="Unlabeled"),
  chart_geom = "Line Chart",
  share = TRUE,
  labels_and_colors=labels_and_colors,
  # NA, #VAR.ncol
...
ggsave600dpi("..//Output//psr_vendorsize_abs.png", SimpleVendor_dollar, 
...
undebug(ggsave600dpi)
ggsave600dpi("..//Output//psr_vendorsize_share.png", SimpleVendor_line, 
             width=6.5, height= 5, units="in",size=12, lineheight=1.2
             )
