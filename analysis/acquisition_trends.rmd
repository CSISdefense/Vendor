...
log_plot(plot=Commercial, df=def_data %>% filter(Fiscal_YQ<=2023.2),
                     filename="acq_fig5_4_commercial",xlsx="DoD_Acq_Trends_Contracts.xlsx",
                     sheet="5-4 CommCust",path="../output/AcqTrends/", height=4,
...
log_plot(plot=RnDphase, df=def_data %>% filter(Fiscal_YQ<=2023.2) %>% filter(SimpleArea=="R&D"),
