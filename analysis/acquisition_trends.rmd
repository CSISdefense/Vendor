...
PricingHistory<-build_plot(
  data=PricingUpdate %>% filter(Fiscal_YQ <= 2023.2),
  chart_geom = "Line Chart",
  share = TRUE,
 ...
 #             )+labs(title=NULL,
  ...
  theme(legend.position = "right",
    ...
    date_x_year_breaks(1980,2022,5,partial_year=2023,partial_label="\nQ1–Q2")+
...
log_plot(plot=PricingHistory, df=PricingUpdate  %>% filter(Fiscal_YQ<=2023.2),
...
(fpds_pricing_bar <-  build_plot(data=full_data %>% filter(Fiscal_Year>=2012 & Fiscal_YQ<=2023.2),
                            ...
                            format=TRUE,
                            alpha_var="YTD",
)+date_x_year_breaks(2012,2022,3,partial_year=2023,partial_label="\nQ1–Q2")+
    theme(legend.position = "right")+
...
VendorSizePricing<-build_plot(
  data=full_data %>% filter(Fiscal_YQ<=2023.2 & Fiscal_Year>2000 & Shiny.VendorSize!="Unlabeled" &
...
(waiversimple <-  build_plot(data=full_data %>% filter(PlaceOfManufacture_Sum %in% c("In U.S. but Foreign Services or Content",
                               ...
                               filter(Fiscal_Year>=2009 & Fiscal_YQ<=2023.2),
                            chart_geom="Bar Chart",
                            share=FALSE,
                            x_var="dFYear",alpha_var="YTD",
                            y_var="Action_Obligation_OMB24_GDP22",
  ...
  labs(x="Fiscal Year",
    ...
    theme(legend.position = "right")+
    date_x_year_breaks(2009,2022,2,partial_year=2023,partial_label="\nQ1–Q2")+
...
log_plot(plot=waiversimple, df=full_data   %>% filter(Fiscal_YQ<=2023.2 & 
