...
SimpleVendor_dollar<-build_plot(
  data=def_data %>% filter(Fiscal_Year<=2020 & !is.na(SimpleArea) & SimpleArea!="Unlabeled"),
  chart_geom = "Bar Chart",
  labels_and_colors=labels_and_colors,
  # NA, #VAR.ncol
  x_var="dFYear", #x_var
...
PSRComp_line<-build_plot(
 ...
 #             )+labs(title=NULL,
  ...
  theme(legend.position = "bottom")+
  labs(x="Fiscal Year",
       y="Obligations (Constant 2022 $s)")+scale_x_date(date_breaks = "4 years",date_labels = "'%y")
)
