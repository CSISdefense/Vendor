...
SimpleVendor_dollar<-build_plot(
 ...
 #             )+labs(title=NULL,
  ...
  # color="Competition")+
  theme(legend.position = "right")+
  labs(y="Obligations (Constant 2020 $s)",caption="Source: FPDS; CSIS Analysis.\nNote: The merger of Raytheon and United Technologies took place in April of 2020 and thus\ndid not make the cutofff for inclusion in FY2020. McDonnell Douglas is grouped with the Big-5.")
)
...
SimpleVendor_share<-build_plot(
 ...
 #             )+labs(title=NULL,
  ...
  # color="Competition")+
  theme(legend.position = "right")+
  labs(y="Obligations (Constant 2020 $s)",caption="Source: FPDS; CSIS Analysis.\nNote: The merger of Raytheon and United Technologies took place in April of 2020 and thus did not\nmake the cutofff for inclusion in FY2020. McDonnell Douglas is grouped with the Big-5.")
)
