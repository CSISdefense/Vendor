...
ggsave600dpi("..//Output//toplineqr_keynote.svg", toplineq+
...
# addWorksheet(wb, sheetName = "2-1 TOA")
 writeData(wb, output_TY, sheet = "2-1 TOA", startRow = 1, startCol = 9)
...
write.csv(file="..//Output//toa_sam_annual_TY.csv",row.names = FALSE,na="",output_TY
          )
write.csv(file="..//Output//toa_sam_annual.csv",row.names = FALSE,na="",output_TY
          )
...
ggsave600dpi("..//Output//topline_vehicle7.png", ToplineVehicle7, 
             width=13, height= 4.5, units="in",size=11
             )

write.csv(file="..//Output//topline_vehicle7.csv",row.names = FALSE, na = "",
...
# ggsave600dpi("..//Output//Topline_Pricing_History.png", PricingHistory, 
...
#              )
  ...
  ggsave600dpi("..//Output//Topline_Pricing_History.svg", PricingHistory,  
               width=6.5, height= 3, units="in",size=12, lineheight=1.2
               )
  

write.csv(file="..//Output//Topline_Pricing_History.csv",row.names = FALSE, na = "",
...
write.csv(file="..//Output//Topline_Pricing_History_cur.csv",row.names = FALSE, na = "",
...
ggsave600dpi("..//Output//topline_commercial.svg", Commercial+
...
ggsave600dpi("..//Output//topline_UnmDuration.png", UnmDuration, 
             width=11, height= 5.5, units="in",size=14,lineheight = 1.2
             )


ggsave600dpi("..//Output//topline_CurDuration.png", CurDuration, 
             width=11, height= 5.5, units="in",size=14,lineheight = 1.2
             )

ggsave600dpi("..//Output//topline_CurDuration.svg", CurDuration,#+facet_wrap(~SubCustomer.platform,nrow=1), 
             width=6.5, height= 3, units="in",size=11,lineheight = 1.2
             )

ggsave600dpi("..//Output//topline_UnmDuration.png", UnmDuration,#+facet_wrap(~SubCustomer.platform,nrow=1), 
             width=6.5, height= 3, units="in",size=11,lineheight = 1.2
             )

ggsave600dpi("..//Output//topline_UnmDuration.svg", UnmDuration,#+facet_wrap(~SubCustomer.platform,nrow=1), 
             width=6.5, height= 3, units="in",size=11,lineheight = 1.2
             )

write.csv(file="..//Output//topline_CurDuration_current.csv",row.names = FALSE, na = "",
...
write.csv(file="..//Output//topline_UmdDuration_current.csv",row.names = FALSE, na = "",
...
ggsave600dpi("..//Output//topline_psr.svg", ToplinePSR, 
             width=6.5, height= 3, units="in",size=11, lineheight=1.2
             )
...
ggsave600dpi("..//Output//PSR_Q.png", PSR_Q, 
             width=12, height= 6, units="in",size=12, lineheight=1.2
             )

ggsave600dpi("..//Output//PSR_Q.svg", PSR_Q, 
             width=6.5, height= 3, units="in",size=11, lineheight=1.2
             )
...
output_TY<-def_data %>% filter(Fiscal_YQ<=2023.2) %>% group_by(SimpleArea,Fiscal_Year)%>%
          ...
          pivot_wider(id_cols=c(SimpleArea),
                      names_from=Fiscal_Year,values_from=Action_Obligation_Then_Year)
write.csv(file="..//Output//PSR_Q.csv",row.names = FALSE, na = "",
          output_TY)
...
write.csv(file="..//Output//PSRComp_cur.csv",row.names = FALSE, na = "",
...
ggsave("..//Output/PSRComp_both.png", 
...
ggsave("..//Output//PSRComp_both_keynote.png", 
             gridExtra::grid.arrange(
               PSRComp_bar+labs(
...
ggsave("..//Output//PSRComp_both_keynote.svg", 
             gridExtra::grid.arrange(
               PSRComp_bar+labs(
                 title="DOD Contract Obligations by Commercial Categorization, 2000-2022",
                  y="Obligations\n(Const. 2022 $s)",
...
ggsave600dpi("..//Output//topline_subcustomer_keynote.svg", SubCustomer+
...
ggsave600dpi("..//Output//topline_platform_bar_keynote.svg", Platform_Bar+
...
write.csv(output_TY,file="..//Output//topline_subcustomer_current.csv",row.names = FALSE, na = "",
          )

wb <- loadWorkbook("..//Output//AcqTrends//DoD_Acq_Trends_Contracts.xlsx")
 writeData(wb, output_TY, sheet = "2-2 Cust", startRow = 1, startCol = 10)
saveWorkbook(wb,file="..//Output//AcqTrends//DoD_Acq_Trends_Contracts.xlsx",overwrite = TRUE)
...
ggsave600dpi("..//Output//subcustomer_covid.png", SubCustomerCovid, 
             width=12, height= 6, units="in",size=12,lineheight = 1.2
             )

ggsave600dpi("..//Output//subcustomer_covid.svg", SubCustomerCovid+facet_wrap(~SubCustomer.sum,nrow=1), 
             width=6.5, height= 4, units="in",size=11,lineheight = 1.2
             )

write.csv(file="..//Output//subcustomer_covid.csv",row.names = FALSE, na = "",
...
# ggsave600dpi("..//Output//SubCustomer_Pricing_History.png", PricingHistory, 
#              width=6.5, height= 4, units="in",size=11
#              )
...
ggsave600dpi("..//Output//SubCustomer_Pricing_History.svg", PricingHistory,  
             width=6.5, height= 3, units="in",size=12, lineheight=1.2
             )


write.csv(file="..//Output//SubCustomer_Pricing_History_share.csv",row.names = FALSE, na = "",
  arrange(pivot_wider(PricingHistory$data %>% 
                        arrange(dFYear) %>% mutate(Fiscal_Year=lubridate::year(dFYear)),
                      id_cols=c(PricingInflation),
                      names_from=Fiscal_Year,values_from=Action_Obligation_OMB24_GDP22),PricingInflation)%>%
...
write.csv(file="..//Output//SubCustomer_Pricing_History.csv",row.names = FALSE, na = "",
...
ggsave600dpi("..//Output//subcustomer_commercial_keynote.png", CommercialCust+
               labs(title="DOD Contract Obligations by  Commercial Categorization, 2000-2022"),
             width=13, height= 5.5, units="in", size=20, lineheight = 0.75
             )

ggsave600dpi("..//Output//subcustomer_commercial_keynote.svg", CommercialCust+
               labs(title="DOD Contract Obligations by  Commercial Categorization, 2000-2022"),
             width=13, height= 5.5, units="in", size=20, lineheight = 0.75
             )


write.csv(file="..//Output//subcustomer_commercial.csv",row.names = FALSE, na = "",
...
ggsave600dpi("..//Output//platform_products.png", PlatformProducts, 
             width=6.5, height= 4, units="in",size=11,lineheight = 0.75
             )

write.csv(file="..//Output//platform_products_cur.csv",row.names = FALSE, na = "",
...
ggsave600dpi("..//Output//PlatformRnD.png", PlatformRnD, 
             width=6.5, height= 4, units="in",size=11,lineheight = 0.75
             )
...
ggsave600dpi("..//Output//PlatformQ.png", PlatformQ, 
             width=6.5, height= 4, units="in",size=11,lineheight = 0.75
             )

ggsave600dpi("..//Output//PlatformQ_slide.svg", PlatformQ+
...
ggsave600dpi("..//Output//PlatformQ_keynote.svg", PlatformQ+
               labs(title="Ordnance & Missile Contract Obligations, 2000-2023Q1"),
             width=9, height= 5.5, units="in", size=20, lineheight = 0.75
             )


ggsave600dpi("..//Output//OnMQ_keynote.png", OnMQ+
               labs(title="Ordnance & Missile Contract Obligations, 2000-2023Q1"),
             width=9, height= 5.5, units="in", size=20, lineheight = 0.75
             )

ggsave600dpi("..//Output//OnMQ_keynote.svg", OnMQ+
               labs(title="Ordnance & Missile Contract Obligations, 2000-2023Q1"),
             width=9, height= 5.5, units="in", size=20, lineheight = 0.75
             )
...
ggsave600dpi("..//Output//OnMQ.png", OnMQ, 
             width=6.5, height= 4, units="in",size=11,lineheight = 0.75
             )
...
write.csv(file="..//Output//platform_YTD_current.csv",row.names = FALSE, na = "",
          output_TY)
...
write.csv(file="..//Output//platform_quarter_current.csv",row.names = FALSE, na = "",
          output_TY)
...
write.csv(file="..//Output//platform_vendor.csv",row.names = FALSE, na = "",
...
write.csv(file="..//Output//platform_comp.csv",row.names = FALSE, na = "",
...
ggsave600dpi("..//Output//platform_commercial.png", CommercialPlat, 
             width=6, height= 5.5, units="in",size=12,lineheight = 1.2
             )

ggsave600dpi("..//Output//platform_commercial.svg", CommercialPlat,#+facet_wrap(~SubCustomer.platform,nrow=1), 
             width=6.5, height= 4, units="in",size=11,lineheight = 1.2
             )

ggsave600dpi("..//Output//platform_commercial.emf", CommercialPlat,#+facet_wrap(~SubCustomer.platform,nrow=1), 
             width=6.5, height= 4, units="in",size=11,lineheight = 1.2
             )


write.csv(file="..//Output//platform_commercial.csv",row.names = FALSE, na = "",
          CommercialPlat$data%>%mutate(Fiscal_Year=year(dFYear)) %>%
          pivot_wider(id_cols=c(SubCustomer.platform,AnyCommercialText),
                      names_from=Fiscal_Year,values_from=Action_Obligation_OMB24_GDP22))

write.csv(file="..//Output//platform_commercial_current.csv",row.names = FALSE, na = "",
...
write.csv(file="..//Output//platform_multiyear_cur.csv",row.names = FALSE, na = "",
...
ggsave600dpi("..//Output//Platform_MultiYear.png", PlatformMultiYear,  
             width=12, height= 6, units="in",size=12, lineheight=1.2
             )

ggsave600dpi("..//Output//Platform_MultiYearShare.png", PlatformMultiYearShare+facet_wrap(PlatformPortfolio~.,nrow=2)+
                labs(y="Share of Obligations",
...
ggsave("..//Output//Platform_MultiYearShare_keynote.png", 
...
ggsave("..//Output//Platform_MultiYearShare_keynote.svg", 
               PlatformMultiYearShare+labs(
                 title="DOD Share of Contract Obligations to Multiyear Contracts, 2000-2023Q1")+
                 facet_wrap(PlatformPortfolio~.,nrow=2)+
                labs(y="Share of Obligations",
...
write.csv(file="..//Output//PlatformMultiYearShare.csv",row.names = FALSE, na = "",
...
ggsave600dpi("..//Output//Munitions//ukraine_platform_bar.png", Platform_Ukr_Bar, 
             width=11, height= 5.5, units="in",size=14,lineheight = 1.2
             )

ggsave600dpi("..//Output//Munitions//ukraine_platform_bar.emf", Platform_Ukr_Bar,
             width=6.5, height= 4, units="in",size=11,lineheight = 1.2
             )
...
write.csv(file="..//Output//Munitions//ukraine_platform_current.csv",row.names = FALSE, na = "",
          output_TY)
...
ggsave600dpi("..//Output//topline_vendor_intl.svg", ToplineVendorIntl+
  labs(y="Obligations (Constant 2022 $s)",caption="Source: FPDS and CSIS analysis.\nNote: The merger of Raytheon and United Technologies is took place in \nApril 2020 and thus did not make the cutofff for inclusion in FY2020."), 
...
write.csv(file="..//Output//topline_vendor_intl_cur.csv",row.names = FALSE, na = "",
...
ggsave600dpi("..//Output//vendorsize_awardtaskshare.svg", VendorSizeVehicleSumLine
+
...
ggsave600dpi("..//Output//VendorSize_Pricing2021share.png", VendorSizePricing2021share+
               facet_wrap(~Shiny.VendorSize,nrow=1),
             width=6.5, height= 3, units="in",size=10,lineheight=1
             )

ggsave600dpi("..//Output//VendorSize_Pricing2021share.svg", VendorSizePricing2021share+
               facet_wrap(~Shiny.VendorSize,nrow=1),
             width=6.5, height= 3, units="in",size=10,lineheight=1)



ggsave600dpi("..//Output//vendorsize_pricing.png", VendorSizePricing+
  labs(y="Obligations (Constant 2022 $s)",caption="Source: FPDS; CSIS analysis.\nNote: The merger of Raytheon and United Technologies is took place in \nApril 2020 and thus did not make the cutofff for inclusion in FY2020."),
             width=6, height= 5, units="in",size=12,lineheight=1
             )

ggsave600dpi("..//Output//vendorsize_pricing_2021.png", VendorSizePricing2021+theme(legend.position = "none")+
...
write.csv(file="..//Output//vendorsize_pricing_current.csv",row.names = FALSE, na = "",
...
write.csv(file="..//Output//VendorSize_Pricing2021.csv",row.names = FALSE, na = "",
...
ggsave600dpi("..//Output//Vehicle_MultiYear.png", VehicleMultiYear,  
             width=12, height= 6, units="in",size=12, lineheight=1.2
             )

ggsave600dpi("..//Output//Vehicle_MultiYearShare.png", VehicleMultiYearShare,  
             width=6.5, height= 4, units="in",size=12, lineheight=1.2
             )

write.csv(file="..//Output//VehicleMultiYearShare.csv",row.names = FALSE, na = "",
...
ggsave600dpi("..//Output//PSR_MultiYear.png", PSRMultiYear,  
             width=12, height= 6, units="in",size=12, lineheight=1.2
             )

ggsave600dpi("..//Output//PSR_MultiYearShare.png", PSRMultiYearShare,  
             width=6.5, height= 4, units="in",size=12, lineheight=1.2
             )

write.csv(file="..//Output//PSRMultiYearShare.csv",row.names = FALSE, na = "",
