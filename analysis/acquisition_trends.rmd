...
ToplineComp<-build_plot(
 ...
 #             )+labs(title=NULL,
  ...
  # color="Competition")+
  theme(legend.position = "right")+
  labs(y="Obligations (Constant 2019 $s)",caption="Source: FPDS; CSIS analysis\nNote: Number of offers imputed for single-award vehicles starting in FY2018.")
)
...
ToplineVehicle<-build_plot(
  ...
  x_var="dFYear", #x_var
  y_var="Action_Obligation_OMB19_19", #VAR.y.variable
  color_var="VendorSize", #color_var
...
ggsave600dpi("..//Output//subcustomer_PSR.png", SubCustomerPSR, 
             width=12, height= 6, units="in",size=11
             )
