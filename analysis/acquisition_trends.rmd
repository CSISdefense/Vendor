...
## Topline Competition
```{r ToplineComp}
full_data %>% group_by(Fiscal_Year) %>% summarise(Action_Obligation_OMB24_GDP22=sum(Action_Obligation_OMB24_GDP22))
full_data %>% filter(Fiscal_Year==2021) %>% group_by(Competition.sum) %>% summarise(Action_Obligation_OMB24_GDP22=sum(Action_Obligation_OMB24_GDP22))
...
ota_merge<-ota_def%>%filter(Fiscal_Year >=2015 & Fiscal_Year <=2021) %>%
  ...
  dplyr::summarise(Action_Obligation_OMB24_GDP22=sum(Dollars_Obligated_OMB23_GDP21),
