...
log_plot(plot=toplineTOA, df=output_TY,y_var="Dollars_OMB25_GDP23",
                     filename="nps_fig1_toa_fms",xlsx="DoD_2024_NPS.xlsx",
         ...
         output_doc_svg=TRUE,var_list=c("source","FMS")
         )
...
log_plot(plot=toplineOutlay, df=output_TY,y_var="Dollars_OMB25_GDP23",
                     filename="nps_fig1_outlay_fms",xlsx="DoD_2024_NPS.xlsx",
...
log_plot(plot=UnmDuration, df=def_data  %>% filter(Fiscal_YQ<2024),
                     filename="nps_fig9_UmdDuration",xlsx="DoD_2024_NPS.xlsx",
                     sheet="9 Dur",path="../output/AcqTrends/NPS2024/",second_path=online_path,
         height=2.75,include_YTD=FALSE,
...
log_plot(plot=OTAPSR, df=def_kota %>% filter(Fiscal_YQ<2024),
                     filename="nps_fig2_kota_areatype",xlsx="DoD_2024_NPS.xlsx",
...
log_plot(plot=SubCustomer+facet_wrap(~SubCustomer.sum,nrow=1)+
           date_x_year_breaks(1990,2022,8), df=def_data %>% filter(Fiscal_YQ<2024),
                     filename="nps_fig4_component",xlsx="DoD_2024_NPS_pt2.xlsx",
...
log_plot(plot=CommercialCust, df=def_data %>% filter(Fiscal_YQ<2024),
                     filename="nps_fig5_commercial_subcustomer",xlsx="DoD_2024_NPS_pt2.xlsx",
                     sheet="5 Comm",path="../output/AcqTrends/NPS2024/",second_path=online_path,
         height=4,include_YTD=FALSE,
                     startRow=1,format=TRUE,excel_y_var=TRUE,excel_formulas = TRUE,
         output_doc_svg=TRUE
         )
...
log_plot(plot=Platform_Bar+theme(plot.margin = margin(t=0,r=0.25,b=0.1,l=0.1,"inches")), df=def_data   %>% filter(Fiscal_YQ<2024),
                     filename="nps_fig3_platform",xlsx="DoD_2024_NPS.xlsx",
                     sheet="3 Plat",path="../output/AcqTrends/NPS2024/",second_path=online_path,
         height=3.5,include_YTD=FALSE,
                     startRow=1,format=TRUE,excel_y_var=TRUE,excel_formulas = TRUE,
         output_doc_svg=TRUE
         )
...
log_plot(plot=PlatformMultiYearShare, df=def_data %>% filter(Fiscal_Year>=2000 &Fiscal_YQ<2024),
                     filename="nps_fig11_multiyear",xlsx="DoD_2024_NPS.xlsx",
                     sheet="11 Mult",path="../output/AcqTrends/NPS2024/",
...
log_plot(PlatformGFEshare+
           ...
           filter(Fiscal_Year>=2007 & Fiscal_YQ<2024 & gfe_gfp_code=="Y"&
                    !is.na(PlatformPortfolio) & PlatformPortfolio!="Unlabeled"),
                     filename="nps_fig9_gfe_plat",xlsx="DoD_2024_NPS.xlsx",
         sheet="9 GFE",
...
log_plot(plot=ToplineVendorIntl, df=full_data %>% filter(Fiscal_YQ<=2023.2),
                     filename="nps_fig5_vendor",xlsx="DoD_2024_NPS.xlsx",
                     sheet="5 Vend",path="../output/AcqTrends/NPS2024/",
...
def_data<-def_data %>% mutate(VendorSize.NTDC=factor(case_when(
...
ToplineVendorNTDC<-build_plot(
  data=def_data %>% filter(Fiscal_Year>=2007& Fiscal_YQ<=2023.2 ),# & Fiscal_Year<=2021
  chart_geom = "Bar Chart",
  share = FALSE,
  labels_and_colors=def_lc,
  # NA, #VAR.ncol
