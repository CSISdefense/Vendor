...
ggsave600dpi(path="..//Output//PBL//",filename="topline_subcustomer.png", SubCustomer, 
             width=12, height= 6, units="in",size=12,lineheight = 1.2
             )

ggsave600dpi(path="..//Output//PBL//",filename="topline_subcustomer.svg", SubCustomer+facet_wrap(~SubCustomer.sum,nrow=1), 
             width=6.5, height= 4, units="in",size=11,lineheight = 1.2
             )

ggsave600dpi(path="..//Output//PBL//",filename="topline_subcustomer.emf", SubCustomer+facet_wrap(~SubCustomer.sum,nrow=1), 
             width=6.5, height= 4, units="in",size=11,lineheight = 1.2
             )


write.csv(file="..//Output//PBL//topline_subcustomer.csv",row.names = FALSE, na = "",
          pivot_wider(SubCustomer$data,id_cols=c(SubCustomer.sum,SubCustomer.platform),
                      names_from=Fiscal_Year,values_from=Action_Obligation_OMB25_GDP23))

write.csv(file="..//Output//PBL//topline_subcustomer_current.csv",row.names = FALSE, na = "",
          pbl_short %>% group_by(SubCustomer.sum,ContractingSubCustomer,Fiscal_Year)%>%
...
summary(pbl_short$ContractingSubCustomer)
```
