...
write.csv(platpscintldef %>% filter(Fiscal_Year>=2000 & IsPossibleSoftwareEngineering==1) %>%
  group_by(SWpsc,ProductOrServiceCode,ProductOrServiceCodeText,Fiscal_Year)%>% summarise(o=sum(Action_Obligation_OMB24_GDP22))%>%#/1000000000
