...
ggsave600dpi("..//Output//DISA//DISA_comp.png", DISAComp,  
             width=13, height= 6, units="in",size=16, lineheight=1.2
             )



write.csv(file="..//Output//DISA//DISA_competition.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//DISA//DISA_vendor.png", DISAVendor, 
             width=6.5, height= 4, units="in",size=11
             )


write.csv(file="..//Output//DISA//DISA_vendorsize.csv",row.names = FALSE,
          # DISAComp$data%>% mutate(dFYear=lubridate::year(dFYear))%>%
...
write.csv(file="..//Output//DISA//DISA_vehicle.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//DISA//DISA_vehicle.png", DISAVehicle, 
             width=13, height= 6, units="in",size=16
             )
ggsave600dpi("..//Output//DISA//DISA_vehicle_paper.png", DISAVehicle, 
             width=13, height= 4.25, units="in",size=16
             )
ggsave600dpi("..//Output//DISA//DISA_vehicle_paper.svg", DISAVehicle, 
             width=13, height= 4.25, units="in",size=16
             )
...
# ggsave600dpi("..//Output//DISA//DISA_pricing.png", DISAPricing, 
#              width=6.5, height= 4, units="in",size=11
#              )
...
write.csv(file="..//Output//DISA//DISA_pricing.csv",row.names = FALSE,
...
# ggsave600dpi("..//Output//DISA//DISA_pricing.png", DISAcomm, 
#              width=6.5, height= 4, units="in",size=11
#              )


ggsave600dpi("..//Output//DISA//DISA_comm.png", DISAcomm,  
             width=13, height= 6, units="in",size=16, lineheight=1.2
             )

ggsave600dpi("..//Output//DISA//DISA_comm_paper.png", DISAcomm,  
             width=13, height= 4.2, units="in",size=16, lineheight=1.2
             )
ggsave600dpi("..//Output//DISA//DISA_comm_paper.svg", DISAcomm,  
             width=13, height= 4.2, units="in",size=16, lineheight=1.2
             )


write.csv(file="..//Output//DISA//DISA_comm.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//DISA//DISA_Funder.png", Funder, 
             width=13, height= 6, units="in",size=16,lineheight = 1.2
             )
ggsave600dpi("..//Output//DISA//DISA_Funder.svg", Funder, 
             width=13, height= 6, units="in",size=16,lineheight = 1.2
             )


write.csv(file="..//Output//DISA//DISA_Funder.csv",row.names = FALSE,
...
write.csv(file="..//Output//DISA//DISA_Funder_current.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//DISA//ICT_disa.png", ICT, 
             width=13, height= 6, units="in",size=16,lineheight = 1.2
             )
# 
# write.csv(file="..//Output//DISA//DISA_Funder.csv",row.names = FALSE,
...
# 
# 
# ggsave600dpi("..//Output//DISA//ICT_funder.png", ICTfunder, 
#              width=13, height= 6, units="in",size=16,lineheight = 1.2
#              )
# 
# write.csv(file="..//Output//DISA//DISA_Funder.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//DISA//DISA_psr.png", DISAPSR, 
             width=13, height= 6, units="in",size=16, lineheight=1.2
             )

write.csv(file="..//Output//DISA//DISA_psr.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//DISA//DISA_psr_detail.png", DISAPSRdetail, 
             width=13, height= 6, units="in",size=16, lineheight=1.2
             )
ggsave600dpi("..//Output//DISA//DISA_psr_detail.svg", DISAPSRdetail, 
             width=13, height= 6, units="in",size=16, lineheight=1.2
             )


write.csv(file="..//Output//DISA//DISA_DISAPSRdetail.csv",row.names = FALSE,
...
# write.csv(file="..//Output//DISA//DISA_psr_detail_current.csv",row.names = FALSE,
#           disa_data %>% group_by(SimpleArea,Fiscal_Year)%>%
#             dplyr::summarize(Action_Obligation_Then_Year=sum(Action_Obligation_Then_Year,na.rm=TRUE))%>%
#           pivot_wider(id_cols=c(SimpleArea),
#                       names_from=Fiscal_Year,values_from=Action_Obligation_Then_Year))
...
# ggsave600dpi("..//Output//DISA//DISA_psr_RnDPhase.png", RnDphase, 
#              width=13, height= 6, units="in",size=16, lineheight=1.2
#              )
                           

# write.csv(file="..//Output//DISA//DISA_psr_RnDPhase.csv",row.names = FALSE,
#           pivot_wider(RnDphase$data,id_cols=c(ProductServiceOrRnDarea),
#                       names_from=Fiscal_Year,values_from=Action_Obligation_OMB20_GDP20)%>%
#             arrange(ProductServiceOrRnDarea))
            

# write.csv(file="..//Output//DISA//DISA_psr_RnDPhase_current.csv",row.names = FALSE,
...
# ggsave600dpi("..//Output//DISA//DISA_psr_Services.png", Services, 
#              width=13, height= 6, units="in",size=16, lineheight=1.2
#              )
                           

# write.csv(file="..//Output//DISA//DISA_psr_Services.csv",row.names = FALSE,
#           pivot_wider(Services$data,id_cols=c(ProductServiceOrRnDarea),
#                       names_from=Fiscal_Year,values_from=Action_Obligation_OMB20_GDP20)%>%
#             arrange(ProductServiceOrRnDarea))
#             

# write.csv(file="..//Output//DISA//DISA_psr_Services_current.csv",row.names = FALSE,
#           disa_data %>% filter(SimpleArea=="R&D") %>%
#             format_data_for_plot(fy_var="Fiscal_Year",y_var="Action_Obligation_Then_Year",color_var = "ProductServiceOrRnDarea",
#                                  labels_and_colors=labels_and_colors) %>%
#           pivot_wider(id_cols=c(ProductServiceOrRnDarea),
...
# ggsave600dpi("..//Output//DISA//DISA_psr_Products.png", Products, 
#              width=13, height= 6, units="in",size=16, lineheight=1.2
#              )
                           

# write.csv(file="..//Output//DISA//DISA_psr_Products.csv",row.names = FALSE,
#           pivot_wider(Products$data,id_cols=c(ProductServiceOrRnDarea),
#                       names_from=Fiscal_Year,values_from=Action_Obligation_OMB20_GDP20)%>%
#             arrange(ProductServiceOrRnDarea))
#             

# write.csv(file="..//Output//DISA//DISA_psr_Products_current.csv",row.names = FALSE,
#           disa_data %>% filter(SimpleArea=="R&D") %>%
#             format_data_for_plot(fy_var="Fiscal_Year",y_var="Action_Obligation_Then_Year",color_var = "ProductServiceOrRnDarea",
#                                  labels_and_colors=labels_and_colors) %>%
#           pivot_wider(id_cols=c(ProductServiceOrRnDarea),
...
# 
# 
# ggsave600dpi("..//Output//DISA//OfficePricing.png", OfficePricing, 
#              width=12, height= 6, units="in",size=11,lineheight = 1.2
#              )
# 
# # write.csv(file="..//Output//DISA//DISA_OfficePricing.csv",row.names = FALSE,
# #           pivot_wider(OfficePricing$data,id_cols=c(Office.sum,Office.platform),
# #                       names_from=Fiscal_Year,values_from=Action_Obligation_OMB20_GDP20))
# 
# write.csv(file="..//Output//DISA//DISA_OfficePricing_current.csv",row.names = FALSE,
...
write.csv(prodserv,"..\\Output\\DISA\\DISA_prodserv.csv",row.names = FALSE)
# write.csv(prodservcomm,"..\\Output\\DISA\\DISA_prodservComm.csv",row.names = FALSE)
...
#   summarise(Action_Obligation_OMB20_GDP20=sum(Action_Obligation_OMB20_GDP20,na.rm=TRUE))
# 
# write.csv(naics,"..\\Output\\DISA\\DISA_NAICS.csv",row.names = FALSE)
# 
...
#   summarise(Action_Obligation_OMB20_GDP20=sum(Action_Obligation_OMB20_GDP20,na.rm=TRUE))
# write.csv(naicsD399,"..\\Output\\DISA\\DISA_NAICSD399.csv",row.names = FALSE)
# 
# prodservcomm<-disa_sum %>% filter(Fiscal_Year>=2002) %>% group_by(ProductOrServiceCode,ProductOrServiceCodeText,ProductServiceOrRnDarea,SimpleArea,Commercial)%>%
#   summarise(Action_Obligation_OMB20_GDP20=sum(Action_Obligation_OMB20_GDP20,na.rm=TRUE)) %>%pivot_wider(names_from = Commercial, values_from=Action_Obligation_OMB20_GDP20)
# 
...
write.csv(file="..//Output//DISA//DISA_prodserv_Comm.csv",row.names = FALSE,
...
ggsave600dpi(DISAProdServdetail,file="..//Output//DISA//DISA_prodserv_comm.png",  
             width=13, height= 6, units="in",size=16, lineheight=1.2
             )
ggsave600dpi(DISAProdServdetail,file="..//Output//DISA//DISA_prodserv_comm.svg",  
             width=13, height= 6, units="in",size=16, lineheight=1.2
             )
```
### Hand Office
...
# ggsave600dpi(DISA_prodservdetail,file="..//Output//DISA//DISA_prodserv.png",  
#              width=13, height= 6, units="in",size=16, lineheight=1.2
#              )
```
...
# 
# ggsave600dpi("..//Output//DISA//DISA_commPSR.png", DISAcommPSR,  
#              width=13, height= 6, units="in",size=16, lineheight=1.2
#              )
# write.csv(file="..//Output//DISA//DISA_commPSR.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//DISA//DISA_CommVeh.png", CommVeh,  
             width=13, height= 6, units="in",size=16, lineheight=1.2
             )

ggsave600dpi("..//Output//DISA//DISA_VehCommSum.png", VehCommSum,  
             width=13, height= 6, units="in",size=16, lineheight=1.2
             )

ggsave600dpi("..//Output//DISA//DISA_VehCommSum.svg", VehCommSum,  
             width=13, height= 6, units="in",size=16, lineheight=1.2
             )
# 
ggsave600dpi("..//Output//DISA//DISA_VehCommSum.svg", VehCommSum,  
...
# write.csv(file="..//Output//DISA//DISA_CommVeh.csv",row.names = FALSE,
#           CommVeh$data%>% mutate(dFYear=lubridate::year(dFYear))%>%
#             pivot_wider(id_cols=c(Vehicle.sum7,Commercial),
#                         names_from=dFYear,values_from=Action_Obligation_OMB20_GDP20))

write.csv(file="..//Output//DISA//DISA_VehCommSum.csv",row.names = FALSE,
...
# ggsave600dpi("..//Output//DISA//DISA_CommComp.png", CommComp,  
#              width=13, height= 6, units="in",size=16, lineheight=1.2
#              )
# 
# ggsave600dpi("..//Output//DISA//DISA_CompCommSum.png", CompComm,  
#              width=13, height= 6, units="in",size=16, lineheight=1.2
#              )
...
# ggsave600dpi("..//Output//DISA//DISA_Office.png", Office, 
#              width=13, height= 6, units="in",size=16,lineheight = 1.2
#              )

# write.csv(file="..//Output//DISA//DISA_Office.csv",row.names = FALSE,
...
# 
# write.csv(file="..//Output//DISA//DISA_Office_current.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//DISA//DISA_OfficeLoc.png", OfficeLoc, 
             width=13, height= 6, units="in",size=16,lineheight = 1.2
             )
...
OfficeSum<-build_plot(
 ...
 #             )+labs(title=NULL,
  ...
  # color="Competition")+
  theme(legend.position = "right")+
  labs(y="Obligations (Constant 2020 $s)")#+  scale_fill_manual(values=cbPalette)
)

ggsave600dpi("..//Output//DISA//DISA_OfficeSum.png", OfficeSum, 
             width=13, height= 6, units="in",size=16,lineheight = 1.2
             )
ggsave600dpi("..//Output//DISA//DISA_OfficeSum.svg", OfficeSum, 
             width=13, height= 6, units="in",size=16,lineheight = 1.2
             )
write.csv(file="..//Output//DISA//DISA_OfficeSum.csv",row.names = FALSE,
          arrange(pivot_wider(OfficeSum$data %>% 
                        arrange(dFYear) %>% mutate(Fiscal_Year=lubridate::year(dFYear)),
                      id_cols=c(OfficeScott,OfficeSum),
                    names_from=Fiscal_Year,values_from=
                      Action_Obligation_OMB20_GDP20),OfficeScott,OfficeSum))
...
ggsave600dpi("..//Output//DISA//DISA_OfficePSR.png", OfficePSR, 
             width=13, height= 6, units="in",size=16,lineheight = 1.2
             )

ggsave600dpi("..//Output//DISA//DISA_OfficePSR_paper.png", OfficePSR, 
             width=13, height= 4.5, units="in",size=16,lineheight = 1.2
             )

ggsave600dpi("..//Output//DISA//DISA_OfficePSR_paper.svg", OfficePSR, 
             width=13, height= 4.5, units="in",size=16,lineheight = 1.2
             )

write.csv(file="..//Output//DISA//DISA_OfficePSR.csv",row.names = FALSE,
...
# write.csv(file="..//Output//DISA//DISA_OfficePSR_current.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//DISA//DISA_OfficeFunder.png", OfficeFunder, 
             width=13, height= 6, units="in",size=16,lineheight = 1.2
             )

ggsave600dpi("..//Output//DISA//DISA_OfficeFunder_paper.png", OfficeFunder, 
             width=13, height= 4.5, units="in",size=16,lineheight = 1.2
             )
ggsave600dpi("..//Output//DISA//DISA_OfficeFunder_paper.svg", OfficeFunder, 
             width=13, height= 4.5, units="in",size=16,lineheight = 1.2
             )

write.csv(file="..//Output//DISA//DISA_OfficeFunder.csv",row.names = FALSE,
...
ggsave600dpi("..//Output//DISA//DISA_OfficeComm.png", OfficeComm, 
             width=13, height= 6, units="in",size=16,lineheight = 1.2
             )


ggsave600dpi("..//Output//DISA//DISA_OfficeComm_paper.png", OfficeComm, 
             width=13, height= 4.5, units="in",size=16,lineheight = 1.2
             )


ggsave600dpi("..//Output//DISA//DISA_OfficeComm_paper.svg", OfficeComm, 
             width=13, height= 4.5, units="in",size=16,lineheight = 1.2
             )


write.csv(file="..//Output//DISA//DISA_OfficeComm.csv",row.names = FALSE,
...
# write.csv(file="..//Output//DISA//DISA_OfficeComm_current.csv",row.names = FALSE,
#           disa_sum %>% group_by(Office.sum,ContractingOffice,Fiscal_Year)%>%
#             dplyr::summarize(Action_Obligation_Then_Year=sum(Action_Obligation_Then_Year,na.rm=TRUE))%>%
#           pivot_wider(id_cols=c(Office.sum,ContractingOffice),
#                       names_from=Fiscal_Year,values_from=Action_Obligation_Then_Year))
...
# 
# ggsave600dpi("..//Output//DISA//DISA_OfficeVehicle.png", OfficeVehicle, 
#              width=13, height= 6, units="in",size=16,lineheight = 1.2
#              )

ggsave600dpi("..//Output//DISA//DISA_OfficeVehicle_paper.png", OfficeVehicle, 
             width=13, height= 4.5, units="in",size=16,lineheight = 1.2
             )
ggsave600dpi("..//Output//DISA//DISA_OfficeVehicle_paper.svg", OfficeVehicle, 
             width=13, height= 4.5, units="in",size=16,lineheight = 1.2
             )

write.csv(file="..//Output//DISA//DISA_OfficeVehicle.csv",row.names = FALSE,
...
# write.csv(file="..//Output//DISA//DISA_OfficeVehicle_current.csv",row.names = FALSE,
#           disa_sum %>% group_by(Office.sum,ContractingOffice,Fiscal_Year)%>%
#             dplyr::summarize(Action_Obligation_Then_Year=sum(Action_Obligation_Then_Year,na.rm=TRUE))%>%
#           pivot_wider(id_cols=c(Office.sum,ContractingOffice),
#                       names_from=Fiscal_Year,values_from=Action_Obligation_Then_Year))
...
# 
# ggsave600dpi("..//Output//DISA//OfficeVehicle.png", OfficeVehicle, 
#              width=13, height= 6, units="in",size=16,lineheight = 1.2
#              )
...
# ggsave600dpi("..//Output//DISA//DISA_FunderComm.png", FunderComm, 
#              width=13, height= 6, units="in",size=16,lineheight = 1.2
#              )
...
# ggsave600dpi("..//Output//DISA//DISA_OfficePricing.png", OfficePricing, 
#              width=13, height= 6, units="in",size=16,lineheight = 1.2
#              )
...
ggsave600dpi("..//Output//DISA//DISA_platform.png", Platform, 
             width=13, height= 6, units="in",size=16,lineheight = 1.2
             )


write.csv(file="..//Output//DISA//DISA_platform_current.csv",row.names = FALSE,
...
# ggsave600dpi("..//Output//DISA//DISA_platform_subcustomer.png", PlatformSubCustomer, 
...
# ggsave600dpi("..//Output//DISA//DISA_platform_PSR.png", PlatformPSR, 
#              width=6.5, height= 4, units="in",size=11,lineheight = 0.75
#              )
...
# ggsave600dpi("..//Output//DISA//DISA_platform_vendor.png", PlatformVendor, 
#              width=6.5, height= 4, units="in",size=11,lineheight = 0.75
#              )
...
# ggsave600dpi("..//Output//DISA//DISA_platform_comp.png", PlatformComp, 
#              width=6.5, height= 4, units="in",size=11,lineheight = 0.75
#              )
