...
ggsave600dpi(DISAProdServdetail,file="..//output//DISA_prodserv_comm.png",  
             width=13, height= 6, units="in",size=16, lineheight=1.2
             )
ggsave600dpi(DISAProdServdetail,file="..//output//DISA_prodserv_comm.eps",  
             width=13, height= 6, units="in",size=16, lineheight=1.2
             )
```
### Hand Office
...
ggsave600dpi("..//Output//DISA_VehCommSum.eps", VehCommSum,  
             width=13, height= 6, units="in",size=16, lineheight=1.2
             )
# 
ggsave600dpi("..//Output//DISA_VehCommSum.svg", VehCommSum,  
             width=13, height= 6, units="in",size=16, lineheight=1.2
             )
