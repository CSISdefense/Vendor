...
write.csv(file="..//Output//DISA_comm.csv",row.names = FALSE,
          arrange(pivot_wider(DISAcomm$data %>% 
                        arrange(dFYear) %>% mutate(fiscal_year=lubridate::year(dFYear)),
                      id_cols=c(Commercial),
                      names_from=fiscal_year,values_from=Action_Obligation_OMB20_GDP20),Commercial))
...
write.csv(file="..//Output//DISA_Funder.csv",row.names = FALSE,
          arrange(pivot_wider(Funder$data %>% 
                        arrange(dFYear) %>% mutate(fiscal_year=lubridate::year(dFYear)),
                      id_cols=c(Funder),
                      names_from=fiscal_year,values_from=Action_Obligation_OMB20_GDP20),Funder))
