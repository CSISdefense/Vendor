...
# summary(factor(missing_original$WhyMissing))
# sum(missing_original$Action.Obligation[missing_original$WhyMissing=="Close/Term LastCurrent Out of Range"])
# rm(missing_original)
...
sum(now_incomplete_boost$Action.Obligation[now_incomplete_boost$WhyIncomplete=="MaxBoostDate>=2017"])
sum(now_incomplete_boost$Action.Obligation.x[now_incomplete_boost$WhyIncomplete=="Not Closed/Term & Last Current is na"])
sum(now_incomplete_boost$Action.Obligation.x[now_incomplete_boost$WhyIncomplete=="Not Closed/Term & Last Current>=2017"])
...
# summary(completely_missing_boost$Action.Obligation)
