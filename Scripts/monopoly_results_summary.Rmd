...
# summary(factor(missing_original$WhyMissing))
# sum(missing_original$Action_Obligation[missing_original$WhyMissing=="Close/Term LastCurrent Out of Range"])
# rm(missing_original)
