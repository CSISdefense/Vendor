...
def<-left_join(def,def_detail)
    ...
    def$n_CBre<-(def$ChangeOrderCeilingGrowth/
                        def$UnmodifiedContractBaseAndAllOptionsValue_Then_Year)+1
    def$n_CBre[
      is.na(def$n_CBre) & def$b_CBre==0]<-1

    #l_CBre
    def$l_CBre<-na_non_positive_log(def$n_CBre)
