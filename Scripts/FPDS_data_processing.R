...
write.csv(munitiondef %>% select(-PricingUCA,-organizationaltype,-ClassifyNumberOfOffers,-CompetitionClassification,-VendorSize,-Small,
                                 -ClassifyNumberOfOffers),file="data/clean/Defense_Munition_FPDS_FMS_skinny.txt",row.names=FALSE,na = "N/A")
