...
write_delim(descrip,file="..//data_raw//OTA_descrip_hash.csv",delim = ",")#,fileEncoding = "UTF-16LE")
#Add the descrip_row_number back to the main dataframe
OTA_data_current<-read_and_join_experiment(OTA_data_current,
                         path="..//data_raw//",dir="",lookup_file = "OTA_descrip_hash.csv",
...
d<-read_delim(file.path("..","data","semi_clean","ota_description_UAS.txt"),na ="",col_types="ccccc",delim="\t")
problems(d)
...
write_delim(d,file.path("..","data","semi_clean","ota_description_UAS.txt"),na = "",delim="\t",eol="\r\n")
