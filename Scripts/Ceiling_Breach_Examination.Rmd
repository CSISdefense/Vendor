...
W912UMtrans$chgWonT[is.na(W912UMtrans$chgWonT)&
                      (W912UMtrans$baseandalloptionsvalue==0 | 
                       W912UMtrans$ChangeOrderCeilingGrowth==0)
...
#Percent Growth
summary(Hmisc::cut2(cbre_preclean$n_CBre-1,c(1,
                                          10,
                                          100
                                          )))
summary(Hmisc::cut2(cbre$n_CBre-1,c(1,
                                          10,
                                          100
                                          )))

summary(cbre$Ceil[(cbre$n_CBre-1)>10])
summary(cbre$Ceil[(cbre$n_CBre-1)>100])
...
# write.csv(file="..\\Data\\semi_clean\\p_CBre_post_clean_outliers.csv",cbre %>% filter((n_CBre-1)>10),row.names = FALSE)
write.csv(file="..\\Data\\semi_clean\\n_CBre_post_clean_outliers.csv",cbre %>% filter(ChangeOrderCeilingGrowth>=2.5e8),row.names = FALSE)
```
