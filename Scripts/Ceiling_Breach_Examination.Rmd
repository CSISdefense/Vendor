...
summary(cbre_preclean$ChangeOrderCeilingGrowth+ChangeOrderCeilingRescision)
...
W912UMtrans<-inner_join(W912UMtrans,W912UM %>% group_by() %>%
                          dplyr::select(CSIScontractID,
                                        ...
                                        ChangeOrderCeilingGrowth+ChangeOrderCeilingRescision,
...
(
  ggplot(cbre, aes(x=n_CBre,y=ChangeOrderCeilingGrowth+ChangeOrderCeilingRescision)) +#,color=qGrowth
    geom_point(alpha=0.25,shape=".")+
    # theme(axis.text.x = element_text(angle = 90, hjust = 1))+
    scale_x_log10()+scale_y_log10()#+
  #+
