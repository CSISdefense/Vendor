...
This is a quick inspection to make sure that the version of the transformed dataset to be used is current.
...
### Contract Initial Examination
```{r W912UMExercised}
#Old W912UM Code copied over from Exercised_Option_Examination.Rmd in the services repo
...
### Transaction
#### Unmodified Transactions
```{r W912UM_exercised_transction_unmodified}
# W912UMtrans<-read.delim(file="..\\data\\semi_clean\\W912UM_complete.txt", sep="\t")
