...
def_all$n_CBre <- def_all$ChangeOrderCeilingGrowth +
  ifelse(def_all$SteadyScopeCeilingModification+def_all$AdminCeilingModification<0,
         def_all$SteadyScopeCeilingModification+def_all$AdminCeilingModification,0)+1
def_all$n_CBre[def_all$n_CBre<=1 & def_all$ChangeOrderCeilingGrowth>0]<-NA
def_all$n_CBre[def_all$ChangeOrderCeilingGrowth==0]<-1
...
summary(def_detail$IsParentCSIScontractID)
