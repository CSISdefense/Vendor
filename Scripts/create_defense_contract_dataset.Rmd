...
colnames(def_all)[colnames(def_all)=="UnmodifiedContractBaseAndAllOptionsValue"]<-"UnmodifiedCeiling"
debug(input_contract_ceiling_breach)
def_all<-input_contract_ceiling_breach(def_all,
             file="Contract.SP_ContractCeilingBreachCustomer.txt")

sum(def_all$ContractBaseAndAllOptionsValue)

sum(def_all$UnmodifiedCeiling)
sum(def_all$ChangeOrderCeilingGrowth)


nrow(def_all[def_all$UnmodifiedCeiling+
  ...
  def_all$SteadyScopeCeilingModification!=
    def_all$ContractBaseAndAllOptionsValue,])


def_all$CeilingCheckSum<-def_all$UnmodifiedCeiling+
  def_all$ChangeOrderCeilingGrowth+
  def_all$ChangeOrderCeilingRescision+
    def_all$AdminCeilingModification+
    def_all$EndingCeilingModification+
...
summary(def_all$CeilingCheckSum)
summary(def_all$ContractBaseAndAllOptionsValue)


View(def_all %>% dplyr::select(CSIScontractID,
                               UnmodifiedCeiling,
                               ...
                               CeilingCheckSum) %>% 
       filter(CeilingCheckSum-ContractBaseAndAllOptionsValue>1))
