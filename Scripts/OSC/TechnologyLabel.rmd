...
swb<-loadWorkbook(file=file.path(sharepoint_output_path,"selected_assistance_critical_tech.xlsx"))
...
writeData(wb, sheet="DFC",dfc)
writeData(wb, sheet="USAS",loanSelected %>% filter(AnyTag==TRUE & !is.na(AnyTag)))
saveWorkbook(wb,file=file.path(repo_output_path,"selected_assistance_critical_tech.xlsx"),overwrite = TRUE)
