...
writeData_twice(swb,rwb,sheet="504-bio",sba.504 %>% filter(NaicsCode %in% c(541711, 541714)))
writeData_twice(swb,rwb, sheet="7a-bio",sba.7a %>% filter(NaicsCode %in% c(541711, 541714)))
