...
discrete_fitted_cbre_model(smp,"cb_Comp") + 
...
#Plot the Fitted
#Add the fitted regression line
discrete_fitted_cbre_model(smp,"n_Comp") +
...
#Competition curves
fitted_b_CBre_model(smp,"cl_Ceil") + stat_function(fun = b_CBre_02A_curve, 
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_02A)
...
#Frequency Plot
freq_continuous_cbre_plot(smp,"lsqr_Ceil")

#Percent Terminated Plot
binned_percent_cbre_plot(smp,"lsqr_Ceil")

#Model
b_CBre_02B <- glm (data=smp,
                 b_CBre ~n_Comp + cl_Ceil + clsqr_Ceil, family=binomial(link="logit"))
display(b_CBre_02B)

#Plot the fitted model plot
b_CBre_02B_curve<-function(x, Comp){invlogit(cbind(1,Comp,x, x^2) %*%  coef(b_CBre_02B))}

#Competition curves
fitted_b_CBre_model(smp,"cl_Ceil") + stat_function(fun = b_CBre_02B_curve, 
                             args=list(Comp=0),color="blue")+
  stat_function(fun = b_CBre_02B_curve, 
                             args=list(Comp=2),color="blue")

#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_02B)

#Plot residuals versus fitted
residuals_cbre_plot(b_CBre_02B)+
  labs(x="Estimated  Pr (Ceiling Breach)")

residuals_cbre_plot(b_CBre_02B,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
...
b_CBre_02C <- glm (data=smp,
                 b_CBre ~n_Comp + cl_Ceil + clsqr_Ceil + n_Comp:cl_Ceil, family=binomial(link="logit"))
display(b_CBre_02C)

b_CBre_02C_curve<-function(x, Comp){invlogit(cbind(1,Comp,x,x^2,Comp*x) %*%  coef(b_CBre_02C))}

#Competition Curves
fitted_b_CBre_model(smp,"cl_Ceil") + stat_function(fun = b_CBre_02C_curve, 
                             args=list(Comp=0),color="blue")+
  stat_function(fun = b_CBre_02C_curve, 
                             args=list(Comp=2),color="blue")

#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_02C)
...
b_CBre_02D_curve<-function(x, Comp,Ceil){invlogit(cbind(1,Comp,Ceil,Ceil^2,x,Comp*Ceil) %*%  coef(b_CBre_02D))}

#Competition Curves
fitted_b_CBre_model(smp,"cl_Days") + stat_function(fun = b_CBre_02D_curve, 
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_02D)
...
#Competition Curves
fitted_b_CBre_model(smp,"cl_Days") + stat_function(fun = b_CBre_02E_curve, 
                             args=list(Comp=0,Ceil=0),color="blue")+
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_02E)
...
#Frequency Plot
freq_continuous_cbre_plot(smp,"lsqr_Days")

#Percent Terminated Plot
binned_percent_cbre_plot(smp,"lsqr_Days")


#Create the model
b_CBre_02F <- glm (data=smp,
                 b_CBre ~n_Comp + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days, family=binomial(link="logit"))
display(b_CBre_02F)

b_CBre_02F_curve<-function(x, Comp,Ceil){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,x,x^2,
        Comp*Ceil,x*Ceil) %*%  coef(b_CBre_02F))}

#Competition curves
fitted_b_CBre_model(smp,"cl_Ceil") + stat_function(fun = b_CBre_02F_curve, 
                             args=list(Comp=0),color="blue")+
  stat_function(fun = b_CBre_02F_curve, 
                             args=list(Comp=2),color="blue")

#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_02F)

#Plot residuals versus fitted
residuals_cbre_plot(b_CBre_02F)+
  labs(x="Estimated  Pr (Ceiling Breach)")
...
residuals_cbre_plot(b_CBre_02F,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
...
#Create the model
b_CBre_02G <- glm (data=smp,
                 b_CBre ~n_Comp + 
                   cl_Ceil + cl_Days+ clsqr_Days +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days, family=binomial(link="logit"))
display(b_CBre_02G)

b_CBre_02G_curve<-function(x, Comp,Ceil){invlogit(
  cbind(1,Comp,Ceil,x,x^2,
        Comp*Ceil,x*Ceil) %*%  coef(b_CBre_02E))}

#Competition curves
fitted_b_CBre_model(smp,"cl_Ceil") + stat_function(fun = b_CBre_02G_curve, 
                             args=list(Comp=0),color="blue")+
  stat_function(fun = b_CBre_02G_curve, 
                             args=list(Comp=2),color="blue")

#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_02G)

#Plot residuals versus fitted
residuals_cbre_plot(b_CBre_02G)+
  labs(x="Estimated  Pr (Ceiling Breach)")

residuals_cbre_plot(b_CBre_02G,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
...
#Competition curves
fitted_b_CBre_model(smp,"cl_Days") + stat_function(fun = b_CBre_02H_curve, 
                             args=list(Comp=0,Ceil=0),color="blue")+
...
#Competition curves
discrete_fitted_cbre_model(smp,"SIDV") +
...
#Competition curves
discrete_fitted_cbre_model(smp,"MIDV") +
...
#Competition curves
discrete_fitted_cbre_model(smp,"OIDV") +
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_03A)
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_03B)
...
b_CBre_03C <- glm (data=smp,
                 ...
                 SIDV:cl_Days+MIDV:cl_Days+FSSGWAC:cl_Days+BPABOA:cl_Days++
                   SIDV:n_Comp+MIDV:n_Comp+FSSGWAC:n_Comp+BPABOA:n_Comp , family=binomial(link="logit"))
display(b_CBre_03C)
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_03C)
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_03D)
...
#Competition curves
discrete_fitted_cbre_model(smp,"cl_Ceil") +
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_03E)
...
residuals_cbre_plot(b_CBre_03E,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
...
# Plot the model and Vehicle for SIDV
b_CBre_03F_SIDV_curve<-function(x, Comp,Days,SIDV,MIDV,OIDV){invlogit(
  cbind(1,Comp,x,Days,Days^2,SIDV,MIDV,OIDV,
        Comp*x,Days*x,Days*Comp,
        Days*SIDV,Days*MIDV,Days*OIDV,
        Comp*SIDV,Comp*MIDV,Comp*OIDV) %*%  coef(b_CBre_03F))}

#Competition curves
discrete_fitted_cbre_model(smp,"cl_Ceil") +
  stat_function(fun = b_CBre_03F_SIDV_curve,
                             args=list(Comp=0,Days=0,
                                       MIDV=0,FSSGWAC=0,BPABOA=0,SIDV=0),color="blue")+
  stat_function(fun = b_CBre_03F_SIDV_curve,
                             args=list(Comp=2,Days=0,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_03F)
...
#Plot residuals versus fitted
residuals_cbre_plot(b_CBre_03F)+
  labs(x="Estimated  Pr (Ceiling Breach)")

# residuals_cbre_plot(b_CBre_03E,"cl_Days")+
  # labs(x="Centered Log(Duration)")


# residuals_cbre_plot(b_CBre_03F,"cl_Days")+
  # labs(x="Centered Log(Duration)")
```
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_04A)
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_04B)
...
#Vehicle curves
discrete_fitted_cbre_model(smp,"n_Fixed") +
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_04C)
...
#Days curves
discrete_fitted_cbre_model(smp,"n_Incent") +
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_04D)
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_04E)
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_04F)
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_04G)
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_04H)
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_05A)
...
#Frequency Plot
freq_discrete_cbre_plot(smp,"Intl","FxCb")

#Percent Terminated Plot 
discrete_percent_cbre_plot(smp,"Intl","FxCb")
...
#Frequency Plot
freq_discrete_cbre_plot(smp,"Intl","Veh")

#Percent Terminated Plot 
discrete_percent_cbre_plot(smp,"Intl","Veh")



#Create the model
b_CBre_05C <- glm (data=smp,
                 b_CBre ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + FSSGWAC + BPABOA +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
                   ...
                   SIDV:n_Comp+MIDV:n_Comp+FSSGWAC:n_Comp+BPABOA:n_Comp+
                   b_UCA:n_Comp+
                   SIDV:b_Intl+MIDV:b_Intl+FSSGWAC:b_Intl+BPABOA:b_Intl
                    , family=binomial(link="logit"))
display(b_CBre_05C)

# Plot the model and Vehicle 
b_CBre_05C_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed,UCA){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,UCA,x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV,
        UCA*Comp) %*%  coef(b_CBre_05C))}

#Days curves
discrete_fitted_cbre_model(smp,"SIDV") +
  stat_function(fun = b_CBre_05C_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,SIDV=0,FSSGWAC=0,BPABOA=0,
                                       Fixed=1,UCA=0),color="blue")+
  stat_function(fun = b_CBre_05C_curve,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_05C)

#Plot residuals versus fittedO
residuals_cbre_plot(b_CBre_05C)+
  labs(x="Estimated  Pr (Ceiling Breach)")
...
#Days curves
discrete_fitted_cbre_model(smp,"b_ODoD") +
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_06A)
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_06B)
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_08A)
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_08B)
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_08C)
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_CBre_08D)
