...
* b_Crai is a binary variable that has a value of 1 for a ceiling Breach of any size has occured, 0 otherwise. ('r summary(DefenseModelAndDetail$b_Crai)
...
b_Crai_smp250k<-DefenseModelAndDetail[!is.na(DefenseModelAndDetail$b_Term)&
...
b_Crai_smp250k<-b_Crai_smp250k[sample(nrow(b_Crai_smp250k),250000),]


b_Crai_smp1m<-DefenseModelAndDetail[!is.na(DefenseModelAndDetail$b_Term)&
                                  !is.na(DefenseModelAndDetail$Comp)&
                                  !is.na(DefenseModelAndDetail$l_Ceil)&
                                  !is.na(DefenseModelAndDetail$l_Days)&
                                  !is.na(DefenseModelAndDetail$n_Fixed)&
...
b_Crai_smp1m<-b_Crai_smp1m[sample(nrow(b_Crai_smp1m),1000000),]




summary(b_Crai_smp250k$b_Comp )
summary(b_Crai_smp250k$n_Comp )
summary(b_Crai_smp250k$Comp )
summary(b_Crai_smp250k$CompOffr )
summary(b_Crai_smp250k$EffComp )
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"Comp")

#Percent Terminated Plot
discrete_percent_b_Crai_plot(b_Crai_smp250k,"Comp")

#Model
b_Crai_01A <- glm (data=b_Crai_smp250k,
                 b_Term ~ cb_Comp, family=binomial(link="logit"))
display(b_Crai_01A)

#Plot the new variable and coefficients
#Add the fitted regression line
discrete_fitted_b_Crai_model(b_Crai_smp250k,"cb_Comp") + 
  stat_function(fun = fit_curve, args=list(a=coef(b_Crai_01A)[1],                                                        b=coef(b_Crai_01A)[2]),color="blue")
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"EffComp")


#Percent Terminated Plot
discrete_percent_b_Crai_plot(b_Crai_smp250k,"EffComp")

#Model
b_Crai_01B <- glm (data=b_Crai_smp250k,
                 b_Term ~ cn_Comp, family=binomial(link="logit"))
display(b_Crai_01B)

#Plot the Fitted
#Add the fitted regression line
discrete_fitted_b_Crai_model(b_Crai_smp250k,"n_Comp") +
  stat_function(fun = fit_curve, args=list(a=coef(b_Crai_01B)[1],
                                           b=coef(b_Crai_01B)[2]),
                color="blue")
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"CompOffr")

#Percent Terminated Plot
discrete_percent_b_Crai_plot(b_Crai_smp250k,"CompOffr")

#Model
b_Crai_01C <- glm (data=b_Crai_smp250k,
...
#Add the fitted regression line
discrete_fitted_b_Crai_model(b_Crai_smp250k,"n_Comp") +
  stat_function(fun = fit_curve, args=list(a=coef(b_Crai_01C)[1],
                                           b=coef(b_Crai_01C)[2]),
                color="blue")
...
#Frequency Plot
freq_continuous_b_Crai_plot(b_Crai_smp250k,"l_Offr")

#Percent Terminated Plot 
binned_percent_b_Crai_plot(b_Crai_smp250k,"l_Offr")

#Percent Terminated Plot
binned_percent_b_Crai_plot(b_Crai_smp250k,"l_Offr","FxCb")

#Percent Terminated Plot
binned_percent_b_Crai_plot(b_Crai_smp250k,"l_Offr","PSR")

#Percent Terminated Plot
binned_percent_b_Crai_plot(b_Crai_smp250k,"l_Offr","Veh")


#Model
b_Crai_01D <- glm (data=b_Crai_smp250k,
                 b_Term ~ cl_Offr, family=binomial(link="logit"))
display(b_Crai_01D)

#Variant Model
b_Crai_smp250k$clsqr_Offer<-b_Crai_smp250k$cl_Offr^2
b_Crai_01E <- glm (data=b_Crai_smp250k,
                 b_Term ~ cl_Offr +clsqr_Offer, family=binomial(link="logit"))
display(b_Crai_01E)

#Plot the data and fitted curve
b_Crai_01D_plot<-ggplot(data=b_Crai_smp250k,
...
#Plot the Fitted
#Add the fitted regression line
discrete_fitted_b_Crai_model(b_Crai_smp250k,"cl_Offr") +
  stat_function(fun = fit_curve, args=list(a=coef(b_Crai_01D)[1],
                                           b=coef(b_Crai_01D)[2]),
                             color="blue")

#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_01D)



#Plot residuals versus fitted
residuals_b_Crai_plot(b_Crai_01D,bins=3)+
...
freq_continuous_b_Crai_plot(b_Crai_smp250k,"UnmodifiedContractBaseAndAllOptionsValue",
               bins=1000)
freq_continuous_b_Crai_plot(subset(b_Crai_smp250k,UnmodifiedContractBaseAndAllOptionsValue<100000000),
               "UnmodifiedContractBaseAndAllOptionsValue",
               bins=1000)

#Frequency Plot for logged ceiling
freq_continuous_b_Crai_plot(b_Crai_smp250k,"l_Ceil")

#Percent Terminated Plot
binned_percent_b_Crai_plot(b_Crai_smp250k,"l_Ceil")

#Model
b_Crai_02A <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + cl_Ceil, family=binomial(link="logit"))
display(b_Crai_02A)


#Plot the fitted model plot
b_Crai_02A_curve<-function(x, Comp){invlogit(cbind(1,Comp,x) %*%  coef(b_Crai_02A))}

#Competition curves
fitted_b_Crai_model(b_Crai_smp250k,"cl_Ceil") + stat_function(fun = b_Crai_02A_curve, 
                             args=list(Comp=0),color="blue")+
  stat_function(fun = b_Crai_02A_curve, 
                             args=list(Comp=2),color="blue")



#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_02A)

#Plot residuals versus fitted
residuals_b_Crai_plot(b_Crai_02A)+
  labs(x="Estimated  Pr (Termination)")

residuals_b_Crai_plot(b_Crai_02A,"cl_Ceil")+
...
#Frequency Plot
freq_continuous_b_Crai_plot(b_Crai_smp250k,"lsqr_Ceil")

#Percent Terminated Plot
binned_percent_b_Crai_plot(b_Crai_smp250k,"lsqr_Ceil")

#Model
b_Crai_02B <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + cl_Ceil + clsqr_Ceil, family=binomial(link="logit"))
display(b_Crai_02B)

#Plot the fitted model plot
b_Crai_02B_curve<-function(x, Comp){invlogit(cbind(1,Comp,x, x^2) %*%  coef(b_Crai_02B))}

#Competition curves
fitted_b_Crai_model(b_Crai_smp250k,"cl_Ceil") + stat_function(fun = b_Crai_02B_curve, 
                             args=list(Comp=0),color="blue")+
  stat_function(fun = b_Crai_02B_curve, 
                             args=list(Comp=2),color="blue")

#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_02B)

#Plot residuals versus fitted
residuals_b_Crai_plot(b_Crai_02B)+
  labs(x="Estimated  Pr (Termination)")

residuals_b_Crai_plot(b_Crai_02B,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
...
#Frequency Plot
freq_continuous_b_Crai_plot(b_Crai_smp250k,"l_Ceil","EffComp")

#Plot the percent terminated across cost ceiling and competition
binned_percent_b_Crai_plot(b_Crai_smp250k,"l_Ceil","EffComp")

#Create the model
b_Crai_02C <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + cl_Ceil + clsqr_Ceil + n_Comp:cl_Ceil, family=binomial(link="logit"))
display(b_Crai_02C)

b_Crai_02C_curve<-function(x, Comp){invlogit(cbind(1,Comp,x,x^2,Comp*x) %*%  coef(b_Crai_02C))}

#Competition Curves
fitted_b_Crai_model(b_Crai_smp250k,"cl_Ceil") + stat_function(fun = b_Crai_02C_curve, 
                             args=list(Comp=0),color="blue")+
  stat_function(fun = b_Crai_02C_curve, 
                             args=list(Comp=2),color="blue")

#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_02C)

#Plot residuals versus fitted
residuals_b_Crai_plot(b_Crai_02C)+
  labs(x="Estimated  Pr (Termination)")

residuals_b_Crai_plot(b_Crai_02C,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
```
...
freq_continuous_b_Crai_plot(b_Crai_smp250k,"UnmodifiedDays",
               bins=1000)

#Frequency Plot for logged max duration
freq_continuous_b_Crai_plot(b_Crai_smp250k,"l_Days")

#Percent Terminated Plot
binned_percent_b_Crai_plot(b_Crai_smp250k,"l_Days")


#Model
b_Crai_02D <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
...
b_Crai_02D_curve<-function(x, Comp,Ceil){invlogit(cbind(1,Comp,Ceil,Ceil^2,x,Comp*Ceil) %*%  coef(b_Crai_02D))}

#Competition Curves
fitted_b_Crai_model(b_Crai_smp250k,"cl_Days") + stat_function(fun = b_Crai_02D_curve, 
                             args=list(Comp=0,Ceil=0),color="blue")+
  stat_function(fun = b_Crai_02D_curve, 
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_02D)


#Plot residuals versus fitted
residuals_b_Crai_plot(b_Crai_02D)+
  labs(x="Estimated  Pr (Termination)")
# debug(binned.resids)
# residuals_b_Crai_plot(b_Crai_02D,"cl_Days")+
  # labs(x="Centered Log(Ceiling)")
...
ggplot(data=subset(b_Crai_smp250k,!is.na(l_Ceil)),
...
#Create the model
b_Crai_02E <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + clsqr_Ceil + cl_Days+
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days, family=binomial(link="logit"))
display(b_Crai_02E)

b_Crai_02E_curve<-function(x, Comp,Ceil){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,x,
        Comp*Ceil,x*Ceil) %*%  coef(b_Crai_02E))}



#Competition Curves
fitted_b_Crai_model(b_Crai_smp250k,"cl_Days") + stat_function(fun = b_Crai_02E_curve, 
                             args=list(Comp=0,Ceil=0),color="blue")+
  stat_function(fun = b_Crai_02E_curve, 
                             args=list(Comp=2,Ceil=0),color="blue")
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_02E)


#Plot residuals versus fitted
residuals_b_Crai_plot(b_Crai_02E)+
  labs(x="Estimated  Pr (Termination)")
# debug(binned.resids)
# residuals_b_Crai_plot(b_Crai_02E,"cl_Days")+
  # labs(x="Centered Log(Ceiling)")
...
#Frequency Plot
freq_continuous_b_Crai_plot(b_Crai_smp250k,"lsqr_Days")

#Percent Terminated Plot
binned_percent_b_Crai_plot(b_Crai_smp250k,"lsqr_Days")


#Create the model
b_Crai_02F <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days, family=binomial(link="logit"))
display(b_Crai_02F)

b_Crai_02F_curve<-function(x, Comp,Ceil){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,x,x^2,
        Comp*Ceil,x*Ceil) %*%  coef(b_Crai_02F))}

#Competition curves
fitted_b_Crai_model(b_Crai_smp250k,"cl_Ceil") + stat_function(fun = b_Crai_02F_curve, 
                             args=list(Comp=0),color="blue")+
  stat_function(fun = b_Crai_02F_curve, 
                             args=list(Comp=2),color="blue")

#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_02F)

#Plot residuals versus fitted
residuals_b_Crai_plot(b_Crai_02F)+
  labs(x="Estimated  Pr (Termination)")

# residuals_b_Crai_plot(b_Crai_02F,"cl_days")+
#   labs(x="Centered Log(Days)")


residuals_b_Crai_plot(b_Crai_02F,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
...
#Create the model
b_Crai_02G <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ clsqr_Days +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days, family=binomial(link="logit"))
display(b_Crai_02G)

b_Crai_02G_curve<-function(x, Comp,Ceil){invlogit(
  cbind(1,Comp,Ceil,x,x^2,
        Comp*Ceil,x*Ceil) %*%  coef(b_Crai_02E))}

#Competition curves
fitted_b_Crai_model(b_Crai_smp250k,"cl_Ceil") + stat_function(fun = b_Crai_02G_curve, 
                             args=list(Comp=0),color="blue")+
  stat_function(fun = b_Crai_02G_curve, 
                             args=list(Comp=2),color="blue")

#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_02G)

#Plot residuals versus fitted
residuals_b_Crai_plot(b_Crai_02G)+
  labs(x="Estimated  Pr (Termination)")

residuals_b_Crai_plot(b_Crai_02G,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
...
#Frequency Plot
freq_continuous_b_Crai_plot(b_Crai_smp250k,"l_Days","EffComp")

#Plot the percent terminated across cost ceiling and competition
binned_percent_b_Crai_plot(b_Crai_smp250k,"l_Days","EffComp")

#Create the model
b_Crai_02H <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days, family=binomial(link="logit"))
display(b_Crai_02H)

b_Crai_02H_curve<-function(x, Comp,Ceil){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,x,x^2,
        Comp*Ceil,x*Ceil,x*Comp) %*%  coef(b_Crai_02H))}

#Competition curves
fitted_b_Crai_model(b_Crai_smp250k,"cl_Days") + stat_function(fun = b_Crai_02H_curve, 
                             args=list(Comp=0,Ceil=0),color="blue")+
  stat_function(fun = b_Crai_02H_curve, 
                             args=list(Comp=2,Ceil=0),color="blue")
...
```{r Model03A}
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"Veh")

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"Veh")


#Create the model
b_Crai_03A <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days, family=binomial(link="logit"))
...
b_Crai_03A_SIDV_curve<-function(x, Comp,Ceil,Days,MIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,x,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp) %*%  coef(b_Crai_03A))}

#Competition curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"SIDV") +
  stat_function(fun = b_Crai_03A_SIDV_curve, 
...
b_Crai_03A_MIDV_curve<-function(x, Comp,Ceil,Days,SIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,SIDV,x,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp) %*%  coef(b_Crai_03A))}

#Plot the model and Vehicle for MIDV
#Competition curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"MIDV") +
  stat_function(fun = b_Crai_03A_MIDV_curve, 
                             args=list(Comp=0,Ceil=0,Days=0,
...
b_Crai_03A_OIDV_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,SIDV,MIDV,x,
        Comp*Ceil,Days*Ceil,Days*Comp) %*%  coef(b_Crai_03A))}

#Plot the model and Vehicle for OIDV
#Competition curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"OIDV") +
  stat_function(fun = b_Crai_03A_OIDV_curve, 
                             args=list(Comp=0,Ceil=0,Days=0,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_03A)

#Plot residuals versus fitted
residuals_b_Crai_plot(b_Crai_03A)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_continuous_b_Crai_plot(b_Crai_smp250k,"l_Days","Veh")


#Percent Terminated Plot 
binned_percent_b_Crai_plot(b_Crai_smp250k,"l_Days","Veh")

#Create the model
b_Crai_03B <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
...
# Plot the model and Vehicle for SIDV
b_Crai_03B_SIDV_curve<-function(x, Comp,Ceil,Days,MIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,x,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Days*x,Days*MIDV,Days*OIDV) %*%  coef(b_Crai_03B))}

#Duration curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"SIDV") +
  stat_function(fun = b_Crai_03B_SIDV_curve,
...
b_Crai_03B_MIDV_curve<-function(x, Comp,Ceil,Days,SIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,SIDV,x,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Days*SIDV,Days*x,Days*OIDV) %*%  coef(b_Crai_03B))}

#Plot the model and Vehicle for MIDV
#Duration Curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"MIDV") +
  stat_function(fun = b_Crai_03B_MIDV_curve,
                             args=list(Comp=0,Ceil=0,Days=-1,
                                       SIDV=0,OIDV=0),color="blue")+
  stat_function(fun = b_Crai_03B_MIDV_curve,
                             args=list(Comp=0,Ceil=0,Days=1,
...
b_Crai_03B_OIDV_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,SIDV,MIDV,x,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Days*SIDV,Days*MIDV,Days*x) %*%  coef(b_Crai_03B))}

#Plot the model and Vehicle for OIDV
#Duration curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"OIDV") +
  stat_function(fun = b_Crai_03B_OIDV_curve,
                             args=list(Comp=0,Ceil=0,Days=-1,
                                       SIDV=0,MIDV=0),color="blue")+
  stat_function(fun = b_Crai_03B_OIDV_curve,
                             args=list(Comp=0,Ceil=0,Days=1,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_03B)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_03B)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"EffComp","Veh")

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"EffComp","Veh")


#Create the model
b_Crai_03C <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
# Plot the model and Vehicle for SIDV
b_Crai_03C_SIDV_curve<-function(x, Comp,Ceil,Days,MIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,x,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV) %*%  coef(b_Crai_03C))}

#Competition curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"SIDV") +
  stat_function(fun = b_Crai_03C_SIDV_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,OIDV=0),color="blue")+
  stat_function(fun = b_Crai_03C_SIDV_curve,
                             args=list(Comp=2,Ceil=0,Days=0,
...
b_Crai_03C_MIDV_curve<-function(x, Comp,Ceil,Days,SIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,SIDV,x,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Days*SIDV,Days*x,Days*OIDV,
        Comp*SIDV,Comp*x,Comp*OIDV) %*%  coef(b_Crai_03C))}

#Plot the model and Vehicle for MIDV
#Competition Curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"MIDV") +
  stat_function(fun = b_Crai_03C_MIDV_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       SIDV=0,OIDV=0),color="blue")+
  stat_function(fun = b_Crai_03C_MIDV_curve,
                             args=list(Comp=2,Ceil=0,Days=0,
...
b_Crai_03C_OIDV_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,SIDV,MIDV,x,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Days*SIDV,Days*MIDV,Days*x,
        Comp*SIDV,Comp*MIDV,Comp*x) %*%  coef(b_Crai_03C))}

#Plot the model and Vehicle for OIDV
#Competition curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"OIDV") +
  stat_function(fun = b_Crai_03C_OIDV_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       SIDV=0,MIDV=0),color="blue")+
  stat_function(fun = b_Crai_03C_OIDV_curve,
                             args=list(Comp=2,Ceil=0,Days=0,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_03C)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_03C)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_continuous_b_Crai_plot(b_Crai_smp250k,"l_Ceil","Veh")


#Percent Terminated Plot 
binned_percent_b_Crai_plot(b_Crai_smp250k,"l_Ceil","Veh")

#Create the model

#Create the model
b_Crai_03D <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
# Plot the model and Vehicle for SIDV
b_Crai_03D_SIDV_curve<-function(x, Comp,Ceil,Days,MIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,x,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV,
        Ceil*x,Ceil*MIDV,Ceil*OIDV) %*%  coef(b_Crai_03D))}

#Competition curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"SIDV") +
  stat_function(fun = b_Crai_03D_SIDV_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,OIDV=0),color="blue")+
  stat_function(fun = b_Crai_03D_SIDV_curve,
                             args=list(Comp=2,Ceil=0,Days=0,
...
b_Crai_03D_MIDV_curve<-function(x, Comp,Ceil,Days,SIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,SIDV,x,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Days*SIDV,Days*x,Days*OIDV,
        Comp*SIDV,Comp*x,Comp*OIDV,
        Ceil*SIDV,Ceil*x,Ceil*OIDV) %*%  coef(b_Crai_03D))}

#Plot the model and Vehicle for MIDV
#Competition Curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"MIDV") +
  stat_function(fun = b_Crai_03D_MIDV_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       SIDV=0,OIDV=0),color="blue")+
  stat_function(fun = b_Crai_03D_MIDV_curve,
                             args=list(Comp=2,Ceil=0,Days=0,
...
b_Crai_03D_OIDV_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,SIDV,MIDV,x,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Days*SIDV,Days*MIDV,Days*x,
        Comp*SIDV,Comp*MIDV,Comp*x,
        Ceil*SIDV,Ceil*MIDV,Ceil*x) %*%  coef(b_Crai_03D))}

#Plot the model and Vehicle for OIDV
#Competition curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"OIDV") +
  stat_function(fun = b_Crai_03D_OIDV_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       SIDV=0,MIDV=0),color="blue")+
  stat_function(fun = b_Crai_03D_OIDV_curve,
                             args=list(Comp=2,Ceil=0,Days=0,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_03D)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_03D)+
  labs(x="Estimated  Pr (Termination)")
...
#Create the model
b_Crai_03E <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil  + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
# Plot the model and Vehicle for SIDV
b_Crai_03E_SIDV_curve<-function(x, Comp,Days,SIDV,MIDV,OIDV){invlogit(
  cbind(1,Comp,x,Days,Days^2,SIDV,MIDV,OIDV,
        Comp*x,Days*x,Days*Comp,
        Days*SIDV,Days*MIDV,Days*OIDV,
        Comp*SIDV,Comp*MIDV,Comp*OIDV) %*%  coef(b_Crai_03E))}

#Competition curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"cl_Ceil") +
  stat_function(fun = b_Crai_03E_SIDV_curve,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_03E)

#Plot residuals versus fitted
residuals_b_Crai_plot(b_Crai_03E)+
  labs(x="Estimated  Pr (Termination)")

residuals_b_Crai_plot(b_Crai_03D,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")


residuals_b_Crai_plot(b_Crai_03E,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
...
#Create the model
b_Crai_03F <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil  + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
# Plot the model and Vehicle for SIDV
b_Crai_03F_SIDV_curve<-function(x, Comp,Days,SIDV,MIDV,OIDV){invlogit(
  cbind(1,Comp,x,Days,Days^2,SIDV,MIDV,OIDV,
        Comp*x,Days*x,Days*Comp,
        Days*SIDV,Days*MIDV,Days*OIDV,
        Comp*SIDV,Comp*MIDV,Comp*OIDV) %*%  coef(b_Crai_03F))}

#Competition curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"cl_Ceil") +
  stat_function(fun = b_Crai_03F_SIDV_curve,
                             args=list(Comp=0,Days=0,
                                       MIDV=0,OIDV=0,SIDV=0),color="blue")+
  stat_function(fun = b_Crai_03F_SIDV_curve,
                             args=list(Comp=2,Days=0,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_03F)
...
#Plot residuals versus fitted
residuals_b_Crai_plot(b_Crai_03F)+
  labs(x="Estimated  Pr (Termination)")

# residuals_b_Crai_plot(b_Crai_03E,"cl_Days")+
  # labs(x="Centered Log(Duration)")


# residuals_b_Crai_plot(b_Crai_03F,"cl_Days")+
  # labs(x="Centered Log(Duration)")
```
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"FxCb")

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"FxCb")


#Create the model
b_Crai_04A <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
b_Crai_04A_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV) %*%  coef(b_Crai_04A))}

#Competition curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"SIDV") +
  stat_function(fun = b_Crai_04A_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_04A)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_04A)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_continuous_b_Crai_plot(b_Crai_smp250k,"l_Days","FxCb")

#Percent Terminated Plot 
binned_percent_b_Crai_plot(b_Crai_smp250k,"l_Days","FxCb")


#Create the model
b_Crai_04B <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
# Plot the model and Vehicle 
b_Crai_04B_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV,
        Days*x) %*%  coef(b_Crai_04B))}

#Days curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"SIDV") +
  stat_function(fun = b_Crai_04B_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,SIDV=0,OIDV=0),color="blue")+
  stat_function(fun = b_Crai_04B_curve,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_04B)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_04B)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"FxCb","Veh")

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"FxCb","Veh")

#Create the model
b_Crai_04C <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Fixed +
...
# Plot the model and Vehicle for SIDV
b_Crai_04C_curve<-function(x, Comp,Ceil,Days,MIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        n_Fixed,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Days*SIDV,Days*MIDV,Days*OIDV,
...
#Vehicle curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"n_Fixed") +
  stat_function(fun = b_Crai_04C_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_04C)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_04C)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"Fee")

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"Fee")



#Create the model
b_Crai_04D <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
...
# Plot the model and Vehicle 
b_Crai_04D_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV) %*%  coef(b_Crai_04D))}

#Days curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"n_Incent") +
  stat_function(fun = b_Crai_04D_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_04D)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_04D)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"Fee","FxCb")+
  theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"Fee","FxCb")+
   theme(axis.text.x = element_text(angle = 90, hjust = 1))



#Create the model
b_Crai_04E <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
# Plot the model and Vehicle 
b_Crai_04E_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV,
        x*Fixed) %*%  coef(b_Crai_04E))}

#Days curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"SIDV") +
  stat_function(fun = b_Crai_04E_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_04E)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_04E)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"UCA")

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"UCA")



#Create the model
b_Crai_04F <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
# Plot the model and Vehicle 
b_Crai_04F_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV) %*%  coef(b_Crai_04F))}

#Days curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"SIDV") +
  stat_function(fun = b_Crai_04F_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,SIDV=0,OIDV=0,
                                       Fixed=1),color="blue")+
  stat_function(fun = b_Crai_04F_curve,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_04F)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_04F)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"UCA","n_Comp")

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"UCA","n_Comp")



#Create the model
b_Crai_04G <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
# Plot the model and Vehicle 
b_Crai_04G_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV) %*%  coef(b_Crai_04G))}

#Days curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"SIDV") +
  stat_function(fun = b_Crai_04G_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,SIDV=0,OIDV=0,
                                       Fixed=1),color="blue")+
  stat_function(fun = b_Crai_04G_curve,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_04G)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_04G)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_continuous_b_Crai_plot(b_Crai_smp250k,"l_Days","UCA")

#Percent Terminated Plot 
binned_percent_b_Crai_plot(b_Crai_smp250k,"l_Days","UCA")


#Create the model
b_Crai_04H <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
# Plot the model and Vehicle 
b_Crai_04H_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV,
        Comp*x,Days*x) %*%  coef(b_Crai_04H))}

#Days curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"SIDV") +
  stat_function(fun = b_Crai_04H_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,SIDV=0,OIDV=0,
                                       Fixed=1),color="blue")+
  stat_function(fun = b_Crai_04H_curve,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_04H)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_04H)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"Intl")

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"Intl")



#Create the model
b_Crai_05A <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
# Plot the model and Vehicle 
b_Crai_05A_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed,UCA){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,UCA,x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV,
        UCA*Comp) %*%  coef(b_Crai_05A))}

#Days curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"SIDV") +
  stat_function(fun = b_Crai_05A_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,SIDV=0,OIDV=0,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_05A)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_05A)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"Intl","FxCb")

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"Intl","FxCb")
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"Intl","Veh")

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"Intl","Veh")



#Create the model
b_Crai_05C <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
# Plot the model and Vehicle 
b_Crai_05C_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed,UCA){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,UCA,x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV,
        UCA*Comp) %*%  coef(b_Crai_05C))}

#Days curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"SIDV") +
  stat_function(fun = b_Crai_05C_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,SIDV=0,OIDV=0,
                                       Fixed=1,UCA=0),color="blue")+
  stat_function(fun = b_Crai_05C_curve,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_05C)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_05C)+
  labs(x="Estimated  Pr (Termination)")
...
# b_Crai_09A <- glmer(data=b_Crai_smp1m,
#                  b_Term ~n_Comp + 
#                    cl_Ceil + cl_Days+ 
#                    SIDV + MIDV + OIDV +
#                    n_Fixed + b_UCA + 
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


b_Crai_smp250k$b_ODoD<-b_Crai_smp250k$Who
levels(b_Crai_smp250k$b_ODoD)<- list("1"=c("Other DoD"), 
                                "0"=c("Air Force","Army","Navy"))
b_Crai_smp250k$b_ODoD[b_Crai_smp250k$b_ODoD=="Uncategorized"]<-NA
b_Crai_smp250k$b_ODoD<-as.integer(as.character(b_Crai_smp250k$b_ODoD))

#Create the model
b_Crai_06A <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
# Plot the model and Vehicle 
b_Crai_06A_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed,UCA,Intl){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,UCA,Intl,x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV,
        UCA*Comp) %*%  coef(b_Crai_06A))}

#Days curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"b_ODoD") +
  stat_function(fun = b_Crai_06A_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,SIDV=0,OIDV=0,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_06A)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_06A)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"EffComp","Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"EffComp","Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))
...
#Create the model
b_Crai_06B <- glm (data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
# Plot the model and Vehicle 
b_Crai_06B_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed,UCA,Intl){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,UCA,Intl,x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV,
        UCA*Comp) %*%  coef(b_Crai_06B))}

#Days curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"b_ODoD") +
  stat_function(fun = b_Crai_06B_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,SIDV=0,OIDV=0,
                                       Fixed=1,UCA=0,Intl=0),color="blue")+
  stat_function(fun = b_Crai_06B_curve,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_06B)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_06B)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"NAICS")

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"NAICS")

b_Crai_08A <- glmer(data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Fixed + b_UCA + 
...
# Plot the model and Vehicle 
b_Crai_08A_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed,UCA){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,UCA,x,
        Days*x,Days*MIDV,Days*OIDV,
        UCA*Comp) %*%  coef(b_Crai_08A))}

#Days curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"SIDV") +
  stat_function(fun = b_Crai_08A_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,SIDV=0,OIDV=0,
                                       Fixed=1,UCA=0),color="blue")+
  stat_function(fun = b_Crai_08A_curve,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_08A)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_08A)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))



#Create the model
b_Crai_08B <- glmer(data=b_Crai_smp1m,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Fixed + b_UCA + 
...
# b_Crai_08B <- glmer(data=b_Crai_smp250k,
#                  b_Term ~n_Comp + 
#                    cl_Ceil + cl_Days+ 
#                    SIDV + MIDV + OIDV +
#                    n_Comp:cl_Ceil  +
...
# Plot the model and Vehicle 
# b_Crai_08B_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed,UCA){invlogit(
#   cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
#         Comp*Ceil,Days*Ceil,Days*Comp,
#         Fixed,UCA,x,
#         Days*x,Days*MIDV,Days*OIDV,
#         UCA*Comp) %*%  coef(b_Crai_08B))}
# save(b_Crai_08B,file="Term08B.Rdata")
load("Term08B.Rdata")
#Days curves
discrete_fitted_b_Crai_model(b_Crai_smp250k,"SIDV") +
  stat_function(fun = b_Crai_08B_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,SIDV=0,OIDV=0,
                                       Fixed=1,UCA=0),color="blue")+
  stat_function(fun = b_Crai_08B_curve,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_08B)

#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_08B)+
  labs(x="Estimated  Pr (Termination)")
...
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"PSR_What","EffComp")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"EffComp","PSR")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_b_Crai_plot(b_Crai_smp250k,"EffComp","What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_b_Crai_plot(b_Crai_smp250k,"EffComp","PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


#Effective Competition
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"PSR_What","Veh")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"Veh","PSR")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_b_Crai_plot(b_Crai_smp250k,"Veh","What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_b_Crai_plot(b_Crai_smp250k,"Veh","PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#FxCb
#Frequency Plot
freq_discrete_b_Crai_plot(b_Crai_smp250k,"PSR_What","FxCb")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_b_Crai_plot(b_Crai_smp250k,"FxCb","PSR")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_b_Crai_plot(b_Crai_smp250k,"FxCb","What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_b_Crai_plot(b_Crai_smp250k,"FxCb","PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


b_Crai_08C <- glmer(data=b_Crai_smp250k,
                 b_Term ~ #n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  +
...
b_Crai_08D <- glmer(data=b_Crai_smp250k,
                 b_Term ~ n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  +
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_08C)


#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_08C)+
  labs(x="Estimated  Pr (Termination)")


# b_Crai_08E <- glmer(data=b_Crai_smp250k,
#                  b_Term ~ n_Comp + 
#                    cl_Ceil + cl_Days+ 
#                    SIDV + MIDV + OIDV +
#                    n_Comp:cl_Ceil  +
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(b_Crai_08D)


#Plot residuals versus fittedO
residuals_b_Crai_plot(b_Crai_08D)+
  labs(x="Estimated  Pr (Termination)")
...
b_Crai_09A <- glmer(data=b_Crai_smp250k,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Fixed + b_UCA + 
