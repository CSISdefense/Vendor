...
Comp_Cons_NCS6A <- glm (data=smp,
                 b_MultiOffr ~c_def6_HHI_lag1, family=binomial(link="logit"))
...
CBre_Comp_NCS6C <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def6_ratio_lag1, 
                 family=binomial(link="logit"))
...
CBre_Comp_NCS6D <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def6_ratio_lag1+n_Comp:cl_def6_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS6B,Comp_Cons_NCS6C,Comp_Cons_NCS6D,
                       CBre_Comp_01B,CBre_Comp_NCS6C,CBre_Comp_NCS6D,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_NCS6C,Comp_Cons_NCS6D,bins=20)
...
CBre_Comp_NCS6E <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS6C,Comp_Cons_NCS6E,
...
#Plot residuals versus fitted
 stargazer::stargazer(Comp_Cons_NCS6C,Comp_Cons_NCS6E,Comp_Cons_NCS6F,Comp_Cons_NCS6G,
                       CBre_Comp_NCS6C,CBre_Comp_NCS6E,CBre_Comp_NCS6G,
                       type="text",digits=2)



summary_residual_compare(Comp_Cons_NCS6F,Comp_Cons_NCS6G,bins=20)
summary_residual_compare(CBre_Comp_NCS6E,CBre_Comp_NCS6G,bins=20)
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_01F, Comp_Cons_02A,CBre_Comp_01B,CBre_Comp_02A,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_01F,Comp_Cons_02A,CBre_Comp_01B,CBre_Comp_02A,bins=2)
