...
cbre_data$l_CRai<-log(cbre_data$ChangeOrderBaseAndAllOptionsValue)
```
...
#Model
CBre_Comp_01D <- glm (cbre_data,
                 l_CRai ~ cl_Offr)
glmer_examine(CBre_Comp_01D)

#Variant Model
smp$clsqr_Offer<-smp$cl_Offr^2
CBre_Comp_01E <- glm (cbre_data,
                 l_CRai ~ cl_Offr +clsqr_Offer)
glmer_examine(CBre_Comp_01E)

#Plot the data and fitted curve
CBre_Comp_01D_plot<-ggplot(cbre_data,
...
#Model
CBre_Cons_NCS6A <- glm (cbre_data,
                 l_CRai ~c_def6_HHI_lag1)
...
summary_regression_compare(CBre_Cons_NCS6A,CBre_Cons_NCS6A,bins=20)
...
#Model
CBre_Cons_NCS6B <- glm (cbre_data,
                 l_CRai ~cl_def6_HHI_lag1)
...
summary_regression_compare(CBre_Cons_NCS6A,CBre_Cons_NCS6B,bins=20)
...
#Model
CBre_Cons_NCS6C <- glm (cbre_data,
                 l_CRai ~cl_def6_HHI_lag1+cl_def6_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(CBre_Cons_NCS6C)

CBre_Comp_NCS6C <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def6_ratio_lag1, 
                 family=binomial(link="logit"))
...
summary_regression_compare(CBre_Cons_NCS6B,CBre_Cons_NCS6C,bins=20)
summary_regression_compare(CBre_Comp_01B,CBre_Comp_NCS6C,bins=2)
...
#Model
CBre_Cons_NCS6D <- glm (cbre_data,
                 l_CRai ~cl_def6_HHI_lag1+cl_def6_ratio_lag1+cl_def6_HHI_lag1:cl_def6_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(CBre_Cons_NCS6D)

CBre_Comp_NCS6D <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def6_ratio_lag1+n_Comp:cl_def6_ratio_lag1, 
                 family=binomial(link="logit"))
...
summary_regression_compare(CBre_Cons_NCS6C,CBre_Cons_NCS6D,bins=20)
summary_regression_compare(CBre_Comp_NCS6C,CBre_Comp_NCS6D,bins=2)
...
#Model
CBre_Cons_NCS6E <- glm (cbre_data,
                 l_CRai ~cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1)
glmer_examine(CBre_Cons_NCS6E)


CBre_Comp_NCS6E <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1, 
                 family=binomial(link="logit"))
...
summary_regression_compare(CBre_Cons_NCS6C,CBre_Cons_NCS6E,bins=20)
summary_regression_compare(CBre_Comp_NCS6C,CBre_Comp_NCS6E,bins=20)
...
#Model
CBre_Cons_NCS6F <- glm (cbre_data,
                 l_CRai ~cl_def6_HHI_lag1+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1)
...
summary_regression_compare(CBre_Cons_NCS6E,CBre_Cons_NCS6F,bins=20)
...
#Model
CBre_Cons_NCS6G <- glm (cbre_data,
                 l_CRai ~cl_def6_HHI_lag1+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1+cl_def6_HHI_lag1:cl_def6_ratio_lag1)
...
summary_regression_compare(CBre_Cons_NCS6F,CBre_Cons_NCS6G,bins=20)
...
CBre_Cons_NCS6H <- glm (cbre_data,
                 l_CRai ~cl_def6_HHI_lag1+cl_def6_ratio_lag1+cl_def6_obl_lag1+
                  cl_US6_avg_sal_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1 )
glmer_examine(CBre_Cons_NCS6H)


CBre_Comp_NCS6H <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1, 
                 family=binomial(link="logit"))
...
summary_regression_compare(CBre_Cons_NCS6F,CBre_Cons_NCS6H,bins=20)
summary_regression_compare(CBre_Comp_NCS6E,CBre_Comp_NCS6H,bins=20)
...
#Model
CBre_Cons_NCS5A <- glm (cbre_data,
                 l_CRai ~cl_def5_HHI_lag1)
...
summary_regression_compare(CBre_Cons_NCS6B,CBre_Cons_NCS5A,bins=20)
...
#Model
CBre_Cons_NCS5B <- glm (cbre_data,
                 l_CRai ~cl_def5_HHI_lag1+cl_def5_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(CBre_Cons_NCS5B)

CBre_Comp_NCS5B <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def5_ratio_lag1, 
                 family=binomial(link="logit"))
...
summary_regression_compare(CBre_Cons_NCS5A,CBre_Cons_NCS5B,bins=20)
summary_regression_compare(CBre_Cons_NCS6D,CBre_Cons_NCS5B,bins=20)
summary_regression_compare(CBre_Comp_01B,CBre_Comp_NCS5B,bins=2)
summary_regression_compare(CBre_Comp_NCS6D,CBre_Comp_NCS5B,bins=2)
...
#Model
CBre_Cons_NCS5C <- glm (cbre_data,
                 l_CRai ~cl_def5_HHI_lag1+cl_def5_ratio_lag1+cl_def5_HHI_lag1:cl_def5_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(CBre_Cons_NCS5C)

CBre_Comp_NCS5C <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def5_ratio_lag1+n_Comp:cl_def5_ratio_lag1, 
                 family=binomial(link="logit"))
...
summary_regression_compare(CBre_Cons_NCS5B,CBre_Cons_NCS5C,bins=10)
summary_regression_compare(CBre_Comp_NCS5B,CBre_Comp_NCS5C,bins=5)
...
#Model
CBre_Cons_NCS5D <- glm (cbre_data,
                 l_CRai ~cl_def5_HHI_lag1+cl_def5_ratio_lag1+cl_def5_obl_lag1)
glmer_examine(CBre_Cons_NCS5D)


CBre_Comp_NCS5D <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def5_ratio_lag1+cl_def5_obl_lag1, 
                 family=binomial(link="logit"))
...
summary_regression_compare(CBre_Cons_NCS5B,CBre_Cons_NCS5D,bins=10)
summary_regression_compare(CBre_Comp_NCS5B,CBre_Comp_NCS5D,bins=5)
...
summary_regression_compare(CBre_Cons_NCS5D,CBre_Cons_NCS5E,bins=20)
summary_regression_compare(CBre_Cons_NCS6F,CBre_Cons_NCS5E,bins=20)
...
#Model
CBre_Cons_NCS4A <- glm (cbre_data,
                 l_CRai ~cl_def4_HHI_lag1)
...
summary_regression_compare(CBre_Cons_NCS6B,CBre_Cons_NCS4A,bins=20)
...
#Model
CBre_Cons_NCS4B <- glm (cbre_data,
                 l_CRai ~cl_def4_HHI_lag1+cl_def4_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(CBre_Cons_NCS4B)

CBre_Comp_NCS4B <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def4_ratio_lag1, 
                 family=binomial(link="logit"))
...
summary_regression_compare(CBre_Cons_NCS4A,CBre_Cons_NCS4B,bins=20)
summary_regression_compare(CBre_Cons_NCS5B,CBre_Cons_NCS4B,bins=20)
summary_regression_compare(CBre_Comp_01B,CBre_Comp_NCS4B,bins=2)
summary_regression_compare(CBre_Comp_NCS5B,CBre_Comp_NCS4B,bins=2)
...
#Model
CBre_Cons_NCS4C <- glm (cbre_data,
                 l_CRai ~cl_def4_HHI_lag1+cl_def4_ratio_lag1+cl_def4_HHI_lag1:cl_def4_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(CBre_Cons_NCS4C)

CBre_Comp_NCS4C <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def4_ratio_lag1+n_Comp:cl_def4_ratio_lag1, 
                 family=binomial(link="logit"))
...
summary_regression_compare(CBre_Cons_NCS2B,CBre_Cons_NCS2C,bins=10)
summary_regression_compare(CBre_Comp_NCS2B,CBre_Comp_NCS2C,bins=5)
...
#Model
CBre_Cons_NCS4D <- glm (cbre_data,
                 l_CRai ~cl_def4_HHI_lag1+cl_def4_ratio_lag1+cl_def4_obl_lag1)
glmer_examine(CBre_Cons_NCS4D)


CBre_Comp_NCS4D <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def4_ratio_lag1+ cl_def4_obl_lag1,
                 family=binomial(link="logit"))
...
stargazer::stargazer(CBre_Cons_NCS4B,CBre_Cons_NCS4D,CBre_Cons_NCS6E,
  ...
  #Compare to prior at same level
summary_regression_compare(CBre_Cons_NCS4B,CBre_Cons_NCS4D,bins=20)
#Compare to prior at lower level
summary_regression_compare(CBre_Cons_NCS6E,CBre_Cons_NCS4D,bins=20)
summary_regression_compare(CBre_Co_NCS4B,CBre_Comp_NCS4D,bins=20)
```
...
CBre_Cons_NCS4E <- glm (cbre_data,
                 l_CRai ~cl_def4_HHI_lag1+cl_def4_ratio_lag1+cl_def4_obl_lag1+
                   cl_def4_HHI_lag1:cl_def4_obl_lag1)
...
#Plot residuals versus fitted
  ...
  #Compare to prior at same level
summary_regression_compare(CBre_Cons_NCS4D,CBre_Cons_NCS4E,bins=20)
summary_regression_compare(CBre_Cons_NCS6F,CBre_Cons_NCS4E,bins=20)
...
#Model
CBre_Cons_NCS3A <- glm (cbre_data,
                 l_CRai ~cl_def3_HHI_lag1)
...
summary_regression_compare(CBre_Cons_NCS6B,CBre_Cons_NCS3A,bins=20)
...
#Model
CBre_Cons_NCS3B <- glm (cbre_data,
                 l_CRai ~cl_def3_HHI_lag1+cl_def3_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(CBre_Cons_NCS3B)

CBre_Comp_NCS3B <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def3_ratio_lag1, 
                 family=binomial(link="logit"))
...
summary_regression_compare(CBre_Cons_NCS3A,CBre_Cons_NCS3B,bins=20)
summary_regression_compare(CBre_Cons_NCS4B,CBre_Cons_NCS3B,bins=20)
summary_regression_compare(CBre_Comp_01B,CBre_Comp_NCS3B,bins=2)
summary_regression_compare(CBre_Comp_NCS4B,CBre_Comp_NCS3B,bins=2)
...
#Model
CBre_Cons_NCS3C <- glm (cbre_data,
                 l_CRai ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+cl_def3_HHI_lag1:cl_def3_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(CBre_Cons_NCS3C)

CBre_Comp_NCS3C <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def3_ratio_lag1+n_Comp:cl_def3_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Model
CBre_Cons_NCS3D <- glm (cbre_data,
                 l_CRai ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+cl_def3_obl_lag1)
glmer_examine(CBre_Cons_NCS3D)


CBre_Comp_NCS3D <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def3_ratio_lag1+ cl_def3_obl_lag1,
                 family=binomial(link="logit"))
...
stargazer::stargazer(CBre_Cons_NCS3B,CBre_Cons_NCS3E,CBre_Cons_NCS6F,
  ...
  #Compare to prior at same level
summary_regression_compare(CBre_Cons_NCS3A,CBre_Cons_NCS3D,bins=20)
#Compare to prior at lower level
summary_regression_compare(CBre_Cons_NCS6E,CBre_Cons_NCS3D,bins=20)
```
...
#Model
CBre_Cons_NCS3E <- glm (cbre_data,
                 l_CRai ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+cl_def3_obl_lag1+cl_def3_HHI_lag1:cl_def3_obl_lag1)
...
#Plot residuals versus fitted
  ...
  #Compare to prior at same level
summary_regression_compare(CBre_Cons_NCS3D,CBre_Cons_NCS3E,bins=20)
summary_regression_compare(CBre_Cons_NCS6F,CBre_Cons_NCS3E,bins=20)
...
CBre_Cons_NCS3F <- glm (cbre_data,
                 l_CRai ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+cl_def3_obl_lag1+
                  cl_US3_avg_sal_lag1+cl_def3_HHI_lag1:cl_def3_obl_lag1 )
glmer_examine(CBre_Cons_NCS3F)


CBre_Comp_NCS3F <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def3_ratio_lag1+cl_def3_obl_lag1+cl_US3_avg_sal_lag1, 
                 family=binomial(link="logit"))
...
CBre_Cons_NCS3F2 <- glm (cbre_data,
                 l_CRai ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1
                  cl_US3_avg_sal_lag1 )#+cl_def3_HHI_lag1:cl_def3_obl_lag1
glmer_examine(CBre_Cons_NCS3F2)


CBre_Comp_NCS3F2 <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def3_ratio_lag1+cl_US3_avg_sal_lag1, #cl_def3_obl_lag1+
                 family=binomial(link="logit"))
glmer_examine(CBre_Comp_NCS3F2)


CBre_Cons_NCS3F3 <- glm (cbre_data,
                 l_CRai ~cl_def3_HHI_lag1+cl_def3_obl_lag1+#cl_def3_ratio_lag1
                  cl_US3_avg_sal_lag1+cl_def3_HHI_lag1:cl_def3_obl_lag1 )
glmer_examine(CBre_Cons_NCS3F3)
glmer_examine(CBre_Cons_NCS3F3)

CBre_Cons_NCS3F4 <- glm (cbre_data,
                 l_CRai ~cl_def3_HHI_lag1+cl_def3_obl_lag1+#cl_def3_ratio_lag1
                  cl_US3_avg_sal_lag1 )#+cl_def3_HHI_lag1:cl_def3_obl_lag1
glmer_examine(CBre_Cons_NCS3F4)
glmer_examine(CBre_Cons_NCS3F4)

CBre_Comp_NCS3F3 <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def3_obl_lag1+cl_US3_avg_sal_lag1, #cl_def3_ratio_lag1
                 family=binomial(link="logit"))
...
summary_regression_compare(CBre_Cons_NCS3F,CBre_Cons_NCS3F2,bins=20)
summary_regression_compare(CBre_Comp_NCS3D,CBre_Comp_NCS3F2,bins=10)
summary_regression_compare(CBre_Cons_NCS3F2,CBre_Cons_NCS3F4,bins=20)
summary_regression_compare(CBre_Comp_NCS3F2,CBre_Comp_NCS3F3,bins=10)

summary_regression_compare(CBre_Cons_NCS3F,CBre_Cons_NCS3F4,bins=20)
summary_regression_compare(CBre_Comp_NCS3D,CBre_Comp_NCS3F3,bins=10)
...
CBre_Cons_NCS3G2 <- glm (cbre_data,
                 l_CRai ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                  cl_US3_avg_sal_lag1+
...
CBre_Cons_NCS3G3 <- glm (cbre_data,
                 l_CRai ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                  #cl_US3_avg_sal_lag1+
                   cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                  cl_US6_avg_sal_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1  )
...
vif(CBre_Comp_NCS3G)
#Defense obl 3 have the highest VIF and no coefficient to speak of, dropping it
CBre_Comp_NCS3G2 <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def3_ratio_lag1+cl_US3_avg_sal_lag1+#cl_def3_obl_lag1+
                   n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1, 
                 family=binomial(link="logit"))
...
CBre_Comp_NCS3G3 <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def3_ratio_lag1+#cl_US3_avg_sal_lag1+#cl_def3_obl_lag1+
                   n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1, 
                 family=binomial(link="logit"))
...
summary_regression_compare(CBre_Cons_NCS3F4,CBre_Cons_NCS3G3,bins=20)
summary_regression_compare(CBre_Comp_NCS3F3,CBre_Comp_NCS3G3,bins=10)
summary_regression_compare(CBre_Cons_NCS3F2,CBre_Cons_NCS3G3,bins=20)
summary_regression_compare(CBre_Comp_NCS3F2,CBre_Comp_NCS3G3,bins=10)

summary_regression_compare(CBre_Cons_NCS3F,CBre_Cons_NCS3G3,bins=20)
summary_regression_compare(CBre_Comp_NCS3D,CBre_Comp_NCS3G3,bins=10)
summary_regression_compare(CBre_Cons_NCS6G,CBre_Cons_NCS3G3,bins=20)
summary_regression_compare(CBre_Comp_NCS6G,CBre_Comp_NCS3G3,bins=10)
...
#Model
CBre_Cons_NCS2A <- glm (cbre_data,
                 l_CRai ~cl_def2_HHI_lag1)
...
summary_regression_compare(CBre_Cons_NCS6B,CBre_Cons_NCS2A,bins=20)
...
#Model
CBre_Cons_NCS2B <- glm (cbre_data,
                 l_CRai ~cl_def2_HHI_lag1+cl_def2_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(CBre_Cons_NCS2B)

CBre_Comp_NCS2B <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def2_ratio_lag1, 
                 family=binomial(link="logit"))
...
summary_regression_compare(CBre_Cons_NCS2A,CBre_Cons_NCS2B,bins=10)
summary_regression_compare(CBre_Cons_NCS3B,CBre_Cons_NCS2B,bins=20)
summary_regression_compare(CBre_Comp_01B,CBre_Comp_NCS2B,bins=2)
summary_regression_compare(CBre_Comp_NCS3B,CBre_Comp_NCS2B,bins=2)
...
#Model
CBre_Cons_NCS2C <- glm (cbre_data,
                 l_CRai ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+cl_def2_HHI_lag1:cl_def2_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(CBre_Cons_NCS2C)

CBre_Comp_NCS2C <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def2_ratio_lag1+n_Comp:cl_def2_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Model
CBre_Cons_NCS2D <- glm (cbre_data,
                 l_CRai ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+cl_def2_obl_lag1)
glmer_examine(CBre_Cons_NCS2D)


CBre_Comp_NCS2D <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def2_ratio_lag1+cl_def2_obl_lag1, 
                 family=binomial(link="logit"))
...
stargazer::stargazer(CBre_Cons_NCS6B,CBre_Cons_NCS6E,CBre_Cons_NCS6F,
  ...
  #Compare to prior at same level
summary_regression_compare(CBre_Cons_NCS2A,CBre_Cons_NCS2D,bins=10)
#Compare to prior at lower level
summary_regression_compare(CBre_Cons_NCS6E,CBre_Cons_NCS2D,bins=10)
summary_regression_compare(CBre_Cons_NCS3G,CBre_Cons_NCS2D,bins=10)
```
...
#Model
CBre_Cons_NCS2E <- glm (cbre_data,
                 l_CRai ~cl_def2_HHI_lag1+cl_def2_obl_lag1+cl_def2_HHI_lag1:cl_def2_obl_lag1)
...
stargazer::stargazer(CBre_Cons_NCS6B,CBre_Cons_NCS6D,CBre_Cons_NCS6E,
  ...
  #Compare to prior at same level
summary_regression_compare(CBre_Cons_NCS2B,CBre_Cons_NCS2D,bins=20)
#Compare to prior at lower level
summary_regression_compare(CBre_Cons_NCS6E,CBre_Cons_NCS2D,bins=20)
summary_regression_compare(CBre_Co_NCS2B,CBre_Comp_NCS2D,bins=20)
...
CBre_Cons_NCS2F <- glm (cbre_data,
                 l_CRai ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+cl_def2_obl_lag1+
                  cl_US2_avg_sal_lag1+cl_def2_HHI_lag1:cl_def2_obl_lag1 )
glmer_examine(CBre_Cons_NCS2F)


CBre_Comp_NCS2F <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def2_ratio_lag1+cl_def2_obl_lag1+cl_US2_avg_sal_lag1, 
                 family=binomial(link="logit"))
...
CBre_Cons_NCS2F2 <- glm (cbre_data,
                 l_CRai ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+#cl_def2_obl_lag1
                  cl_US2_avg_sal_lag1 )#+cl_def2_HHI_lag1:cl_def2_obl_lag1
glmer_examine(CBre_Cons_NCS2F2)


CBre_Comp_NCS2F2 <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def2_ratio_lag1+cl_US2_avg_sal_lag1, #cl_def2_obl_lag1+
                 family=binomial(link="logit"))
...
CBre_Cons_NCS2F3 <- glm (cbre_data,
                 l_CRai ~cl_def2_HHI_lag1+cl_def2_obl_lag1+#cl_def2_ratio_lag1
                  cl_US2_avg_sal_lag1 )#+cl_def2_HHI_lag1:cl_def2_obl_lag1


CBre_Comp_NCS2F3 <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def2_obl_lag1+cl_US2_avg_sal_lag1, #cl_def2_ratio_lag1
                 family=binomial(link="logit"))
glmer_examine(CBre_Comp_NCS2F2)
...
summary_regression_compare(CBre_Cons_NCS2D,CBre_Cons_NCS2F2,bins=10)
summary_regression_compare(CBre_Comp_NCS2D,CBre_Comp_NCS2F2,bins=5)
summary_regression_compare(CBre_Cons_NCS2F2,CBre_Cons_NCS2F3,bins=10)
summary_regression_compare(CBre_Comp_NCS2F2,CBre_Comp_NCS2F3,bins=5)

summary_regression_compare(CBre_Cons_NCS2F,CBre_Cons_NCS2F3,bins=20)
summary_regression_compare(CBre_Comp_NCS2D,CBre_Comp_NCS2F3,bins=10)
...
CBre_Cons_NCS2G3 <- glm (cbre_data,
                 l_CRai ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+
                  #cl_US2_avg_sal_lag1+
                   cl_def6_HHI_lag1+cl_def6_ratio_lag1+cl_def6_obl_lag1+
                  cl_US6_avg_sal_lag1,#+cl_def6_HHI_lag1:cl_def6_obl_lag1  ,
...
CBre_Comp_NCS2G <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def2_ratio_lag1+cl_US2_avg_sal_lag1+
...
CBre_Comp_NCS2G2 <- glm (cbre_data,
                 l_CRai ~n_Comp+cl_def2_ratio_lag1+#cl_US2_avg_sal_lag1+
                   cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1, 
                 family=binomial(link="logit"))
...
#Model
CBre_Cons_02A <- glm (cbre_data,
                 l_CRai ~cl_def6_HHI_lag1 + 
                   cl_Ceil)
glmer_examine(CBre_Cons_02C)

CBre_Comp_02A <- glm (cbre_data,
                 l_CRai ~n_Comp + cl_Ceil)
...
summary_regression_compare(CBre_Cons_01F,CBre_Cons_02A,CBre_Comp_01B,CBre_Comp_02A,bins=2)
...
#Create the model
CBre_Cons_02C <- glm (cbre_data,
                 l_CRai ~cl_def6_HHI_lag1 + 
                   cl_Ceil + 
                   cl_def6_HHI_lag1:cl_Ceil)
glmer_examine(CBre_Cons_02C)

CBre_Comp_02C <- glm (cbre_data,
                 l_CRai ~n_Comp + 
                   cl_Ceil + 
                   n_Comp:cl_Ceil)
...
summary_regression_compare(CBre_Cons_02A,CBre_Cons_02C,CBre_Comp_02A,CBre_Comp_02C,bins=20)
...
#Model
CBre_Cons_02D <- glm (cbre_data,
                 l_CRai ~cl_def6_HHI_lag1 + 
                   cl_Ceil + cl_Days + 
                   cl_def6_HHI_lag1:cl_Ceil)
glmer_examine(CBre_Cons_02D)

CBre_Comp_02D <- glm (cbre_data,
                 l_CRai ~n_Comp + 
                   cl_Ceil + cl_Days )
...
summary_regression_compare(CBre_Cons_02C,CBre_Cons_02D,CBre_Comp_02A,CBre_Comp_02D,bins=20)
...
summary_regression_compare(CBre_Cons_02D,CBre_Cons_02E,CBre_Comp_02D,CBre_Comp_02E,bins=20)
...
summary_regression_compare(CBre_Cons_02D,CBre_Cons_02H,CBre_Comp_02D,CBre_Comp_02H,bins=20)
...
summary_regression_compare(CBre_Cons_02H,CBre_Cons_03A,CBre_Comp_02D,CBre_Comp_03A,bins=20)
...
glmer_examine(CBre_Cons_03B2)
  ...
  summary_regression_compare(CBre_Cons_03A,CBre_Cons_03B2,CBre_Comp_03A,CBre_Comp_03B,bins=20)
...
summary_regression_compare(CBre_Cons_03B2,CBre_Cons_03C,CBre_Comp_03B,CBre_Comp_03C,bins=20)
...
stargazer::stargazer(CBre_Cons_03B2,CBre_Cons_03D2,
                     CBre_Comp_03B,CBre_Comp_03D,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_03B2,CBre_Cons_03D2,CBre_Comp_03B,CBre_Comp_03D,bins=20)
summary_regression_compare(CBre_Cons_03A,CBre_Cons_03D2,bins=20)
...
stargazer::stargazer(CBre_Cons_03D2,CBre_Cons_04A,
                     CBre_Comp_03D,CBre_Comp_04A,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_03D2,CBre_Cons_04A,CBre_Comp_03D,CBre_Comp_04A,bins=20)
...
stargazer::stargazer(CBre_Cons_04A,CBre_Cons_04B,
                     CBre_Comp_04A,CBre_Comp_04B,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_04A,CBre_Cons_04B,CBre_Comp_04A,CBre_Comp_04B,bins=20)
...
stargazer::stargazer(CBre_Cons_04B,CBre_Cons_04C,
                     CBre_Comp_04B,CBre_Comp_04C,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_04A,CBre_Cons_04B,CBre_Comp_04B,CBre_Comp_04C,bins=20)
...
stargazer::stargazer(CBre_Cons_04C,CBre_Cons_04D,
                     CBre_Comp_04C,CBre_Comp_04D,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_04C,CBre_Cons_04D,
...
stargazer::stargazer(CBre_Cons_04C,CBre_Cons_04E2,
                     CBre_Comp_04C,CBre_Comp_04E2,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_04C,CBre_Cons_04E2,CBre_Comp_04C,CBre_Comp_04E2,bins=20)
...
stargazer::stargazer(CBre_Cons_04C,CBre_Cons_04F,
                     CBre_Comp_04C,CBre_Comp_04F,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_04C,CBre_Cons_04F,CBre_Comp_04C,CBre_Comp_04F,bins=20)
...
stargazer::stargazer(CBre_Cons_04C,CBre_Cons_04G,
                     CBre_Comp_04C,CBre_Comp_04G,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_04C,CBre_Cons_04G,CBre_Comp_04C,CBre_Comp_04G,bins=20)
...
stargazer::stargazer(CBre_Cons_04G,CBre_Cons_04H,
                     CBre_Comp_04G,CBre_Comp_04H,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_04G,CBre_Cons_04H,CBre_Comp_04G,CBre_Comp_04H,bins=20)
...
stargazer::stargazer(CBre_Cons_04H,CBre_Cons_04I,
                     CBre_Comp_04H,CBre_Comp_04I,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_04H,CBre_Cons_04I,CBre_Comp_04H,CBre_Comp_04I,bins=20)
...
stargazer::stargazer(CBre_Cons_04I,CBre_Cons_04J2,
                     CBre_Comp_04I,CBre_Comp_04J2,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_04I,CBre_Cons_04J2,CBre_Comp_04I,CBre_Comp_04J2,bins=20)
...
stargazer::stargazer(CBre_Cons_04I,CBre_Cons_04K,
                     CBre_Comp_04I,CBre_Comp_04K,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_04I,CBre_Cons_04K,CBre_Comp_04I,CBre_Comp_04K,bins=20)
...
stargazer::stargazer(CBre_Cons_04L2,
                     CBre_Comp_04L2,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_04L2,CBre_Cons_04L2,CBre_Comp_04L2,CBre_Comp_04L2,bins=20)
...
stargazer::stargazer(CBre_Cons_04K,CBre_Cons_05A,
                     CBre_Comp_04K,CBre_Comp_05A,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_04K,CBre_Cons_05A,CBre_Comp_04K,CBre_Comp_05A,bins=20)
...
stargazer::stargazer(CBre_Cons_05A,CBre_Cons_05B,
                     CBre_Comp_05A,CBre_Comp_05B,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_05A,CBre_Cons_05B,CBre_Comp_05A,CBre_Comp_05B,bins=20)
...
stargazer::stargazer(CBre_Cons_05A,CBre_Cons_05C,
                     CBre_Comp_05A,CBre_Comp_05C,type="text",
                       digits=2)
summary_regression_compare(CBre_Cons_05A,CBre_Cons_05C,CBre_Comp_05A,CBre_Comp_05C,bins=20)
...
summary_regression_compare(CBre_Cons_05C,CBre_Cons_06A3,CBre_Comp_05C,CBre_Comp_06A3,bins=20)
...
summary_regression_compare(CBre_Cons_06A3,CBre_Cons_06B,CBre_Comp_06A3,CBre_Comp_06B,bins=20)
...
summary_regression_compare(CBre_Cons_06A3,CBre_Cons_06C,CBre_Comp_06A3,CBre_Comp_06C,bins=20)
...
summary_regression_compare(CBre_Cons_06C,CBre_Cons_06D,CBre_Comp_06C,CBre_Comp_06D,bins=20)
...
summary_regression_compare(CBre_Cons_06D,CBre_Cons_07A,CBre_Comp_06D,CBre_Comp_07A,bins=20)
...
summary_regression_compare(CBre_Cons_07A,CBre_Cons_07B,CBre_Comp_07A,CBre_Comp_07B,bins=20)
...
summary_regression_compare(CBre_Cons_07A,CBre_Cons_07C,CBre_Comp_07A,CBre_Comp_07C,bins=20)
...
summary_regression_compare(CBre_Cons_07C,CBre_Cons_08A,CBre_Comp_07C,CBre_Comp_08A,bins=20)
...
summary_regression_compare(CBre_Cons_07C,CBre_Cons_08B,CBre_Comp_07C,CBre_Comp_08B,bins=20)
...
CBre_Cons_Comp_09A <- glm (cbre_data,
                      l_CRai ~cl_def6_HHI_lag1 +cl_def6_ratio_lag1+cl_def6_obl_lag1+
                  cl_US6_avg_sal_lag1
                        cl_Ceil + cl_Days+ 
                        Veh +
...
summary_regression_compare(CBre_Cons_07B,CBre_Cons_Comp_09A,CBre_Comp_07B,CBre_Cons_Comp_09A,bins=100)
...
CBre_Cons_Comp_09B <- glm (cbre_data,
                      l_CRai ~cl_def3_HHI_lag1+
...
summary_regression_compare(CBre_Cons_07C,CBre_Cons_Comp_09B,CBre_Comp_07C,CBre_Cons_Comp_09B,bins=100)
...
summary_regression_compare(CBre_Cons_07C,CBre_Cons_10A,CBre_Comp_07C,CBre_Comp_10A,bins=20)
...
summary_regression_compare(CBre_Comp_10A,CBre_Comp_10B,CBre_Cons_10A,CBre_Cons_10B,bins=20)
...
summary_regression_compare(CBre_Cons_10D,CBre_Cons_10E,CBre_Comp_10B,CBre_Comp_10E,bins=20)
...
summary_regression_compare(CBre_Cons_10D,CBre_Cons_10F,CBre_Comp_10B,CBre_Comp_10F,bins=20)
...
summary_regression_compare(CBre_Cons_10D,CBre_Cons_10G,CBre_Comp_10B,CBre_Comp_10G,bins=20)
...
summary_regression_compare(CBre_Cons_10F,CBre_Cons_10H,bins=20)
...
summary_regression_compare(CBre_Cons_10F,CBre_Cons_10I,bins=20)
summary_regression_compare(CBre_Cons_10H,CBre_Cons_10I,bins=20)
...
summary_regression_compare(CBre_Cons_10H,CBre_Cons_10J,CBre_Comp_10F,CBre_Comp_10J,bins=20)
...
CBre_Cons_Comp_10K <- glm (cbre_data,
                      l_CRai ~cl_def3_HHI_lag1+
                        cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                        #cl_US3_avg_sal_lag1+
                        cl_def6_HHI_lag1+
...
CBre_Cons_Comp_10K2 <- glm (cbre_data,
                      l_CRai ~cl_def3_HHI_lag1+
                        cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                        #cl_US3_avg_sal_lag1+
                        cl_def6_HHI_lag1+
...
CBre_Cons_Comp_10K3 <- glm (cbre_data,
                      l_CRai ~cl_def3_HHI_lag1+
                        cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                        #cl_US3_avg_sal_lag1+
                        cl_def6_HHI_lag1+
...
CBre_Cons_Comp_10K4<- glm (cbre_data,
                      l_CRai ~#cl_def3_HHI_lag1+
                        #cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                        #cl_US3_avg_sal_lag1+
                        cl_def6_HHI_lag1+
...
CBre_Cons_Comp_10K5<- glm (cbre_data,
                      l_CRai ~#cl_def3_HHI_lag1+
                        #cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                        #cl_US3_avg_sal_lag1+
                        cl_def6_HHI_lag1+
...
summary_regression_compare(CBre_Cons_10I,CBre_Cons_10J,bins=20)
...
CBre_Cons_Comp_11A <- glm (cbre_data,
                      l_CRai ~cl_def3_HHI_lag1+
                        cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                        #cl_US3_avg_sal_lag1+
                        cl_def6_HHI_lag1+
...
summary_regression_compare(CBre_Comp_10F,CBre_Comp_11A,
...
CBre_Cons_Comp_11C <- glm (cbre_data,
                      l_CRai ~cl_def3_HHI_lag1+
                        cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                        #cl_US3_avg_sal_lag1+
                        cl_def6_HHI_lag1+
...
summary_regression_compare(CBre_Comp_10F,CBre_Comp_11C,
...
summary_regression_compare(CBre_Cons_07B2,CBre_Cons_12A,CBre_Comp_07B2,CBre_Comp_07C3,bins=20)
...
summary_regression_compare(CBre_Cons_07B2,CBre_Cons_12B,CBre_Comp_07B2,CBre_Comp_07C3,bins=20)
```
...
glmer_examine(CBre_Cons_13B,display=TRUE)
  ...
  CBre_Cons_13B_1m <- glmer (cbre_data1m,
                          l_CRai ~cl_def3_HHI_lag1+
                            cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                            #cl_US3_avg_sal_lag1+
                            cl_def6_HHI_lag1+
...
summary_regression_compare(CBre_Cons_14A,CBre_Cons_13B,CBre_Comp_14A.restart,CBre_Comp_13B,bins=20)
...
stargazer::stargazer(CBre_Cons_13B,CBre_Cons_13B.restart,
                     ...
                     digits=2)
summary_regression_compare(CBre_Cons_13B,CBre_Cons_13B.restart,CBre_Cons_13B_1m,CBre_Cons_13B_1m_restart,bins=50)
...
summary_regression_compare(CBre_Cons_13B,CBre_Cons_13B.restart,CBre_Comp_14A.restart,CBre_Comp_13B,bins=20)
...
CBre_Comp_13C <- glmer (cbre_data,
                        l_CRai ~CompOffr+cl_def3_ratio_lag1+
                          #cl_US3_avg_sal_lag1+#cl_def3_obl_lag1+
                          cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1+
                          cl_Ceil + cl_Days+
                          Veh  +
...
CBre_Comp_13C_1m <- glmer (cbre_data1m,
                        l_CRai ~CompOffr+cl_def3_ratio_lag1+
                          #cl_US3_avg_sal_lag1+#cl_def3_obl_lag1+
                          cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1+
                          cl_Ceil + cl_Days+
...
summary_regression_compare(CBre_Cons_14A,CBre_Cons_13C,CBre_Comp_14A.restart,CBre_Comp_13C,bins=20)
...
load("Output//CBre_Comp_13C.rdata")
  ...
  summary_regression_compare(CBre_Cons_13C,CBre_Cons_13C.restart,CBre_Comp_14A.restart,CBre_Comp_13C,bins=20)
...
summary_regression_compare(CBre_Cons_13C,CBre_Cons_13D,#CBre_Comp_14A.restart,CBre_Comp_13D,
                         bins=20)
...
load("Output//CBre_Comp_13D.rdata")
  ...
  summary_regression_compare(CBre_Cons_13D,CBre_Cons_13D.restart,CBre_Comp_13D,CBre_Comp_13D.restart,bins=20)
  summary_regression_compare(CBre_Cons_13C,CBre_Cons_13D.restart,CBre_Comp_13C,CBre_Comp_13D.restart,bins=20)
...
summary_regression_compare(CBre_Cons_13D,CBre_Cons_13E,#CBre_Comp_14A.restart,CBre_Comp_13E,
                         bins=100)
summary_regression_compare(CBre_Cons_13B,CBre_Cons_13E,#CBre_Comp_14A.restart,CBre_Comp_13E,
                         bins=100)
...
load("Output//CBre_Comp_13D.rdata")
  ...
  summary_regression_compare(CBre_Cons_13D,CBre_Cons_13D.restart,CBre_Comp_13D,CBre_Comp_13D.restart,bins=20)
  summary_regression_compare(CBre_Cons_13B,CBre_Cons_13D.restart,CBre_Comp_13B,CBre_Comp_13D.restart,bins=20)
...
CBre_Cons_Comp_14A <- glmer (cbre_data,
                      l_CRai ~cl_def6_HHI_lag1 +cl_def6_ratio_lag1+cl_def6_obl_lag1+
                  cl_US6_avg_sal_lag1+
                    n_Comp+
                        cl_Ceil + cl_Days+ 
...
summary_regression_compare(CBre_Cons_13A,CBre_Cons_13B,CBre_Comp_13A.restart,CBre_Comp_13B,bins=20)
...
CBre_Cons_Comp_14B <- glmer (cbre_data,
                      l_CRai ~cl_def6_HHI_lag1 +cl_def6_ratio_lag1+cl_def6_obl_lag1+
                  cl_US6_avg_sal_lag1+
                    CompOffr+
                        cl_Ceil + cl_Days+ 
...
CBre_Cons_Comp_15A <- glmer (cbre_data,
                 l_CRai ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                  #cl_US3_avg_sal_lag1+
                   cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                  cl_US6_avg_sal_lag1+
...
CBre_Cons_Comp_15B <- glmer (cbre_data,
                 l_CRai ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                  #cl_US3_avg_sal_lag1+
                   cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                  cl_US6_avg_sal_lag1+
...
summary_regression_compare(CBre_Cons_05C,CBre_Cons_06A,CBre_Comp_04I,CBre_Comp_06A,bins=20)
...
summary_regression_compare(CBre_Cons_06A,CBre_Cons_06B,CBre_Comp_06A,CBre_Comp_06B,bins=20)
...
summary_regression_compare(CBre_Cons_06A,CBre_Cons_06C,CBre_Comp_06A,CBre_Comp_06C,bins=20)
...
summary_regression_compare(CBre_Cons_06C,CBre_Cons_06D,CBre_Comp_06C,CBre_Comp_06D,bins=20)
summary_regression_compare(CBre_Cons_06A,CBre_Cons_06D,CBre_Comp_06A,CBre_Comp_06D,bins=20)
```
...
summary_regression_compare(CBre_Cons_06D,CBre_Cons_06E,CBre_Comp_06C,CBre_Comp_06E,bins=20)
```
...
summary_regression_compare(CBre_Cons_07A,CBre_Cons_07B2,CBre_Comp_07A,CBre_Comp_07B2,bins=20)
...
summary_regression_compare(CBre_Cons_07B2,CBre_Cons_11A,CBre_Comp_07B2,CBre_Comp_07C3,bins=20)
...
summary_regression_compare(CBre_Cons_11A,CBre_Cons_11A,CBre_Comp_11A,CBre_Comp_11A.restart,bins=20)
