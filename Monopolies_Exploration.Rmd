...
NAICS6_join$CalendarYear<-NAICS6_join$CalendarYear+1
  colnames(NAICS6_join)[colnames(NAICS6_join) %in% c("def6_hh_index","def6_obl","def6_ratio","US6_avg_sal")]<-
    paste(colnames(NAICS6_join)[colnames(NAICS6_join) %in%
                                    c("def6_hh_index","def6_obl","def6_ratio","US6_avg_sal")],"_lag1",sep="")
  




save(annual_naics6_summary,NAICS_join,file="output//naics_join.Rdata")
```