...
#               aes(x=Fiscal.Year,y=def6_hh_index))+geom_line()+facet_wrap(~NAICS_Code )
# 
...
filter(annual_naics5_summary,def4_obl==max(annual_naics5_summary$def4_obl))
...
filter(annual_naics5_summary,def3_obl==max(annual_naics5_summary$def3_obl))
...
max(annual_naics3_summary$def2_obl,na.rm=TRUE)

filter(annual_naics5_summary,def2_obl==max(annual_naics5_summary$def2_obl))
...
ggplot(annual_naics2_summary,aes(x=Fiscal.Year,weight=def2_obl))+
  geom_bar()+facet_wrap(~NAICS_Code)


ggplot(annual_naics6_summary,aes(x=Fiscal.Year,weight=def2_obl))+
...
# Output
```{r Output}
NAICS6_join<-subset(annual_naics6_summary,exclude==FALSE)
...
NAICS6_join$CalendarYear<-NAICS6_join$CalendarYear+1
  colnames(NAICS6_join)[colnames(NAICS6_join) %in% c("def6_hh_index","def6_obl","def6_ratio","US6_avg_sal")]<-
    paste(colnames(NAICS6_join)[colnames(NAICS6_join) %in%                                     c("def6_hh_index","def6_obl","def6_ratio","US6_avg_sal")],"_lag1",sep="")
NAICS6_join$NAICS6<-as.integer(NAICS6_join$NAICS6)
    
NAICS5_join<-subset(annual_naics5_summary,exclude==FALSE)
...
NAICS5_join$CalendarYear<-NAICS5_join$CalendarYear+1
  colnames(NAICS5_join)[colnames(NAICS5_join) %in% c("def5_hh_index","def5_obl","def5_ratio","US5_avg_sal")]<-
    paste(colnames(NAICS5_join)[colnames(NAICS5_join) %in%                                     c("def5_hh_index","def5_obl","def5_ratio","US5_avg_sal")],"_lag1",sep="")
NAICS5_join$NAICS5<-as.integer(NAICS5_join$NAICS5)
    
NAICS4_join<-subset(annual_naics4_summary,exclude==FALSE)
...
NAICS4_join$CalendarYear<-NAICS4_join$CalendarYear+1
  colnames(NAICS4_join)[colnames(NAICS4_join) %in% c("def4_hh_index","def4_obl","def4_ratio","US4_avg_sal")]<-
    paste(colnames(NAICS4_join)[colnames(NAICS4_join) %in%                                     c("def4_hh_index","def4_obl","def4_ratio","US4_avg_sal")],"_lag1",sep="")
NAICS4_join$NAICS4<-as.integer(NAICS4_join$NAICS4)

NAICS3_join<-subset(annual_naics3_summary,exclude==FALSE)
...
NAICS3_join$CalendarYear<-NAICS3_join$CalendarYear+1
  colnames(NAICS3_join)[colnames(NAICS3_join) %in% c("def3_hh_index","def3_obl","def3_ratio","US3_avg_sal")]<-
    paste(colnames(NAICS3_join)[colnames(NAICS3_join) %in%                                     c("def3_hh_index","def3_obl","def3_ratio","US3_avg_sal")],"_lag1",sep="")
NAICS3_join$NAICS3<-as.integer(NAICS3_join$NAICS3)
  
  NAICS2_join<-subset(annual_naics2_summary,exclude==FALSE)
...
NAICS2_join$CalendarYear<-NAICS2_join$CalendarYear+1
  colnames(NAICS2_join)[colnames(NAICS2_join) %in% c("def2_hh_index","def2_obl","def2_ratio","US2_avg_sal")]<-
    paste(colnames(NAICS2_join)[colnames(NAICS2_join) %in%                                     c("def2_hh_index","def2_obl","def2_ratio","US2_avg_sal")],"_lag1",sep="")
