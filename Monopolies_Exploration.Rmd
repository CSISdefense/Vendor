...
# Output
```{r Output}
NAICS6_join<-annual_naics6_summary
...
NAICS5_join<-annual_naics5_summary
...
NAICS4_join<-annual_naics4_summary
...
NAICS3_join<-annual_naics3_summary
...
NAICS3_join$CalendarYear<-NAICS3_join$CalendarYear+1
  ...
  NAICS2_join<-annual_naics2_summary
