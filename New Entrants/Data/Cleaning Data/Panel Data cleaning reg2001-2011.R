...
final <- read_csv("K:/2018-01 NPS New Entrants/Data/Data/Cleaned Data/SAM Data merged with FPDS, exp2000-2019.csv")
...
nop_0111 <- read_csv("Panel data reg 2001-2011 - no parent filter.csv")
nop_0111 <- select(nop_0111, -X1)

x0116.datasetnop <- rbind(nop_0111, dataset.2012, dataset.2013, dataset.2014, dataset.2015, dataset.2016)
x0116.datasetnop <- x0116.datasetnop %>%
  filter(!is.na(biz_size))


write.csv(x0116.datasetnop, "Panel Data 2001-2016 -nop.csv")  
write.csv(dataset.2012, "dataset2012-nop .csv")
write.csv(dataset.2013, "dataset2013-nop .csv")
write.csv(dataset.2014, "dataset2014-nop.csv")
write.csv(dataset.2015, "dataset2015-nop.csv")
write.csv(dataset.2016, "dataset2016-nop.csv")
...
all.dataset.DOD_nop <- rbind(dataset.2001, dataset.2002, dataset.2003, dataset.2004, dataset.2005, dataset.2006, dataset.2007, dataset.2008, dataset.2009, dataset.2010, dataset.2011)

##all.dataset.parentno <- rbind(dataset.2001, dataset.2002, dataset.2003, dataset.2004, dataset.2005, dataset.2006, dataset.2007, dataset.2008, dataset.2009, dataset.2010, dataset.2011)


write.csv(dataset.2001, "dataset2001DODnop.csv")
write.csv(dataset.2002, "dataset2002DODnop.csv")
write.csv(dataset.2003, "dataset2003DODnop.csv")
write.csv(dataset.2004, "dataset2004DODnop.csv")
write.csv(dataset.2005, "dataset2005DODnop.csv")
write.csv(dataset.2006, "dataset2006DODnop.csv")

write.csv(all.dataset.DOD_nop, "Panel Data reg 2001-2011 DOD-nop.csv")
...
panel_dataDOD <- read_csv("Panel Data reg 2001-2011 DOD-nop.csv")
panel_dataDOD <- select(panel_dataDOD, -X1)

x0116.dataset <- rbind(panel_dataDOD, dataset.2012, dataset.2013, dataset.2014, dataset.2015, dataset.2016)
x0116.dataset <- x0116.dataset %>% 
  filter(!is.na(biz_size))


write.csv(x0116.dataset, "Panel Data 2001-2016 DOD-nop.csv")  
write.csv(dataset.2012, "dataset2012DOD-nop .csv")
write.csv(dataset.2013, "dataset2013DOD-nop .csv")
write.csv(dataset.2014, "dataset2014DOD-nop.csv")
write.csv(dataset.2015, "dataset2015DOD-nop.csv")
write.csv(dataset.2016, "dataset2016DOD-nop.csv")
...
dataset.2001 = joined.5 %>% 
  ...
  select(duns, biz_size, years.in.SAM, NAICS2, ServicesCategory, location, ownership.woman, 
         ownership.veteran, ownership.minority, ownership.foreign, contract.actions,
         obligated.amt, firm.age, three.year, five.year,ten.year, survival.status, DEPARTMENT_NAME, AGENCY_NAME, registrationDate) %>% 
  filter(NAICS2 != "NU")
