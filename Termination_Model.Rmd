...
###Model 01E: Ordinal No Competition / Number of Offer  
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS6B,Term_Cons_NCS6C,
                       Term_Comp_01C,Term_Comp_NCS6C,type="text",
                       digits=2)


summary_residual_compare(Term_Cons_NCS6B,Term_Cons_NCS6C,bins=20)
summary_residual_compare(Term_Comp_01C,Term_Comp_NCS6C,bins=2)
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS6D,Term_Cons_NCS5A,Term_Cons_NCS5B,
                       Term_Comp_01C,Term_Comp_NCS6D,Term_Comp_NCS5B,type="text",
                       digits=2)
...
summary_residual_compare(Term_Comp_01C,Term_Comp_NCS5B,bins=2)
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS5A,Term_Cons_NCS5B,Term_Cons_NCS5D,
                       Term_Comp_01C,Term_Comp_NCS5B,Term_Comp_NCS5D,type="text",
                       digits=2)
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS5B,Term_Cons_NCS4A,Term_Cons_NCS4B,
                       Term_Comp_01C,Term_Comp_NCS5B,Term_Comp_NCS4B,type="text",
                       digits=2)
...
summary_residual_compare(Term_Comp_01C,Term_Comp_NCS4B,bins=2)
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS4B,Term_Cons_NCS3A,Term_Cons_NCS3B,
                       Term_Comp_01C,Term_Comp_NCS4B,Term_Comp_NCS3B,type="text",
                       digits=2)
...
summary_residual_compare(Term_Comp_01C,Term_Comp_NCS3B,bins=2)
...
Term_Comp_NCS3F <- glm (data=smp,
                 b_Term ~CompOffr+cl_def3_ratio_lag1+cl_def3_obl_lag1+cl_US3_avg_sal_lag1, 
                 family=binomial(link="logit"))
...
Term_Comp_NCS3F3 <- glm (data=smp,
                 b_Term ~CompOffr+cl_def3_obl_lag1+cl_US3_avg_sal_lag1, #cl_def3_ratio_lag1
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS3B,Term_Cons_NCS2A,Term_Cons_NCS2B,
                       Term_Comp_01C,Term_Comp_NCS3B,Term_Comp_NCS2B,type="text",
                       digits=2)
...
summary_residual_compare(Term_Comp_01C,Term_Comp_NCS2B,bins=2)
...
Term_Comp_NCS2F3 <- glm (data=smp,
                 b_Term ~CompOffr+cl_def2_obl_lag1+cl_US2_avg_sal_lag1, #cl_def2_ratio_lag1
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS2F2)
...
Term_Comp_NCS2G <- glm (data=smp,
                 b_Term ~CompOffr+cl_def2_ratio_lag1+cl_US2_avg_sal_lag1+
...
Term_Comp_02A <- glm (data=smp,
                 b_Term ~CompOffr + cl_Ceil, family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_01F, Term_Cons_02A,Term_Comp_01C,Term_Comp_02A,type="text",
                       digits=2)


summary_residual_compare(Term_Cons_01F,Term_Cons_02A,Term_Comp_01C,Term_Comp_02A,bins=2)
...
Term_Comp_02C <- glm (data=smp,
                 b_Term ~CompOffr + 
                   cl_Ceil + 
                   CompOffr:cl_Ceil, family=binomial(link="logit"))
...
#Frequency Plot
freq_continuous_term_plot(smp,"l_Days","CompOffr")

#Plot the percent terminated across cost ceiling and competition
binned_percent_term_plot(smp,"l_Days","CompOffr")
...
Term_Comp_02H <- glm (data=smp,
                 b_Term ~CompOffr + 
                   cl_Ceil + cl_Days+ 
                   CompOffr:cl_Days, family=binomial(link="logit"))
...
Term_Comp_03C <- glm (data=smp,
                 b_Term ~CompOffr + 
                   ...
                   Veh +
                 Veh:cl_Days+
                   Veh:CompOffr, family=binomial(link="logit"))
...
Term_Comp_NCS6D <- glm (data=smp,
                 b_Term ~CompOffr+cl_def6_ratio_lag1+CompOffr:cl_def6_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS6B,Term_Cons_NCS6C,Term_Cons_NCS6D,
                       Term_Comp_01C,Term_Comp_NCS6C,Term_Comp_NCS6D,type="text",
                       digits=2)
...
Term_Comp_NCS5C <- glm (data=smp,
                 b_Term ~CompOffr+cl_def5_ratio_lag1+CompOffr:cl_def5_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS5A,Term_Cons_NCS5B,Term_Cons_NCS5C,
                       Term_Comp_01C,Term_Comp_NCS5B,Term_Comp_NCS5C,type="text",
                       digits=2)
...
Term_Comp_NCS4C <- glm (data=smp,
                 b_Term ~CompOffr+cl_def4_ratio_lag1+CompOffr:cl_def4_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS4A,Term_Cons_NCS4B,Term_Cons_NCS4C,
                       Term_Comp_01C,Term_Comp_NCS4B,Term_Comp_NCS4C,type="text",
                       digits=2)
...
Term_Comp_NCS3C <- glm (data=smp,
                 b_Term ~CompOffr+cl_def3_ratio_lag1+CompOffr:cl_def3_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS3A,Term_Cons_NCS3B,Term_Cons_NCS3C,
                       Term_Comp_01C,Term_Comp_NCS3B,Term_Comp_NCS3C,type="text",
                       digits=2)
...
Term_Comp_NCS2C <- glm (data=smp,
                 b_Term ~CompOffr+cl_def2_ratio_lag1+CompOffr:cl_def2_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS2A,Term_Cons_NCS2B,Term_Cons_NCS2C,
                       Term_Comp_01C,Term_Comp_NCS2B,Term_Comp_NCS2C,type="text",
                       digits=2)
