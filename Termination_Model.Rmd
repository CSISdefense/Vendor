...
###Model 13C: Agency/Office+NAICS6/NAICS3 trimmed
```{r Model13C}
load("Output//Term_Cons_13C.rdata")

Term_Cons_13C <- glmer (data=smp,
                 b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                  #cl_US3_avg_sal_lag1+
                   cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                  cl_US6_avg_sal_lag1+
...
glmer_examine(Term_Cons_13C,display=TRUE)

save(Term_Cons_13C,file="Output//Term_Cons_13C.rdata")
