...
binned_fitted_versus_Term_residuals(Term_Comp_01D)
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS6A,type="text",
                       digits=2)


summary_residual_compare(Term_Cons_NCS6A,Term_Cons_NCS6A,bins=20)
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS6A,Term_Cons_NCS6B,Term_Cons_NCS6E,type="text",
                       digits=2)
...
Term_Comp_NCS6C <- glm (data=smp,
                 b_Term ~n_Comp+cl_def6_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS6B,Term_Cons_NCS6C,
                       Term_Comp_01B,Term_Comp_NCS6C,type="text",
                       digits=2)


summary_residual_compare(Term_Cons_NCS6B,Term_Cons_NCS6C,bins=20)
summary_residual_compare(Term_Comp_01B,Term_Comp_NCS6C,bins=2)
...
Term_Comp_NCS6E <- glm (data=smp,
                 b_Term ~n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS6C,Term_Cons_NCS6E,
                       Term_Comp_NCS6C,Term_Comp_NCS6E,
                       type="text",digits=2)


summary_residual_compare(Term_Cons_NCS6C,Term_Cons_NCS6E,bins=20)
summary_residual_compare(Term_Comp_NCS6C,Term_Comp_NCS6E,bins=20)
...
glmer_examine(Term_Cons_NCS6H)


Term_Comp_NCS6H <- glm (data=smp,
                 b_Term ~n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS6H)
...
#Plot residuals versus fitted
 stargazer::stargazer(Term_Cons_NCS6C,Term_Cons_NCS6E,Term_Cons_NCS6F,Term_Cons_NCS6H,
                       Term_Comp_NCS6C,Term_Comp_NCS6E,Term_Comp_NCS6H,
                       type="text",digits=2)



summary_residual_compare(Term_Cons_NCS6F,Term_Cons_NCS6H,bins=20)
summary_residual_compare(Term_Comp_NCS6E,Term_Comp_NCS6H,bins=20)
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS6B,Term_Cons_NCS6E,Term_Cons_NCS6F,Term_Cons_NCS5A,type="text",
                       digits=2)
...
Term_Comp_NCS5B <- glm (data=smp,
                 b_Term ~n_Comp+cl_def5_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS6D,Term_Cons_NCS5A,Term_Cons_NCS5B,
                       Term_Comp_01B,Term_Comp_NCS6D,Term_Comp_NCS5B,type="text",
                       digits=2)
...
summary_residual_compare(Term_Comp_01B,Term_Comp_NCS5B,bins=2)
...
#Model
Term_Cons_NCS5D <- glm (data=smp,
                 b_Term ~cl_def5_HHI_lag1+cl_def5_ratio_lag1+cl_def5_obl_lag1, family=binomial(link="logit"))
glmer_examine(Term_Cons_NCS5D)


Term_Comp_NCS5D <- glm (data=smp,
                 b_Term ~n_Comp+cl_def5_ratio_lag1+cl_def5_obl_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS5D)
# 
# #Plot the fitted model plot
# Term_Comp_02A_curve<-function(x, Comp){invlogit(cbind(1,Comp,x) %*%  coef(Term_Comp_02A))}
# 
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS5A,Term_Cons_NCS5B,Term_Cons_NCS5D,
                       Term_Comp_01B,Term_Comp_NCS5B,Term_Comp_NCS5D,type="text",
                       digits=2)


summary_residual_compare(Term_Cons_NCS5B,Term_Cons_NCS5D,bins=10)
summary_residual_compare(Term_Comp_NCS5B,Term_Comp_NCS5D,bins=5)
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS6B,Term_Cons_NCS6E,Term_Cons_NCS6F,Term_Cons_NCS4A,type="text",
                       digits=2)
...
Term_Comp_NCS4B <- glm (data=smp,
                 b_Term ~n_Comp+cl_def4_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS5B,Term_Cons_NCS4A,Term_Cons_NCS4B,
                       Term_Comp_01B,Term_Comp_NCS5B,Term_Comp_NCS4B,type="text",
                       digits=2)
...
summary_residual_compare(Term_Comp_01B,Term_Comp_NCS4B,bins=2)
...
#Model
Term_Cons_NCS4D <- glm (data=smp,
                 b_Term ~cl_def4_HHI_lag1+cl_def4_ratio_lag1+cl_def4_obl_lag1, family=binomial(link="logit"))
glmer_examine(Term_Cons_NCS4D)


Term_Comp_NCS4D <- glm (data=smp,
                 b_Term ~n_Comp+cl_def4_ratio_lag1+ cl_def4_obl_lag1,
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS4D)
# 
# #Plot the fitted model plot
# Term_Comp_02A_curve<-function(x, Comp){invlogit(cbind(1,Comp,x) %*%  coef(Term_Comp_02A))}
# 
...
#Plot residuals versus fitted
stargazer::stargazer(Term_Cons_NCS4B,Term_Cons_NCS4D,Term_Cons_NCS6E,
                       Term_Comp_NCS4B,Term_Comp_NCS4D,Term_Comp_NCS6E,type="text",
                       digits=2)



  #Compare to prior at same level
summary_residual_compare(Term_Cons_NCS4B,Term_Cons_NCS4D,bins=20)
#Compare to prior at lower level
summary_residual_compare(Term_Cons_NCS6E,Term_Cons_NCS4D,bins=20)
summary_residual_compare(Term_Co_NCS4B,Term_Comp_NCS4D,bins=20)
```
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS6B,Term_Cons_NCS6E,Term_Cons_NCS6F,Term_Cons_NCS3A,type="text",
                       digits=2)
...
Term_Comp_NCS3B <- glm (data=smp,
                 b_Term ~n_Comp+cl_def3_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS4B,Term_Cons_NCS3A,Term_Cons_NCS3B,
                       Term_Comp_01B,Term_Comp_NCS4B,Term_Comp_NCS3B,type="text",
                       digits=2)
...
summary_residual_compare(Term_Comp_01B,Term_Comp_NCS3B,bins=2)
...
Term_Comp_NCS3D <- glm (data=smp,
                 b_Term ~n_Comp+cl_def3_ratio_lag1+ cl_def3_obl_lag1,
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
stargazer::stargazer(Term_Cons_NCS3B,Term_Cons_NCS3E,Term_Cons_NCS6F,
                       Term_Cons_NCS3B,Term_Cons_NCS3D,type="text",
                       digits=2)



  #Compare to prior at same level
summary_residual_compare(Term_Cons_NCS3A,Term_Cons_NCS3D,bins=20)
#Compare to prior at lower level
summary_residual_compare(Term_Cons_NCS6E,Term_Cons_NCS3D,bins=20)
```
...
Term_Comp_NCS3F <- glm (data=smp,
                 b_Term ~n_Comp+cl_def3_ratio_lag1+cl_def3_obl_lag1+cl_US3_avg_sal_lag1, 
                 family=binomial(link="logit"))
...
Term_Cons_NCS3F2 <- glm (data=smp,
                 b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1
                  cl_US3_avg_sal_lag1 , family=binomial(link="logit"))#+cl_def3_HHI_lag1:cl_def3_obl_lag1
glmer_examine(Term_Cons_NCS3F2)


Term_Comp_NCS3F2 <- glm (data=smp,
                 b_Term ~n_Comp+cl_def3_ratio_lag1+cl_US3_avg_sal_lag1, #cl_def3_obl_lag1+
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS3F2)


Term_Cons_NCS3F3 <- glm (data=smp,
                 b_Term ~cl_def3_HHI_lag1+cl_def3_obl_lag1+#cl_def3_ratio_lag1
                  cl_US3_avg_sal_lag1+cl_def3_HHI_lag1:cl_def3_obl_lag1 , family=binomial(link="logit"))
glmer_examine(Term_Cons_NCS3F3)
glmer_examine(Term_Cons_NCS3F3)

Term_Cons_NCS3F4 <- glm (data=smp,
                 b_Term ~cl_def3_HHI_lag1+cl_def3_obl_lag1+#cl_def3_ratio_lag1
                  cl_US3_avg_sal_lag1 , family=binomial(link="logit"))#+cl_def3_HHI_lag1:cl_def3_obl_lag1
glmer_examine(Term_Cons_NCS3F4)
glmer_examine(Term_Cons_NCS3F4)

Term_Comp_NCS3F3 <- glm (data=smp,
                 b_Term ~n_Comp+cl_def3_obl_lag1+cl_US3_avg_sal_lag1, #cl_def3_ratio_lag1
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS3F3)
...
#Plot residuals versus fitted
 stargazer::stargazer(Term_Cons_NCS3E,Term_Cons_NCS3F2,Term_Cons_NCS3F4,Term_Cons_NCS6G,
                       Term_Comp_NCS3D,Term_Comp_NCS3F2,Term_Comp_NCS3F3,Term_Comp_NCS6G,
                       type="text",digits=2)


summary_residual_compare(Term_Cons_NCS3F,Term_Cons_NCS3F2,bins=20)
summary_residual_compare(Term_Comp_NCS3D,Term_Comp_NCS3F2,bins=10)
summary_residual_compare(Term_Cons_NCS3F2,Term_Cons_NCS3F4,bins=20)
summary_residual_compare(Term_Comp_NCS3F2,Term_Comp_NCS3F3,bins=10)

summary_residual_compare(Term_Cons_NCS3F,Term_Cons_NCS3F4,bins=20)
summary_residual_compare(Term_Comp_NCS3D,Term_Comp_NCS3F3,bins=10)
...
Term_Cons_NCS3G3 <- glm (data=smp,
                 b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                  #cl_US3_avg_sal_lag1+
                   cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                  cl_US6_avg_sal_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1  , family=binomial(link="logit"))
glmer_examine(Term_Cons_NCS3G3)
vif(Term_Cons_NCS3G3)


Term_Comp_NCS3G <- glm (data=smp,
                 b_Term ~n_Comp+cl_def3_ratio_lag1+cl_def3_obl_lag1+cl_US3_avg_sal_lag1+
                   n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS3G)
vif(Term_Comp_NCS3G)
#Defense obl 3 have the highest VIF and no coefficient to speak of, dropping it
Term_Comp_NCS3G2 <- glm (data=smp,
                 b_Term ~n_Comp+cl_def3_ratio_lag1+cl_US3_avg_sal_lag1+#cl_def3_obl_lag1+
                   n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS3G2)
vif(Term_Comp_NCS3G2)
#Taking out average salary 3 to keep the models snced up.
Term_Comp_NCS3G3 <- glm (data=smp,
                 b_Term ~n_Comp+cl_def3_ratio_lag1+#cl_US3_avg_sal_lag1+#cl_def3_obl_lag1+
                   n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS3G3)
vif(Term_Comp_NCS3G3)
...
#Plot residuals versus fitted
 stargazer::stargazer(Term_Cons_NCS3E,Term_Cons_NCS3F2,Term_Cons_NCS3F4,Term_Cons_NCS6G,Term_Cons_NCS3G3,
                       Term_Comp_NCS3D,Term_Comp_NCS3F2,Term_Comp_NCS3F3,Term_Comp_NCS6G,Term_Comp_NCS3G3,
                       type="text",digits=2)


summary_residual_compare(Term_Cons_NCS3F4,Term_Cons_NCS3G3,bins=20)
summary_residual_compare(Term_Comp_NCS3F3,Term_Comp_NCS3G3,bins=10)
summary_residual_compare(Term_Cons_NCS3F2,Term_Cons_NCS3G3,bins=20)
summary_residual_compare(Term_Comp_NCS3F2,Term_Comp_NCS3G3,bins=10)

summary_residual_compare(Term_Cons_NCS3F,Term_Cons_NCS3G3,bins=20)
summary_residual_compare(Term_Comp_NCS3D,Term_Comp_NCS3G3,bins=10)
summary_residual_compare(Term_Cons_NCS6G,Term_Cons_NCS3G3,bins=20)
summary_residual_compare(Term_Comp_NCS6G,Term_Comp_NCS3G3,bins=10)
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS6B,Term_Cons_NCS6E,Term_Cons_NCS6F,Term_Cons_NCS2A,type="text",
                       digits=2)
...
Term_Comp_NCS2B <- glm (data=smp,
                 b_Term ~n_Comp+cl_def2_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS3B,Term_Cons_NCS2A,Term_Cons_NCS2B,
                       Term_Comp_01B,Term_Comp_NCS3B,Term_Comp_NCS2B,type="text",
                       digits=2)
...
summary_residual_compare(Term_Comp_01B,Term_Comp_NCS2B,bins=2)
...
Term_Comp_NCS2D <- glm (data=smp,
                 b_Term ~n_Comp+cl_def2_ratio_lag1+cl_def2_obl_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
stargazer::stargazer(Term_Cons_NCS6B,Term_Cons_NCS6E,Term_Cons_NCS6F,
                       Term_Cons_NCS2A,Term_Cons_NCS2D,type="text",
                       digits=2)



  #Compare to prior at same level
summary_residual_compare(Term_Cons_NCS2A,Term_Cons_NCS2D,bins=10)
#Compare to prior at lower level
summary_residual_compare(Term_Cons_NCS6E,Term_Cons_NCS2D,bins=10)
summary_residual_compare(Term_Cons_NCS3G,Term_Cons_NCS2D,bins=10)
```
...
glmer_examine(Term_Cons_NCS2F)


Term_Comp_NCS2F <- glm (data=smp,
                 b_Term ~n_Comp+cl_def2_ratio_lag1+cl_def2_obl_lag1+cl_US2_avg_sal_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS2F)
...
Term_Cons_NCS2F2 <- glm (data=smp,
                 b_Term ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+#cl_def2_obl_lag1
                  cl_US2_avg_sal_lag1 , family=binomial(link="logit"))#+cl_def2_HHI_lag1:cl_def2_obl_lag1
glmer_examine(Term_Cons_NCS2F2)


Term_Comp_NCS2F2 <- glm (data=smp,
                 b_Term ~n_Comp+cl_def2_ratio_lag1+cl_US2_avg_sal_lag1, #cl_def2_obl_lag1+
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS2F2)


glmer_examine(Term_Cons_NCS2F2)
glmer_examine(Term_Cons_NCS2F2)

Term_Cons_NCS2F3 <- glm (data=smp,
                 b_Term ~cl_def2_HHI_lag1+cl_def2_obl_lag1+#cl_def2_ratio_lag1
                  cl_US2_avg_sal_lag1 , family=binomial(link="logit"))#+cl_def2_HHI_lag1:cl_def2_obl_lag1


Term_Comp_NCS2F3 <- glm (data=smp,
                 b_Term ~n_Comp+cl_def2_obl_lag1+cl_US2_avg_sal_lag1, #cl_def2_ratio_lag1
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS2F2)

glmer_examine(Term_Cons_NCS2F3)
glmer_examine(Term_Cons_NCS2F3)
# 
# #Plot the fitted model plot
# Term_Comp_02A_curve<-function(x, Comp){invlogit(cbind(1,Comp,x) %*%  coef(Term_Comp_02A))}
...
#Plot residuals versus fitted
 stargazer::stargazer(Term_Cons_NCS2D,Term_Cons_NCS2F2,Term_Cons_NCS2F3,#Term_Cons_NCS6G,
                       Term_Comp_NCS2D,Term_Comp_NCS2F2,Term_Comp_NCS2F3,#Term_Comp_NCS6G,
                       type="text",digits=2)


summary_residual_compare(Term_Cons_NCS2D,Term_Cons_NCS2F2,bins=10)
summary_residual_compare(Term_Comp_NCS2D,Term_Comp_NCS2F2,bins=5)
summary_residual_compare(Term_Cons_NCS2F2,Term_Cons_NCS2F3,bins=10)
summary_residual_compare(Term_Comp_NCS2F2,Term_Comp_NCS2F3,bins=5)

summary_residual_compare(Term_Cons_NCS2F,Term_Cons_NCS2F3,bins=20)
summary_residual_compare(Term_Comp_NCS2D,Term_Comp_NCS2F3,bins=10)
...
#Model
Term_Cons_NCS2G <- glm (data=smp,
                 b_Term ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+
                  cl_US2_avg_sal_lag1+
                   cl_def6_HHI_lag1+cl_def6_ratio_lag1+cl_def6_obl_lag1+
                  cl_US6_avg_sal_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1  , family=binomial(link="logit"))
glmer_examine(Term_Cons_NCS2G)
...
Term_Cons_NCS2G3 <- glm (data=smp,
                 b_Term ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+
                  #cl_US2_avg_sal_lag1+
                   cl_def6_HHI_lag1+cl_def6_ratio_lag1+cl_def6_obl_lag1+
                  cl_US6_avg_sal_lag1,#+cl_def6_HHI_lag1:cl_def6_obl_lag1  ,
                 family=binomial(link="logit"))
glmer_examine(Term_Cons_NCS2G3)




 stargazer::stargazer(Term_Cons_NCS2D,Term_Cons_NCS2F2,Term_Cons_NCS2G3,#Term_Cons_NCS6G,
                       Term_Comp_NCS2D,Term_Comp_NCS2F2,Term_Comp_NCS2G3,#Term_Comp_NCS6G,
                       type="text",digits=2)



Term_Comp_NCS2G <- glm (data=smp,
                 b_Term ~n_Comp+cl_def2_ratio_lag1+cl_US2_avg_sal_lag1+
                   cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS2G)
...
Term_Comp_NCS2G2 <- glm (data=smp,
                 b_Term ~n_Comp+cl_def2_ratio_lag1+#cl_US2_avg_sal_lag1+
                   cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS2G2)
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_01F, Term_Cons_02A,Term_Comp_01B,Term_Comp_02A,type="text",
                       digits=2)


summary_residual_compare(Term_Cons_01F,Term_Cons_02A,Term_Comp_01B,Term_Comp_02A,bins=2)
...
Term_Comp_02C_curve<-function(x, Comp){invlogit(cbind(1,Comp,x,Comp*x) %*%  coef(Term_Comp_02C))}
...
#Plot the fitted values vs actual results
  stargazer::stargazer(Term_Cons_02A,Term_Cons_02C,Term_Comp_02A,Term_Comp_02C,type="text",
                       digits=2)


summary_residual_compare(Term_Cons_02A,Term_Cons_02C,Term_Comp_02A,Term_Comp_02C,bins=20)
...
Term_Comp_02D_curve<-function(x, Comp,Ceil){invlogit(cbind(1,Comp,Ceil,x,Comp*Ceil) %*%  coef(Term_Comp_02D))}
...
#Plot the fitted values vs actual results
binned_fitted_versus_Term_residuals(Term_Comp_02D)
...
# residuals_Term_plot(Term_Comp_02D,"cl_Days")+
  ...
  stargazer::stargazer(Term_Cons_02D,Term_Comp_02D,type="text",
                       digits=2)

summary_residual_compare(Term_Cons_02C,Term_Cons_02D,Term_Comp_02A,Term_Comp_02D,bins=20)
...
# 
# #Plot the fitted values vs actual results
# binned_fitted_versus_Term_residuals(Term_Comp_02H)
# 
# #Plot residuals versus fitted
# residuals_Term_plot(Term_Comp_02H)+
#   labs(x="Estimated  Pr (Ceiling Breach)")

# residuals_Term_plot(Term_Comp_02F,"cl_days")+
#   labs(x="Centered Log(Days)")

stargazer::stargazer(Term_Cons_02D,Term_Cons_02H,Term_Comp_02D,Term_Comp_02H,type="text",
                       digits=2)


summary_residual_compare(Term_Cons_02D,Term_Cons_02H,Term_Comp_02D,Term_Comp_02H,bins=20)
...
#Plot the fitted values vs actual results
stargazer::stargazer(Term_Cons_02H,Term_Cons_03A,Term_Comp_02D,Term_Comp_03A,type="text",
                       digits=2)


summary_residual_compare(Term_Cons_02H,Term_Cons_03A,Term_Comp_02D,Term_Comp_03A,bins=20)
...
#                                        SIDV=0,MIDV=0),color="blue")
  ...
  Term_Cons_03B2 <- glm (data=smp,
                 ...
                 Veh:cl_Days
                 , family=binomial(link="logit"))
glmer_examine(Term_Cons_03B2)

  stargazer::stargazer(Term_Cons_03A,Term_Cons_03B2,Term_Comp_03A,Term_Comp_03B,type="text",
                         digits=2)
...
#                                        SIDV=0,MIDV=0),color="blue")
  ...
  stargazer::stargazer(Term_Cons_03B2,Term_Cons_03C,Term_Comp_03B,Term_Comp_03C,type="text",
                       digits=2)


summary_residual_compare(Term_Cons_03B2,Term_Cons_03C,Term_Comp_03B,Term_Comp_03C,bins=20)
...
Term_Cons_03D2 <- glm (data=smp,
                 ...
                 Veh:cl_Days+
                   Veh:cl_Ceil, family=binomial(link="logit"))
glmer_examine(Term_Cons_03D2)


stargazer::stargazer(Term_Cons_03B2,Term_Cons_03D2,
                     Term_Comp_03B,Term_Comp_03D,type="text",
                       digits=2)
summary_residual_compare(Term_Cons_03B2,Term_Cons_03D2,Term_Comp_03B,Term_Comp_03D,bins=20)
summary_residual_compare(Term_Cons_03A,Term_Cons_03D2,bins=20)
...
stargazer::stargazer(Term_Cons_03D2,Term_Cons_04A,
                     Term_Comp_03D,Term_Comp_04A,type="text",
                       digits=2)
summary_residual_compare(Term_Cons_03D2,Term_Cons_04A,Term_Comp_03D,Term_Comp_04A,bins=20)
...
Term_Comp_04E <- glm (data=smp,
                 ...
                 Veh:cl_Days+
                   ...
                   cl_Days:PricingFee , 
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_04E)
glmer_examine(Term_Comp_04E)


Term_Comp_04E2 <- glm (data=smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   Veh +
                   #cl_def6_HHI_lag1:cl_Ceil  + 
                 # Veh:cl_Days+
                   ...
                   cl_Days:PricingFee , 
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_04E2)

# Plot the model and Vehicle 
# Term_Comp_04E_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV){invlogit(
#   cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
#         Comp*Ceil,Days*Ceil,Days*Comp,
#         x,
#         Days*x,Days*MIDV,Days*OIDV,
#         Comp*x,Comp*MIDV,Comp*OIDV,
#         Days*x) %*%  coef(Term_Comp_04E))}
...
# 
# #Plot the fitted values vs actual results
# binned_fitted_versus_Term_residuals(Term_Comp_04E)
# 
# #Plot residuals versus fittedO
...
stargazer::stargazer(Term_Cons_04C,Term_Cons_04E2,
                     Term_Comp_04C,Term_Comp_04E2,type="text",
                       digits=2)
summary_residual_compare(Term_Cons_04C,Term_Cons_04E2,Term_Comp_04C,Term_Comp_04E2,bins=20)
...
Term_Comp_04G <- glm (data=smp,
                 ...
                 Veh:cl_Days+
                   ...
                   cl_Ceil:PricingFee , 
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_04G)
glmer_examine(Term_Comp_04G)

# Plot the model and Vehicle 
# Term_Comp_04G_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV){invlogit(
#   cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
#         Comp*Ceil,Days*Ceil,Days*Comp,
#         x,
#         Days*x,Days*MIDV,Days*OIDV,
#         Comp*x,Comp*MIDV,Comp*OIDV,
#         Days*x) %*%  coef(Term_Comp_04G))}
...
stargazer::stargazer(Term_Cons_04C,Term_Cons_04G,
                     Term_Comp_04C,Term_Comp_04G,type="text",
                       digits=2)
summary_residual_compare(Term_Cons_04C,Term_Cons_04G,Term_Comp_04C,Term_Comp_04G,bins=20)
...
# 
# #Plot the fitted values vs actual results
# binned_fitted_versus_Term_residuals(Term_Comp_04H)
# 
# #Plot residuals versus fittedO
...
#         Fixed,x,
#         Days*x,Days*MIDV,Days*OIDV,
#         Comp*x,Comp*MIDV,Comp*OIDV) %*%  coef(Term_Comp_04I))}
# 
# #Days curves
# fitted_Term_model(smp,"SIDV") +
...
stargazer::stargazer(Term_Cons_04H,Term_Cons_04I,
                     Term_Comp_04H,Term_Comp_04I,type="text",
                       digits=2)
summary_residual_compare(Term_Cons_04H,Term_Cons_04I,Term_Comp_04H,Term_Comp_04I,bins=20)
...
b_Term ~cl_def6_HHI_lag1 + 
  ...
  # b_UCA:cl_Ceil+
                b_UCA:cl_def6_HHI_lag1 + 
                  b_UCA:l_Days
                    , family=binomial(link="logit"))
glmer_examine(Term_Cons_04J)

Term_Comp_04J <- glm (data=smp,
b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   Veh  +
  PricingFee+ b_UCA +
...
b_Term ~cl_def6_HHI_lag1 + 
  ...
  # b_UCA:cl_Ceil+
                b_UCA:cl_def6_HHI_lag1 + 
                  b_UCA:l_Days
                    , family=binomial(link="logit"))
glmer_examine(Term_Cons_04J2)

Term_Comp_04J2 <- glm (data=smp,
b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   Veh  +
  PricingFee+ b_UCA +
  ...
  # b_UCA:cl_Ceil+
                ...
                b_UCA:n_Comp + 
                  b_UCA:l_Days
                    , family=binomial(link="logit"))
glmer_examine(Term_Comp_04J2)



stargazer::stargazer(Term_Cons_04I,Term_Cons_04J2,
                     Term_Comp_04I,Term_Comp_04J2,type="text",
                       digits=2)
summary_residual_compare(Term_Cons_04I,Term_Cons_04J2,Term_Comp_04I,Term_Comp_04J2,bins=20)
...
stargazer::stargazer(Term_Cons_04K,Term_Cons_05A,
                     Term_Comp_04K,Term_Comp_05A,type="text",
                       digits=2)
summary_residual_compare(Term_Cons_04K,Term_Cons_05A,Term_Comp_04K,Term_Comp_05A,bins=20)
...
# Plot the model and Vehicle 
# Term_Comp_05B_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed,UCA){invlogit(
#   cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
#         Comp*Ceil,Days*Ceil,Days*Comp,
#         Fixed,UCA,x,
#         Days*x,Days*MIDV,Days*OIDV,
#         Comp*x,Comp*MIDV,Comp*OIDV,
#         UCA*Comp) %*%  coef(Term_Comp_05B))}
# 
# #Days curves
# fitted_Term_model(smp,"SIDV") +
#   stat_function(fun = Term_Comp_05B_curve,
#                              args=list(Comp=0,Ceil=0,Days=0,
#                                        MIDV=0,SIDV=0,FSSGWAC=0,BPABOA=0,
#                                        Fixed=1,UCA=0),color="blue")+
#   stat_function(fun = Term_Comp_05B_curve,
...
Term_Cons_06A2 <- glm (data=smp,
                      b_Term ~cl_def6_HHI_lag1 + 
                        ...
                        b_Intl:Veh
                      , family=binomial(link="logit"))
glmer_examine(Term_Cons_06A2)


Term_Cons_06A3 <- glm (data=smp,
                      b_Term ~cl_def6_HHI_lag1 + 
                        cl_Ceil + cl_Days+ 
                        Veh +
                        PricingFee + b_UCA +
...
Term_Comp_06A2 <- glm (data=smp,
                      b_Term ~n_Comp + 
                        ...
                        b_Intl:Veh 
                      , family=binomial(link="logit"))
glmer_examine(Term_Comp_06A2)


Term_Comp_06A3 <- glm (data=smp,
                      b_Term ~n_Comp + 
                        cl_Ceil + cl_Days+ 
                        Veh  +
                        PricingFee+ b_UCA +
                        ...
                        b_Intl:Veh 
                      , family=binomial(link="logit"))
glmer_examine(Term_Comp_06A3)





  stargazer::stargazer(Term_Cons_05C,Term_Cons_06A3,Term_Comp_05C,Term_Comp_06A3,type="text",
                       digits=2)
  
summary_residual_compare(Term_Cons_05C,Term_Cons_06A3,Term_Comp_05C,Term_Comp_06A3,bins=20)
...
glmer_examine(Term_Comp_06B)
  ...
  stargazer::stargazer(Term_Cons_06A3,Term_Cons_06B,Term_Comp_06A3,Term_Comp_06B,type="text",
                       digits=2)
  
summary_residual_compare(Term_Cons_06A3,Term_Cons_06B,Term_Comp_06A3,Term_Comp_06B,bins=20)

rm(Term_Cons_06B,Term_Comp_06B)
...
glmer_examine(Term_Comp_06C)
  ...
  stargazer::stargazer(Term_Cons_06A3,Term_Cons_06C,Term_Comp_06A3,Term_Comp_06C,type="text",
                       digits=2)
  
summary_residual_compare(Term_Cons_06A3,Term_Cons_06C,Term_Comp_06A3,Term_Comp_06C,bins=20)
...
glmer_examine(Term_Comp_06D)
  ...
  stargazer::stargazer(Term_Cons_06C,Term_Cons_06D,Term_Comp_06C,Term_Comp_06D,type="text",
                       digits=2)
...
glmer_examine(Term_Comp_07A)
  ...
  stargazer::stargazer(Term_Cons_06D,Term_Cons_07A,Term_Comp_06D,Term_Comp_07A,type="text",
                       digits=2)
...
glmer_examine(Term_Comp_07B)
  ...
  stargazer::stargazer(Term_Cons_07A,Term_Cons_07B,Term_Comp_07A,Term_Comp_07B,type="text",
                       digits=2)
  
summary_residual_compare(Term_Cons_07A,Term_Cons_07B,Term_Comp_07A,Term_Comp_07B,bins=20)
...
stargazer::stargazer(Term_Cons_07A,Term_Cons_07B,Term_Cons_07C,Term_Cons_07C,Term_Comp_07A,Term_Comp_07B,Term_Comp_07C,Term_Comp_07C,type="text",
                       digits=2)

summary_residual_compare(Term_Cons_07A,Term_Cons_07C,Term_Comp_07A,Term_Comp_07C,bins=20)
...
glmer_examine(Term_Comp_10A)
  ...
  stargazer::stargazer(Term_Cons_07C,Term_Cons_10A,Term_Comp_07C,Term_Comp_10A,type="text",
                       digits=2)
  
summary_residual_compare(Term_Cons_07C,Term_Cons_10A,Term_Comp_07C,Term_Comp_10A,bins=20)
...
glmer_examine(Term_Comp_10B)
  ...
  stargazer::stargazer(Term_Comp_10A,Term_Comp_10B,Term_Cons_10A,Term_Cons_10B,type="text",
                       digits=2)
  
  

summary_residual_compare(Term_Comp_10A,Term_Comp_10B,Term_Cons_10A,Term_Cons_10B,bins=20)
...
glmer_examine(Term_Comp_10E)
  ...
  stargazer::stargazer(Term_Cons_10D,Term_Cons_10E,Term_Comp_10B,Term_Comp_10E,type="text",
                       digits=2)
  
  

summary_residual_compare(Term_Cons_10D,Term_Cons_10E,Term_Comp_10B,Term_Comp_10E,bins=20)
...
summary_residual_compare(Term_Cons_10D,Term_Cons_10G,Term_Comp_10B,Term_Comp_10G,bins=20)
...
glmer_examine(Term_Cons_10H)
  ...
  stargazer::stargazer(Term_Cons_10F,Term_Cons_10H,type="text",
                       digits=2)
  
  

summary_residual_compare(Term_Cons_10D,Term_Cons_10H,bins=20)


```
Results are not significant and are contrary to expectations, though the deviance reduction is fairly large. Leaving it in for now.
...
glmer_examine(Term_Cons_10I)
  ...
  stargazer::stargazer(Term_Cons_10F,Term_Cons_10H,Term_Cons_10I,type="text",
                       digits=2)
...
```
Having both in does not encoutner VIF problems, but adds little to the model. Only ratio is significant, so leaving out def_obl interaction. The next step is to check for the removal of ratio for def3.



### Model 10J: Def Sec Obl:HHI
Because HHI in smaller sectors tends to be larger, high readings from large sectors may deserve more weight. This interaction is expected to amplify HHI magnitudes.
```{r Model10J}
...
glmer_examine(Term_Comp_10J)
  ...
  stargazer::stargazer(Term_Cons_10H,Term_Cons_10J,
                       Term_Comp_10F,Term_Comp_10J,type="text",
                       digits=2)
  
  

summary_residual_compare(Term_Cons_10H,Term_Cons_10J,Term_Comp_10F,Term_Comp_10J,bins=20)
...
Term_Cons_NCS6D <- glm (data=smp,
                 b_Term ~cl_def6_HHI_lag1+cl_def6_ratio_lag1+cl_def6_HHI_lag1:cl_def6_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Cons_NCS6D)

Term_Comp_NCS6D <- glm (data=smp,
                 b_Term ~n_Comp+cl_def6_ratio_lag1+n_Comp:cl_def6_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS6B,Term_Cons_NCS6C,Term_Cons_NCS6D,
                       Term_Comp_01B,Term_Comp_NCS6C,Term_Comp_NCS6D,type="text",
                       digits=2)


summary_residual_compare(Term_Cons_NCS6C,Term_Cons_NCS6D,bins=20)
summary_residual_compare(Term_Comp_NCS6C,Term_Comp_NCS6D,bins=2)
...
#Model
Term_Cons_NCS6F <- glm (data=smp,
                 b_Term ~cl_def6_HHI_lag1+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1, family=binomial(link="logit"))
glmer_examine(Term_Cons_NCS6F)
...
#Plot residuals versus fitted
  ...
  stargazer::stargazer(Term_Cons_NCS6C,Term_Cons_NCS6E,Term_Cons_NCS6F,
                       Term_Comp_NCS6C,Term_Comp_NCS6E,
                       type="text",digits=2)


summary_residual_compare(Term_Cons_NCS6E,Term_Cons_NCS6F,bins=20)
...
#Model
Term_Cons_NCS6G <- glm (data=smp,
                 b_Term ~cl_def6_HHI_lag1+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1+cl_def6_HHI_lag1:cl_def6_ratio_lag1, family=binomial(link="logit"))
glmer_examine(Term_Cons_NCS6G,display=TRUE)
...
#Plot residuals versus fitted
  ...
  stargazer::stargazer(Term_Cons_NCS6C,Term_Cons_NCS6F,Term_Cons_NCS6G,
                       Term_Comp_NCS6C,Term_Comp_NCS6E,
                       type="text",digits=2)


summary_residual_compare(Term_Cons_NCS6F,Term_Cons_NCS6G,bins=20)
...
Term_Cons_NCS5C <- glm (data=smp,
                 b_Term ~cl_def5_HHI_lag1+cl_def5_ratio_lag1+cl_def5_HHI_lag1:cl_def5_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Cons_NCS5C)

Term_Comp_NCS5C <- glm (data=smp,
                 b_Term ~n_Comp+cl_def5_ratio_lag1+n_Comp:cl_def5_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS5C)
# 
# #Plot the fitted model plot
# Term_Comp_05A_curve<-function(x, Comp){invlogit(cbind(1,Comp,x) %*%  coef(Term_Comp_05A))}
# 
# #Competition curves
# fitted_Term_model(smp,"cl_Ceil") + stat_function(fun = Term_Comp_05A_curve, 
#                              args=list(Comp=0),color="blue")+
#   stat_function(fun = Term_Comp_05A_curve, 
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS5A,Term_Cons_NCS5B,Term_Cons_NCS5C,
                       Term_Comp_01B,Term_Comp_NCS5B,Term_Comp_NCS5C,type="text",
                       digits=2)
...
#Model
Term_Cons_NCS5E <- glm (data=smp,
                 b_Term ~cl_def5_HHI_lag1+cl_def5_ratio_lag1+cl_def5_obl_lag1+
                   cl_def5_HHI_lag1:cl_def5_obl_lag1, family=binomial(link="logit"))
glmer_examine(Term_Cons_NCS5E)
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS5D,Term_Cons_NCS5E,Term_Cons_NCS6F,
                       Term_Comp_NCS5D,Term_Comp_NCS6E,type="text",
                       digits=2)

  #Compare to prior at same level
summary_residual_compare(Term_Cons_NCS5D,Term_Cons_NCS5E,bins=20)
summary_residual_compare(Term_Cons_NCS6F,Term_Cons_NCS5E,bins=20)
...
Term_Cons_NCS4C <- glm (data=smp,
                 b_Term ~cl_def4_HHI_lag1+cl_def4_ratio_lag1+cl_def4_HHI_lag1:cl_def4_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Cons_NCS4C)

Term_Comp_NCS4C <- glm (data=smp,
                 b_Term ~n_Comp+cl_def4_ratio_lag1+n_Comp:cl_def4_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS4C)
# 
# #Plot the fitted model plot
# Term_Comp_04A_curve<-function(x, Comp){invlogit(cbind(1,Comp,x) %*%  coef(Term_Comp_04A))}
# 
# #Competition curves
# fitted_Term_model(smp,"cl_Ceil") + stat_function(fun = Term_Comp_04A_curve, 
#                              args=list(Comp=0),color="blue")+
#   stat_function(fun = Term_Comp_04A_curve, 
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS4A,Term_Cons_NCS4B,Term_Cons_NCS4C,
                       Term_Comp_01B,Term_Comp_NCS4B,Term_Comp_NCS4C,type="text",
                       digits=2)


summary_residual_compare(Term_Cons_NCS2B,Term_Cons_NCS2C,bins=10)
summary_residual_compare(Term_Comp_NCS2B,Term_Comp_NCS2C,bins=5)
...
Term_Cons_NCS4E <- glm (data=smp,
                 b_Term ~cl_def4_HHI_lag1+cl_def4_ratio_lag1+cl_def4_obl_lag1+
                   cl_def4_HHI_lag1:cl_def4_obl_lag1, family=binomial(link="logit"))
glmer_examine(Term_Cons_NCS4E)
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS4D,Term_Cons_NCS4E,Term_Cons_NCS6F,
                       Term_Comp_NCS4D,Term_Comp_NCS6E,type="text",
                       digits=2)

  #Compare to prior at same level
summary_residual_compare(Term_Cons_NCS4D,Term_Cons_NCS4E,bins=20)
summary_residual_compare(Term_Cons_NCS6F,Term_Cons_NCS4E,bins=20)
...
Term_Cons_NCS3C <- glm (data=smp,
                 b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+cl_def3_HHI_lag1:cl_def3_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Cons_NCS3C)

Term_Comp_NCS3C <- glm (data=smp,
                 b_Term ~n_Comp+cl_def3_ratio_lag1+n_Comp:cl_def3_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Comp_NCS3C)
# 
# #Plot the fitted model plot
# Term_Comp_03A_curve<-function(x, Comp){invlogit(cbind(1,Comp,x) %*%  coef(Term_Comp_03A))}
# 
# #Competition curves
# fitted_Term_model(smp,"cl_Ceil") + stat_function(fun = Term_Comp_03A_curve, 
#                              args=list(Comp=0),color="blue")+
#   stat_function(fun = Term_Comp_03A_curve, 
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS3A,Term_Cons_NCS3B,Term_Cons_NCS3C,
                       Term_Comp_01B,Term_Comp_NCS3B,Term_Comp_NCS3C,type="text",
                       digits=2)
...
Term_Cons_NCS3E <- glm (data=smp,
                 b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+cl_def3_obl_lag1+cl_def3_HHI_lag1:cl_def3_obl_lag1, family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS3D,Term_Cons_NCS3E,Term_Cons_NCS6F,
                       Term_Comp_NCS3D,Term_Comp_NCS6E,type="text",
                       digits=2)

  #Compare to prior at same level
summary_residual_compare(Term_Cons_NCS3D,Term_Cons_NCS3E,bins=20)
summary_residual_compare(Term_Cons_NCS6F,Term_Cons_NCS3E,bins=20)
...
Term_Cons_NCS2C <- glm (data=smp,
                 b_Term ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+cl_def2_HHI_lag1:cl_def2_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Term_Cons_NCS2C)

Term_Comp_NCS2C <- glm (data=smp,
                 b_Term ~n_Comp+cl_def2_ratio_lag1+n_Comp:cl_def2_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Term_Cons_NCS2A,Term_Cons_NCS2B,Term_Cons_NCS2C,
                       Term_Comp_01B,Term_Comp_NCS2B,Term_Comp_NCS2C,type="text",
                       digits=2)
...
Term_Cons_NCS2E <- glm (data=smp,
                 b_Term ~cl_def2_HHI_lag1+cl_def2_obl_lag1+cl_def2_HHI_lag1:cl_def2_obl_lag1, family=binomial(link="logit"))
...
#Plot residuals versus fitted
stargazer::stargazer(Term_Cons_NCS6B,Term_Cons_NCS6D,Term_Cons_NCS6E,
                       Term_Comp_NCS2B,Term_Comp_NCS2D,Term_Comp_NCS6E,type="text",
                       digits=2)



  #Compare to prior at same level
summary_residual_compare(Term_Cons_NCS2B,Term_Cons_NCS2D,bins=20)
#Compare to prior at lower level
summary_residual_compare(Term_Cons_NCS6E,Term_Cons_NCS2D,bins=20)
summary_residual_compare(Term_Co_NCS2B,Term_Comp_NCS2D,bins=20)
...
Term_Cons_11A<-Term_Cons_14A
Term_Comp_11A<-Term_Comp_14A
Term_Comp_11A.restart<-Term_Comp_14A.restart
Term_Comp_11A.devfun<-Term_Comp_14A.devfun
...
glmer_examine(Term_Comp_13B)
  ...
  stargazer::stargazer(Term_Cons_14A,Term_Cons_13B,Term_Comp_14A.restart,Term_Comp_13B,type="text",
                       digits=2)
  
  

summary_residual_compare(Term_Cons_14A,Term_Cons_13B,Term_Comp_14A.restart,Term_Comp_13B,bins=20)
...
stargazer::stargazer(Term_Cons_14A,Term_Cons_13B,Term_Cons_13B.restart,Term_Comp_14A.restart,Term_Comp_13B,type="text",
                       digits=2)
...
load("Output//Term_Comp_13B.rdata")
  ...
  summary_residual_compare(Term_Cons_13B,Term_Cons_13B.restart,Term_Comp_14A.restart,Term_Comp_13B,bins=20)
...
load("Output//Term_Cons_13D.rdata")
...
glmer_examine(Term_Cons_13D,display=TRUE)
...
glmer_examine(Term_Comp_13D)
  ...
  stargazer::stargazer(Term_Cons_13B, Term_Cons_13D,Term_Comp_13B,type="text",
                       digits=2)
  
  

summary_residual_compare(Term_Cons_13B,Term_Cons_13D,#Term_Comp_14A.restart,Term_Comp_13D,
                         bins=20)

Term_Cons_13B@devcomp$cmp[[8]]
Term_Cons_13B@devcomp$cmp

any(diag.vals<1e-6)

if(!exists("Term_Cons_13D.devfun"))
  Term_Cons_13D.devfun <- update(Term_Cons_13D, devFunOnly=TRUE)

if (isLMM(Term_Cons_13D)) {
  pars <- getME(Term_Cons_13D,"theta")
} else {
  ## GLMM: requires both random and fixed parameters
  pars <- getME(Term_Cons_13D, c("theta","fixef"))
}
if (require("numDeriv")) {
  cat("hess:\n"); print(hess <- hessian(Term_Cons_13D.devfun, unlist(pars)))
  cat("grad:\n"); print(grad <- grad(Term_Cons_13D.devfun, unlist(pars)))
  cat("scaled gradient:\n")
  print(scgrad <- solve(chol(hess), grad))
}
## compare with internal calculations:
Term_Cons_13D@optinfo$derivs

if(!exists("Term_Cons_13D.restart"))
  Term_Cons_13D.restart <- update(Term_Cons_13D, start=pars)
glmer_examine(Term_Cons_13D.restart)




#CBre Comp
if(!exists("Term_Comp_13D.devfun"))
  Term_Comp_13D.devfun <- update(Term_Comp_13D, devFunOnly=TRUE)

if (isLMM(Term_Comp_13D)) {
  pars <- getME(Term_Comp_13D,"theta")
} else {
  ## GLMM: requires both random and fixed parameters
  pars <- getME(Term_Comp_13D, c("theta","fixef"))
}
if (require("numDeriv")) {
  cat("hess:\n"); print(hess <- hessian(Term_Comp_13D.devfun, unlist(pars)))
  cat("grad:\n"); print(grad <- grad(Term_Comp_13D.devfun, unlist(pars)))
  cat("scaled gradient:\n")
  print(scgrad <- solve(chol(hess), grad))
}
## compare with internal calculations:
Term_Comp_13D@optinfo$derivs

if(!exists("Term_Comp_13D.restart"))
  Term_Comp_13D.restart <- update(Term_Comp_13D, start=pars)
glmer_examine(Term_Comp_13D.restart)


  save(Term_Cons_13D,Term_Comp_13D,Term_Cons_13D.restart,Term_Comp_13D.restart,
       file="Output//Term_Cons_13D.rdata")
  
stargazer::stargazer(Term_Cons_13B,Term_Cons_13D,Term_Cons_13D.restart,
                    Term_Comp_13B,Term_Comp_13D,Term_Comp_13D.restart,
                    type="text",
                       digits=2)
  ...
  save(Term_Cons_13D,Term_Comp_13D.devfun,Term_Cons_13D.restart,
       Term_Comp_13D,Term_Comp_13D.devfun,Term_Comp_13D.restart,
       file="Output//Term_Cons_13D.rdata")
load("Output//Term_Comp_13D.rdata")

  summary_residual_compare(Term_Cons_13D,Term_Cons_13D.restart,Term_Comp_13D,Term_Comp_13D.restart,bins=20)
  summary_residual_compare(Term_Cons_13B,Term_Cons_13D.restart,Term_Comp_13B,Term_Comp_13D.restart,bins=20)
...
Term_Comp_13E <- glmer (data=smp,
                   ...
                   n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1+
                      ...
                      , family=binomial(link="logit"),
                        verbose=1)
glmer_examine(Term_Comp_13E,display=TRUE)

save(Term_Cons_13E,Term_Comp_13E,file="Output//Term_13E.rdata")
  stargazer::stargazer(Term_Cons_13B, Term_Cons_13D,Term_Cons_13E,Term_Comp_13B,type="text",
                       digits=2)
  
  

summary_residual_compare(Term_Cons_13B,Term_Cons_13E,#Term_Comp_14A.restart,Term_Comp_13E,
                         bins=20)
...
if(!exists("Term_Cons_13E.devfun"))
  Term_Cons_13E.devfun <- update(Term_Cons_13E, devFunOnly=TRUE)
...
summary_residual_compare(Term_Cons_05C,Term_Cons_06A,Term_Comp_04I,Term_Comp_06A,bins=20)
