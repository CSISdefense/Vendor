...
##Sample Criteria
```{r DetailCustomer}
if(!exists("def_all_detail")) def_all_detail<-NULL
# debug(input_sample_criteria)
debug(input_sample_criteria)
def_all_detail<-input_sample_criteria(def_all_detail,                                file="Contract.SP_ContractSampleCriteriaDetailsCustomer.txt",
...
load(file="Data\\defense_contract_all_detail.Rdata")
save(file="Data\\defense_contract_all_detail.Rdata",def_all_detail)
...
def_all_detail<-input_contract_psc_office_naics(def_all_detail,                                file="Contract.SP_ContractSampleCriteriaDetailsCustomer.txt")
...
def_all_detail<-dplyr::left_join(def_all_detail,test,by="CSIScontractID")


  def_all_detail$topContractingOfficeAgencyID<-factor(
    def_all_detail$topContractingOfficeAgencyID
  )
  def_all_detail$topContractingOfficeID<-factor(
    def_all_detail$topContractingOfficeID
  )
  def_all_detail$topProductOrServiceCode<-factor(
    def_all_detail$topProductOrServiceCode
  )
  def_all_detail$topPrincipalNAICScode<-factor(
    def_all_detail$topPrincipalNAICScode
  )
  
  def_all_detail$AgencyID<-def_all_detail$topContractingOfficeAgencyID
  debug(na_check)
      def_all_detail<-read_and_join_experiment(def_all_detail,
                                    "Agency_AgencyID.csv",
                                     by="AgencyID",
  ...
  def_all_detail<- subset(def_all_detail,Customer=="Defense")
  def_all_detail<-def_all_detail[,!colnames(def_all_detail) %in% 
                     c(
...
def_all_detail<-input_initial_scope(def_all_detail,
...
# load(file="Data\\defense_contract_all_detail.Rdata")
# undebug(input_initial_scope)
def_all_detail<-input_contract_delta(def_all_detail,
             file="Defense_Contract_SP_ContractModificationDeltaCustomer.csv")

save(file="Data\\defense_contract_all_detail.Rdata",def_all_detail)
```

# Split between def_all_detail and def_detail

##Location
```{r Location}


def_detail<-def_all_detail
rm(def_all_detail)
#Drop contracts starting before the study period and not clearly end within it
def_detail<-subset(def_detail, StartFY>=2007   &
    (LastCurrentCompletionDate<="2017-09-30" | IsClosed==1)
)

# load(file="Data\\defense_contract_complete_detail.Rdata")
...
save(file="Data\\defense_contract_complete_detail.Rdata",def_detail)
...
def_all_detail<-apply_lookups(Path,def_all_detail)
...
# def_all_detail<-csis360::read_and_join(
#   def_all_detail,
...
# def_all_detail$SubCustomer.sum<-factor(def_all_detail$SubCustomer.sum)
# def_all_detail$SubCustomer.sum<-droplevels(def_all_detail$SubCustomer.sum)
# def_all_detail$SubCustomer.sum<-droplevels(def_all_detail$SubCustomer.sum)
...
save(file="Data\\defense_contract_all_detail.Rdata",def_all_detail)
save(file="Data\\defense_contract_complete_detail.Rdata",def_detail)
# def_all_detail<-rename_dataset(def_all_detail)
...
def_all<-rename_dataset(def_all_detail)
