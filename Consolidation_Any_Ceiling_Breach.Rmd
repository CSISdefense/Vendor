...
Term_smp25k<-DefenseModelAndDetail[!is.na(DefenseModelAndDetail$b_Crai)&
...
Term_smp25k<-Term_smp25k[sample(nrow(Term_smp25k),250000),]
...
summary(Term_smp25k$b_Comp )
summary(Term_smp25k$c_hh_index_lag1 )
summary(Term_smp25k$Comp )
summary(Term_smp25k$CompOffr )
summary(Term_smp25k$EffComp )
...
# Term_smp25k<-DefenseModelAndDetail[
...
# 
# 
# freq_continuous_term_plot(Term_smp25k,"l_Ceil")
# exp(mean(Term_smp25k$l_Ceil,na.rm=TRUE))
# 
# Term_smp25k$StartFY
# 
# cutoff<-quantile(Term_smp25k$l_Ceil,0.05,na.rm=TRUE)
# exp(cutoff)
# cutoff<-log(3500)
# 
# nrow(subset(Term_smp25k,l_Ceil<cutoff,na.rm=TRUE))/nrow(Term_smp25k)
# sum(subset(Term_smp25k,l_Ceil<cutoff)$b_Crai)/sum(Term_smp25k$b_Crai)
# 
# 
# sum(subset(Term_smp25k,l_Ceil<cutoff,na.rm=TRUE)$Action.Obligation)/sum(Term_smp25k$Action.Obligation)
# sum(subset(Term_smp25k,l_Ceil>=cutoff,na.rm=TRUE)$Action.Obligation)/sum(Term_smp25k$Action.Obligation)
# 
# sum(subset(Term_smp25k,l_Ceil<cutoff)$b_Crai)/nrow(subset(Term_smp25k,l_Ceil<cutoff,na.rm=TRUE))
# 
# sum(subset(Term_smp25k,l_Ceil>=cutoff)$b_Crai)/nrow(subset(Term_smp25k,l_Ceil<cutoff,na.rm=TRUE))
# 
# 
...
#Frequency Plot
freq_continuous_term_plot(Term_smp25k,"hh_index_lag1")

ggplot(data=Term_smp25k,aes(x=hh_index_lag1,weight=Action.Obligation))+geom_histogram()

freq_continuous_term_plot(Term_smp25k,"hh_index_lag1","Veh")

ggplot(data=Term_smp25k,aes(x=hh_index_lag1,weight=Action.Obligation))+geom_histogram()+facet_wrap(~Veh)

freq_continuous_term_plot(Term_smp25k,"hh_index_lag1","PSR")
freq_continuous_term_plot(Term_smp25k,"hh_index_lag1","FxCb")

#Percent Terminated Plot 
debug(binned_percent_term_plot)
binned_percent_term_plot(Term_smp25k,"hh_index_lag1")

#Percent Terminated Plot
binned_percent_term_plot(Term_smp25k,"hh_index_lag1","FxCb")

#Percent Terminated Plot
binned_percent_term_plot(Term_smp25k,"hh_index_lag1","PSR")

#Percent Terminated Plot
binned_percent_term_plot(Term_smp25k,"hh_index_lag1","Veh")


#Model
Term_01A <- glm (data=Term_smp25k,
                 b_Crai ~ c_hh_index_lag1, family=binomial(link="logit"))
display(Term_01A)

#Plot the Fitted
#Add the fitted regression line
discrete_fitted_term_model(Term_smp25k,"chh_index_lag1") +
...
freq_continuous_term_plot(Term_smp25k,"UnmodifiedContractBaseAndAllOptionsValue",
               bins=1000)
freq_continuous_term_plot(subset(Term_smp25k,UnmodifiedContractBaseAndAllOptionsValue<100000000),
...
#Percent Terminated Plot
binned_percent_term_plot(Term_smp25k,"l_Ceil")

#Model
Term_02A <- glm (data=Term_smp25k,
...
#Competition curves
fitted_term_model(Term_smp25k,"cl_Ceil") + stat_function(fun = Term_02A_curve, 
...
#Frequency Plot
freq_continuous_term_plot(Term_smp25k,"lsqr_Ceil")

#Percent Terminated Plot
binned_percent_term_plot(Term_smp25k,"lsqr_Ceil")

#Model
Term_02B <- glm (data=Term_smp25k,
...
#Competition curves
fitted_term_model(Term_smp25k,"cl_Ceil") + stat_function(fun = Term_02B_curve, 
                             args=list(Comp=0),color="blue")+
...
#Frequency Plot
freq_continuous_term_plot(Term_smp25k,"l_Ceil","EffComp")

#Plot the percent terminated across cost ceiling and competition
binned_percent_term_plot(Term_smp25k,"l_Ceil","EffComp")

#Create the model
Term_02C <- glm (data=Term_smp25k,
...
#Competition Curves
fitted_term_model(Term_smp25k,"cl_Ceil") + stat_function(fun = Term_02C_curve, 
                             args=list(Comp=0),color="blue")+
...
freq_continuous_term_plot(Term_smp25k,"UnmodifiedDays",
               bins=1000)

#Frequency Plot for logged max duration
freq_continuous_term_plot(Term_smp25k,"l_Days")

#Percent Terminated Plot
binned_percent_term_plot(Term_smp25k,"l_Days")


#Model
Term_02D <- glm (data=Term_smp25k,
...
#Competition Curves
fitted_term_model(Term_smp25k,"cl_Days") + stat_function(fun = Term_02D_curve, 
...
ggplot(data=subset(Term_smp25k,!is.na(l_Ceil)),
...
#Competition Curves
fitted_term_model(Term_smp25k,"cl_Days") + stat_function(fun = Term_02E_curve, 
                             args=list(Comp=0,Ceil=0),color="blue")+
...
#Frequency Plot
freq_continuous_term_plot(Term_smp25k,"lsqr_Days")

#Percent Terminated Plot
binned_percent_term_plot(Term_smp25k,"lsqr_Days")


#Create the model
Term_02F <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
...
#Competition curves
fitted_term_model(Term_smp25k,"cl_Ceil") + stat_function(fun = Term_02F_curve, 
                             args=list(Comp=0),color="blue")+
...
#Competition curves
fitted_term_model(Term_smp25k,"cl_Ceil") + stat_function(fun = Term_02G_curve, 
                             args=list(Comp=0),color="blue")+
...
#Frequency Plot
freq_continuous_term_plot(Term_smp25k,"l_Days","EffComp")

#Plot the percent terminated across cost ceiling and competition
binned_percent_term_plot(Term_smp25k,"l_Days","EffComp")

#Create the model
Term_02H <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
...
#Competition curves
fitted_term_model(Term_smp25k,"cl_Days") + stat_function(fun = Term_02H_curve, 
                             args=list(Comp=0,Ceil=0),color="blue")+
...
```{r Model03A}
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"Veh")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"Veh")


#Create the model
Term_03A <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days, family=binomial(link="logit"))
...
#Competition curves
discrete_fitted_term_model(Term_smp25k,"SIDV") +
...
#Competition curves
discrete_fitted_term_model(Term_smp25k,"MIDV") +
...
#Competition curves
discrete_fitted_term_model(Term_smp25k,"OIDV") +
...
#Frequency Plot
freq_continuous_term_plot(Term_smp25k,"l_Days","Veh")


#Percent Terminated Plot 
binned_percent_term_plot(Term_smp25k,"l_Days","Veh")

#Create the model
Term_03B <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"EffComp","Veh")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"EffComp","Veh")


#Create the model
Term_03C <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_continuous_term_plot(Term_smp25k,"l_Ceil","Veh")


#Percent Terminated Plot 
binned_percent_term_plot(Term_smp25k,"l_Ceil","Veh")

#Create the model

#Create the model
Term_03D <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Competition curves
discrete_fitted_term_model(Term_smp25k,"cl_Ceil") +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"FxCb")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"FxCb")


#Create the model
Term_04A <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_continuous_term_plot(Term_smp25k,"l_Days","FxCb")

#Percent Terminated Plot 
binned_percent_term_plot(Term_smp25k,"l_Days","FxCb")


#Create the model
Term_04B <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"FxCb","Veh")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"FxCb","Veh")

#Create the model
Term_04C <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Fixed +
...
#Vehicle curves
discrete_fitted_term_model(Term_smp25k,"n_Fixed") +
...
#Frequency Plot
freq_discrete_crai_plot(Term_smp25k,"Fee")
debug(discrete_percent_crai_plot)
#Percent Terminated Plot
discrete_percent_crai_plot(Term_smp25k,"Fee")



#Create the model
Term_04D <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
...
#Days curves
discrete_fitted_term_model(Term_smp25k,"n_Incent") +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"Fee","FxCb")+
  theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"Fee","FxCb")+
   theme(axis.text.x = element_text(angle = 90, hjust = 1))



#Create the model
Term_04E <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"UCA")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"UCA")



#Create the model
Term_04F <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"UCA","c_hh_index_lag1")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"UCA","c_hh_index_lag1")



#Create the model
Term_04G <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_continuous_term_plot(Term_smp25k,"l_Days","UCA")

#Percent Terminated Plot 
binned_percent_term_plot(Term_smp25k,"l_Days","UCA")


#Create the model
Term_04H <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"Intl")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"Intl")



#Create the model
Term_05A <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"Intl","FxCb")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"Intl","FxCb")
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"Intl","Veh")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"Intl","Veh")



#Create the model
Term_05C <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


Term_smp25k$b_ODoD<-Term_smp25k$Who
levels(Term_smp25k$b_ODoD)<- list("1"=c("Other DoD"), 
                                "0"=c("Air Force","Army","Navy"))
Term_smp25k$b_ODoD[Term_smp25k$b_ODoD=="Uncategorized"]<-NA
Term_smp25k$b_ODoD<-as.integer(as.character(Term_smp25k$b_ODoD))

#Create the model
Term_06A <- glm (data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Days curves
discrete_fitted_term_model(Term_smp25k,"b_ODoD") +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"EffComp","Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"EffComp","Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"NAICS")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"NAICS")

Term_08A <- glmer(data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Fixed + b_UCA + 
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))
...
# Term_08B <- glmer(data=Term_smp25k,
#                  b_Crai ~c_hh_index_lag1 + 
#                    cl_Ceil + cl_Days+ 
#                    SIDV + MIDV + OIDV +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"PSR_What","EffComp")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"EffComp","PSR")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(Term_smp25k,"EffComp","What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(Term_smp25k,"EffComp","PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


#Effective Competition
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"PSR_What","Veh")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"Veh","PSR")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(Term_smp25k,"Veh","What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(Term_smp25k,"Veh","PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#FxCb
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"PSR_What","FxCb")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"FxCb","PSR")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(Term_smp25k,"FxCb","What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(Term_smp25k,"FxCb","PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


Term_08C <- glmer(data=Term_smp25k,
                 b_Crai ~ #c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  +
...
Term_08D <- glmer(data=Term_smp25k,
                 b_Crai ~ c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  +
...
# Term_08E <- glmer(data=Term_smp25k,
#                  b_Crai ~ c_hh_index_lag1 + 
#                    cl_Ceil + cl_Days+ 
#                    SIDV + MIDV + OIDV +
#                    c_hh_index_lag1:cl_Ceil  +
...
Term_09A <- glmer(data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Fixed + b_UCA + 
...
#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"NAICS")
Term_smp25k$topContractingOfficeID
Term_09A <- glmer(data=Term_smp25k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
