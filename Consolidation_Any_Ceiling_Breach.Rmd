...
Term_smp250k<-DefenseModelAndDetail[!is.na(DefenseModelAndDetail$b_Crai)&
...
Term_smp250k<-Term_smp250k[sample(nrow(Term_smp250k),250000),]


Term_smp1m<-DefenseModelAndDetail[!is.na(DefenseModelAndDetail$b_Crai)&
                                  !is.na(DefenseModelAndDetail$Comp)&
                                  !is.na(DefenseModelAndDetail$l_Ceil)&
                                  !is.na(DefenseModelAndDetail$l_Days)&
                                  !is.na(DefenseModelAndDetail$n_Fixed)&
...
summary(Term_smp250k$b_Comp )
summary(Term_smp250k$c_hh_index_lag1 )
summary(Term_smp250k$Comp )
summary(Term_smp250k$CompOffr )
summary(Term_smp250k$EffComp )
...
# Term_smp250k<-DefenseModelAndDetail[
...
# 
# 
# freq_continuous_term_plot(Term_smp250k,"l_Ceil")
# exp(mean(Term_smp250k$l_Ceil,na.rm=TRUE))
# 
# Term_smp250k$StartFY
# 
# cutoff<-quantile(Term_smp250k$l_Ceil,0.05,na.rm=TRUE)
# exp(cutoff)
# cutoff<-log(3500)
# 
# nrow(subset(Term_smp250k,l_Ceil<cutoff,na.rm=TRUE))/nrow(Term_smp250k)
# sum(subset(Term_smp250k,l_Ceil<cutoff)$b_Crai)/sum(Term_smp250k$b_Crai)
# 
# 
# sum(subset(Term_smp250k,l_Ceil<cutoff,na.rm=TRUE)$Action.Obligation)/sum(Term_smp250k$Action.Obligation)
# sum(subset(Term_smp250k,l_Ceil>=cutoff,na.rm=TRUE)$Action.Obligation)/sum(Term_smp250k$Action.Obligation)
# 
# sum(subset(Term_smp250k,l_Ceil<cutoff)$b_Crai)/nrow(subset(Term_smp250k,l_Ceil<cutoff,na.rm=TRUE))
# 
# sum(subset(Term_smp250k,l_Ceil>=cutoff)$b_Crai)/nrow(subset(Term_smp250k,l_Ceil<cutoff,na.rm=TRUE))
# 
# 
...
#Frequency Plot
freq_continuous_term_plot(Term_smp250k,"hh_index_lag1")

ggplot(data=Term_smp250k,aes(x=hh_index_lag1,weight=Action.Obligation))+geom_histogram()

freq_continuous_term_plot(Term_smp250k,"hh_index_lag1","Veh")

ggplot(data=Term_smp250k,aes(x=hh_index_lag1,weight=Action.Obligation))+geom_histogram()+facet_wrap(~Veh)

freq_continuous_term_plot(Term_smp250k,"hh_index_lag1","PSR")
freq_continuous_term_plot(Term_smp250k,"hh_index_lag1","FxCb")

#Percent Terminated Plot 
debug(binned_percent_term_plot)
binned_percent_term_plot(Term_smp250k,"hh_index_lag1")

#Percent Terminated Plot
binned_percent_term_plot(Term_smp250k,"hh_index_lag1","FxCb")

#Percent Terminated Plot
binned_percent_term_plot(Term_smp250k,"hh_index_lag1","PSR")

#Percent Terminated Plot
binned_percent_term_plot(Term_smp250k,"hh_index_lag1","Veh")


#Model
Term_01A <- glm (data=Term_smp250k,
                 b_Crai ~ c_hh_index_lag1, family=binomial(link="logit"))
display(Term_01A)

#Plot the Fitted
#Add the fitted regression line
discrete_fitted_term_model(Term_smp250k,"chh_index_lag1") +
  stat_function(fun = fit_curve, args=list(a=coef(Term_01A)[1],
                                           b=coef(Term_01A)[2]),
                             color="blue")

#Plot the fitted values vs actual results
binned_fitted_versus_residuals(Term_01A)



#Plot residuals versus fitted
residuals_term_plot(Term_01A,bins=3)+
...
freq_continuous_term_plot(Term_smp250k,"UnmodifiedContractBaseAndAllOptionsValue",
               bins=1000)
freq_continuous_term_plot(subset(Term_smp250k,UnmodifiedContractBaseAndAllOptionsValue<100000000),
...
#Percent Terminated Plot
binned_percent_term_plot(Term_smp250k,"l_Ceil")

#Model
Term_02A <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + cl_Ceil, family=binomial(link="logit"))
display(Term_02A)
...
#Competition curves
fitted_term_model(Term_smp250k,"cl_Ceil") + stat_function(fun = Term_02A_curve, 
...
#Frequency Plot
freq_continuous_term_plot(Term_smp250k,"lsqr_Ceil")

#Percent Terminated Plot
binned_percent_term_plot(Term_smp250k,"lsqr_Ceil")

#Model
Term_02B <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + cl_Ceil + clsqr_Ceil, family=binomial(link="logit"))
display(Term_02B)
...
#Competition curves
fitted_term_model(Term_smp250k,"cl_Ceil") + stat_function(fun = Term_02B_curve, 
                             args=list(Comp=0),color="blue")+
...
#Frequency Plot
freq_continuous_term_plot(Term_smp250k,"l_Ceil","EffComp")

#Plot the percent terminated across cost ceiling and competition
binned_percent_term_plot(Term_smp250k,"l_Ceil","EffComp")

#Create the model
Term_02C <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + cl_Ceil + clsqr_Ceil + c_hh_index_lag1:cl_Ceil, family=binomial(link="logit"))
display(Term_02C)

Term_02C_curve<-function(x, Comp){invlogit(cbind(1,Comp,x,x^2,Comp*x) %*%  coef(Term_02C))}

#Competition Curves
fitted_term_model(Term_smp250k,"cl_Ceil") + stat_function(fun = Term_02C_curve, 
                             args=list(Comp=0),color="blue")+
...
freq_continuous_term_plot(Term_smp250k,"UnmodifiedDays",
               bins=1000)

#Frequency Plot for logged max duration
freq_continuous_term_plot(Term_smp250k,"l_Days")

#Percent Terminated Plot
binned_percent_term_plot(Term_smp250k,"l_Days")


#Model
Term_02D <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + clsqr_Ceil + cl_Days + clsqr_Ceil +
                   c_hh_index_lag1:cl_Ceil , family=binomial(link="logit"))
display(Term_02D)
...
#Competition Curves
fitted_term_model(Term_smp250k,"cl_Days") + stat_function(fun = Term_02D_curve, 
...
ggplot(data=subset(Term_smp250k,!is.na(l_Ceil)),
...
#Create the model
Term_02E <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + clsqr_Ceil + cl_Days+
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days, family=binomial(link="logit"))
display(Term_02E)
...
#Competition Curves
fitted_term_model(Term_smp250k,"cl_Days") + stat_function(fun = Term_02E_curve, 
                             args=list(Comp=0,Ceil=0),color="blue")+
...
#Frequency Plot
freq_continuous_term_plot(Term_smp250k,"lsqr_Days")

#Percent Terminated Plot
binned_percent_term_plot(Term_smp250k,"lsqr_Days")


#Create the model
Term_02F <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
...
#Competition curves
fitted_term_model(Term_smp250k,"cl_Ceil") + stat_function(fun = Term_02F_curve, 
                             args=list(Comp=0),color="blue")+
...
#Create the model
Term_02G <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
...
#Competition curves
fitted_term_model(Term_smp250k,"cl_Ceil") + stat_function(fun = Term_02G_curve, 
                             args=list(Comp=0),color="blue")+
...
#Frequency Plot
freq_continuous_term_plot(Term_smp250k,"l_Days","EffComp")

#Plot the percent terminated across cost ceiling and competition
binned_percent_term_plot(Term_smp250k,"l_Days","EffComp")

#Create the model
Term_02H <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days, family=binomial(link="logit"))
display(Term_02H)
...
#Competition curves
fitted_term_model(Term_smp250k,"cl_Days") + stat_function(fun = Term_02H_curve, 
                             args=list(Comp=0,Ceil=0),color="blue")+
...
```{r Model03A}
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"Veh")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"Veh")


#Create the model
Term_03A <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days, family=binomial(link="logit"))
...
#Competition curves
discrete_fitted_term_model(Term_smp250k,"SIDV") +
...
#Competition curves
discrete_fitted_term_model(Term_smp250k,"MIDV") +
...
#Competition curves
discrete_fitted_term_model(Term_smp250k,"OIDV") +
...
#Frequency Plot
freq_continuous_term_plot(Term_smp250k,"l_Days","Veh")


#Percent Terminated Plot 
binned_percent_term_plot(Term_smp250k,"l_Days","Veh")

#Create the model
Term_03B <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"EffComp","Veh")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"EffComp","Veh")


#Create the model
Term_03C <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
                 SIDV:cl_Days+MIDV:cl_Days+OIDV:cl_Days +
                   SIDV:c_hh_index_lag1+MIDV:c_hh_index_lag1+OIDV:c_hh_index_lag1 , family=binomial(link="logit"))
display(Term_03C)
...
#Frequency Plot
freq_continuous_term_plot(Term_smp250k,"l_Ceil","Veh")


#Percent Terminated Plot 
binned_percent_term_plot(Term_smp250k,"l_Ceil","Veh")

#Create the model

#Create the model
Term_03D <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
                 SIDV:cl_Days+MIDV:cl_Days+OIDV:cl_Days +
                   SIDV:c_hh_index_lag1+MIDV:c_hh_index_lag1+OIDV:c_hh_index_lag1 +
...
#Create the model
Term_03E <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil  + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Competition curves
discrete_fitted_term_model(Term_smp250k,"cl_Ceil") +
...
#Create the model
Term_03F <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil  + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"FxCb")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"FxCb")


#Create the model
Term_04A <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_continuous_term_plot(Term_smp250k,"l_Days","FxCb")

#Percent Terminated Plot 
binned_percent_term_plot(Term_smp250k,"l_Days","FxCb")


#Create the model
Term_04B <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"FxCb","Veh")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"FxCb","Veh")

#Create the model
Term_04C <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Fixed +
...
#Vehicle curves
discrete_fitted_term_model(Term_smp250k,"n_Fixed") +
...
#Frequency Plot
freq_discrete_crai_plot(Term_smp250k,"Fee")
debug(discrete_percent_crai_plot)
#Percent Terminated Plot
discrete_percent_crai_plot(Term_smp250k,"Fee")



#Create the model
Term_04D <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
...
#Days curves
discrete_fitted_term_model(Term_smp250k,"n_Incent") +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"Fee","FxCb")+
  theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"Fee","FxCb")+
   theme(axis.text.x = element_text(angle = 90, hjust = 1))



#Create the model
Term_04E <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"UCA")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"UCA")



#Create the model
Term_04F <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"UCA","c_hh_index_lag1")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"UCA","c_hh_index_lag1")



#Create the model
Term_04G <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_continuous_term_plot(Term_smp250k,"l_Days","UCA")

#Percent Terminated Plot 
binned_percent_term_plot(Term_smp250k,"l_Days","UCA")


#Create the model
Term_04H <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"Intl")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"Intl")



#Create the model
Term_05A <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"Intl","FxCb")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"Intl","FxCb")
...
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"Intl","Veh")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"Intl","Veh")



#Create the model
Term_05C <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
# Term_09A <- glmer(data=Term_smp1m,
#                  b_Crai ~c_hh_index_lag1 + 
#                    cl_Ceil + cl_Days+ 
#                    SIDV + MIDV + OIDV +
#                    n_Fixed + b_UCA + 
...
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


Term_smp250k$b_ODoD<-Term_smp250k$Who
levels(Term_smp250k$b_ODoD)<- list("1"=c("Other DoD"), 
                                "0"=c("Air Force","Army","Navy"))
Term_smp250k$b_ODoD[Term_smp250k$b_ODoD=="Uncategorized"]<-NA
Term_smp250k$b_ODoD<-as.integer(as.character(Term_smp250k$b_ODoD))

#Create the model
Term_06A <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Days curves
discrete_fitted_term_model(Term_smp250k,"b_ODoD") +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"EffComp","Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"EffComp","Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))
...
#Create the model
Term_06B <- glm (data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  + cl_Ceil:cl_Days  + c_hh_index_lag1:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"NAICS")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"NAICS")

Term_08A <- glmer(data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Fixed + b_UCA + 
...
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

Term_smp250k$NAICS2<-substr(Term_smp250k$NAICS,1,2)

#Create the model

Term_08B2 <- glmer(data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Fixed + b_UCA + 
...
Term_smp250k$NAICS4<-substr(Term_smp250k$NAICS,1,4)
Term_08B4 <- glmer(data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Fixed + b_UCA + 
...
Term_smp250k$NAICS3<-substr(Term_smp250k$NAICS,1,3)
Term_08B3 <- glmer(data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Fixed + b_UCA + 
...
# Term_08B <- glmer(data=Term_smp250k,
#                  b_Crai ~c_hh_index_lag1 + 
#                    cl_Ceil + cl_Days+ 
#                    SIDV + MIDV + OIDV +
#                    c_hh_index_lag1:cl_Ceil  +
#                    # cl_Ceil:cl_Days  + 
#                    c_hh_index_lag1:cl_Days +
#                    n_Fixed + b_UCA + 
#                    b_Intl + 
#                    SIDV:cl_Days+MIDV:cl_Days+OIDV:cl_Days +
#                    SIDV:c_hh_index_lag1+MIDV:c_hh_index_lag1+OIDV:c_hh_index_lag1+
...
save(Term_08B2,Term_08B3,Term_08B4,file="Cons_Term08B.Rdata")
...
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"PSR_What","EffComp")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"EffComp","PSR")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(Term_smp250k,"EffComp","What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(Term_smp250k,"EffComp","PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


#Effective Competition
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"PSR_What","Veh")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"Veh","PSR")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(Term_smp250k,"Veh","What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(Term_smp250k,"Veh","PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#FxCb
#Frequency Plot
freq_discrete_term_plot(Term_smp250k,"PSR_What","FxCb")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"FxCb","PSR")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(Term_smp250k,"FxCb","What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(Term_smp250k,"FxCb","PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


Term_08C <- glmer(data=Term_smp250k,
                 b_Crai ~ #c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  +
                   ...
                   SIDV:c_hh_index_lag1+MIDV:c_hh_index_lag1+OIDV:c_hh_index_lag1+
                   b_UCA:c_hh_index_lag1+
                   (1 + c_hh_index_lag1 | PSR) + (1 | PSR_What)
                    , family=binomial(link="logit"))
display(Term_08C)


Term_08D <- glmer(data=Term_smp250k,
                 b_Crai ~ c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   c_hh_index_lag1:cl_Ceil  +
                   ...
                   SIDV:c_hh_index_lag1+MIDV:c_hh_index_lag1+OIDV:c_hh_index_lag1+
                   b_UCA:c_hh_index_lag1+
                   (1  | PSR) + (1 + c_hh_index_lag1| PSR_What)
                    , family=binomial(link="logit"))
display(Term_08D)
...
# Term_08E <- glmer(data=Term_smp250k,
#                  b_Crai ~ c_hh_index_lag1 + 
#                    cl_Ceil + cl_Days+ 
#                    SIDV + MIDV + OIDV +
#                    c_hh_index_lag1:cl_Ceil  +
...
#                    SIDV:c_hh_index_lag1+MIDV:c_hh_index_lag1+OIDV:c_hh_index_lag1+
#                    b_UCA:c_hh_index_lag1+
#                    (1+c_hh_index_lag1  | PSR) + (1+ c_hh_index_lag1 | PSR_What)
#                     , family=binomial(link="logit"))
# display(Term_08E)
...
Term_09A <- glmer(data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Fixed + b_UCA + 
...
#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp250k,"NAICS")
Term_smp250k$topContractingOfficeID
Term_09A <- glmer(data=Term_smp250k,
                 b_Crai ~c_hh_index_lag1 + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
...
#Ran for two hours Model failed to converge with max|grad| = 0.186396 (tol = 0.001, component 1)
# Plot the model and Vehicle 
Term_09A_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed,UCA){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,UCA,x,
        Days*x,Days*MIDV,Days*OIDV,
        UCA*Comp) %*%  coef(Term_09A))}

#Days curves
discrete_fitted_term_model(Term_smp250k,"SIDV") +
  stat_function(fun = Term_09A_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,SIDV=0,OIDV=0,
                                       Fixed=1,UCA=0),color="blue")+
  stat_function(fun = Term_09A_curve,
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(Term_09A)

#Plot residuals versus fittedO
residuals_term_plot(Term_09A)+
  labs(x="Estimated  Pr (Termination)")
