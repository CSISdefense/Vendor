...
### NAICS When Office
```{r NAICS_When_Office}
if(!exists("NAICS_When_Office_term"))
  NAICS_When_Office_term <- glmer(data=smp,
                             b_Term ~  (1 | NAICS3/NAICS) + (1 | StartCY) + (1 | Agency:Office)
                             , family=binomial(link="logit"))
get_icc(display=TRUE,NAICS_When_Office_term)

if(!exists("NAICS_When_Office_cbre"))
  NAICS_When_Office_cbre <- glmer(data=smp,
                             b_CBre ~  (1 | NAICS3/NAICS)+ (1 | StartCY) + (1 | Agency;Office)
                             , family=binomial(link="logit"))
get_icc(display=TRUE,NAICS_When_Office_cbre)

if(!exists("NAICS_When_Office_comp"))
  NAICS_When_Office_comp <- glmer(data=smp,
                             b_Comp ~  (1 | NAICS3/NAICS)+ (1 | StartCY) + (1 | Agency:Office)
                             , family=binomial(link="logit"))
get_icc(display=TRUE,NAICS_When_Office_comp)
...
save(Office_cbre,Office_term,Office_comp,
     ...
     # NAICS_When_Office_cbre,NAICS_When_Office_term,NAICS_When_Office_comp,
...
get_icc(NAICS_When_Office_term)
...
get_icc(NAICS_When_Office_cbre)
...
get_icc(NAICS_When_Office_comp)
