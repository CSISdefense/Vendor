...
#Create the model
Term_Comp_02E <- glm (data=smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + clsqr_Ceil + cl_Days+
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days, family=binomial(link="logit"))
display(Term_Comp_02E)

Term_Comp_02E_curve<-function(x, Comp,Ceil){invlogit(
...
#Competition Curves
fitted_term_model(smp,"cl_Days") + stat_function(fun = Term_Comp_02E_curve, 
                             args=list(Comp=0,Ceil=0),color="blue")+
  stat_function(fun = Term_Comp_02E_curve, 
                             args=list(Comp=2,Ceil=0),color="blue")
...
#Plot the fitted values vs actual results
binned_fitted_versus_residuals(Term_Comp_02E)


#Plot residuals versus fitted
residuals_term_plot(Term_Comp_02E)+
  labs(x="Estimated  Pr (Termination)")
# debug(binned.resids)
# residuals_term_plot(Term_Comp_02E,"cl_Days")+
  # labs(x="Centered Log(Ceiling)")
...
#Frequency Plot
freq_discrete_term_plot(smp,"UCA","n_Comp")

#Percent Terminated Plot 
discrete_percent_term_plot(smp,"UCA","n_Comp")
