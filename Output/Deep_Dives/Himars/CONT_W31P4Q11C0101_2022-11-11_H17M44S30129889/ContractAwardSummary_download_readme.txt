...
This ZIP file was generated from a specific Contract Award Summary Page on USAspending.gov, located at https://www.usaspending.gov/award/37391851
...
File: Contract_[Award PIID]_FederalAccountFunding_#.csv
...
File: Contract_[Award PIID]_Sub-Awards_#.csv

This file contains all Sub-Contract data associated with this prime award. Sub-Contract data is also available from the Advanced Search or Custom Award Download sections of the site.

File: Contract_[Award PIID]_TransactionHistory_#.csv

This file contains transaction-level data for all of the modifications made to this contract award, including the base award. This data is also available from the Advanced Search, Award Data Archive, and Custom Award Download sections of the site.
