...
Term_smp25k<-DefenseModelAndDetail[!is.na(DefenseModelAndDetail$b_Term)&
...
# sum(subset(Term_smp25k,l_Ceil<cutoff)$b_Term)/sum(Term_smp25k$b_Term)
# 
# 
# sum(subset(Term_smp25k,l_Ceil<cutoff,na.rm=TRUE)$Action.Obligation)/sum(Term_smp25k$Action.Obligation)
# sum(subset(Term_smp25k,l_Ceil>=cutoff,na.rm=TRUE)$Action.Obligation)/sum(Term_smp25k$Action.Obligation)
# 
# sum(subset(Term_smp25k,l_Ceil<cutoff)$b_Term)/nrow(subset(Term_smp25k,l_Ceil<cutoff,na.rm=TRUE))
# 
# sum(subset(Term_smp25k,l_Ceil>=cutoff)$b_Term)/nrow(subset(Term_smp25k,l_Ceil<cutoff,na.rm=TRUE))
# 
# 
...
Term_01A <- glm (data=Term_smp25k,
                 b_Term ~ c_hh_index_lag1, family=binomial(link="logit"))
display(Term_01A)
...
Term_02A <- glm (data=Term_smp25k,
                 b_Term ~c_hh_index_lag1 + cl_Ceil, family=binomial(link="logit"))
display(Term_02A)
...
Term_02B <- glm (data=Term_smp25k,
                 b_Term ~c_hh_index_lag1 + cl_Ceil + clsqr_Ceil, family=binomial(link="logit"))
display(Term_02B)
...
Term_02C <- glm (data=Term_smp25k,
                 b_Term ~c_hh_index_lag1 + cl_Ceil + clsqr_Ceil + c_hh_index_lag1:cl_Ceil, family=binomial(link="logit"))
display(Term_02C)
