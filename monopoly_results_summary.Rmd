...
source("DIIGstat.r")
grouped_barplot("Term")
grouped_barplot("CBre")
```
...
ratio_category <- c("def6_ratio_lag1", "def5_ratio_lag1", "def4_ratio_lag1", "def3_ratio_lag1", "def2_ratio_lag1")
...
statsummary_continuous(obl_category)
```
...
statsummary_continuous(("UnmodifiedContractBaseAndAllOptionsValue"))
statsummary_continuous(("UnmodifiedDays"))
