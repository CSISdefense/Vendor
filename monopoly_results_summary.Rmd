...
### Platform Portfolio
```{r Platform, fig.width=6.5 , fig.height=3.5}
annual_platform_summary$platformPortfolio
annual_platform_summary$plat_short <-swr(annual_platform_summary$platformPortfolio,nwrap = 21)
annual_platform_summary<-subset(annual_platform_summary,Fiscal.Year>=2000 & Fiscal.Year<=2017)
plat<-ggplot(subset(annual_platform_summary,!is.na(platformPortfolio)),
...
ggsave(plat,filename="Output//platform_hhi.png",height=3, width=6.5)
```
