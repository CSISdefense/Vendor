...
glmer_examine(Term_Cons_Comp_14B,dislay=TRUE)
odds_ratio(Term_Cons_Comp_14B,"Term_Cons_Comp_14A")
...
or1<-odds_ratio(CBre_Cons_13B,"CBre_Cons_13B","Concentration","Ceiling Breaches")
...
comp.or<-comp.or[comp.or$variable %in% c("cl_def3_HHI_lag1"    ,"cl_def6_HHI_lag1" ,"CompOffr1 offer" ,                 
"CompOffr2 offers",                  "CompOffr3-4 offers",                "CompOffr5+ offers",                 "CompOffr1 offer:b_UCA",            
 "CompOffr2 offers:b_UCA"   ,         "CompOffr3-4 offers:b_UCA",          "CompOffr5+ offers:b_UCA"),]
comp.or<-comp.or[c(c("output" ,  "input"  ,  "variable",   "2.5 %"  , "OR"  , "97.5 %" ))]

CBre_Cons_13B,CBre_Comp_13C,CBre_Cons_Comp_15A
#https://www.lcampanelli.org/mixed-effects-modeling-lme4/
gridExtra::grid.arrange(dotplot(ranef(CBre_Cons_13B, condVar = T), strip = T, scales=list(relation='free'))$Agency,
...
texreg::htmlreg(list(Term_Cons_13E,Term_Comp_13E2,Term_Cons_Comp_14A),file="Output//Term_Model.html",
                single.row = TRUE,
                custom.model.name=c("Concentration",
                                    "Competition",
                                    "Both"
