...
save(file="Term_Cons.RData",Term_Cons_08A,Term_Cons_08A2,Term_Cons_08A3,Term_Cons_08B)



Term_Cons_08A4 <- glm(data=smp1m,
                        b_Term ~c_HHI_lag1 + 
                          cl_Ceil + cl_Days+ 
                          Veh+
                          # c_HHI_lag1:cl_Ceil  + cl_Ceil:cl_Days  +
...
display(Term_Cons_08A4)
glmer_examine(Term_Cons_08A4)

Term_Cons_08A5 <- glm(data=smp1m,
                        b_Term ~c_HHI_lag1 + 
                          cl_Ceil + cl_Days+ 
                          Veh+
                          c_HHI_lag1:cl_Ceil  + cl_Ceil:cl_Days  +
                          ...
                          b_UCA:c_HHI_lag1 +
                         NAICS2, family=binomial(link="logit"))
display(Term_Cons_08A5)
glmer_examine(Term_Cons_08A5)

Term_Cons_08A6 <- glm(data=smp1m,
                        b_Term ~c_HHI_lag1 + 
                          cl_Ceil + cl_Days+ 
                          Veh+
                          c_HHI_lag1:cl_Ceil  + cl_Ceil:cl_Days  +
                          ...
                          b_Intl +
                          Veh:cl_Days+
                          # Veh:c_HHI_lag1+ VIF 7.9 for c_HHI_lag1
                          b_UCA:c_HHI_lag1 +
                         NAICS2, family=binomial(link="logit"))
display(Term_Cons_08A6)
glmer_examine(Term_Cons_08A6)


Term_Cons_08A7 <- glm(data=smp1m,
                        b_Term ~c_HHI_lag1 + 
                          cl_Ceil + cl_Days+ 
                          Veh+
                          c_HHI_lag1:cl_Ceil  + cl_Ceil:cl_Days  +
                          ...
                          n_Fixed + b_UCA +
                          b_Intl +
                          # Veh:cl_Days+ VIF 2.23 Directly and 6.46 for Cl_days
                          # Veh:c_HHI_lag1+ VIF 7.9 for c_HHI_lag1
                          b_UCA:c_HHI_lag1 +
                         NAICS2, family=binomial(link="logit"))
display(Term_Cons_08A7)
glmer_examine(Term_Cons_08A7)

Term_Cons_08B2 <- glm(data=smp1m,
                       b_Term ~cl_HHI_lag1 + 
                         cl_Ceil + cl_Days+ 
                         Veh+
                         # c_HHI_lag1:cl_Ceil  + cl_Ceil:cl_Days  +# c_HHI_lag1:cl_Days +
...
CBre_Cons_08B2<- glm(data=smp1m,
                      ...
                      b_UCA:c_HHI_lag1+
                         NAICS2                       , family=binomial(link="logit"))
display(CBre_Cons_08B2)
glmer_examine(CBre_Cons_08B2)

CBre_Cons_08B3<- glm(data=smp1m,
                       b_CBre ~ cl_HHI_lag1 + 
                      cl_Ceil + cl_Days+ 
                      Veh+
                      n_Fixed + b_UCA +
                      ...
                      b_UCA:c_HHI_lag1+
                         NAICS2                       , family=binomial(link="logit"))
display(CBre_Cons_08B3)
glmer_examine(CBre_Cons_08B3)
...
save(file="CBre_Cons.RData",CBre_Cons_05A,CBre_Cons_08A,CBre_Cons_08B2)#,CBre_Cons_08B
