...
# load("Output//CBre_Cons_13B_1m.rdata") Missing
...
if(!exists("Term_Cons_13E")){
  ...
  # save(Term_Cons_13E,file="Output//Term_Cons_13E.rdata")
    ...
    Term_Cons_13E2_1m <- glmer (data=smp1m,
                          b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                            #cl_US3_avg_sal_lag1+
                            cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                            cl_US6_avg_sal_lag1+
...
```{r Both-Term}
#load(file="Output//Term_Cons_Comp_14B.rdata") Missing
...
Term_Cons_Comp_14B2_1m <- glmer (data=smp1m,
                             b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                               #cl_US3_avg_sal_lag1+
                               cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                               cl_US6_avg_sal_lag1+
