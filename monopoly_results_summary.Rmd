...
def$NAICS5<-as.integer(substr(def$NAICS,1,5))
def$NAICS4<-as.integer(substr(def$NAICS,1,4))
def$NAICS3<-as.integer(substr(def$NAICS,1,3))
def$NAICS2<-create_naics2(def$NAICS)
def$StartCY<-def$StartFY

  def<-left_join(def,NAICS6_join, by=c("StartCY"="CalendarYear",
                                                    "NAICS"="NAICS6"))

  def<-left_join(def,NAICS5_join, by=c("StartCY"="CalendarYear",
                                                    "NAICS5"="NAICS5"))

daf<-left_join(def,NAICS4_join, by=c("StartCY"="CalendarYear",
                                     "NAICS4"="NAICS4"))
def<-left_join(def,NAICS3_join, by=c("StartCY"="CalendarYear",
                                     "NAICS3"="NAICS3"))
def<-left_join(def,NAICS2_join, by=c("StartCY"="CalendarYear",
                                     "NAICS2"="NAICS2"))
