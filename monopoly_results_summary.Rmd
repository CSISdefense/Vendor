...
create_naics2<-function(data){
  data$NAICS2<-substring(data$NAICS,1,2)
  data$NAICS2[data$NAICS2 %in% c('31','32','33')]<-'31-33'
  data$NAICS2[data$NAICS2 %in% c('44','45')]<-'44-45'
  data$NAICS2[data$NAICS2 %in% c('48','49')]<-'48-49'
  data$NAICS2<-factor(data$NAICS2)
...
def$NAICS_Code<-create_naics2(def)


smp1m$NAICS2<-create_naics2(smp1m)
