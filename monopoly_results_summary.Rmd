...
summary(complete)
complete<-complete & !def$CSIScontractID %in% smp1m$CSIScontractID
smpnew<-def[complete,]
...
if(!exists("Comp_Cons_15C")){
  ...
  Comp_Cons_15C<-update(Comp_Cons_15C,verbose=1)
...
get_icc(Comp_Cons_15C,summary=TRUE)
```
...
if(!exists("Term_Comp_13E2")){
  ...
  save(Term_Comp_13E,Term_Comp_13E2,file="Output//Term_Comp_13E2.rdata")
    ...
    Term_Comp_13E2_1m <- glmer (data=smp1m,
                          b_Term ~CompOffr+cl_def3_ratio_lag1+#cl_US3_avg_sal_lag1+#cl_def3_obl_lag1+
                            cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1+
                            cl_Ceil + cl_Days+
                            Veh  +
  ...
  save(Term_Comp_13E,Term_Comp_13E2,Term_Comp_13E2_1m,file="Output//Term_Comp_13E2.rdata")
}
...
Term_Cons_Comp_14B_1m <- glmer (data=smp1m,
                             b_Term ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                               ...
                               (1 | NAICS3/NAICS) + (1 | Agency/Office)
                             , family=binomial(link="logit"),verbose=1)
  save(Term_Cons_Comp_14B_1m,file="Output//Term_Cons_Comp_14B_1m.rdata")
