...
centered_log_description(def$l_Offr,"number of offers")
NA_stats(def,"l_Offr")
...
if(!exists("CBre_Cons_13B")){
  CBre_Cons_13B_1m <- glmer (data=smp1m,
                          ...
                          verbose=1)
  save(CBre_Cons_13B,CBre_Cons_13B.restart,CBre_Cons_13B_1m,file="Output//CBre_Cons_13B.rdata")
}
...
stargazer::stargazer(Term_Cons_Comp_14B,Term_Cons_Comp_14B_1m,type="text",
  ...
  save(Term_Cons_Comp_14B,Term_Cons_Comp_14B_1m,file="Output//Term_Cons_Comp_14A.rdata")
