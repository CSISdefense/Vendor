...
if(!exists("CBre_Cons_Comp_14B")){
  CBre_Cons_Comp_14B <- glmer (data=smp,
                               b_CBre ~cl_def6_HHI_lag1 +cl_def6_ratio_lag1+cl_def6_obl_lag1+
                                 ...
                                 (1 | Agency/Office) ,
                               family=binomial(link="logit"))
  save(CBre_Cons_Comp_14B,file="Output//CBre_Cons_Comp_14B.rdata")
}

glmer_examine(CBre_Cons_Comp_14B,display=TRUE)
odds_ratio(CBre_Cons_Comp_14B,"CBre_Cons_Comp_14B")
...
odds_ratio(Term_Cons_13B,"Term_Cons_13B")
...
```{r Term-Comp}
load(file="Output//Term_Comp_13C.rdata")

if(!exists("Term_Comp_13C")){
...
glmer_examine(Term_Comp_13C,display=TRUE)
odds_ratio(Term_Comp_13C,"Term_Comp_13C")
```
...
texreg::htmlreg(list(Comp_Cons_15A),file="Output//Offr_Model.html",single.row = TRUE,
...
texreg::htmlreg(list(CBre_Cons_13B,CBre_Comp_13C,CBre_Cons_Comp_14B),file="Output//CBre_Model.html",single.row = TRUE,
                custom.model.name=c("Consolidation",
                                    "Competition",
                                    "Both"),
                        stars=c(0.05,0.01,0.001))
...
texreg::htmlreg(list(Term_Cons_13B,Term_Comp_13C),file="Output//Term_Model.html",single.row = TRUE,
                custom.model.name=c("Consolidation",
                                    "Competition"#,
                                    #"Both"
                                    ),
