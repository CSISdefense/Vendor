...
stargazer::stargazer(Comp_Cons_15C,Comp_Cons_15C_1m,
                     Comp_Cons_15D,Comp_Cons_15D_1m,type="text",
                       digits=2)
...
texreg::htmlreg(list(Comp_Cons_15C,Comp_Cons_15C_1m),file="Output//Offr_Model_1m.html",
                single.row = TRUE,
                custom.model.name=c("Concentration","Concentration 1m"),
                        stars=c(0.1,0.05,0.01,0.001),
                groups = list("Study Variables" = 2:3,
                              "NAICS Characteristics" =4:7,
                              "Contract Characteristics"=8:20,
...
#                                     "Both",
#                                     "Both 1m"
texreg::htmlreg(list(Term_Cons_13E_1m,Term_Comp_13E2,Term_Cons_Comp_14B_1m),file="Output//Term_Model_1m.html",
                single.row = TRUE,
                custom.model.name=c("Concentration",
                                    "Competition",
                                    "Both"
