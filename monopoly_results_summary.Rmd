...
colnames(NAICS_summary)[colnames(NAICS_summary)=="NAICS3"]<-"NAICS_Code"

NAICS_summary$NAICS_Code<-as.character(NAICS_summary$NAICS_Code)
NAICS_summary<-as.data.frame(NAICS_summary)
# NAICS_summary<-csis360::read_and_join(NAICS_summary,
#                         lookup_file = "Lookup_PrincipalNAICScode.csv",
#                         path="",
...
csis360::read_and_join(NAICS_summary,
                            lookup_file = "Lookup_NAICS_code.csv",
                            path="",
                            dir="Lookup\\",
                            by="NAICS_Code",
...
colnames(NAICS_summary)
NAICS_long<-NAICS_summary[,colnames(NAICS_summary) %in% c( "NAICS_Code",
                                                    "def3_HHI_lag1",
                                                    "def3_obl_lag1",
                                                    "def3_ratio_lag1",
                                                    # "US3_avg_sal_lag1",
                                                    ...
                                                    "principalnaicscodeText",
                                                     "NAICS_shorthand",
                                                    "CY")]
NAICS_long<-melt(NAICS_long, id=c("NAICS_Code","naics_dollar_rank","naics_count_rank","principalnaicscodeText","CY", "NAICS_shorthand"))
