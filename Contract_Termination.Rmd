...
Term_plot_01A<-ggplot(data=Term_smp,
       aes(y=j_Term,x=cb_Comp))+geom_jitter(alpha=0.01,height=0)+scale_y_sqrt()
...
Term_01C_plot<-ggplot(data=Term_smp,
       aes(y=j_Term,x=cn_Offr))+geom_jitter(alpha=0.01,height=0)+scale_y_sqrt()
...
Term_02A_plot<-ggplot(data=Term_smp,
       aes(y=j_Term,x=cl_Ceil))+geom_point(alpha=0.01)+scale_x_sqrt()
...
Term_02C_plot<-ggplot(data=Term_smp,
       aes(y=j_Term,x=cl_Days))+geom_point(alpha=0.01)+scale_x_sqrt()
...
#First a quick frequency plot for terminations by duration and IDV
ggplot(data=subset(Term_smp,!is.na(IDV)),
...
Term_03B_plot<-ggplot(data=Term_smp,
       aes(y=j_Term,x=IDV))+geom_point(alpha=0.01)+scale_x_sqrt()
