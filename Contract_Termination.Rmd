...
discrete_fitted_term_model(Term_smp,"cl_Ceil") +  stat_function(fun = fit_curve, args=list(a=coef(Term_01A)[1],
                                                        b=coef(Term_01A)[2]),
                             color="blue")
...
Term_03A_plot<-ggplot(data=Term_smp,
       aes(y=j_Term,x=Veh))+geom_jitter(alpha=0.01,height=0)+scale_y_sqrt() +
  labs(title="Fitted Linear Model", caption="Source: FPDS, CSIS Analysis")
...
#Competition curves
fitted_term_model(Term_smp,"Veh") + fitted_term_model(Term_smp,"cl_Days") + stat_function(fun = Term_02H_curve, 
                             args=list(Comp=0,Ceil=0),color="blue")+
  stat_function(fun = Term_02H_curve, 
                             args=list(Comp=2,Ceil=0),color="blue")
