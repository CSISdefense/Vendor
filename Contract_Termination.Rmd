...
Term_01D_bar<-ggplot(data=Term_smp,
       aes(x=l_Offer))+geom_bar(stat="count")+facet_wrap(~Term,ncol=1,scales="free_y")
Term_01D_bar
Term_01D_bar+facet_grid(Term~PSR,scales="free_y")
Term_01D_bar+facet_grid(Term~FxCb,scales="free_y")
Term_01D_bar+facet_grid(Term~Veh,scales="free_y")
Term_01D_bar+facet_grid(Term~PSR_What,scales="free_y")+
