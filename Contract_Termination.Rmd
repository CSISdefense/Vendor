...
ggplot(data=Term_smp,
  ...
  labs(title="Initial Cost Ceiling Frequency by Termination",
          caption="Source: FPDS, CSIS Analysis")
...
ggplot(data=subset(Term_smp,!is.na(n_Comp)&!is.na(bin_Ceil_Comp)) %>% 
  ...
  labs(title="Percent Terminated for Contracts Binned by Initial Cost Ceiling and Faceted by Competion",
          caption="Source: FPDS, CSIS Analysis")
...
ggplot(data=Term_smp,
  ...
  labs(title="Initial Maximum Duration by Termination",
          caption="Source: FPDS, CSIS Analysis")
...
ggplot(data=subset(Term_smp,!is.na(bin_Offer)) %>% 
  ...
  labs(title="Percent Terminated for Contracts Binned by Initial Maximum Duration",
          caption="Source: FPDS, CSIS Analysis")
...
ggplot(data=subset(Term_smp,!is.na(l_Ceil)),
  ...
  labs(title="Initial Maximum Duration and Cost Ceiling by Termination",
          caption="Source: FPDS, CSIS Analysis")
...
ggplot(data=subset(Term_smp,!is.na(n_Comp)),
  ...
  labs(title="Initial Maximum Duration and Competition by Termination",
          caption="Source: FPDS, CSIS Analysis")
...
ggplot(data=subset(Term_smp,!is.na(n_Comp)&!is.na(bin_Days_Comp)) %>% 
  ...
  labs(title="Percent Terminated for Contracts Binned by Initial Maximum Duration and Faceted by Competion",
          caption="Source: FPDS, CSIS Analysis")
...
ggplot(data=subset(Term_smp,!is.na(Veh)) %>% 
  ...
  scale_y_continuous(labels =  scales::percent)+
  labs(title="Percent Terminated by Contract Vehcile",
          caption="Source: FPDS, CSIS Analysis")
