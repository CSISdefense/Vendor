...
Term_02A <- glmer (data=Term_smp,
                 b_Term ~ l_Ceil +
               (1 | Who) + (1 | PSR_What) + (1 | StartFY), family=binomial(link="logit"))
display(Term_02A)


Term_02A_s <- glm (data=Term_smp,
...
Term_plot_01A+ stat_function(fun = fit_curve, args=list(a=coef(Term_02A_s)[1],
                                                        b=coef(Term_02A_s)[2]),
                             color="blue")
