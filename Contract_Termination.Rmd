...
discrete_percent_term_plot(DefenseModelAndDetail,"Fee")
...
Term_04E <- glm (data=Term_smp,
                 b_Term ~n_Comp + 
                   ...
                   SIDV:cl_Days+MIDV:cl_Days+OIDV:cl_Days +
                   SIDV:n_Comp+MIDV:n_Comp+OIDV:n_Comp +
                   n_Fixed:n_Incent +n_Fixed:n_NoFee 
                    , family=binomial(link="logit"))
display(Term_04E)
...
#Frequency Plot
freq_discrete_term_plot(Term_smp,"UCA","FxCb")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp,"UCA","FxCb")
