...
ggplot(data=Term_smp,
       aes(x=Term))+geom_histogram(stat="count",bins=20) + 
  scale_y_continuous(labels = scales::comma) +facet_wrap(~Comp,scales="free_y")+
  labs(title="Termination Frequency by Competition",
...
ggplot(data=subset(Term_smp,!is.na(b_Comp)) %>% 
  group_by(b_Comp) %>% 
  summarise (mean_Term = mean(b_Term)),
       aes(y=mean_Term,x=b_Comp))+geom_line(group=1)+
  scale_y_continuous(labels =  scales::percent)+
  labs(title="Percent Terminated by Competition",
          caption="Source: FPDS, CSIS Analysis")
...
Term_plot_01A<-ggplot(data=Term_smp,
       aes(y=j_Term,x=cb_Comp))+geom_jitter(alpha=0.01,height=0)+scale_y_sqrt() + labs(title="Fitted Linear Model", caption="Source: FPDS, CSIS Analysis")

#Add the fitted regression line
Term_plot_01A+ stat_function(fun = fit_curve, args=list(a=coef(Term_01A)[1],
                                                        b=coef(Term_01A)[2]),
                             color="blue")
...
ggplot(data=Term_smp,
       aes(x=Term))+geom_histogram(stat="count",bins=20) +
  scale_y_continuous(labels = scales::comma) +facet_wrap(~n_Comp,scales="free_y")+
  labs(title="Termination Frequency by Competition",
          caption="Source: FPDS, CSIS Analysis")
...
ggplot(data=subset(Term_smp,!is.na(n_Comp)) %>% 
  group_by(n_Comp) %>% 
  summarise (mean_Term = mean(b_Term)),
       aes(y=mean_Term,x=n_Comp))+geom_line(group=1)+
  scale_y_continuous(labels =  scales::percent)+
  labs(title="Percent Terminated by Competition",
          caption="Source: FPDS, CSIS Analysis")
...
#Plot the Fitted
Term_plot_01B<-ggplot(data=Term_smp,
       aes(y=j_Term,x=cn_Comp))+geom_jitter(alpha=0.01,height=0)+scale_y_sqrt() +
  labs(title="Fitted Linear Model",
          caption="Source: FPDS, CSIS Analysis")

#Add the fitted regression line
Term_plot_01B+ stat_function(fun = fit_curve, args=list(a=coef(Term_01B)[1],
                                                        b=coef(Term_01B)[2]),
                             color="blue")
...
ggplot(data=Term_smp,
       aes(x=Term))+geom_histogram(stat="count",bins=20) +
  scale_y_continuous(labels = scales::comma) + facet_wrap(~n_Offr,scales="free_y")+
  labs(title="Termination Frequency by Competition",
          caption="Source: FPDS, CSIS Analysis")


#Percent Terminated Plot 
ggplot(data=subset(Term_smp,!is.na(n_Offr)) %>% 
  group_by(n_Offr) %>% 
  summarise (mean_Term = mean(b_Term)),
       aes(y=mean_Term,x=n_Offr))+geom_line(group=1)+
  scale_y_continuous(labels =  scales::percent)+
  labs(title="Percent Terminated by Competition",
          caption="Source: FPDS, CSIS Analysis")
...
#Plot the 
Term_01C_plot<-ggplot(data=Term_smp,
       aes(y=j_Term,x=cn_Offr))+geom_jitter(alpha=0.01,height=0)+scale_y_sqrt() + labs(title="Fitted Linear Model", caption="Source: FPDS, CSIS Analysis")

#Add the fitted regression line
Term_01C_plot+ stat_function(fun = fit_curve, args=list(a=coef(Term_01C)[1],
                                                        b=coef(Term_01C)[2]),
                             color="blue")
...
ggplot(data=Term_smp,
  ...
  labs(title="Termination Frequency by Number of Offers",
          caption="Source: FPDS, CSIS Analysis")


#Percent Terminated Plot 
Term_smp$bin_Offer<-bin_df(Term_smp,"l_Offer")
ggplot(data=subset(Term_smp,!is.na(bin_Offer)) %>% 
  group_by(bin_Offer) %>% 
  summarise (mean_Term = mean(b_Term),
             mean_l_Offer =mean(l_Offer)),
       aes(y=mean_Term,x=mean_l_Offer))+geom_point()+
  labs(title="Percent Terminated for Contracts Binned by Number of Offers",
          caption="Source: FPDS, CSIS Analysis")
...
#Add the fitted regression line
Term_01D_plot+ stat_function(fun = fit_curve, args=list(a=coef(Term_01D)[1],
                                                        b=coef(Term_01D)[2]),
                             color="blue")
...
#Frequency Plot
ggplot(data=subset(Term_smp,UnmodifiedContractBaseAndAllOptionsValue<100000000),
       aes(x=UnmodifiedContractBaseAndAllOptionsValue))+geom_histogram(bins=1000) + scale_y_continuous(labels = scales::comma) + facet_wrap(~Term,ncol=1,scales="free_y")+
...
#Frequency Plot
ggplot(data=Term_smp,
       aes(x=l_Ceil))+geom_histogram(bins=20) + scale_y_continuous(labels = scales::comma) + facet_wrap(~Term,ncol=1,scales="free_y")+
  labs(title="Frequency by Termination",
          caption="Source: FPDS, CSIS Analysis")
...
ggplot(data=subset(Term_02A_data,!is.na(fitted) & !is.na(b_Term) ) %>% 
  group_by(bin_fitted) %>% 
  summarise (mean_Term = mean(b_Term),
             mean_fitted =mean(fitted)),
...
Term_02A_res<-binned.resids (Term_02A_data$fitted,
...
ggplot(data=subset(Term_02B_data,!is.na(fitted) & !is.na(b_Term) ) %>% 
  group_by(bin_fitted) %>% 
  summarise (mean_Term = mean(b_Term),
             mean_fitted =mean(fitted)),
       aes(y=mean_Term,x=mean_fitted))+geom_point() + labs(title="Binned Fitted Linear Model",           caption="Source: FPDS, CSIS Analysis")
...
Term_02B_res<-binned.resids (Term_02B_data$fitted,
                              Term_02B_data$fitted-Term_02B_data$b_Term, nclass=40)$binned

ggplot(data=Term_02B_res,
       aes(x=xbar,y-ybar))+
  geom_point(aes(y=ybar))+ #Residuals
  geom_line(aes(y=se2),col="grey")+
  geom_line(aes(y=-se2),col="grey")+
...
Term_02B_res<-binned.resids (Term_02B_data$cl_Ceil,
                              Term_02B_data$fitted-Term_02B_data$b_Term, nclass=40)$binned
...
ggplot(data=subset(Term_02C_data,!is.na(fitted) & !is.na(b_Term) ) %>% 
  group_by(bin_fitted) %>% 
  summarise (mean_Term = mean(b_Term),
             mean_fitted =mean(fitted)),
       aes(y=mean_Term,x=mean_fitted))+geom_point() + labs(title="Binned Fitted Linear Model",           caption="Source: FPDS, CSIS Analysis")
...
#Plot the residuals
Term_02C_res<-binned.resids (Term_02C_data$fitted,
                              Term_02C_data$fitted-Term_02C_data$b_Term, nclass=40)$binned

ggplot(data=Term_02C_res,
       aes(x=xbar,y-ybar))+
  geom_point(aes(y=ybar))+ #Residuals
  geom_line(aes(y=se2),col="grey")+
  geom_line(aes(y=-se2),col="grey")+
...
#Frequency Plot
ggplot(data=Term_smp,
       aes(x=l_Days))+geom_histogram(bins=20) + scale_y_continuous(labels = scales::comma) + facet_wrap(~Term,ncol=1,scales="free_y")+
  labs(title="Frequency by Termination",
          caption="Source: FPDS, CSIS Analysis")
...
Term_02C <- glm (data=Term_smp,
                 b_Term ~n_Comp + cl_Ceil + clsqr_Ceil + cl_Days+ n_Comp:cl_Ceil , family=binomial(link="logit"))
display(Term_02C)



Term_02C_plot<-ggplot(data=Term_smp,
       aes(y=j_Term,x=cl_Days))+geom_point(alpha=0.01)+scale_y_sqrt() + 
  labs(title="Fitted Linear Model", caption="Source: FPDS, CSIS Analysis")
...
ggplot(data=subset(Term_02D_data,!is.na(fitted) & !is.na(b_Term) ) %>% 
  group_by(bin_fitted) %>% 
  summarise (mean_Term = mean(b_Term),
             mean_fitted =mean(fitted)),
       aes(y=mean_Term,x=mean_fitted))+geom_point() + labs(title="Binned Fitted Linear Model",           caption="Source: FPDS, CSIS Analysis")
...
#Plot the residuals
Term_02D_res<-binned.resids (Term_02D_data$fitted,
                              Term_02D_data$fitted-Term_02D_data$b_Term, nclass=40)$binned

ggplot(data=Term_02D_res,
       aes(x=xbar,y-ybar))+
  geom_point(aes(y=ybar))+ #Residuals
  geom_line(aes(y=se2),col="grey")+
  geom_line(aes(y=-se2),col="grey")+
...
ggplot(data=subset(Term_02E_data,!is.na(fitted) & !is.na(b_Term) ) %>% 
  group_by(bin_fitted) %>% 
  summarise (mean_Term = mean(b_Term),
             mean_fitted =mean(fitted)),
       aes(y=mean_Term,x=mean_fitted))+geom_point() + labs(title="Binned Fitted Linear Model",           caption="Source: FPDS, CSIS Analysis")
...
#Plot the residuals
Term_02E_res<-binned.resids (Term_02E_data$fitted,
                              Term_02E_data$fitted-Term_02E_data$b_Term, nclass=40)$binned

ggplot(data=Term_02E_res,
       aes(x=xbar,y-ybar))+
  geom_point(aes(y=ybar))+ #Residuals
  geom_line(aes(y=se2),col="grey")+
  geom_line(aes(y=-se2),col="grey")+
...
ggplot(data=Term_smp,
       aes(x=Term))+geom_histogram(stat="count",bins=20) +
  scale_y_continuous(labels = scales::comma) +facet_wrap(~Veh,scales="free_y")+
  labs(title="Termination Frequency by Contract Vehicle",
          caption="Source: FPDS, CSIS Analysis")
...
ggplot(data=subset(Term_smp,!is.na(Veh)) %>% 
  group_by(Veh) %>% 
  summarise (mean_Term = mean(b_Term)),
       aes(y=mean_Term,x=Veh))+geom_line(group=1)+
  scale_y_continuous(labels =  scales::percent)+
  labs(title="Average Termination Rate",
          caption="Source: FPDS, CSIS Analysis")
...
Term_03A_plot<-ggplot(data=Term_smp,
       aes(y=j_Term,x=IDV))+geom_jitter(alpha=0.01,height=0)+scale_y_sqrt() +
  labs(title="Fitted Linear Model", caption="Source: FPDS, CSIS Analysis")
...
ggplot(data=subset(Term_03A_data,!is.na(fitted) & !is.na(b_Term) ) %>% 
  group_by(bin_fitted) %>% 
  summarise (mean_Term = mean(b_Term),
             mean_fitted =mean(fitted)),
       aes(y=mean_Term,x=mean_fitted))+geom_point() + labs(title="Binned Fitted Linear Model",           caption="Source: FPDS, CSIS Analysis")
