...
#Plot residuals versus fitted
residuals_cbre_plot(CBre_Comp_02A)+
  labs(x="Estimated  Pr (Ceiling Breach)")

residuals_cbre_plot(CBre_Comp_02A,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_Comp_02C)

#Plot residuals versus fitted
residuals_cbre_plot(CBre_Comp_02C)+
  labs(x="Estimated  Pr (Ceiling Breach)")

residuals_cbre_plot(CBre_Comp_02C,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
```
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_Comp_02E)


#Plot residuals versus fitted
residuals_cbre_plot(CBre_Comp_02E)+
  labs(x="Estimated  Pr (Ceiling Breach)")
# debug(binned.resids)
# residuals_cbre_plot(CBre_Comp_02E,"cl_Days")+
  # labs(x="Centered Log(Ceiling)")
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_Comp_02G)

#Plot residuals versus fitted
residuals_cbre_plot(CBre_Comp_02G)+
  labs(x="Estimated  Pr (Ceiling Breach)")
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_Comp_03A)

#Plot residuals versus fitted
residuals_cbre_plot(CBre_Comp_03A)+
  labs(x="Estimated  Pr (Ceiling Breach)")
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_Comp_03B)

#Plot residuals versus fittedO
residuals_cbre_plot(CBre_Comp_03B)+
  labs(x="Estimated  Pr (Ceiling Breach)")
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_Comp_03C)

#Plot residuals versus fittedO
residuals_cbre_plot(CBre_Comp_03C)+
  labs(x="Estimated  Pr (Ceiling Breach)")
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_Comp_03D)

#Plot residuals versus fittedO
residuals_cbre_plot(CBre_Comp_03D)+
  labs(x="Estimated  Pr (Ceiling Breach)")
...
CBre_Comp_03E <- glm (data=smp,
                   b_CBre ~n_Comp + 
                     ...
                     SIDV:n_Comp+MIDV:n_Comp+FSSGWAC:n_Comp+BPABOA:n_Comp  + SIDV:cl_Ceil+MIDV:cl_Ceil+FSSGWAC:cl_Ceil+BPABOA:cl_Ceil+
                     SIDV:cl_Ceil+MIDV:cl_Ceil+FSSGWAC:cl_Ceil+BPABOA:cl_Ceil, family=binomial(link="logit"))
display(CBre_Comp_03E)


# Plot the model and Vehicle for SIDV
CBre_Comp_03E_SIDV_curve<-function(x, Comp,Days,SIDV,MIDV,OIDV){invlogit(
  cbind(1,Comp,x,Days,SIDV,MIDV,OIDV,
        Comp*x,Days*x,
        Days*SIDV,Days*MIDV,Days*OIDV,
        Comp*SIDV,Comp*MIDV,Comp*OIDV) %*%  coef(CBre_Comp_03E))}

#Competition curves
fitted_cbre_model(smp,"cl_Ceil") +
  stat_function(fun = CBre_Comp_03E_SIDV_curve,
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_Comp_03E)

#Plot residuals versus fitted
residuals_cbre_plot(CBre_Comp_03E)+
  labs(x="Estimated  Pr (Ceiling Breach)")

residuals_cbre_plot(CBre_Comp_03D,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
...
glmer_examine(CBre_Comp_07A)
  ...
  stargazer::stargazer(Term_Comp_07A,CBre_Comp_07A,type="text",
                       digits=2)
  
  

summary_residual_compare(CBre_Comp_07A,CBre_Comp_07A,Term_Comp_07A,Term_Comp_07A,bins=20)
...
CBre_Comp_07B<- glm(data=smp,
                       ...
                       # n_Comp:cl_Days +
                         ...
                         NAICS2
                       , family=binomial(link="logit"))
display(CBre_Comp_07B)
glmer_examine(CBre_Comp_07B)

  stargazer::stargazer(CBre_Comp_07A,CBre_Comp_07B,Term_Comp_07A,Term_Comp_07B,type="text",
                       digits=2)
  
  

summary_residual_compare(CBre_Comp_07A,CBre_Comp_07B,Term_Comp_07A,Term_Comp_07B,bins=20)
...
CBre_Comp_07C<- glm(data=smp,
                       b_CBre ~n_Comp + 
                        ...
                        n_Comp:cl_Days +
                         ...
                         NAICS2
                       , family=binomial(link="logit"))
display(CBre_Comp_07C)
glmer_examine(CBre_Comp_07C)

  stargazer::stargazer(CBre_Comp_07B,CBre_Comp_07C,Term_Comp_07B,Term_Comp_07C,type="text",
                       digits=2)
  
  

summary_residual_compare(CBre_Comp_07B,CBre_Comp_07C,Term_Comp_07B,Term_Comp_07C,bins=20)
...
Term_Comp_07D <- glm(data=smp,
                       b_Term ~n_Comp + 
                         ...
                         NAICS2
                       , family=binomial(link="logit"))
display(Term_Comp_07D)
glmer_examine(Term_Comp_07D)
  
CBre_Comp_07D<- glm(data=smp,
                       b_CBre ~n_Comp + 
                         cl_Ceil + cl_Days+
                         Veh+
                          n_Comp:cl_Ceil  +# cl_Ceil:cl_Days  +
                         ...
                         NAICS2
                       , family=binomial(link="logit"))
display(CBre_Comp_07D)
glmer_examine(CBre_Comp_07D)

  stargazer::stargazer(CBre_Comp_07B,CBre_Comp_07D,Term_Comp_07B,Term_Comp_07D,type="text",
                       digits=2)
  
  

summary_residual_compare(CBre_Comp_07B,CBre_Comp_07D,Term_Comp_07B,Term_Comp_07D,bins=20)
...
Term_Comp_07E <- glm(data=smp,
                       b_Term ~n_Comp + 
                         ...
                         NAICS2
                       , family=binomial(link="logit"))
display(Term_Comp_07E)
glmer_examine(Term_Comp_07E)
  
CBre_Comp_07E<- glm(data=smp,
                       b_CBre ~n_Comp + 
                         cl_Ceil + cl_Days+
                         Veh+
                         # cl_Ceil:cl_Days  +
                         ...
                         NAICS2
                       , family=binomial(link="logit"))
display(CBre_Comp_07E)
glmer_examine(CBre_Comp_07E)

  stargazer::stargazer(CBre_Comp_07B,CBre_Comp_07E,Term_Comp_07B,Term_Comp_07E,type="text",
                       digits=2)
  
  

summary_residual_compare(CBre_Comp_07B,CBre_Comp_07E,Term_Comp_07B,Term_Comp_07E,bins=20)
