...
glmer_examine(CBre_Comp_10F)
  ...
  stargazer::stargazer(CBre_Cons_10E,CBre_Cons_10F,CBre_Comp_10E,CBre_Comp_10F,type="text",
                       digits=2)
...
###Model 15A: Agency/Office+NAICS6/NAICS3 trimmed
```{r Model15A}
load("Output//CBre_Cons_15A.rdata")
...
if (isLMM(CBre_Cons_13C)) {
  pars <- getME(CBre_Cons_13C,"theta")
} else {
  ## GLMM: requires both random and fixed parameters
  pars <- getME(CBre_Cons_13C, c("theta","fixef"))
}
if (require("numDeriv")) {
...
if (isLMM(CBre_Comp_13C)) {
  pars <- getME(CBre_Comp_13C,"theta")
} else {
  ## GLMM: requires both random and fixed parameters
  pars <- getME(CBre_Comp_13C, c("theta","fixef"))
}
if (require("numDeriv")) {
...
save(CBre_Cons_Comp_15A,"Output//CBre_Cons_Comp_15A.rdata")
