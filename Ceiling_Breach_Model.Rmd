...
### Model 09A: NAICS3/NAICS6 Combination
```{r Model07B}
...
CBre_Cons_13B@devcomp$cmp[[8]]
CBre_Cons_13B@devcomp$cmp
...
###Model 14B: Agency/Office+NAICS6/NAICS3 trimmed
```{r Model14B}
load("Output//CBre_Cons_14B.rdata")
...
save(CBre_Cons_Comp_14B,"Output//CBre_Cons_Comp_14B.rdata")
  ...
  stargazer::stargazer(CBre_Cons_14A,CBre_Cons_14B,CBre_Comp_14A.restart,CBre_Comp_14B,type="text",
                       digits=2)
  
  

summary_residual_compare(CBre_Cons_14A,CBre_Cons_14B,CBre_Comp_14A.restart,CBre_Comp_14B,bins=20)
