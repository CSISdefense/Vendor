...
#Plot residuals versus fitted
  stargazer::stargazer(CBre_Cons_NCS6A,CBre_Cons_NCS6B,CBre_Cons_NCS6C,type="text",
                       digits=2)
...
CBre_Cons_NCS6C <- glm (data=smp,
                 b_CBre ~cl_def6_HHI_lag1+cl_def6_obl_lag1, family=binomial(link="logit"))
...
#### Model NCS6D: Interaction of HHI and size
...
CBre_Cons_NCS6D <- glm (data=smp,
                 b_CBre ~cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1, family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(CBre_Cons_NCS6B,CBre_Cons_NCS6C,CBre_Cons_NCS6D,type="text",
                       digits=2)
...
#Plot residuals versus fitted
  stargazer::stargazer(CBre_Cons_NCS6B,CBre_Cons_NCS6C,CBre_Cons_NCS6D,CBre_Cons_NCS5A,type="text",
                       digits=2)
...
#Model
CBre_Cons_NCSB <- glm (data=smp,
                 b_CBre ~cl_def5_HHI_lag1+cl_def5_obl_lag1, family=binomial(link="logit"))
display(CBre_Cons_NCSB)
...
stargazer::stargazer(CBre_Cons_NCS6B,CBre_Cons_NCS6C,CBre_Cons_NCS6D,
                       CBre_Cons_NCS5A,CBre_Cons_NCSB,type="text",
                       digits=2)



  #Compare to prior at same level
summary_residual_compare(CBre_Cons_NCS5A,CBre_Cons_NCSB,bins=20)
#Compare to prior at lower level
summary_residual_compare(CBre_Cons_NCS6C,CBre_Cons_NCSB,bins=20)
```
Size seems to ad less to the model at level 5 than level 6.

#### Model NCS5C: Interaction of HHI and size
Whether consolidation has positive or negative effets, these should be stronger for larger sectors, as size tends to dilute HHI. The interaction should estimate a significant change in the likelihood of breaches. While the hypothesis allows for both efficiencies and the downsides of monopoly to arrive from consolidation, the study team expects that the interaction with sector size will positively estimate ceiling breaches, as the efficiency may apply just as well in small sectors.
```{r ModelNCS5C_CBre}
#Frequency Plot for unlogged ceiling
...
CBre_Cons_NCS5C <- glm (data=smp,
                 b_CBre ~cl_def5_HHI_lag1+cl_def5_obl_lag1+cl_def5_HHI_lag1:cl_def5_obl_lag1, family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(CBre_Cons_NCS6B,CBre_Cons_NCS6C,CBre_Cons_NCS6D,
                       CBre_Cons_NCS5A,CBre_Cons_NCSB,CBre_Cons_NCS5C,type="text",
                       digits=2)

  #Compare to prior at same level
summary_residual_compare(CBre_Cons_NCSB,CBre_Cons_NCS5C,bins=20)
#Compare to prior at lower level
summary_residual_compare(CBre_Cons_NCS6D,CBre_Cons_NCS5C,bins=20)
...
#Plot residuals versus fitted
  stargazer::stargazer(CBre_Cons_NCS6B,CBre_Cons_NCS6C,CBre_Cons_NCS6D,CBre_Cons_NCS4A,type="text",
                       digits=2)
...
CBre_Cons_NCS4B <- glm (data=smp,
                 b_CBre ~cl_def4_HHI_lag1+cl_def4_obl_lag1, family=binomial(link="logit"))
...
#Plot residuals versus fitted
stargazer::stargazer(CBre_Cons_NCS6B,CBre_Cons_NCS6C,CBre_Cons_NCS6D,
                       CBre_Cons_NCS4A,CBre_Cons_NCS4B,type="text",
                       digits=2)
...
#Compare to prior at lower level
summary_residual_compare(CBre_Cons_NCS6C,CBre_Cons_NCS4B,bins=20)
```
Size seems to add less to the model at level 4 than level 6.

#### Model NCS4C: Interaction of HHI and size
Whether consolidation has positive or negative effets, these should be stronger for larger sectors, as size tends to dilute HHI. The interaction should estimate a significant change in the likelihood of breaches. While the hypothesis allows for both efficiencies and the downsides of monopoly to arrive from consolidation, the study team expects that the interaction with sector size will positively estimate ceiling breaches, as the efficiency may apply just as well in small sectors.
```{r ModelNCS4C_CBre}
#Frequency Plot for unlogged ceiling
...
CBre_Cons_NCS4C <- glm (data=smp,
                 b_CBre ~cl_def4_HHI_lag1+cl_def4_obl_lag1+cl_def4_HHI_lag1:cl_def4_obl_lag1, family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(CBre_Cons_NCS6B,CBre_Cons_NCS6C,CBre_Cons_NCS6D,
                       CBre_Cons_NCS4A,CBre_Cons_NCS4B,CBre_Cons_NCS4C,type="text",
                       digits=2)

  #Compare to prior at same level
summary_residual_compare(CBre_Cons_NCS4B,CBre_Cons_NCS4C,bins=20)
#Compare to prior at lower level
summary_residual_compare(CBre_Cons_NCS6D,CBre_Cons_NCS4C,bins=20)
...
#Plot residuals versus fitted
  stargazer::stargazer(CBre_Cons_NCS6B,CBre_Cons_NCS6C,CBre_Cons_NCS6D,CBre_Cons_NCS3A,type="text",
                       digits=2)
...
CBre_Cons_NCS3B <- glm (data=smp,
                 b_CBre ~cl_def3_HHI_lag1+cl_def3_obl_lag1, family=binomial(link="logit"))
...
#Plot residuals versus fitted
stargazer::stargazer(CBre_Cons_NCS6B,CBre_Cons_NCS6C,CBre_Cons_NCS6D,
                       CBre_Cons_NCS3A,CBre_Cons_NCS3B,type="text",
                       digits=2)
...
#Compare to prior at lower level
summary_residual_compare(CBre_Cons_NCS6C,CBre_Cons_NCS3B,bins=20)
```
Size seems to add less to the model at level 3 than level 6.

#### Model NCS3C: Interaction of HHI and size
Whether consolidation has positive or negative effets, these should be stronger for larger sectors, as size tends to dilute HHI. The interaction should estimate a significant change in the likelihood of breaches. While the hypothesis allows for both efficiencies and the downsides of monopoly to arrive from consolidation, the study team expects that the interaction with sector size will positively estimate ceiling breaches, as the efficiency may apply just as well in small sectors.
```{r ModelNCS3C_CBre}
#Frequency Plot for unlogged ceiling
...
CBre_Cons_NCS3C <- glm (data=smp,
                 b_CBre ~cl_def3_HHI_lag1+cl_def3_obl_lag1+cl_def3_HHI_lag1:cl_def3_obl_lag1, family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(CBre_Cons_NCS6B,CBre_Cons_NCS6C,CBre_Cons_NCS6D,
                       CBre_Cons_NCS3A,CBre_Cons_NCS3B,CBre_Cons_NCS3C,type="text",
                       digits=2)

  #Compare to prior at same level
summary_residual_compare(CBre_Cons_NCS3B,CBre_Cons_NCS3C,bins=20)
#Compare to prior at lower level
summary_residual_compare(CBre_Cons_NCS6D,CBre_Cons_NCS3C,bins=20)
...
#### Model NCS3D: NAICS 6 and NAICS 3
Consolidation at lessa nd more granular levels may have differnt effects. The magnitude of NAICS 3 should be greater than that of NAICS6, 
```{r ModelNCS3C_CBre}
#Frequency Plot for unlogged ceiling
...
#Plot residuals versus fitted
  stargazer::stargazer(CBre_Cons_NCS6B,CBre_Cons_NCS6C,CBre_Cons_NCS6D,CBre_Cons_NCS2A,type="text",
                       digits=2)
...
CBre_Cons_NCS2B <- glm (data=smp,
                 b_CBre ~cl_def2_HHI_lag1+cl_def2_obl_lag1, family=binomial(link="logit"))
...
#Plot residuals versus fitted
stargazer::stargazer(CBre_Cons_NCS6B,CBre_Cons_NCS6C,CBre_Cons_NCS6D,
                       CBre_Cons_NCS2A,CBre_Cons_NCS2B,type="text",
                       digits=2)
...
#Compare to prior at lower level
summary_residual_compare(CBre_Cons_NCS6C,CBre_Cons_NCS2B,bins=10)
summary_residual_compare(CBre_Cons_NCS3B,CBre_Cons_NCS2B,bins=10)
```
Size seems to add less to the model at level 2 than level 6.

#### Model NCS2C: Interaction of HHI and size
Whether consolidation has positive or negative effets, these should be stronger for larger sectors, as size tends to dilute HHI. The interaction should estimate a significant change in the likelihood of breaches. While the hypothesis allows for both efficiencies and the downsides of monopoly to arrive from consolidation, the study team expects that the interaction with sector size will positively estimate ceiling breaches, as the efficiency may apply just as well in small sectors.
```{r ModelNCS2C_CBre}
#Frequency Plot for unlogged ceiling
...
#Plot residuals versus fitted
  stargazer::stargazer(CBre_Cons_NCS6B,CBre_Cons_NCS6C,CBre_Cons_NCS6D,
                       CBre_Cons_NCS2A,CBre_Cons_NCS2B,CBre_Cons_NCS2C,type="text",
                       digits=2)

  #Compare to prior at same level
summary_residual_compare(CBre_Cons_NCS2B,CBre_Cons_NCS2C,bins=10)
#Compare to prior at lower level
summary_residual_compare(CBre_Cons_NCS6D,CBre_Cons_NCS2C,bins=10)
