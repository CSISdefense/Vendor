...
add_who<-function(contract){
  if(!"AgencyID" %in% colnames(contract))
     colnames(contract)[colnames(contract)=="Agency"]<-"AgencyID"
  csis360::read_and_join(contract,
  ...
  colnames(contract)[colnames(contract)=="SubCustomer"]<-"Who"
...
```{r Model06A}
    #Frequency Plot
    summary_discrete_plot(contract,"Who",rotate_text=TRUE)
    summary_discrete_plot(contract,"b_ODoD",rotate_text=TRUE)
...
### Model 07C No Who, but sector data
```{r Model07C}
...
CBre_Cons_07C2 <- glm (data=smp,
                  ...
                  cl_US6_avg_sal_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1+ 
                       ...
                       # Who:b_Intl+
                        NAICS2
                      , family=binomial(link="logit"))
display(CBre_Cons_07C2)
glmer_examine(CBre_Cons_07C2)

CBre_Comp_07C2 <- glm (data=smp,
                      b_CBre ~n_Comp +
                        cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1+ 
                        cl_Ceil + cl_Days+ 
                        Veh  +
                   ...
                   NAICS2
                      , family=binomial(link="logit"))
display(CBre_Comp_07C2)
glmer_examine(CBre_Comp_07C2)



CBre_Cons_07C3 <- glm (data=smp,
                      b_CBre ~cl_def6_HHI_lag1 +cl_def6_ratio_lag1+cl_def6_obl_lag1+
                  cl_US6_avg_sal_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1+ 
                        cl_Ceil + cl_Days+ 
                        Veh +
                       ...
                       # Who:b_Intl+
                        NAICS2
                      , family=binomial(link="logit"))
display(CBre_Cons_07C3)
glmer_examine(CBre_Cons_07C3)

CBre_Comp_07C3 <- glm (data=smp,
                      b_CBre ~n_Comp +
                        cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1+ 
                        cl_Ceil + cl_Days+ 
                        Veh  +
                   ...
                   NAICS2
                      , family=binomial(link="logit"))
display(CBre_Comp_07C3)
glmer_examine(CBre_Comp_07C3)
  stargazer::stargazer(CBre_Cons_07B2,CBre_Cons_07C2,CBre_Cons_07C3,CBre_Comp_07B2,CBre_Comp_07C2,CBre_Comp_07C3,type="text",
                       digits=2)
  
summary_residual_compare(CBre_Cons_07B2,CBre_Cons_07C2,CBre_Comp_07B2,CBre_Comp_07C2,bins=20)
summary_residual_compare(CBre_Cons_07B2,CBre_Cons_07C3,CBre_Comp_07B2,CBre_Comp_07C3,bins=20)


```
### Model 07D: NAICS3/NAICS6
```{r Model07D}
...
CBre_Cons_07D <- glm (data=smp,
                      b_CBre ~cl_def6_HHI_lag1 ++cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                  #cl_US3_avg_sal_lag1+
                   cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                  cl_US6_avg_sal_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1  + 
                        cl_Ceil + cl_Days+ 
                       ...
                       # Who:b_Intl+
                        NAICS2
                      , family=binomial(link="logit"))
display(CBre_Cons_07D)
glmer_examine(CBre_Cons_07D)
...
CBre_Cons_07D2 <- glm (data=smp,
                  ...
                  cl_US6_avg_sal_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1  + 
                       ...
                       # Who:b_Intl+
                        NAICS2
                      , family=binomial(link="logit"))
display(CBre_Cons_07D2)
glmer_examine(CBre_Cons_07D2)

CBre_Comp_07D2 <- glm (data=smp,
                      b_CBre ~n_Comp+cl_def3_ratio_lag1+#cl_US3_avg_sal_lag1+#cl_def3_obl_lag1+
                   n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1+
                        cl_Ceil + cl_Days+ 
                        Veh  +
                   ...
                   NAICS2
                      , family=binomial(link="logit"))
display(CBre_Comp_07D2)
glmer_examine(CBre_Comp_07D2)

  
summary_residual_compare(CBre_Cons_07B2,CBre_Cons_07D2,CBre_Comp_07B2,CBre_Comp_07D2,bins=20)
summary_residual_compare(CBre_Cons_07D2,CBre_Cons_07D3,CBre_Comp_07D2,CBre_Comp_07D3,bins=20)


CBre_Cons_07D3 <- glm (data=smp,
                      b_CBre ~cl_def6_HHI_lag1 ++cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                  #cl_US3_avg_sal_lag1+
                   cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                  cl_US6_avg_sal_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1  + 
                       ...
                       # Who:b_Intl+
                        NAICS2
                      , family=binomial(link="logit"))
display(CBre_Cons_07D3)
glmer_examine(CBre_Cons_07D3)

CBre_Comp_07D3 <- glm (data=smp,
                      b_CBre ~n_Comp+cl_def3_ratio_lag1+#cl_US3_avg_sal_lag1+#cl_def3_obl_lag1+
                   n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1+
                        cl_Ceil + cl_Days+ 
                        Veh  +
                   ...
                   NAICS2
                      , family=binomial(link="logit"))
display(CBre_Comp_07D3)
glmer_examine(CBre_Comp_07D3)
summary_residual_compare(CBre_Cons_07D2,CBre_Cons_07D3,CBre_Comp_07D2,CBre_Comp_07D3,bins=20)
...
CBre_Cons_10A <- glm(data=smp,
                       b_CBre ~cl_def6_HHI_lag1 + 
                         cl_Ceil + cl_Days+
                         Veh+
                         # cl_def6_HHI_lag1:cl_Ceil  + cl_Ceil:cl_Days  +
                       # cl_def6_HHI_lag1:cl_Days +
                         n_Fixed + b_UCA +
                         b_Intl +
                         # Veh:cl_Days +
...
CBre_Cons_11A <- glmer (data=smp,
                  ...
                  cl_US6_avg_sal_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1+ 
                   ...
                   (1 | NAICS) + (1 | Agency/Office)
                      , family=binomial(link="logit"),
                  verbose=1)
display(CBre_Cons_11A)
glmer_examine(CBre_Cons_11A)
get_icc(CBre_Cons_11A)
save(CBre_Cons_11A,file="CBre_Cons_11A.rdata")
...
###Model 11C: Agency/Office+NAICS6/NAICS3
...
display(CBre_Cons_11C)
glmer_examine(CBre_Cons_11C)

CBre_Comp_11C <- glmer (data=smp,
                        b_CBre ~n_Comp+cl_def3_ratio_lag1+#cl_US3_avg_sal_lag1+#cl_def3_obl_lag1+
                   n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1+
                        cl_Ceil + cl_Days+
                        Veh  +
                   ...
                   # NAICS2
                      , family=binomial(link="logit"),
                        verbose=1)
display(CBre_Comp_11C)
glmer_examine(CBre_Comp_11C)

```

###Model 11D: Agency/Office+NAICS6/NAICS3 trimmed
```{r Model11D}

CBre_Cons_11D <- glmer (data=smp,
                 b_CBre ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                  #cl_US3_avg_sal_lag1+
                   cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                  cl_US6_avg_sal_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1+
...
display(CBre_Cons_11D)
glmer_examine(CBre_Cons_11D)

CBre_Comp_11D <- glmer (data=smp,
                        b_CBre ~n_Comp+cl_def3_ratio_lag1+#cl_US3_avg_sal_lag1+#cl_def3_obl_lag1+
                   n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1+
                        cl_Ceil + cl_Days+
                        Veh  +
                   ...
                   # NAICS2
                      , family=binomial(link="logit"),
                        verbose=1)
display(CBre_Comp_11D)
glmer_examine(CBre_Comp_11D)
...
CBre_Cons_11B <- glmer (data=smp,
                  ...
                  cl_US6_avg_sal_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1+ 
                   ...
                   (1 | NAICS) + (1 | Agency/Office)
                      , family=binomial(link="logit"),
                  verbose=1)
display(CBre_Cons_11B)
glmer_examine(CBre_Cons_11B)
get_icc(CBre_Cons_11B)
# save(CBre_Cons_11B,file="CBre_Cons_11B.rdata")
CBre_Comp_11B <- glmer (data=smp,
                   ...
                   (1 | NAICS) + (1 | Agency/Office)
                      , family=binomial(link="logit"),
                  verbose=1)
display(CBre_Comp_11B)
glmer_examine(CBre_Comp_11B)
# failure to converge in 10000 evaluation
summary_residual_compare(CBre_Cons_07B2,CBre_Cons_11B,CBre_Comp_07B2,CBre_Comp_07C3,bins=20)
```
