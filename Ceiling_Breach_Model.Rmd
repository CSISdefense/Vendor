...
display(naics06_term)
summary(naics06_term)
get_icc(naics06_term)

naics06_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS)
                  , family=binomial(link="logit"))
display(naics06_cbre)
summary(naics06_cbre)
...
naics05_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS5)
                  , family=binomial(link="logit"))
display(naics05_term)
summary(naics05_term)
get_icc(naics05_term)

naics05_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS5)
                  , family=binomial(link="logit"))
display(naics05_cbre)
summary(naics05_cbre)
...
naics04_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS4)
                  , family=binomial(link="logit"))
display(naics04_term)
summary(naics04_term)
get_icc(naics04_term)

naics04_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS4)
                  , family=binomial(link="logit"))
display(naics04_cbre)
summary(naics04_cbre)
...
naics03_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS3)
                  , family=binomial(link="logit"))
display(naics03_term)
summary(naics03_term)
get_icc(naics03_term)

naics03_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS3)
                  , family=binomial(link="logit"))
display(naics03_cbre)
summary(naics03_cbre)
...
naics02_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS2)
                  , family=binomial(link="logit"))
display(naics02_term)
summary(naics02_term)
get_icc(naics02_term)

naics02_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS2)
                  , family=binomial(link="logit"))
display(naics02_cbre)
summary(naics02_cbre)
...
naics236_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS2/NAICS3/NAICS)
                  , family=binomial(link="logit"))
display(naics236_term)
summary(naics236_term)
...
naics236_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS2/NAICS3/NAICS)
                  , family=binomial(link="logit"))
display(naics236_cbre)
summary(naics236_cbre)
...
naics26_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS2/NAICS)
                  , family=binomial(link="logit"))
display(naics26_term)
summary(naics26_term)
get_icc(naics26_term)
# get_icc(naics03_term,1)
get_icc(naics26_term)
...
naics26_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS2/NAICS)
                  , family=binomial(link="logit"))
display(naics26_cbre)
summary(naics26_cbre)
...
naics36_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS3/NAICS)
                  , family=binomial(link="logit"))
display(naics36_term)
summary(naics36_term)
get_icc(naics36_term)
get_icc(naics02_term,1)
get_icc(naics36_term,1)
get_icc(naics36_term,2)

sjstats::icc(naics36_term)
sum(get_re_var(naics36_term)) / (sum(get_re_var(naics36_term)) + get_re_var(naics36_term, "sigma_2"))
get_re_var(naics36_term)[2] / sum(get_re_var(naics36_term))
...
# units or level-2-units within level-3-units) must be computed manually. Use get_re_var to get the
...
naics36_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS3/NAICS)
                  , family=binomial(link="logit"))
display(naics36_cbre)
summary(naics36_cbre)
get_icc(naics36_cbre)
get_icc(naics02_cbre)
...
sjstats::icc(naics36_term)
iccbin(which(colnames(smp)=="NAICS"),
       which(colnames(smp)=="b_CBre"),smp)
sum(get_re_var(naics36_term)) / (sum(get_re_var(naics36_term)) + get_re_var(naics36_term, "sigma_2"))
get_re_var(naics36_term)[2] / sum(get_re_var(naics36_term))
...
naics46_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS4/NAICS)
                  , family=binomial(link="logit"))
display(naics46_term)
summary(naics46_term)
get_icc(naics46_term)
get_icc(naics02_term,1)
get_icc(naics46_term,1)
get_icc(naics46_term,2)
...
naics46_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS4/NAICS)
                  , family=binomial(link="logit"))
display(naics46_cbre)
summary(naics46_cbre)
...
StartCY_term <- glmer(data=smp,
                 b_Term ~ (1 | StartCY)
                  , family=binomial(link="logit"))
display(StartCY_term)
summary(StartCY_term)
get_icc(StartCY_term)

StartCY_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | StartCY)
                  , family=binomial(link="logit"))
display(StartCY_cbre)
summary(StartCY_cbre)
...
SignedMonth_term <- glmer(data=smp,
                 b_Term ~ (1 | StartCY:SignedMonth)
                  , family=binomial(link="logit"))
display(SignedMonth_term)
summary(SignedMonth_term)
get_icc(SignedMonth_term)

SignedMonth_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | StartCY:SignedMonth)
                  , family=binomial(link="logit"))
display(SignedMonth_cbre)
summary(SignedMonth_cbre)
...
NestedMonth_term <- glmer(data=smp,
                 b_Term ~ (1 | StartCY/SignedMonth)
                  , family=binomial(link="logit"))
display(NestedMonth_term)
summary(NestedMonth_term)
get_icc(NestedMonth_term)

NestedMonth_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | StartCY/SignedMonth)
                  , family=binomial(link="logit"))
display(NestedMonth_cbre)
summary(NestedMonth_cbre)
...
### Calendar Year and NAICS
```{r NAICS_StartCY}

NAICS_StartCY_term <- glmer(data=smp,
                 b_Term ~  (1 | NAICS3/NAICS) + (1 | StartCY)
                  , family=binomial(link="logit"))
display(NAICS_StartCY_term)
summary(NAICS_StartCY_term)
...
save(StartCY_cbre,StartCY_term,StartCY_comp,
     ...
     file="Output//date_empty_models.rdata")

load(file="Output//date_empty_models.rdata")
