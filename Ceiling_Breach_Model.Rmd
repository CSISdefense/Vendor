...
def$c_office_l_Ceil_mean<-(def$l_Ceil-def$office_l_Ceil_mean)/def$office_l_Ceil_sd
summary_continuous_plot(smp,"c_office_l_Ceil_mean")
...
def$c_office_l_Days_mean<-(def$l_Days-def$office_l_Days_mean)/def$office_l_Days_sd
summary_continuous_plot(smp,"c_office_l_Days_mean")
...
CBre_Cons_08B <- glm (data=smp,
                      b_CBre ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                        ...
                        cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                        cl_US6_avg_sal_lag1+     
                        c_office_l_Ceil_mean + c_office_l_Days_mean+ 
                        Veh +
                        PricingFee + b_UCA +
                        b_Intl+
...
summary_residual_compare(CBre_Cons_10D,CBre_Cons_10H,bins=20)
...
summary_residual_compare(CBre_Cons_10D,CBre_Cons_10I,bins=20)
...
```{r Model13B}
load("Output//CBre_Cons_11D.rdata")
...
if (isLMM(CBre_Cons_13B)) {
  pars <- getME(CBre_Cons_13B,"theta")
} else {
  ## GLMM: requires both random and fixed parameters
  pars <- getME(CBre_Cons_13B, c("theta","fixef"))
}
if (require("numDeriv")) {
...
if (isLMM(CBre_Comp_13B)) {
  pars <- getME(CBre_Comp_13B,"theta")
} else {
  ## GLMM: requires both random and fixed parameters
  pars <- getME(CBre_Comp_13B, c("theta","fixef"))
}
if (require("numDeriv")) {
...
glmer_examine(CBre_Cons_13C,display=TRUE)

save(CBre_Cons_13C,file="Output//CBre_Cons_13C.rdata")
...
stargazer::stargazer(CBre_Cons_13C,
                     type="text",
                       digits=2)
...
save(CBre_Cons_13C,CBre_Comp_13C,file="Output//CBre_Cons_13C.rdata")
```


###Model 13D: Agency/Office+NAICS6/NAICS3 trimmed
```{r Model13D}
load("Output//CBre_Cons_11D.rdata")
glmer_examine(CBre_Cons_11D)
...
save(CBre_Cons_13D,file="Output//CBre_Cons_13D.rdata")
...
glmer_examine(CBre_Comp_13D)
  ...
  stargazer::stargazer(CBre_Cons_14A,CBre_Cons_13D,CBre_Comp_14A.restart,CBre_Comp_13D,type="text",
                       digits=2)
  
  

summary_residual_compare(CBre_Cons_14A,CBre_Cons_13D,CBre_Comp_14A.restart,CBre_Comp_13D,bins=20)
...
if (isLMM(CBre_Cons_13D)) {
  pars <- getME(CBre_Cons_13D,"theta")
} else {
  ## GLMM: requires both random and fixed parameters
  pars <- getME(CBre_Cons_13D, c("theta","fixef"))
}
if (require("numDeriv")) {
...
if (isLMM(CBre_Comp_13D)) {
  pars <- getME(CBre_Comp_13D,"theta")
} else {
  ## GLMM: requires both random and fixed parameters
  pars <- getME(CBre_Comp_13D, c("theta","fixef"))
}
if (require("numDeriv")) {
...
stargazer::stargazer(CBre_Cons_14A,CBre_Cons_13D,CBre_Cons_13D.restart,CBre_Comp_14A.restart,CBre_Comp_13D,type="text",
                       digits=2)
  ...
  save(CBre_Cons_13D,CBre_Comp_13D,CBre_Cons_13D.restart,
       file="Output//CBre_Cons_13D.rdata")
load("Output//CBre_Comp_13D.rdata")

  summary_residual_compare(CBre_Cons_13D,CBre_Cons_13D.restart,CBre_Comp_14A.restart,CBre_Comp_13D,bins=20)
