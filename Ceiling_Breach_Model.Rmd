...
summary_residual_compare(CBre_Cons_07C,CBre_Cons_07C,CBre_Comp_07C,CBre_Comp_07C,bins=20)
...
###Model 11A: Too many Interactions
...
###Model 12A: Agency/Office+NAICS6/NAICS3
...
###Model 12B: Agency/Office+NAICS6/NAICS3 trimmed
```{r Model12B}
...
# Plot the model and Vehicle 
# CBre_Comp_13A_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed,UCA){invlogit(
#   cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
#         Comp*Ceil,Days*Ceil,Days*Comp,
#         Fixed,UCA,x,
#         Days*x,Days*MIDV,Days*OIDV,
#         UCA*Comp) %*%  coef(CBre_Comp_13A))}
# 
# #Days curves
# fitted_cbre_model(smp,"SIDV") +
#   stat_function(fun = CBre_Comp_13A_curve,
#                              args=list(Comp=0,Ceil=0,Days=0,
#                                        MIDV=0,SIDV=0,FSSGWAC=0,BPABOA=0,
#                                        Fixed=1,UCA=0),color="blue")+
#   stat_function(fun = CBre_Comp_13A_curve,
