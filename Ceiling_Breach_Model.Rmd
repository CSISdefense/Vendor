...
display(naics23456_term)
summary(naics23456_term)
get_icc(naics23456_term)

naics236_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS2/NAICS3/NAICS)
                  , family=binomial(link="logit"))
display(naics23456_cbre)
summary(naics23456_cbre)
get_icc(naics23456_cbre)
get_icc(naics02_cbre)
...
levels(smp$NAICS3)
save(naics06_cbre,naics06_term,
     #naics236_cbre,naics236_term,
     naics26_cbre,naics26_term,
     naics36_cbre,naics36_term,
     file="output//empty_models.rdata")
```

### NAICS summary
```{r NAICS_empty_summary}
load("Output//empty_models.rdata")
