...
### NAICS level 6
```{r NAICSlevel6}
solo_naics06_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS)
                  , family=binomial(link="logit"))
display(solo_naics06_term)
summary(solo_naics06_term)
get_icc(solo_naics06_term)

solo_naics06_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS)
                  , family=binomial(link="logit"))
display(solo_naics06_cbre)
summary(solo_naics06_cbre)
get_icc(solo_naics06_cbre)
...
### NAICS level 5
```{r NAICSlevel5}
solo_naics05_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS5)
                  , family=binomial(link="logit"))
display(solo_naics05_term)
summary(solo_naics05_term)
get_icc(solo_naics05_term)

solo_naics05_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS5)
                  , family=binomial(link="logit"))
display(solo_naics05_cbre)
summary(solo_naics05_cbre)
get_icc(solo_naics05_cbre)
...
### NAICS level 4
```{r NAICSlevel4}
solo_naics04_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS4)
                  , family=binomial(link="logit"))
display(solo_naics04_term)
summary(solo_naics04_term)
get_icc(solo_naics04_term)

solo_naics04_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS4)
                  , family=binomial(link="logit"))
display(solo_naics04_cbre)
summary(solo_naics04_cbre)
get_icc(solo_naics04_cbre)
...
### NAICS level 3
```{r NAICSlevel3}
solo_naics03_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS3)
                  , family=binomial(link="logit"))
display(solo_naics03_term)
summary(solo_naics03_term)
get_icc(solo_naics03_term)

solo_naics03_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS3)
                  , family=binomial(link="logit"))
display(solo_naics03_cbre)
summary(solo_naics03_cbre)
get_icc(solo_naics03_cbre)


```
### NAICS level 2
```{r NAICSlevel2}
solo_naics02_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS2)
                  , family=binomial(link="logit"))
display(solo_naics02_term)
summary(solo_naics02_term)
get_icc(solo_naics02_term)

solo_naics02_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS2)
                  , family=binomial(link="logit"))
display(solo_naics02_cbre)
summary(solo_naics02_cbre)
get_icc(solo_naics02_cbre)
...
# solo_naics23456_term <- glmer(data=smp,
...
# solo_naics2346_term <- glmer(data=smp,
...
solo_naics236_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS2/NAICS3/NAICS)
                  , family=binomial(link="logit"))
display(solo_naics236_term)
summary(solo_naics236_term)
get_icc(solo_naics236_term)
#Fails even when everything is a factor Error: couldn't evaluate grouping factor NAICS:(NAICS4:(NAICS3:NAICS2)) within model frame: try adding grouping factor to data frame explicitly if possible



display(solo_naics23456_term)
summary(solo_naics23456_term)
get_icc(solo_naics23456_term)

solo_naics236_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS2/NAICS3/NAICS)
                  , family=binomial(link="logit"))
display(solo_naics23456_cbre)
summary(solo_naics23456_cbre)
get_icc(solo_naics23456_cbre)
get_icc(solo_naics02_cbre)

levels(smp$NAICS2)
levels(smp$NAICS)
smp$NAICS5<-factor(smp$NAICS5)
...
smp$NAICS<-factor(smp$NAICS)
smp$NAICS2<-factor(smp$NAICS2)
solo_naics26_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS2/NAICS)
                  , family=binomial(link="logit"))
display(solo_naics26_term)
summary(solo_naics26_term)
get_icc(solo_naics26_term)
get_icc(solo_naics03_term,1)
get_icc(solo_naics26_term,1)
get_icc(solo_naics26_term,2)


solo_naics26_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS2/NAICS)
                  , family=binomial(link="logit"))
display(solo_naics26_cbre)
summary(solo_naics26_cbre)
get_icc(solo_naics26_cbre)
get_icc(solo_naics03_cbre)
...
smp$NAICS<-factor(smp$NAICS)
smp$NAICS2<-factor(smp$NAICS2)
solo_naics36_term <- glmer(data=smp,
                 b_Term ~ (1 | NAICS3/NAICS)
                  , family=binomial(link="logit"))
display(solo_naics36_term)
summary(solo_naics36_term)
get_icc(solo_naics36_term)
get_icc(solo_naics02_term,1)
get_icc(solo_naics36_term,1)
get_icc(solo_naics36_term,2)


solo_naics36_cbre <- glmer(data=smp,
                 b_CBre ~ (1 | NAICS2/NAICS)
                  , family=binomial(link="logit"))
display(solo_naics36_cbre)
summary(solo_naics36_cbre)
get_icc(solo_naics36_cbre)
get_icc(solo_naics02_cbre)
...
smp$capped_def6_ratio_lag1<-cap(smp$def6_ratio_lag1,1)
smp$l_def6_ratio_lag1<-log(smp$def6_ratio_lag1)
smp$cl_def6_ratio_lag1<-scale(smp$def6_ratio_lag1)
summary_continuous_plot(smp,"capped_def6_ratio_lag1")
summary_continuous_plot(smp,"l_def6_ratio_lag1")
smp$capped_def5_ratio_lag1<-cap(smp$def5_ratio_lag1,1)
smp$l_def5_ratio_lag1<-log(smp$def5_ratio_lag1)
smp$cl_def5_ratio_lag1<-scale(smp$def5_ratio_lag1)
summary_continuous_plot(smp,"capped_def5_ratio_lag1")
summary_continuous_plot(smp,"l_def5_ratio_lag1")
smp$capped_def4_ratio_lag1<-cap(smp$def4_ratio_lag1,1)
smp$l_def4_ratio_lag1<-log(smp$def4_ratio_lag1)
smp$cl_def4_ratio_lag1<-scale(smp$def4_ratio_lag1)
summary_continuous_plot(smp,"capped_def4_ratio_lag1")
summary_continuous_plot(smp,"l_def4_ratio_lag1")
smp$capped_def3_ratio_lag1<-cap(smp$def3_ratio_lag1,1)
smp$l_def3_ratio_lag1<-log(smp$def3_ratio_lag1)
smp$cl_def3_ratio_lag1<-scale(smp$def3_ratio_lag1)
summary_continuous_plot(smp,"capped_def3_ratio_lag1")
summary_continuous_plot(smp,"l_def3_ratio_lag1")
smp$capped_def2_ratio_lag1<-cap(smp$def2_ratio_lag1,1)
smp$l_def2_ratio_lag1<-log(smp$def2_ratio_lag1)
smp$cl_def2_ratio_lag1<-scale(smp$def2_ratio_lag1)
...
smp$l_US6_avg_sal_lag1<-log(smp$US6_avg_sal_lag1)
smp$cl_US6_avg_sal_lag1<-scale(smp$l_US6_avg_sal_lag1)
...
#Plot residuals versus fitted
 stargazer::stargazer(CBre_Cons_NCS6C,CBre_Cons_NCS6E,CBre_Cons_NCS6F,CBre_Cons_NCS6G,
...
summary_continuous_plot(smp,"US3_avg_sal_lag1")
smp$l_US3_avg_sal_lag1<-log(smp$US3_avg_sal_lag1)
smp$cl_US3_avg_sal_lag1<-scale(smp$l_US3_avg_sal_lag1)
...
smp$Pricing<-as.character(smp$FxCb)
summary(smp$Fee)
summary(factor(smp$Pricing))
smp$Pricing[smp$Pricing=="Fixed-Price" & smp$Fee=="FFP or No Fee"]<-"FFP"
smp$Pricing[smp$Pricing=="Fixed-Price" & smp$Fee!="FFP or No Fee"]<-"Other FP"
smp$Pricing[smp$Pricing=="Cost-Based" & smp$Fee=="Other Fee"]<-"T&M/LH/FPLOE"
smp$Pricing<-factor(smp$Pricing,c("FFP","Other FP","Combination or Other",
                                  "Cost-Based","T&M/LH/FPLOE"))

summary_discrete_plot(smp,"Pricing")
...
summary(smp$Fee)
summary(factor(smp$Pricing))
smp$PricingFee<-as.character(smp$Pricing)
smp$PricingFee[smp$Fee=="Incentive"]<-"Incentive"
# smp$PricingFee[smp$PricingFee %in% c("Other FP","FFP")] <-"Other FP"
smp$PricingFee[smp$PricingFee %in% c("Cost-Based")] <-"Other CB"
# smp$PricingFee<-factor(smp$PricingFee,c("Other FP","Incentive",
#                                         "Combination or Other",
#                                   "Other CB","T&M/LH/FPLOE"))
smp$PricingFee<-factor(smp$PricingFee,c("FFP","Other FP","Incentive",
                                        "Combination or Other",
                                  "Other CB","T&M/LH/FPLOE"))
...
stargazer::stargazer(CBre_Cons_04C,CBre_Cons_04D,
                     CBre_Comp_04C,CBre_Comp_04D,type="text",
                       digits=2)
summary_residual_compare(CBre_Cons_04C,CBre_Cons_04D,CBre_Comp_04C,CBre_Comp_04D,bins=20)
...
summary_continuous_plot(smp,"cl_HHI_lag1","UCA")
...
Mechanisms like multi-award IDCs and GWAC/FSS use a known pool of contractors but still incorporate competition. They were emphasized in part after earlier scandals 
...
###Model 06B: SubCustomer and International
...
### Model 06D: Other DoD & Competition
...
glmer_examine(CBre_Cons_07A)
  ...
  stargazer::stargazer(CBre_Cons_06D,CBre_Cons_07A,CBre_Comp_06C,CBre_Comp_07A,type="text",
                       digits=2)
  
summary_residual_compare(CBre_Cons_06D,CBre_Cons_07A,CBre_Comp_06C,CBre_Comp_07A,bins=20)


```

### Model 07B: NAICS and Who
```{r Model07B}
corrdisp<-Hmisc::rcorr(
  as.matrix(cbind(subset(crisis_smp, select=c(b_UCA,c_OffCri,cl_Ceil,
                                              cl_Days,n_Fixed,b_Intl)),
...
summary_residual_compare(CBre_Comp_07A,CBre_Comp_10A,CBre_Cons_07A,CBre_Cons_10A,bins=20)
