...
stargazer::stargazer(CBre_Cons_04L,
                     CBre_Comp_04L,type="text",
                       digits=2)
summary_residual_compare(CBre_Cons_04L,CBre_Cons_04L,CBre_Comp_04L,CBre_Comp_04L,bins=20)
...
###Model 11A: Agency/Office+NAICS6
...
CBre_Cons_11A <- glmer (data=smp,
                      ...
                      , family=binomial(link="logit"),
                      verbose=1)
display(CBre_Cons_11)
glmer_examine(CBre_Cons_11)
...
CBre_Comp_11A <- glmer (data=smp,
                   ...
                   # NAICS2
                      , family=binomial(link="logit"),
                   verbose=1)
display(CBre_Comp_11)
glmer_examine(CBre_Comp_11)
