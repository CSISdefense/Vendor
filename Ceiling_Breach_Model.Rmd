...
Firm fixed price contracts have the least flexibility, and thus may estimate a higher probability of ceilign breach. By comparison, time and materials contracts, labor hours, and fixed-price level of effort contracts are comparatively straightforward  but also lack fees meant to incentive cost savings. Thus they may estimate a higher probability of ceilnig breach than narrowly defined cost plus contracts.
```{r Model04B}
...
###Model 04D: Fixed-Price and Maximum Duration Intersection 
...
#Frequency Plot
summary_continuous_plot(smp,"l_Days","Pricing")
...
CBre_Cons_04D <- glm (data=smp,
                 ...
                 Veh:cl_Days+
                   Veh:cl_Ceil+
                Pricing+
                   cl_Days:Pricing, family=binomial(link="logit"))
...
# Plot the model and Vehicle 
# CBre_Comp_04D_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV){invlogit(
#   cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
#         Comp*Ceil,Days*Ceil,Days*Comp,
#         x,
#         Days*x,Days*MIDV,Days*OIDV,
#         Comp*x,Comp*MIDV,Comp*OIDV,
#         Days*x) %*%  coef(CBre_Comp_04D))}
...
CBre_Cons_04D2 <- glm (data=smp,
                ...
                Pricing+
                   cl_Days:Pricing, family=binomial(link="logit"))
display(CBre_Cons_04D2)
glmer_examine(CBre_Cons_04D2)

CBre_Comp_04D2 <- glm (data=smp,
                 b_CBre ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   Veh +
                   #cl_HHI_lag1:cl_Ceil  + 
                 # Veh:cl_Days+
                   ...
                   cl_Days:Pricing , 
                 family=binomial(link="logit"))
display(CBre_Comp_04D2)

stargazer::stargazer(CBre_Cons_04C,CBre_Cons_04D2,
                     CBre_Comp_04C,CBre_Comp_04D2,type="text",
                       digits=2)
summary_residual_compare(CBre_Cons_04C,CBre_Cons_04D2,CBre_Comp_04C,CBre_Comp_04D2,bins=20)
...
###Model 04E: Fixed-Price and Vehicle
...
# Plot the model and Vehicle for SIDV
# CBre_Comp_04E_curve<-function(x, Comp,Ceil,Days,MIDV,OIDV){invlogit(
#   cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
#         n_Fixed,
#         Comp*Ceil,Days*Ceil,Days*Comp,
...
# residuals_cbre_plot(CBre_Comp_02F,"cl_days")+
#   labs(x="Centered Log(Days)")
stargazer::stargazer(CBre_Cons_04C,CBre_Cons_04E,
                     CBre_Comp_04C,CBre_Comp_04E,type="text",
                       digits=2)
summary_residual_compare(CBre_Cons_04C,CBre_Cons_04E,CBre_Comp_04C,CBre_Comp_04E,bins=20)
...
###Model 04G: Fixed-Price and Maximum Duration Intersection 
