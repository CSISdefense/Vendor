...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"Comp")

#Percent Terminated Plot
discrete_percent_term_plot(Term_smp25k,"Comp")
...
discrete_fitted_term_model(Term_smp25k,"cb_Comp") + 
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"EffComp")


#Percent Terminated Plot
discrete_percent_term_plot(Term_smp25k,"EffComp")

#Model
Term_01B <- glm (data=Term_smp25k,
                 b_Term ~ cn_Comp, family=binomial(link="logit"))
display(Term_01B)

#Plot the Fitted
#Add the fitted regression line
discrete_fitted_term_model(Term_smp25k,"n_Comp") +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"CompOffr")

#Percent Terminated Plot
discrete_percent_term_plot(Term_smp25k,"CompOffr")

#Model
Term_01C <- glm (data=Term_smp25k,
...
#Frequency Plot
freq_continuous_term_plot(Term_smp25k,"l_Offr")

#Percent Terminated Plot 
binned_percent_term_plot(Term_smp25k,"l_Offr")

#Percent Terminated Plot
binned_percent_term_plot(Term_smp25k,"l_Offr","FxCb")

#Percent Terminated Plot
binned_percent_term_plot(Term_smp25k,"l_Offr","PSR")

#Percent Terminated Plot
binned_percent_term_plot(Term_smp25k,"l_Offr","Veh")


#Model
Term_01D <- glm (data=Term_smp25k,
                 b_Term ~ cl_Offr, family=binomial(link="logit"))
display(Term_01D)

#Variant Model
Term_smp25k$clsqr_Offer<-Term_smp25k$cl_Offr^2
Term_01E <- glm (data=Term_smp25k,
                 b_Term ~ cl_Offr +clsqr_Offer, family=binomial(link="logit"))
display(Term_01E)

#Plot the data and fitted curve
Term_01D_plot<-ggplot(data=Term_smp25k,
...
#Plot the Fitted
#Add the fitted regression line
discrete_fitted_term_model(Term_smp25k,"cl_Offr") +
...
#Frequency Plot
freq_discrete_term_plot(Term_smp25k,"UCA","n_Comp")

#Percent Terminated Plot 
discrete_percent_term_plot(Term_smp25k,"UCA","n_Comp")
...
#Create the model
Term_08B <- glmer(data=Term_smp1m,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Fixed + b_UCA + 
...
# save(Term_08B,file="Term08B.Rdata")
load("Term08B.Rdata")
#Days curves
discrete_fitted_term_model(Term_smp25k,"SIDV") +
...
Term_08C <- glmer(data=Term_smp1m,
                 b_Term ~n_Comp +
                   cl_Ceil + cl_Days+
                   SIDV + MIDV + OIDV +
                   # n_Comp:cl_Ceil  +
                   ...
                   (1 | NAICS)
                    , family=binomial(link="logit"))
display(Term_08C)
save(Term_08C,file="Term08C.Rdata")
