...
#Competition curves
fitted_term_model(smp,"cl_Ceil") + stat_function(fun = Term_02A_curve, 
...
#Competition curves
fitted_term_model(smp,"cl_Ceil") + stat_function(fun = Term_02B_curve, 
                             args=list(Comp=0),color="blue")+
...
#Competition Curves
fitted_term_model(smp,"cl_Ceil") + stat_function(fun = Term_02C_curve, 
                             args=list(Comp=0),color="blue")+
...
#Competition Curves
fitted_term_model(smp,"cl_Days") + stat_function(fun = Term_02D_curve, 
...
#Competition Curves
fitted_term_model(smp,"cl_Days") + stat_function(fun = Term_02E_curve, 
                             args=list(Comp=0,Ceil=0),color="blue")+
...
#Competition curves
fitted_term_model(smp,"cl_Ceil") + stat_function(fun = Term_02F_curve, 
                             args=list(Comp=0),color="blue")+
...
#Competition curves
fitted_term_model(smp,"cl_Ceil") + stat_function(fun = Term_02G_curve, 
                             args=list(Comp=0),color="blue")+
...
#Competition curves
fitted_term_model(smp,"cl_Days") + stat_function(fun = Term_02H_curve, 
                             args=list(Comp=0,Ceil=0),color="blue")+
