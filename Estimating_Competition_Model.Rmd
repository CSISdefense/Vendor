...
NA_stats(def,"b_Term"))
* b_MultiOffr is a binary variable based on competition. It has a value of 0 for uncompeted contracts and a value of 1 for competition, regardless of number of offers. 'r  summary(def$b_MultiOffr);
NA_stats(def,"b_MultiOffr")'
...
levels(smp$EffComp)
smp$b_MultiOffr<-smp$EffComp
levels(smp$b_MultiOffr)<-list("0"=c("No Comp.","1 Offer"),
                           "1"="2+ Offers")
summary(smp$b_MultiOffr)
summary(smp$EffComp)
smp$b_MultiOffr<-as.numeric(as.character(smp$b_MultiOffr))

levels(smp1m$EffComp)
smp1m$b_MultiOffr<-smp1m$EffComp
levels(smp1m$b_MultiOffr)<-list("0"=c("No Comp.","1 Offer"),
                           "1"="2+ Offers")
summary(smp1m$b_MultiOffr)
summary(smp1m$EffComp)
smp1m$b_MultiOffr<-as.numeric(as.character(smp1m$b_MultiOffr))
...
summary_continuous_plot(output="comp",smp,"def6_HHI_lag1")
summary_continuous_plot(output="comp",smp,"def5_HHI_lag1")
summary_continuous_plot(output="comp",smp,"def4_HHI_lag1")
summary_continuous_plot(output="comp",smp,"def3_HHI_lag1")
summary_continuous_plot(output="comp",smp,"def2_HHI_lag1")

#Model
Comp_Cons_NCS6A <- glm (data=smp,
                 cl_Offr ~c_def6_HHI_lag1, family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS6A,suppress_vif=TRUE)
...
summary_residual_compare(Comp_Cons_NCS6A,Comp_Cons_NCS6A,bins=20)
...
```{r ModelNCS6A_Comp}
#Frequency Plot for unlogged ceiling
summary_continuous_plot(output="comp",smp,"l_def6_HHI_lag1")
summary_continuous_plot(output="comp",smp,"l_def5_HHI_lag1")
summary_continuous_plot(output="comp",smp,"l_def4_HHI_lag1")
summary_continuous_plot(output="comp",smp,"l_def3_HHI_lag1")
summary_continuous_plot(output="comp",smp,"l_def2_HHI_lag1")


#Model
Comp_Cons_NCS6B <- glm (data=smp,
                 b_MultiOffr ~cl_def6_HHI_lag1, family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS6B)
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS6A,Comp_Cons_NCS6B,Comp_Cons_NCS6E,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_NCS6A,Comp_Cons_NCS6B,bins=20)
...
```{r ModelNCS6C_Comp}
#Frequency Plot for unlogged ceiling
summary_continuous_plot(output="comp",smp,"capped_def6_ratio_lag1")
      summary_continuous_plot(output="comp",smp,"l_def6_ratio_lag1")
      summary_continuous_plot(output="comp",smp,"capped_def5_ratio_lag1")
      summary_continuous_plot(output="comp",smp,"l_def5_ratio_lag1")
      
      summary_continuous_plot(output="comp",smp,"capped_def4_ratio_lag1")
      summary_continuous_plot(output="comp",smp,"l_def4_ratio_lag1")
      summary_continuous_plot(output="comp",smp,"capped_def3_ratio_lag1")
      summary_continuous_plot(output="comp",smp,"l_def3_ratio_lag1")
      summary_continuous_plot(output="comp",smp,"capped_def2_ratio_lag1")
      summary_continuous_plot(output="comp",smp,"l_def2_ratio_lag1")
      


#Model
Comp_Cons_NCS6C <- glm (data=smp,
                 b_MultiOffr ~cl_def6_HHI_lag1+cl_def6_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS6C)
...
summary_residual_compare(Comp_Cons_NCS6B,Comp_Cons_NCS6C,bins=20)
summary_residual_compare(bins=2)
...
Comp_Cons_NCS6D <- glm (data=smp,
                 b_MultiOffr ~cl_def6_HHI_lag1+cl_def6_ratio_lag1+cl_def6_HHI_lag1:cl_def6_ratio_lag1, 
                 family=binomial(link="logit"))
...
Defense sector obligations are added to better adjust for the fact that larger sectors tend to have lower HHI indices if only because they include a broader range of activities. In addition, the industrial base is likely more diverse when markets are larger. Thus greater defense in a given sector are expected to estimate a greater likelihood over multi-offer competition. The descriptive statistics tell a somewhat different story with a rise from tiny to small sectors, but lower competition rates in the largest.
Expectations are  unchanged.
```{r ModelNCS6E_Comp}
#Frequency Plot for unlogged ceiling
summary_continuous_plot(output="comp",smp,"def6_obl_lag1")


summary_continuous_plot(output="comp",smp,"l_def6_obl_lag1")
summary_continuous_plot(output="comp",smp,"def5_obl_lag1")

summary_continuous_plot(output="comp",smp,"l_def5_obl_lag1")
summary_continuous_plot(output="comp",smp,"def4_obl_lag1")

summary_continuous_plot(output="comp",smp,"l_def4_obl_lag1")
summary_continuous_plot(output="comp",smp,"def3_obl_lag1")

summary_continuous_plot(output="comp",smp,"l_def4_obl_lag1")
summary_continuous_plot(output="comp",smp,"def2_obl_lag1")

summary_continuous_plot(output="comp",smp,"l_def2_obl_lag1")

#Model
Comp_Cons_NCS6E <- glm (data=smp,
                 b_MultiOffr ~cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1, family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS6E)

Comp_Cons_NCS6E2 <- glm (data=smp1m,
                 b_MultiOffr ~cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1, family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS6E2)

 Comp_Cons_NCS6E3 <- glm (data=smp,
                 b_MultiOffr ~cl_def6_HHI_lag1+cl_def6_obl_lag1, family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS6E3)
# #Plot the fitted model plot
# CBre_Comp_02A_curve<-function(x, Comp){invlogit(cbind(1,Comp,x) %*%  coef(CBre_Comp_02A))}
# 
# #Competition curves
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS6C,Comp_Cons_NCS6E,Comp_Cons_NCS6E2,Comp_Cons_NCS6E3,
                       
                       type="text",digits=2)


summary_residual_compare(Comp_Cons_NCS6C,Comp_Cons_NCS6E,bins=20)
summary_residual_compare(bins=20)
...
#Model
Comp_Cons_NCS6F <- glm (data=smp,
                 b_MultiOffr ~cl_def6_HHI_lag1+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1, family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS6F)
...
#Plot residuals versus fitted
  ...
  stargazer::stargazer(Comp_Cons_NCS6C,Comp_Cons_NCS6E,Comp_Cons_NCS6F,
                       
                       type="text",digits=2)


summary_residual_compare(Comp_Cons_NCS6E,Comp_Cons_NCS6F,bins=20)
...
summary_continuous_plot(output="comp",smp,"US6_avg_sal_lag1")

summary_continuous_plot(output="comp",smp,"l_US6_avg_sal_lag1")

summary_continuous_plot(output="comp",smp,"US5_avg_sal_lag1")
summary_continuous_plot(output="comp",smp,"US4_avg_sal_lag1")
summary_continuous_plot(output="comp",smp,"US3_avg_sal_lag1")
summary_continuous_plot(output="comp",smp,"US2_avg_sal_lag1")

#Model
#cl_def6_obl_lag1

Comp_Cons_NCS6G <- glm (data=smp,
                 b_MultiOffr ~cl_def6_HHI_lag1+cl_def6_ratio_lag1+cl_def6_obl_lag1+
                  cl_US6_avg_sal_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1 , family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS6G)


CBre_Comp_NCS6G <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1, 
                 family=binomial(link="logit"))
glmer_examine(CBre_Comp_NCS6G)
...
#Plot residuals versus fitted
 stargazer::stargazer(Comp_Cons_NCS6C,Comp_Cons_NCS6E,Comp_Cons_NCS6F,Comp_Cons_NCS6G,
                       CBre_Comp_NCS6G,
                       type="text",digits=2)



summary_residual_compare(Comp_Cons_NCS6F,Comp_Cons_NCS6G,bins=20)
summary_residual_compare(CBre_Comp_NCS6G,bins=20)
...
Comp_Cons_NCS5A <- glm (data=smp,
                 b_MultiOffr ~cl_def5_HHI_lag1, family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS6B,Comp_Cons_NCS6E,Comp_Cons_NCS6F,Comp_Cons_NCS5A,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_NCS6B,Comp_Cons_NCS5A,bins=20)
...
Comp_Cons_NCS5B <- glm (data=smp,
                 b_MultiOffr ~cl_def5_HHI_lag1+cl_def5_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS5B)

CBre_Comp_NCS5B <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def5_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS6D,Comp_Cons_NCS5A,Comp_Cons_NCS5B,
                       CBre_Comp_NCS6D,CBre_Comp_NCS5B,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_NCS5A,Comp_Cons_NCS5B,bins=20)
summary_residual_compare(Comp_Cons_NCS6D,Comp_Cons_NCS5B,bins=20)
summary_residual_compare(CBre_Comp_NCS5B,bins=2)
...
Comp_Cons_NCS5C <- glm (data=smp,
                 b_MultiOffr ~cl_def5_HHI_lag1+cl_def5_ratio_lag1+cl_def5_HHI_lag1:cl_def5_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS5C)

CBre_Comp_NCS5C <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def5_ratio_lag1+n_Comp:cl_def5_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS5A,Comp_Cons_NCS5B,Comp_Cons_NCS5C,
                       CBre_Comp_NCS5B,CBre_Comp_NCS5C,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_NCS5B,Comp_Cons_NCS5C,bins=10)
...
Comp_Cons_NCS5D <- glm (data=smp,
                 b_MultiOffr ~cl_def5_HHI_lag1+cl_def5_ratio_lag1+cl_def5_obl_lag1, family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS5D)


CBre_Comp_NCS5D <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def5_ratio_lag1+cl_def5_obl_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS5A,Comp_Cons_NCS5B,Comp_Cons_NCS5D,
                       CBre_Comp_NCS5B,CBre_Comp_NCS5D,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_NCS5B,Comp_Cons_NCS5D,bins=10)
...
Comp_Cons_NCS5E <- glm (data=smp,
                 b_MultiOffr ~cl_def5_HHI_lag1+cl_def5_ratio_lag1+cl_def5_obl_lag1+
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS5D,Comp_Cons_NCS5E,Comp_Cons_NCS6F,
                       CBre_Comp_NCS5D,type="text",
                       digits=2)

  #Compare to prior at same level
summary_residual_compare(Comp_Cons_NCS5D,Comp_Cons_NCS5E,bins=20)
summary_residual_compare(Comp_Cons_NCS6F,Comp_Cons_NCS5E,bins=20)
...
Comp_Cons_NCS4A <- glm (data=smp,
                 b_MultiOffr ~cl_def4_HHI_lag1, family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS4A)
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS6B,Comp_Cons_NCS6E,Comp_Cons_NCS6F,Comp_Cons_NCS4A,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_NCS6B,Comp_Cons_NCS4A,bins=20)
...
Comp_Cons_NCS4B <- glm (data=smp,
                 b_MultiOffr ~cl_def4_HHI_lag1+cl_def4_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS4B)

CBre_Comp_NCS4B <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def4_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS5B,Comp_Cons_NCS4A,Comp_Cons_NCS4B,
                       CBre_Comp_NCS5B,CBre_Comp_NCS4B,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_NCS4A,Comp_Cons_NCS4B,bins=20)
summary_residual_compare(Comp_Cons_NCS5B,Comp_Cons_NCS4B,bins=20)
summary_residual_compare(CBre_Comp_NCS4B,bins=2)
...
Comp_Cons_NCS4C <- glm (data=smp,
                 b_MultiOffr ~cl_def4_HHI_lag1+cl_def4_ratio_lag1+cl_def4_HHI_lag1:cl_def4_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS4C)

CBre_Comp_NCS4C <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def4_ratio_lag1+n_Comp:cl_def4_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS4A,Comp_Cons_NCS4B,Comp_Cons_NCS4C,
                       CBre_Comp_NCS4B,CBre_Comp_NCS4C,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_NCS2B,Comp_Cons_NCS2C,bins=10)
...
Comp_Cons_NCS4D <- glm (data=smp,
                 b_MultiOffr ~cl_def4_HHI_lag1+cl_def4_ratio_lag1+cl_def4_obl_lag1, family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS4D)


CBre_Comp_NCS4D <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def4_ratio_lag1+ cl_def4_obl_lag1,
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
stargazer::stargazer(Comp_Cons_NCS4B,Comp_Cons_NCS4D,Comp_Cons_NCS6E,
                       CBre_Comp_NCS4B,CBre_Comp_NCS4D,type="text",
                       digits=2)



  #Compare to prior at same level
summary_residual_compare(Comp_Cons_NCS4B,Comp_Cons_NCS4D,bins=20)
#Compare to prior at lower level
summary_residual_compare(Comp_Cons_NCS6E,Comp_Cons_NCS4D,bins=20)
...
Comp_Cons_NCS4E <- glm (data=smp,
                 b_MultiOffr ~cl_def4_HHI_lag1+cl_def4_ratio_lag1+cl_def4_obl_lag1+
                   cl_def4_HHI_lag1:cl_def4_obl_lag1, family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS4E)
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS4D,Comp_Cons_NCS4E,Comp_Cons_NCS6F,
                       CBre_Comp_NCS4D,type="text",
                       digits=2)

  #Compare to prior at same level
summary_residual_compare(Comp_Cons_NCS4D,Comp_Cons_NCS4E,bins=20)
summary_residual_compare(Comp_Cons_NCS6F,Comp_Cons_NCS4E,bins=20)
...
Comp_Cons_NCS3A <- glm (data=smp,
                 b_MultiOffr ~cl_def3_HHI_lag1, family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS3A)
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS6B,Comp_Cons_NCS6E,Comp_Cons_NCS6F,Comp_Cons_NCS3A,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_NCS6B,Comp_Cons_NCS3A,bins=20)
...
Comp_Cons_NCS3B <- glm (data=smp,
                 b_MultiOffr ~cl_def3_HHI_lag1+cl_def3_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS3B)

CBre_Comp_NCS3B <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def3_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS4B,Comp_Cons_NCS3A,Comp_Cons_NCS3B,
                       CBre_Comp_NCS4B,CBre_Comp_NCS3B,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_NCS3A,Comp_Cons_NCS3B,bins=20)
summary_residual_compare(Comp_Cons_NCS4B,Comp_Cons_NCS3B,bins=20)
summary_residual_compare(CBre_Comp_NCS3B,bins=2)
...
Comp_Cons_NCS3C <- glm (data=smp,
                 b_MultiOffr ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+cl_def3_HHI_lag1:cl_def3_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS3C)

CBre_Comp_NCS3C <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def3_ratio_lag1+n_Comp:cl_def3_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS3A,Comp_Cons_NCS3B,Comp_Cons_NCS3C,
                       CBre_Comp_NCS3B,CBre_Comp_NCS3C,type="text",
                       digits=2)
...
Comp_Cons_NCS3D <- glm (data=smp,
                 b_MultiOffr ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+cl_def3_obl_lag1, family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS3D)


CBre_Comp_NCS3D <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def3_ratio_lag1+ cl_def3_obl_lag1,
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
stargazer::stargazer(Comp_Cons_NCS3B,Comp_Cons_NCS3E,Comp_Cons_NCS6F,
                       Comp_Cons_NCS3B,Comp_Cons_NCS3D,type="text",
                       digits=2)



  #Compare to prior at same level
summary_residual_compare(Comp_Cons_NCS3A,Comp_Cons_NCS3D,bins=20)
#Compare to prior at lower level
summary_residual_compare(Comp_Cons_NCS6E,Comp_Cons_NCS3D,bins=20)
```
...
Comp_Cons_NCS3E <- glm (data=smp,
                 b_MultiOffr ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+cl_def3_obl_lag1+cl_def3_HHI_lag1:cl_def3_obl_lag1, family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS3D,Comp_Cons_NCS3E,Comp_Cons_NCS6F,
                       CBre_Comp_NCS3D,type="text",
                       digits=2)

  #Compare to prior at same level
summary_residual_compare(Comp_Cons_NCS3D,Comp_Cons_NCS3E,bins=20)
summary_residual_compare(Comp_Cons_NCS6F,Comp_Cons_NCS3E,bins=20)
...
summary_continuous_plot(output="comp",smp,"US3_avg_sal_lag1")
summary_continuous_plot(output="comp",smp,"l_US3_avg_sal_lag1")
...
Comp_Cons_NCS3F <- glm (data=smp,
                 b_MultiOffr ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+cl_def3_obl_lag1+
                  cl_US3_avg_sal_lag1+cl_def3_HHI_lag1:cl_def3_obl_lag1 , family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS3F)


CBre_Comp_NCS3F <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def3_ratio_lag1+cl_def3_obl_lag1+cl_US3_avg_sal_lag1, 
                 family=binomial(link="logit"))
...
Comp_Cons_NCS3F2 <- glm (data=smp,
                 b_MultiOffr ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1
                  cl_US3_avg_sal_lag1 , family=binomial(link="logit"))#+cl_def3_HHI_lag1:cl_def3_obl_lag1
glmer_examine(Comp_Cons_NCS3F2)


CBre_Comp_NCS3F2 <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def3_ratio_lag1+cl_US3_avg_sal_lag1, #cl_def3_obl_lag1+
                 family=binomial(link="logit"))
glmer_examine(CBre_Comp_NCS3F2)


Comp_Cons_NCS3F3 <- glm (data=smp,
                 b_MultiOffr ~cl_def3_HHI_lag1+cl_def3_obl_lag1+#cl_def3_ratio_lag1
                  cl_US3_avg_sal_lag1+cl_def3_HHI_lag1:cl_def3_obl_lag1 , family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS3F3)
glmer_examine(Comp_Cons_NCS3F3)

Comp_Cons_NCS3F4 <- glm (data=smp,
                 b_MultiOffr ~cl_def3_HHI_lag1+cl_def3_obl_lag1+#cl_def3_ratio_lag1
                  cl_US3_avg_sal_lag1 , family=binomial(link="logit"))#+cl_def3_HHI_lag1:cl_def3_obl_lag1
glmer_examine(Comp_Cons_NCS3F4)
glmer_examine(Comp_Cons_NCS3F4)

CBre_Comp_NCS3F3 <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def3_obl_lag1+cl_US3_avg_sal_lag1, #cl_def3_ratio_lag1
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
 stargazer::stargazer(Comp_Cons_NCS3E,Comp_Cons_NCS3F2,Comp_Cons_NCS3F4,Comp_Cons_NCS6G,
                       CBre_Comp_NCS3D,CBre_Comp_NCS3F2,CBre_Comp_NCS3F3,CBre_Comp_NCS6G,
                       type="text",digits=2)


summary_residual_compare(Comp_Cons_NCS3F,Comp_Cons_NCS3F2,bins=20)
summary_residual_compare(CBre_Comp_NCS3D,CBre_Comp_NCS3F2,bins=10)
summary_residual_compare(Comp_Cons_NCS3F2,Comp_Cons_NCS3F4,bins=20)
summary_residual_compare(CBre_Comp_NCS3F2,CBre_Comp_NCS3F3,bins=10)

summary_residual_compare(Comp_Cons_NCS3F,Comp_Cons_NCS3F4,bins=20)
...
Comp_Cons_NCS3G3 <- glm (data=smp,
                 b_MultiOffr ~cl_def3_HHI_lag1+cl_def3_ratio_lag1+#cl_def3_obl_lag1+
                  #cl_US3_avg_sal_lag1+
                   cl_def6_HHI_lag1+cl_def6_obl_lag1+cl_def6_ratio_lag1+
                  cl_US6_avg_sal_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1  , family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS3G3)
vif(Comp_Cons_NCS3G3)
...
#Plot residuals versus fitted
 stargazer::stargazer(Comp_Cons_NCS3E,Comp_Cons_NCS3F2,Comp_Cons_NCS3F4,Comp_Cons_NCS6G,Comp_Cons_NCS3G3,
                       CBre_Comp_NCS3D,CBre_Comp_NCS3F2,CBre_Comp_NCS3F3,CBre_Comp_NCS6G,CBre_Comp_NCS3G3,
                       type="text",digits=2)


summary_residual_compare(Comp_Cons_NCS3F4,Comp_Cons_NCS3G3,bins=20)
summary_residual_compare(CBre_Comp_NCS3F3,CBre_Comp_NCS3G3,bins=10)
summary_residual_compare(Comp_Cons_NCS3F2,Comp_Cons_NCS3G3,bins=20)
summary_residual_compare(CBre_Comp_NCS3F2,CBre_Comp_NCS3G3,bins=10)

summary_residual_compare(Comp_Cons_NCS3F,Comp_Cons_NCS3G3,bins=20)
summary_residual_compare(CBre_Comp_NCS3D,CBre_Comp_NCS3G3,bins=10)
summary_residual_compare(Comp_Cons_NCS6G,Comp_Cons_NCS3G3,bins=20)
...
Comp_Cons_NCS2A <- glm (data=smp,
                 b_MultiOffr ~cl_def2_HHI_lag1, family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS2A)
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS6B,Comp_Cons_NCS6E,Comp_Cons_NCS6F,Comp_Cons_NCS2A,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_NCS6B,Comp_Cons_NCS2A,bins=20)
...
Comp_Cons_NCS2B <- glm (data=smp,
                 b_MultiOffr ~cl_def2_HHI_lag1+cl_def2_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS2B)

CBre_Comp_NCS2B <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def2_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS3B,Comp_Cons_NCS2A,Comp_Cons_NCS2B,
                       CBre_Comp_NCS3B,CBre_Comp_NCS2B,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_NCS2A,Comp_Cons_NCS2B,bins=10)
summary_residual_compare(Comp_Cons_NCS3B,Comp_Cons_NCS2B,bins=20)
summary_residual_compare(CBre_Comp_NCS2B,bins=2)
...
Comp_Cons_NCS2C <- glm (data=smp,
                 b_MultiOffr ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+cl_def2_HHI_lag1:cl_def2_ratio_lag1, 
                 family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS2C)

CBre_Comp_NCS2C <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def2_ratio_lag1+n_Comp:cl_def2_ratio_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_NCS2A,Comp_Cons_NCS2B,Comp_Cons_NCS2C,
                       CBre_Comp_NCS2B,CBre_Comp_NCS2C,type="text",
                       digits=2)
...
Comp_Cons_NCS2D <- glm (data=smp,
                 b_MultiOffr ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+cl_def2_obl_lag1, family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS2D)


CBre_Comp_NCS2D <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def2_ratio_lag1+cl_def2_obl_lag1, 
                 family=binomial(link="logit"))
...
#Plot residuals versus fitted
stargazer::stargazer(Comp_Cons_NCS6B,Comp_Cons_NCS6E,Comp_Cons_NCS6F,
                       Comp_Cons_NCS2A,Comp_Cons_NCS2D,type="text",
                       digits=2)



  #Compare to prior at same level
summary_residual_compare(Comp_Cons_NCS2A,Comp_Cons_NCS2D,bins=10)
#Compare to prior at lower level
summary_residual_compare(Comp_Cons_NCS6E,Comp_Cons_NCS2D,bins=10)
summary_residual_compare(Comp_Cons_NCS3G,Comp_Cons_NCS2D,bins=10)
```
...
Comp_Cons_NCS2E <- glm (data=smp,
                 b_MultiOffr ~cl_def2_HHI_lag1+cl_def2_obl_lag1+cl_def2_HHI_lag1:cl_def2_obl_lag1, family=binomial(link="logit"))
...
#Plot residuals versus fitted
stargazer::stargazer(Comp_Cons_NCS6B,Comp_Cons_NCS6D,Comp_Cons_NCS6E,
                       CBre_Comp_NCS2B,CBre_Comp_NCS2D,type="text",
                       digits=2)



  #Compare to prior at same level
summary_residual_compare(Comp_Cons_NCS2B,Comp_Cons_NCS2D,bins=20)
#Compare to prior at lower level
summary_residual_compare(Comp_Cons_NCS6E,Comp_Cons_NCS2D,bins=20)
...
summary_continuous_plot(output="comp",smp,"US2_avg_sal_lag1")
summary_continuous_plot(output="comp",smp,"l_US2_avg_sal_lag1")
...
Comp_Cons_NCS2F <- glm (data=smp,
                 b_MultiOffr ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+cl_def2_obl_lag1+
                  cl_US2_avg_sal_lag1+cl_def2_HHI_lag1:cl_def2_obl_lag1 , family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS2F)


CBre_Comp_NCS2F <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def2_ratio_lag1+cl_def2_obl_lag1+cl_US2_avg_sal_lag1, 
                 family=binomial(link="logit"))
...
Comp_Cons_NCS2F2 <- glm (data=smp,
                 b_MultiOffr ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+#cl_def2_obl_lag1
                  cl_US2_avg_sal_lag1 , family=binomial(link="logit"))#+cl_def2_HHI_lag1:cl_def2_obl_lag1
glmer_examine(Comp_Cons_NCS2F2)


CBre_Comp_NCS2F2 <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def2_ratio_lag1+cl_US2_avg_sal_lag1, #cl_def2_obl_lag1+
                 family=binomial(link="logit"))
...
Comp_Cons_NCS2F3 <- glm (data=smp,
                 b_MultiOffr ~cl_def2_HHI_lag1+cl_def2_obl_lag1+#cl_def2_ratio_lag1
                  cl_US2_avg_sal_lag1 , family=binomial(link="logit"))#+cl_def2_HHI_lag1:cl_def2_obl_lag1


CBre_Comp_NCS2F3 <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def2_obl_lag1+cl_US2_avg_sal_lag1, #cl_def2_ratio_lag1
                 family=binomial(link="logit"))
glmer_examine(CBre_Comp_NCS2F2)

glmer_examine(Comp_Cons_NCS2F3)
glmer_examine(Comp_Cons_NCS2F3)
# 
# #Plot the fitted model plot
# CBre_Comp_02A_curve<-function(x, Comp){invlogit(cbind(1,Comp,x) %*%  coef(CBre_Comp_02A))}
...
#Plot residuals versus fitted
 stargazer::stargazer(Comp_Cons_NCS2D,Comp_Cons_NCS2F2,Comp_Cons_NCS2F3,#Comp_Cons_NCS6G,
                       CBre_Comp_NCS2D,CBre_Comp_NCS2F2,CBre_Comp_NCS2F3,#CBre_Comp_NCS6G,
                       type="text",digits=2)


summary_residual_compare(Comp_Cons_NCS2D,Comp_Cons_NCS2F2,bins=10)
summary_residual_compare(CBre_Comp_NCS2D,CBre_Comp_NCS2F2,bins=5)
summary_residual_compare(Comp_Cons_NCS2F2,Comp_Cons_NCS2F3,bins=10)
summary_residual_compare(CBre_Comp_NCS2F2,CBre_Comp_NCS2F3,bins=5)

summary_residual_compare(Comp_Cons_NCS2F,Comp_Cons_NCS2F3,bins=20)
...
#Model
Comp_Cons_NCS2G <- glm (data=smp,
                 b_MultiOffr ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+
                  cl_US2_avg_sal_lag1+
                   cl_def6_HHI_lag1+cl_def6_ratio_lag1+cl_def6_obl_lag1+
                  cl_US6_avg_sal_lag1+cl_def6_HHI_lag1:cl_def6_obl_lag1  , family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS2G)
...
Comp_Cons_NCS2G3 <- glm (data=smp,
                 b_MultiOffr ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+
                  #cl_US2_avg_sal_lag1+
                   cl_def6_HHI_lag1+cl_def6_ratio_lag1+cl_def6_obl_lag1+
                  cl_US6_avg_sal_lag1,#+cl_def6_HHI_lag1:cl_def6_obl_lag1  ,
                 family=binomial(link="logit"))
glmer_examine(Comp_Cons_NCS2G3)




 stargazer::stargazer(Comp_Cons_NCS2D,Comp_Cons_NCS2F2,Comp_Cons_NCS2G3,#Comp_Cons_NCS6G,
...
CBre_Comp_NCS2G <- glm (data=smp,
                 b_MultiOffr ~n_Comp+cl_def2_ratio_lag1+cl_US2_avg_sal_lag1+
...
```{r Model02A_Comp}
#Frequency Plot for unlogged ceiling
summary_continuous_plot(output="comp",smp,"UnmodifiedContractBaseAndAllOptionsValue",
               bins=1000)
...
summary_continuous_plot(output="comp",smp,"l_Ceil")

#Model
Comp_Cons_02A <- glm (data=smp,
                 b_MultiOffr ~cl_def6_HHI_lag1 + 
                   cl_Ceil, family=binomial(link="logit"))
glmer_examine(Comp_Cons_02C)

CBre_Comp_02A <- glm (data=smp,
                 b_MultiOffr ~n_Comp + cl_Ceil, family=binomial(link="logit"))
...
#Plot residuals versus fitted
  stargazer::stargazer(Comp_Cons_01F, Comp_Cons_02A,CBre_Comp_02A,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_01F,Comp_Cons_02A,CBre_Comp_02A,bins=2)
...
#Frequency Plot
summary_continuous_plot(output="comp",smp,"l_Ceil","EffComp")


#Create the model
Comp_Cons_02C <- glm (data=smp,
                 b_MultiOffr ~cl_def6_HHI_lag1 + 
                   cl_Ceil + 
...
#Plot the fitted values vs actual results
  stargazer::stargazer(Comp_Cons_02A,Comp_Cons_02C,CBre_Comp_02A,CBre_Comp_02C,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_02A,Comp_Cons_02C,CBre_Comp_02A,CBre_Comp_02C,bins=20)
...
summary_continuous_plot(output="comp",smp,"UnmodifiedDays",
               bins=1000)

#Frequency Plot for logged max duration
summary_continuous_plot(output="comp",smp,"l_Days")



#Model
Comp_Cons_02D <- glm (data=smp,
                 b_MultiOffr ~cl_def6_HHI_lag1 + 
                   cl_Ceil + cl_Days + 
                   cl_def6_HHI_lag1:cl_Ceil, family=binomial(link="logit"))
glmer_examine(Comp_Cons_02D)
...
# residuals_cbre_plot(CBre_Comp_02D,"cl_Days")+
  ...
  stargazer::stargazer(Comp_Cons_02D,CBre_Comp_02D,type="text",
                       digits=2)

summary_residual_compare(Comp_Cons_02C,Comp_Cons_02D,CBre_Comp_02A,CBre_Comp_02D,bins=20)
...
#Create the model
Comp_Cons_02E <- glm (data=smp,
                 b_MultiOffr ~cl_def6_HHI_lag1 + 
                   cl_Ceil + cl_Days + 
                   cl_def6_HHI_lag1:cl_Ceil+
                    cl_Ceil:cl_Days, family=binomial(link="logit"))
glmer_examine(Comp_Cons_02E)
...
fitted_cbre_model(smp,"cl_Days") +  stat_function(fun = CBre_Comp_02E_curve, 
  ...
  stargazer::stargazer(Comp_Cons_02D,Comp_Cons_02E,CBre_Comp_02D,CBre_Comp_02E,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_02D,Comp_Cons_02E,CBre_Comp_02D,CBre_Comp_02E,bins=20)
...
#Frequency Plot
summary_continuous_plot(output="comp",smp,"l_Days","EffComp")

#Create the model
Comp_Cons_02H <- glm (data=smp,
                 b_MultiOffr ~cl_def6_HHI_lag1 + 
                   cl_Ceil + cl_Days+
                   cl_def6_HHI_lag1:cl_Ceil+
                   cl_def6_HHI_lag1:cl_Days, family=binomial(link="logit"))
glmer_examine(Comp_Cons_02H)
...
stargazer::stargazer(Comp_Cons_02D,Comp_Cons_02H,CBre_Comp_02D,CBre_Comp_02H,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_02D,Comp_Cons_02H,CBre_Comp_02D,CBre_Comp_02H,bins=20)
...
#Plot the fitted values vs actual results
stargazer::stargazer(Comp_Cons_02H,Comp_Cons_03A,CBre_Comp_02D,CBre_Comp_03A,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_02H,Comp_Cons_03A,CBre_Comp_02D,CBre_Comp_03A,bins=20)
...
```{r Model03b_MultiOffr}

#Frequency Plot
summary_continuous_plot(output="comp",smp,"l_Days","Veh")




#Create the model
Comp_Cons_03B <- glm (data=smp,
                 b_MultiOffr ~cl_def6_HHI_lag1 + 
                   cl_Ceil + cl_Days+ 
                   Veh +
                   cl_def6_HHI_lag1:cl_Ceil  +
...
#                                        SIDV=0,MIDV=0),color="blue")
  ...
  Comp_Cons_03B2 <- glm (data=smp,
                 ...
                 Veh:cl_Days
                 , family=binomial(link="logit"))
glmer_examine(Comp_Cons_03B2)

  stargazer::stargazer(Comp_Cons_03A,Comp_Cons_03B2,CBre_Comp_03A,CBre_Comp_03B,type="text",
                         digits=2)
  
  summary_residual_compare(Comp_Cons_03A,Comp_Cons_03B2,CBre_Comp_03A,CBre_Comp_03B,bins=20)
...
summary_continuous_plot(output="comp",smp,"HHI_lag1","Veh")

#Create the model
Comp_Cons_03C <- glm (data=smp,
                 b_MultiOffr ~cl_def6_HHI_lag1 + 
                   cl_Ceil + cl_Days+ 
                   Veh +
...
#                                        SIDV=0,MIDV=0),color="blue")
  ...
  stargazer::stargazer(Comp_Cons_03B2,Comp_Cons_03C,CBre_Comp_03B,CBre_Comp_03C,type="text",
                       digits=2)


summary_residual_compare(Comp_Cons_03B2,Comp_Cons_03C,CBre_Comp_03B,CBre_Comp_03C,bins=20)
...
#Frequency Plot
summary_continuous_plot(output="comp",smp,"l_Ceil","Veh")
...
stargazer::stargazer(Comp_Cons_03B2,Comp_Cons_03D2,
                     CBre_Comp_03B,CBre_Comp_03D,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_03B2,Comp_Cons_03D2,CBre_Comp_03B,CBre_Comp_03D,bins=20)
summary_residual_compare(Comp_Cons_03A,Comp_Cons_03D2,bins=20)
...
stargazer::stargazer(Comp_Cons_03D2,Comp_Cons_04A,
                     CBre_Comp_03D,CBre_Comp_04A,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_03D2,Comp_Cons_04A,CBre_Comp_03D,CBre_Comp_04A,bins=20)
...
stargazer::stargazer(Comp_Cons_04A,Comp_Cons_04B,
                     CBre_Comp_04A,CBre_Comp_04B,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_04A,Comp_Cons_04B,CBre_Comp_04A,CBre_Comp_04B,bins=20)
...
stargazer::stargazer(Comp_Cons_04B,Comp_Cons_04C,
                     CBre_Comp_04B,CBre_Comp_04C,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_04A,Comp_Cons_04B,CBre_Comp_04B,CBre_Comp_04C,bins=20)
...
stargazer::stargazer(Comp_Cons_04C,Comp_Cons_04D,
                     CBre_Comp_04C,CBre_Comp_04D,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_04C,Comp_Cons_04D,
...
#Frequency Plot
summary_continuous_plot(output="comp",smp,"l_Days","PricingFee")
...
stargazer::stargazer(Comp_Cons_04C,Comp_Cons_04E2,
                     CBre_Comp_04C,CBre_Comp_04E2,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_04C,Comp_Cons_04E2,CBre_Comp_04C,CBre_Comp_04E2,bins=20)
...
stargazer::stargazer(Comp_Cons_04C,Comp_Cons_04F,
                     CBre_Comp_04C,CBre_Comp_04F,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_04C,Comp_Cons_04F,CBre_Comp_04C,CBre_Comp_04F,bins=20)
...
#Frequency Plot
summary_continuous_plot(output="comp",smp,"l_Ceil","PricingFee")
...
stargazer::stargazer(Comp_Cons_04C,Comp_Cons_04G,
                     CBre_Comp_04C,CBre_Comp_04G,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_04C,Comp_Cons_04G,CBre_Comp_04C,CBre_Comp_04G,bins=20)
...
# residuals_cbre_plot(CBre_Comp_02F,"cl_days")+
#   labs(x="Centered Log(Days)")
stargazer::stargazer(Comp_Cons_04G,Comp_Cons_04H,
                     CBre_Comp_04G,CBre_Comp_04H,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_04G,Comp_Cons_04H,CBre_Comp_04G,CBre_Comp_04H,bins=20)
...
summary_continuous_plot(output="comp",smp,"cl_def6_HHI_lag1","UCA")

#Create the model

Comp_Cons_04I <- glm (data=smp,
b_MultiOffr ~cl_def6_HHI_lag1 + 
                   cl_Ceil + cl_Days+ 
                   Veh +
                   PricingFee + b_UCA +
...
stargazer::stargazer(Comp_Cons_04H,Comp_Cons_04I,
                     CBre_Comp_04H,CBre_Comp_04I,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_04H,Comp_Cons_04I,CBre_Comp_04H,CBre_Comp_04I,bins=20)
...
#Frequency Plot
summary_continuous_plot(output="comp",smp,"l_Days","UCA")
...
stargazer::stargazer(Comp_Cons_04I,Comp_Cons_04J2,
                     CBre_Comp_04I,CBre_Comp_04J2,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_04I,Comp_Cons_04J2,CBre_Comp_04I,CBre_Comp_04J2,bins=20)
...
#Frequency Plot
summary_continuous_plot(output="comp",smp,"l_Ceil","UCA")
...
stargazer::stargazer(Comp_Cons_04I,Comp_Cons_04K,
                     CBre_Comp_04I,CBre_Comp_04K,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_04I,Comp_Cons_04K,CBre_Comp_04I,CBre_Comp_04K,bins=20)
...
stargazer::stargazer(Comp_Cons_04L2,
                     CBre_Comp_04L2,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_04L2,Comp_Cons_04L2,CBre_Comp_04L2,CBre_Comp_04L2,bins=20)
...
stargazer::stargazer(Comp_Cons_04K,Comp_Cons_05A,
                     CBre_Comp_04K,CBre_Comp_05A,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_04K,Comp_Cons_05A,CBre_Comp_04K,CBre_Comp_05A,bins=20)
...
stargazer::stargazer(Comp_Cons_05A,Comp_Cons_05B,
                     CBre_Comp_05A,CBre_Comp_05B,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_05A,Comp_Cons_05B,CBre_Comp_05A,CBre_Comp_05B,bins=20)
...
stargazer::stargazer(Comp_Cons_05A,Comp_Cons_05C,
                     CBre_Comp_05A,CBre_Comp_05C,type="text",
                       digits=2)
summary_residual_compare(Comp_Cons_05A,Comp_Cons_05C,CBre_Comp_05A,CBre_Comp_05C,bins=20)
...
Comp_Cons_06A2 <- glm (data=smp,
                      b_MultiOffr ~cl_def6_HHI_lag1 + 
                        ...
                        b_Intl:Veh
                      , family=binomial(link="logit"))
glmer_examine(Comp_Cons_06A2)


Comp_Cons_06A3 <- glm (data=smp,
                      b_MultiOffr ~cl_def6_HHI_lag1 + 
                        cl_Ceil + cl_Days+ 
                        Veh +
                        PricingFee + b_UCA +
...
glmer_examine(CBre_Comp_06A3)
  ...
  stargazer::stargazer(Comp_Cons_05C,Comp_Cons_06A3,CBre_Comp_05C,CBre_Comp_06A3,type="text",
                       digits=2)
  
summary_residual_compare(Comp_Cons_05C,Comp_Cons_06A3,CBre_Comp_05C,CBre_Comp_06A3,bins=20)

rm(CBre_Comp_06A,CBre_Comp_06A2,Comp_Cons_06A,Comp_Cons_06A2)
```
...
glmer_examine(CBre_Comp_06B)
  ...
  stargazer::stargazer(Comp_Cons_06A3,Comp_Cons_06B,CBre_Comp_06A3,CBre_Comp_06B,type="text",
                       digits=2)
  
summary_residual_compare(Comp_Cons_06A3,Comp_Cons_06B,CBre_Comp_06A3,CBre_Comp_06B,bins=20)

rm(Comp_Cons_06B,CBre_Comp_06B)
...
glmer_examine(CBre_Comp_06C)
  ...
  stargazer::stargazer(Comp_Cons_06A3,Comp_Cons_06C,CBre_Comp_06A3,CBre_Comp_06C,type="text",
                       digits=2)
  
summary_residual_compare(Comp_Cons_06A3,Comp_Cons_06C,CBre_Comp_06A3,CBre_Comp_06C,bins=20)
...
glmer_examine(CBre_Comp_06D)
  ...
  stargazer::stargazer(Comp_Cons_06C,Comp_Cons_06D,CBre_Comp_06C,CBre_Comp_06D,type="text",
                       digits=2)
  
summary_residual_compare(Comp_Cons_06C,Comp_Cons_06D,CBre_Comp_06C,CBre_Comp_06D,bins=20)
...
glmer_examine(CBre_Comp_07A)
  ...
  stargazer::stargazer(Comp_Cons_06D,Comp_Cons_07A,CBre_Comp_06D,CBre_Comp_07A,type="text",
                       digits=2)
  
summary_residual_compare(Comp_Cons_06D,Comp_Cons_07A,CBre_Comp_06D,CBre_Comp_07A,bins=20)
...
glmer_examine(CBre_Comp_07B)
  ...
  stargazer::stargazer(Comp_Cons_07A,Comp_Cons_07B,CBre_Comp_07A,CBre_Comp_07B,type="text",
                       digits=2)
  
summary_residual_compare(Comp_Cons_07A,Comp_Cons_07B,CBre_Comp_07A,CBre_Comp_07B,bins=20)
...
stargazer::stargazer(Comp_Cons_07A,Comp_Cons_07B,Comp_Cons_07C,Comp_Cons_07C,CBre_Comp_07A,CBre_Comp_07B,CBre_Comp_07C,CBre_Comp_07C,type="text",
                       digits=2)

summary_residual_compare(Comp_Cons_07A,Comp_Cons_07C,CBre_Comp_07A,CBre_Comp_07C,bins=20)
summary_residual_compare(Comp_Cons_07C,Comp_Cons_07C,CBre_Comp_07C,CBre_Comp_07C,bins=20)
...
glmer_examine(CBre_Comp_10A)
  ...
  stargazer::stargazer(Comp_Cons_10A,CBre_Comp_10A,type="text",
                       digits=2)
  
summary_residual_compare(CBre_Comp_07A,CBre_Comp_10A,Comp_Cons_07A,Comp_Cons_10A,bins=20)
...
glmer_examine(CBre_Comp_10B)
  ...
  stargazer::stargazer(CBre_Comp_10A,CBre_Comp_10B,Comp_Cons_10A,Comp_Cons_10B,type="text",
                       digits=2)
  
  

summary_residual_compare(CBre_Comp_10A,CBre_Comp_10B,Comp_Cons_10A,Comp_Cons_10B,bins=20)
...
#Sumamry plot
summary_continuous_plot(smp1m,"cl_Days","cl_def6_HHI_lag1")
...
glmer_examine(CBre_Comp_10C)
  ...
  stargazer::stargazer(Comp_Cons_10B,Comp_Cons_10C,CBre_Comp_10B,CBre_Comp_10C,type="text",
                       digits=2)
  
  

summary_residual_compare(Comp_Cons_10B,Comp_Cons_10C,CBre_Comp_10B,CBre_Comp_10C,bins=20)
...
#Sumamry plot
summary_continuous_plot(smp1m,"cl_Ceil","cl_def6_HHI_lag1")
...
glmer_examine(CBre_Comp_10D)
  ...
  stargazer::stargazer(Comp_Cons_10B,Comp_Cons_10D,CBre_Comp_10B,CBre_Comp_10D,type="text",
                       digits=2)
  
  

summary_residual_compare(Comp_Cons_10B,Comp_Cons_10D,CBre_Comp_10B,CBre_Comp_10D,bins=20)
...
glmer_examine(CBre_Comp_10E)
  ...
  stargazer::stargazer(Comp_Cons_10D,Comp_Cons_10E,CBre_Comp_10B,CBre_Comp_10E,type="text",
                       digits=2)
  
  

summary_residual_compare(Comp_Cons_10D,Comp_Cons_10E,CBre_Comp_10B,CBre_Comp_10E,bins=20)
...
summary_residual_compare(Comp_Cons_07B2,Comp_Cons_11A,CBre_Comp_07B2,CBre_Comp_07C3,bins=20)
...
summary_residual_compare(Comp_Cons_11A,Comp_Cons_11A,CBre_Comp_11A,CBre_Comp_11A.restart,bins=20)
...
summary_residual_compare(Comp_Cons_07B2,Comp_Cons_12B,CBre_Comp_07B2,CBre_Comp_07C3,bins=20)
```
...
save(Comp_Cons_13B,CBre_Comp_13B,file="Output//Comp_Cons_13B.rdata")
```
