...
glmer_examine(Comp_Cons_NCS6E2)
 ...
 Comp_Cons_NCS6E3 <- glm (data=smp,
                 cl_Offr ~cl_def6_HHI_lag1+cl_def6_obl_lag1)
...
CBre_Comp_NCS6G <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def6_ratio_lag1+cl_def6_obl_lag1+cl_US6_avg_sal_lag1, 
                 )
...
CBre_Comp_NCS5B <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def5_ratio_lag1, 
                 )
...
Comp_Cons_NCS5C <- glm (data=smp,
                 cl_Offr ~cl_def5_HHI_lag1+cl_def5_ratio_lag1+cl_def5_HHI_lag1:cl_def5_ratio_lag1, 
                 )
glmer_examine(Comp_Cons_NCS5C)

CBre_Comp_NCS5C <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def5_ratio_lag1+n_Comp:cl_def5_ratio_lag1, 
                 )
...
CBre_Comp_NCS5D <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def5_ratio_lag1+cl_def5_obl_lag1, 
                 )
...
CBre_Comp_NCS4B <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def4_ratio_lag1, 
                 )
...
Comp_Cons_NCS4C <- glm (data=smp,
                 cl_Offr ~cl_def4_HHI_lag1+cl_def4_ratio_lag1+cl_def4_HHI_lag1:cl_def4_ratio_lag1, 
                 )
glmer_examine(Comp_Cons_NCS4C)

CBre_Comp_NCS4C <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def4_ratio_lag1+n_Comp:cl_def4_ratio_lag1, 
                 )
...
CBre_Comp_NCS4D <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def4_ratio_lag1+ cl_def4_obl_lag1,
                 )
...
CBre_Comp_NCS3B <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def3_ratio_lag1, 
                 )
...
CBre_Comp_NCS3D <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def3_ratio_lag1+ cl_def3_obl_lag1,
                 )
...
CBre_Comp_NCS3F <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def3_ratio_lag1+cl_def3_obl_lag1+cl_US3_avg_sal_lag1, 
                 )
...
Comp_Cons_NCS3F3 <- glm (data=smp,
                 cl_Offr ~cl_def3_HHI_lag1+cl_def3_obl_lag1+#cl_def3_ratio_lag1
                  cl_US3_avg_sal_lag1+cl_def3_HHI_lag1:cl_def3_obl_lag1 )
...
CBre_Comp_NCS3F3 <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def3_obl_lag1+cl_US3_avg_sal_lag1, #cl_def3_ratio_lag1
                 )
...
CBre_Comp_NCS2B <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def2_ratio_lag1, 
                 )
...
Comp_Cons_NCS2C <- glm (data=smp,
                 cl_Offr ~cl_def2_HHI_lag1+cl_def2_ratio_lag1+cl_def2_HHI_lag1:cl_def2_ratio_lag1, 
                 )
glmer_examine(Comp_Cons_NCS2C)

CBre_Comp_NCS2C <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def2_ratio_lag1+n_Comp:cl_def2_ratio_lag1, 
                 )
...
CBre_Comp_NCS2D <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def2_ratio_lag1+cl_def2_obl_lag1, 
                 )
...
Comp_Cons_NCS2E <- glm (data=smp,
                 cl_Offr ~cl_def2_HHI_lag1+cl_def2_obl_lag1+cl_def2_HHI_lag1:cl_def2_obl_lag1)
...
CBre_Comp_NCS2F <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def2_ratio_lag1+cl_def2_obl_lag1+cl_US2_avg_sal_lag1, 
                 )
...
CBre_Comp_NCS2F2 <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def2_ratio_lag1+cl_US2_avg_sal_lag1, #cl_def2_obl_lag1+
                 )
...
Comp_Cons_NCS2F3 <- glm (data=smp,
                 cl_Offr ~cl_def2_HHI_lag1+cl_def2_obl_lag1+#cl_def2_ratio_lag1
                  cl_US2_avg_sal_lag1 )#+cl_def2_HHI_lag1:cl_def2_obl_lag1


CBre_Comp_NCS2F3 <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def2_obl_lag1+cl_US2_avg_sal_lag1, #cl_def2_ratio_lag1
                 )
glmer_examine(CBre_Comp_NCS2F2)
...
CBre_Comp_NCS2G <- glm (data=smp,
                 cl_Offr ~n_Comp+cl_def2_ratio_lag1+cl_US2_avg_sal_lag1+
