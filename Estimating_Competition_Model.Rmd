...
#Plot residuals versus fitted
stargazer::stargazerComp_Cons_NCS6D,Comp_Cons_NCS5C,(Comp_Cons_NCS4B,Comp_Cons_NCS4C,
                       type="text",
                       digits=2)
...
summary_regression_compare(CBre_Comp_NCS3F3,CBre_Comp_NCS3G3)
summary_regression_compare(Comp_Cons_NCS3F2,Comp_Cons_NCS3G3)
summary_regression_compare(CBre_Comp_NCS3F2,CBre_Comp_NCS3G3)

summary_regression_compare(Comp_Cons_NCS3F,Comp_Cons_NCS3G3)
summary_regression_compare(CBre_Comp_NCS3C,CBre_Comp_NCS3G3)
summary_regression_compare(Comp_Cons_NCS6E,Comp_Cons_NCS3G3)
summary_regression_compare(CBre_Comp_NCS3G3)
...
stargazer::stargazer(Comp_Cons_NCS6B,Comp_Cons_NCS6D,Comp_Cons_NCS6E,
  ...
  #Compare to prior at same level
summary_regression_compare(Comp_Cons_NCS2A,Comp_Cons_NCS2C)
#Compare to prior at lower level
summary_regression_compare(Comp_Cons_NCS6D,Comp_Cons_NCS2C)
summary_regression_compare(Comp_Cons_NCS3G,Comp_Cons_NCS2C)
```
...
summary_regression_compare(Comp_Cons_NCS2C,Comp_Cons_NCS2F2)
summary_regression_compare(CBre_Comp_NCS2C,CBre_Comp_NCS2F2,bins=5)
summary_regression_compare(Comp_Cons_NCS2F2,Comp_Cons_NCS2F3)
...
summary_regression_compare(CBre_Comp_NCS2C,CBre_Comp_NCS2F3)
...
summary_regression_compare(Comp_Cons_NCS5B,Comp_Cons_NCS5B)
...
summary_regression_compare(CBre_Comp_NCS3C,CBre_Comp_NCS3F2)
summary_regression_compare(Comp_Cons_NCS3F2,Comp_Cons_NCS3F4)
summary_regression_compare(CBre_Comp_NCS3F2,CBre_Comp_NCS3F3)

summary_regression_compare(Comp_Cons_NCS3F,Comp_Cons_NCS3F4)
summary_regression_compare(CBre_Comp_NCS3C,CBre_Comp_NCS3F3)
