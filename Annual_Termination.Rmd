...
def_full<-FormatContractModel(def_full)

#ContractWeighted <- apply_lookups(Path,ContractWeighted)


def_full$TermNum<-as.integer(as.character(factor(def_full$Term,
                                  levels=c("Terminated","Unterminated"),
                                  labels=c(1,0))))

def_full$ObligationWT<-def_full$Action.Obligation
def_full$ObligationWT[def_full$ObligationWT<0]<-NA

def_full<-def_full %>% group_by(Ceil) %>% 
  mutate(ceil.median.wt = median(UnmodifiedContractBaseAndAllOptionsValue))



def_full$UnmodifiedYearsFloat<-def_full$UnmodifiedDays/365.25
def_full$UnmodifiedYearsCat<-floor(def_full$UnmodifiedYearsFloat)
def_full$Dur[def_full$UnmodifiedYearsCat<0]<-NA

def_full$Dur.Simple<-as.character(def_full$Dur)
def_full$Dur.Simple[def_full$Dur.Simple %in% c(
    "[0 months,~2 months)",
    "[~2 months,~7 months)",
    "[~7 months-~1 year]")]<-"<~1 year"
def_full$Dur.Simple<-factor(def_full$Dur.Simple,
                                          levels=c("<~1 year",
                                               "(~1 year,~2 years]",
                                               "(~2 years+]"),
                                   ordered=TRUE
...
def_full$Ceil.Simple<-as.character(def_full$Ceil)

def_full$Ceil.Simple[def_full$Ceil.Simple %in% c(
    "75m+",
    "10m - <75m")]<-"10m+"
def_full$Ceil.Simple[def_full$Ceil.Simple %in% c(
    "1m - <10m",
...
def_full$Ceil.Simple[def_full$Ceil.Simple %in% c(
    "15k - <100k",
    "0 - <15k")]<-"0k - <100k"
def_full$Ceil.Simple<-factor(def_full$Ceil.Simple,
       levels=c("0k - <100k",
                "100k - <10m",
                "10m+"),
       ordered=TRUE
...
write.csv(subset(def_full,Term=="Terminated"),"Terminated.csv")
...
# TerminatedDurSummary<-ddply(subset(def_full,StartFY>=2007 & 
#                   !is.na(Ceil)&
...
# 
# TerminatedUnmodifiedYearsCatStat<-rbind(ddply(subset(def_full,
...
# 
# TerminatedDurStat<-rbind(                         ddply(subset(def_full,
#                                 !is.na(Dur) & StartFY>=2007 & 
#                                     StartFY<=2014 & 
#                                     !is.na(Ceil) &
#                                     UnmodifiedCurrentCompletionDate<as.Date("2015-09-30")&
...
# TerminatedDur.SimpleStatCount<-ddply(subset(def_full,
#                                 !is.na(Dur) & StartFY>=2007 & 
#                                     StartFY<=2014 & 
#                                     !is.na(Ceil) &
#                                     UnmodifiedCurrentCompletionDate<as.Date("2015-09-30")&
...
# 
# 
# TerminatedDur.SimpleStat<-rbind(                         ddply(subset(def_full,
#                                 !is.na(Dur) & StartFY>=2007 & 
#                                     StartFY<=2014 & 
#                                     !is.na(Ceil) &
#                                     UnmodifiedCurrentCompletionDate<as.Date("2015-09-30")&
...
# TerminatedSDurSCeilStatCount<-ddply(subset(def_full,
#                                 !is.na(Dur) & StartFY>=2007 & 
#                                     StartFY<=2014 & 
#                                     !is.na(Ceil) &
#                                     UnmodifiedCurrentCompletionDate<as.Date("2015-09-30")&
...
```{r SDurSCeilCount, fig.width=5,fig.height=9, dpi=600}
TerminatedSDurSCeilStatCount<-
    subset(def_full,
           !is.na(Dur.Simple) & 
               ...
               StartFY>=2007 & 
               StartFY<=2016 &                
               (LastCurrentCompletionDate<=as.Date("2017-09-30") |
                    IsClosed==1) &
...
# summary(def_full$Dur)
# 
# TerminatedDur.SimpleIntlStat<-rbind(                         ddply(subset(def_full,
#                                 !is.na(Dur) & StartFY>=2007 & 
...
# 
# TerminatedDurCeilStat<-ddply(subset(def_full,
#                                 !is.na(Dur) & StartFY>=2007 & 
#                                     !is.na(Ceil) &
#                                     UnmodifiedCurrentCompletionDate<as.Date("2015-09-30")&
#                                     !is.na(Term)),
...
# 
# 
# TerminatedFxCb<-rbind(                         ddply(subset(def_full,
