...
def_all$pNewWork3Sig<-round(
  def_all$pNewWorkUnmodifiedBaseAndAll,3)
def_all$pChange3Sig<-round(
  def_all$pChangeOrderUnmodifiedBaseAndAll,3)
...
```{r QuantileSimpleDur}
df.QCrai.SDur<-ddply(subset(def_all,
                                        !is.na(Dur.Simple) & 
               !is.na(Ceil.Big) &
               !is.na(CRai) &
               StartFiscalYear>=2007 & 
